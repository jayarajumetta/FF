...
export type CandidateKind = 'fieldRef' | 'testId' | 'id' | 'role' | 'label' | 'placeholder' | 'name' | 'formControlName' | 'title' | 'text' | 'css' | 'xpath';
...
export declare const DEFAULT_FIELD_REF_ATTRIBUTES: readonly string[];
