# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 018_UMB_Smoke_Test_AL.feature
...
@CL_DC @UMB @smoke @Alabama @Edge @manual @automated
Feature: Execute UMB | Smoke Test for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the UMB | Smoke Test workflow for Alabama (AL)
  ...
  Scenario: UMB | Smoke Test using representative iteration Alabama (AL)
    ...
    When if field condition "'Product:*' != \"Carrier_SpecialFarmPackage  Pages   US   (4.0.0.0)\"" is satisfied, I enter or select "{CLICK}Carrier  CommercialUmbrella  Pages   US   (9.2.0.0){ENTER}{TAB}" in "Product:*"
    ...
    # Source step 0128: Logout | Module: Logout
    ...
    # Source step 0129: Sync for Log out | Module: TBox Wait
    ...
    # Source step 0130: Check for Http Error Msg | Module: Http Error Msg
    ...
    # Source step 0131: Click OK on Http Error Msg | Module: Http Error Msg
    ...
    # Source step 0132: Check Http Error Msg does not exist | Module: Http Error Msg
    ...
    # Source step 0133: Logout | Module: Logout
    ...
    # Source step 0135: Close Explorer Browsers | Module: TBox Start Program
    ...
    # Source step 0136: Close Chrome Browsers | Module: TBox Start Program
    ...
    # Source step 0137: Close Edge Browsers | Module: TBox Start Program
    ...
    # Source step 0138: Close Firefox Browsers | Module: TBox Start Program
    ...
    # Source step 0139: Close Edge Beta Browsers | Module: TBox Start Program
...
# --------------------------------------------------------------------------------------------------
# Source step 0001: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-2f20-80ce-5d027f96d60b
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
# Source step 0002: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-0bbc-87b9-c696eeadae1c
#    - INPUT "Loop Login" with "0"
#    - INPUT "UserName" with "AG09999"
# Source step 0003: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-fac9-aec4-4fe822fb7ba3
...
# Source step 0004: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-3968-7de2-c1a2b66057ad
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0005: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-84b8-db9f-2c3d95eb176a
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0006: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-6434-d312-6a080ca46ff9
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0007: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-c946-0e5f-d6935f35572b
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0008: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-441c-74d4-fe218eac2054
...
# Source step 0009: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-af77-d600-13b30884961e
#    - GROUP "Resource" with "EdgePreferences"
...
# Source step 0010: "Save changes" in module "Save JSON Resource" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-16bb-9737-7910feece8e3
...
# Source step 0011: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-e348-0088-b5a2e9c470cc
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0012: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-cc62-aed8-6406812d1d21
...
# Source step 0013: "OpenUrl" in module "OpenUrl" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-9b65-0001-b57c352824ae
...
# Source step 0014: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-1e76-7eaa-5e5d381c2f2b
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0015: "Check for Log In" in module "Logout" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Check to see if Logged In | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-971c-da15-d4976f72c7c2
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0016: "Logout" in module "Logout" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-cc6f-44d6-31c4ab9449e1
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0017: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-0eef-3b2d-7c78f032caf6
#    - INPUT "Duration" with "1000"
# Source step 0018: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-d84d-dd9a-746c0a359c17
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
# Source step 0019: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-e876-a782-b52ab405b685
#    - INPUT "OK" with "X"
# Source step 0020: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-fe6f-4417-554766be3728
#    - WAIT (Visible) "OK" with "True"
# Source step 0021: "Logout" in module "Logout" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-c0cb-39f3-0bbdca12d481
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0022: "Waiton Username to exist" in module "Login" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com] | 02.08.24 09:13:13 [Admin]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-c273-3ca8-b7aec4510c97
#    - WAIT (Exists) "UserName" with "True"
# Source step 0023: "Login" in module "Login" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-de45-dda2-03d4f2ab6c65
#    - INPUT "UserName" with "AG0u388{TAB}"
#    - INPUT "Password" with "${ENV:CL_DC_PASSWORD}"
#    - INPUT "Login" with "X"
# Source step 0024: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b56-dac7-c8c0-fac02abd5878
#    - WAIT (Exists) "Login" with "True"
# Source step 0025: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b65-9d3a-ea10-1be15024abf3
#    - INPUT "Loop Login" with "1"
# Source step 0026: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b65-9f8f-9b30-3e3861d1c79e
#    - INPUT "Filename" with "Login Error"
# Source step 0027: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:28:07 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8b65-22e6-f245-a3bc367fedea
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-5de3-cfd5-231527f0bd4e
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-70eb-b20b-7cdacd9f948a
#    - INPUT "Loop Login" with "0"
#    - INPUT "UserName" with "AG09999"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-9b67-b09e-63b9215d18a2
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-5a7f-7226-afbe521a5e7a
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-8af1-e864-1a3ddacda0d4
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-fab0-5fb9-4343acb524b9
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-5951-ac36-ceab3b049211
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-edfa-e82f-8dd6a014859d
#    - GROUP "Resource" with "EdgePreferences"
#    - GROUP "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-931b-5497-5998d9be5f0c
#    - GROUP "Resource" with "EdgePreferences"
#    - GROUP "RootObject" with "a blank/null value"
#    - GROUP "RootObject > profile" with "a blank/null value"
#    - INPUT "RootObject > profile > exit_type" with "none"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-43ce-116b-f656efcd5819
#    - INPUT "Resource" with "EdgePreferences"
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-9f46-813b-f0b32acf3c2c
#    - INPUT "Resource" with "EdgePreferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-6c6c-ec4f-1a27e2777949
#    - INPUT "Directory" with "the RUNTIME-DERIVED source value %USERPROFILE%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default"
#    - INPUT "File" with "Cookies"
# Source step 0111: "OpenUrl" in module "OpenUrl" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-6b14-fd34-bed9b23220c9
#    - INPUT "Url" with "https://clasq.anico.com/Express/"
#    - INPUT "UseActiveTab" with "a blank/null value"
#    - GROUP "WebDriverBrowserArguments" with "a blank/null value"
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-d244-f4bb-ea573e96472a
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0113: "Check for Log In" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Check to see if Logged In | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-f754-bf6b-18fd27a4dc99
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0114: "Logout" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e08-e2ae-8205-da7c81bdcc34
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-f06f-f5d9-f1d520a39dd2
#    - INPUT "Duration" with "1000"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-58f6-4080-88e00c847634
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-ca34-a349-6b4101e49be4
#    - INPUT "OK" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-4479-6dfc-c622835f3a15
#    - WAIT (Visible) "OK" with "True"
# Source step 0119: "Logout" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-1998-a843-a7ca9b553895
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-0874-9d1c-aa5f9b2a54fb
#    - WAIT (Exists) "UserName" with "True"
# Source step 0121: "Login" in module "Login" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-954c-2987-37f76e225a21
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-687c-f3f7-86a75c688842
#    - WAIT (Exists) "Login" with "True"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-3d9b-4f3f-378785d9ac6b
#    - INPUT "Loop Login" with "1"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-d261-b5f1-a6997244ba99
#    - INPUT "Filename" with "Login Error"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a1633fd-8e17-3c1a-a2d2-e0770fb3d348
#    - INPUT "GetHostname" with "the RUNTIME-DERIVED source value \"\"\"${COMPUTERNAME}\"\"\""
#    - INPUT "AgentName" with "the RUNTIME-DERIVED source value {B[GetHostname]}"
...
# Source step 0134: "Waiton Username to exist" in module "Login" was disabled. Reason: 02.08.24 09:13:13 [Admin]
...
# Active source step 0075 "Enter other insured info" contains conditionally inapplicable field action(s):
#    - INPUT "Name of Audit contact" with "{TAB}{CLICK}Auditor Doe{TAB}{TAB}" when 'Product (LOB)' != "UMB". Reason: Value condition evaluated false for the selected iteration: 'Product (LOB)' != "UMB"
