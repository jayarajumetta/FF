# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 003_CPP_Basic_Policy_AZ.feature
...
@CL_DC @CPP @basic_policy @Arizona @Edge @manual @automated
Feature: Execute CPP | Basic Policy for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the CPP | Basic Policy workflow for Arizona (AZ)
  ...
  Scenario: CPP | Basic Policy using representative iteration Arizona (AZ)
    ...
    When I enter or select "AZ CPP Testing, Inc.{TAB}" in "Business Name"
    ...
    When I retain hard-coded value "CPP" as runtime value "Product (LOB)"
    When I retain hard-coded value "CPP_BASIC" as runtime value "FormOnPolicyDocName"
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-14b4-ff5f-9400097fd443
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-ce47-a681-c281c6c55378
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-f593-ad2c-5500efd21881
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-d82d-c36f-584da91460f9
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-b2fa-d1cc-2f39a76a28dd
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-4ad0-49c2-45982457f0be
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-c4ee-51c3-64821359ba58
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-6cbd-73b9-56f9eeb923f6
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-54f8-0683-6ca651ea7bcd
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-5991-b960-6da8b0c203fe
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-b127-30e5-045b7b8eaa68
    # Source template XTestStep: 3a13d49c-165b-f6d6-53ae-4d4d2d531699
    Then I wait until "Client Search" exists
    When I click or select "Client Search"

    # Source step 0065: Click Ok | Module: Client Search Results
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-162e-70e7-4655-a24d1916f255
    ...
    # Source step 0066: Navigate to Policy Info Screen | Module: Common Navigation Links
    ...
    # Source step 0067: Wait for screen to appear | Module: Policy Info|Required and Optional Fields
    ...
    # Source step 0069: Enter Effective Date | Module: Policy Info|Required and Optional Fields
    ...
    # Source step 0071: Enter Primary Rating State | Module: Policy Info|Required and Optional Fields
    ...
    # Source step 0072: State is Kansas | Module: TBox Evaluation Tool
    ...
    # Source step 0074: State is Virginia | Module: TBox Evaluation Tool
    ...
    # Source step 0077: Tab out of Primary Rating State Field (For syncronization) | Module: Policy Info|Required and Optional Fields
    ...
    # Source step 0078: Wait for Synchronization | Module: TBox Wait
    ...
    # Source step 0079: Get Quote ID and Buffer | Module: Verify JavaScript Result
    ...
    # Source step 0080: ------->>> DESCRIPTION BUFFER | Module: Policy Info|Required and Optional Fields
    ...
    When I enter RUNTIME-DERIVED value "AZ CPP Basic {NMONTH}.{NDAY}.{NYEAR} {Time}{TAB}" in "Description of Specified Operation"
    ...
    # Source step 0084: Insurance Score | Module: Policy Info|Insurance Score
    ...
    # Source step 0085: Check if it is BAP VT | Module: TBox Evaluation Tool
    ...
    # Source step 0086: Click Insurance Score Consent if available | Module: Policy Info|Insurance Score
    ...
    # Source step 0087: Click Insurance Score and wait for Loading Window | Module: Policy Info|Insurance Score
    ...
    # Source step 0088: Insurance Score | Module: Policy Info|Insurance Score
    ...
    # Source step 0089: Wait 1/2 Second for a max of 60 seconds | Module: TBox Wait
    ...
    # Source step 0093: Wait 1/2 Second | Module: TBox Wait
    ...
    # Source step 0096: Policy Info|CPP Specific Fields - Select IM Checkbox | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select CPP Coverage - GL | Source XTestStep: 3a13d49c-1679-6765-a7e6-ec465c12a945
    When if field condition "(State == \"MD\")||(State == \"NJ\")||(State == \"NY\")||(State == \"VT\")" is satisfied, I leave "Estimated Premium*" blank because the reusable parameter is not supplied for this iteration
    When if field condition "'CPP LOB' == \"GL\"" is satisfied, I click or select "GL"

    # Source step 0097: Policy Info|CPP Specific Fields - Select CP Checkbox | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select CPP Coverage - CP | Source XTestStep: 3a13d49c-1679-64b3-981b-ede79a0d8575
    When if field condition "'CPP LOB' == \"CP\"" is satisfied, I click or select "CP"

    # Source step 0098: Policy Info|CPP Specific Fields - Select IM Checkbox | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select CPP Coverage - IM | Source XTestStep: 3a13d49c-1679-bade-0208-5f9c46979eec
    When if field condition "'CPP LOB' == \"IM\"" is satisfied, I click or select "IM"

    # Source step 0099: Policy Info|CPP Specific Fields | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select CP Detail | Source XTestStep: 3a13d49c-1679-1311-890f-9864b59c58f8
    When if field condition "'CPP LOB' == \"CP\"" is satisfied, I click or select "CP Detail"

    # Source step 0101: Answer CP Policy Covg  Private Windmills question | Module: Policy Covg
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Policy Covg|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-e0ab-6f3b-c188992d4dc7
    Then I wait until "Policy Covg" exists
    When I enter or select "{CLICK}No{ENTER}{TAB}" in "Does any Risk generate power other than Private Windmills or Emergency Backup?*"

    # Source step 0102: Taskbar|Start Button Click Once | Module: Taskbar|Start Button
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Policy Covg|Fill out CP Fields > Common|General|Mask Error Recovery | Source XTestStep: 3a141601-c534-8b80-388b-028f54c064da
    When I click or select "Start"

    # Source step 0103: Taskbar|Start Button Click Once | Module: Taskbar|Start Button
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Policy Covg|Fill out CP Fields > Common|General|Mask Error Recovery | Source XTestStep: 3a141602-8798-4778-640a-dab2517fd518
    When I click or select "Start"

    # Source step 0104: Fill out CP Policy Covg Fields | Module: Policy Covg
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Policy Covg|Fill out CP Fields | Source XTestStep: 3a14635d-54fb-cb82-423a-bac694a6dd36
    When I enter or select "Building & Property{TAB}" in "Policy Coverage"
    When if field condition "'Property Extension Endorsements' != NULL" is satisfied, I enter or select "{CLICK}Silver{ENTER}{TAB}" in "Property Extension Endorsements"
    When if field condition "'Utility Services' != NULL" is satisfied, I enter or select "No{TAB}" in "Utility Services"
    When if field condition "Fungus != NULL" is satisfied, I enter or select "No{TAB}" in "Fungus"

    # Source step 0106: Navigate to Location Screen | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-f236-54dc-b5f3ec8c62cc
    When I click or select "Location"

    # Source step 0107: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-7522-4601-dd3f15877788
    Then I wait until "Address1" exists
    When I enter or select "{TAB}{TAB}1-100{ENTER}{TAB}{TAB}" in "Feet From Hydrant"

    # Source step 0108: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    ...
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0110: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0111: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0112: Fill out CP Location Fields - Miles from FD | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f1c0d-04b7-ad41-2292-b402c4e7ab78
    Then I wait until "Address1" exists
    When I enter or select "{TAB}1{TAB}{TAB}" in "Miles From Fire Department"
    ...
    # Source step 0115: Verify Ft from Hydrant | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f2135-0b1e-da50-e565-2b2b0626dea1
    # Runtime control: If Ft from Hydrant is not entered > Check if Ft from Hydrant is entered
    Then "Feet From Hydrant" property "Value" should does not equal "1-100"

    # Source step 0116: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f2135-1466-eb73-5889-37c9f5655e66
    # Runtime control: If Ft from Hydrant is not entered > Then
    Then I wait until "Address1" exists
    When I enter or select "{TAB}{TAB}1-100{ENTER}{TAB}{TAB}" in "Feet From Hydrant"

    # Source step 0117: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0118: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0119: Fill out CP Location Fields - Call ISO and Select PPC | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f2139-0f16-f884-99bf-50379287767d
    Then I wait until "Address1" exists
    When I click or select "Call ISO"
    When I click or select "Select PPC"
    When I click or select "Select"

    # Source step 0120: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0121: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0122: Verify Ft from Hydrant | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f30c4-9ce6-eb0c-1d8f-c878aa74b6e0
    # Runtime control: If Ft from Hydrant is not entered > Check if Ft from Hydrant is entered
    Then "Feet From Hydrant" property "Value" should does not equal "1-100"

    # Source step 0123: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f30c4-9cea-05e2-4ad7-72e501ec368c
    # Runtime control: If Ft from Hydrant is not entered > Then
    Then I wait until "Address1" exists
    When I enter or select "{CLICK}{CLICK}1-100{ENTER}{ENTER}{TAB}{TAB}" in "Feet From Hydrant"

    # Source step 0124: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0125: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0126: Click OK on CP Location Fields - Call ISO and Select PPC | Module: Location
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields | Source XTestStep: 3a1f30c4-f634-76a6-6610-31db8bd4b358
    Then I wait until "Address1" exists
    When I click or select "OK"

    # Source step 0127: Navigate to Building Screen | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Building|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-f425-295e-50235836f9d0
    When I click or select "Building"

    # Source step 0128: Building - Add Building | Module: Building - Main
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Building|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-3a89-5fd8-2475291a85f6
    Then I wait until "Building" exists
    When I click or select "Add Building"

    # Source step 0129: Building - Select Building Detail | Module: Building - Main
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Building|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-89bf-16b6-51eb94503ada
    Then I wait until "Building" exists
    When I click or select "Detail"

    # Source step 0130: Building - Fill in Building Detail Fields | Module: Building - Detail
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Building|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-324c-10a1-36bcbb391bea
    When if field condition "Construction != NULL" is satisfied, I enter or select "{TAB}Frame{TAB}" in "Construction"
    When if field condition "'Year Built' != NULL" is satisfied, I enter or select "{TAB}2000{TAB}" in "Year Built"
    When if field condition "'Square Feet' != NULL" is satisfied, I enter or select "{TAB}2500{TAB}" in "Square Feet"
    When if field condition "Stories != NULL" is satisfied, I enter or select "{TAB}2{TAB}" in "Stories"
    When if field condition "Interest != NULL" is satisfied, I enter or select "{TAB}Owner{TAB}" in "Interest"
    When if field condition "'Roof Type' != NULL" is satisfied, I enter or select "{TAB}Asphalt shingle{TAB}" in "Roof Type*"
    When if field condition "Deductible != NULL" is satisfied, I enter or select "{TAB}{TAB}{CLICK}{CLICK}500{TAB}" in "Deductible"
    When if field condition "'Deductible Increased Theft' != NULL" is satisfied, I enter or select "{TAB}N/A{TAB}" in "Deductible Increased Theft"
    When if field condition "'Deductible Wind Hail' != NULL" is satisfied, I enter or select "{TAB}N/A{TAB}" in "Deductible Wind Hail"
    When if field condition "'BG2 Symbol' != NULL" is satisfied, I enter or select "{TAB}A{TAB}" in "BG2 Symbol"
    When if field condition "'BG2 Symbol Prefix' != NULL" is satisfied, I enter or select "{CLICK}1{TAB}" in "BG2 Symbol Prefix"
    When if field condition "'Is the building cooled?' != NULL" is satisfied, I enter or select "{TAB}No{TAB}" in "Is the building cooled?*"
    When if field condition "'Is the building heated with a Solid Fuel Heating Device?' != NULL" is satisfied, I enter or select "{TAB}{CLICK}No{TAB}" in "Is the building heated with a Solid Fuel Heating Device?*"
    When if field condition "'Provide a List of Surrounding Exposure/Other Occupancies within 100 ft (Including North, East, South, and West)' != NULL" is satisfied, I enter or select "{TAB}{CLICK}None{TAB}" in "Provide a List of Surrounding Exposure/Other Occupancies within 100 ft (Including North, East, South, and West)"
    When if field condition "'Eligible For Enhanced Wind Rating Program' != NULL" is satisfied, I enter or select "{TAB}No{TAB}" in "Eligible For Enhanced Wind Rating Program"
    When I click or select "OK"

    # Source step 0131: Navigate to Rating Groups Screen | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Rating Groups|Add a Rating Group | Source XTestStep: 3a13d49c-166a-aa15-6529-2aefe5735886
    When I click or select "Rating Groups"

    # Source step 0132: Add Rating Groups | Module: Rating Groups
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Rating Groups|Add a Rating Group | Source XTestStep: 3a13d49c-166a-422c-6f15-174d21ff5ca1
    Then I wait until "Rating Groups" exists
    When if field condition "Description != NULL" is satisfied, I enter or select "{TAB}New Rating Group{TAB}" in "Description"
    When if field condition "'Risk Type' != NULL" is satisfied, I enter or select "{TAB}Direct Damage{TAB}" in "Risk Type"
    When if field condition "Coinsurance != NULL" is satisfied, I enter or select "{TAB}50%{TAB}" in "Coinsurance"
    When if field condition "Deductible != NULL" is satisfied, I enter or select "{TAB}500{TAB}" in "Deductible"
    When if field condition "'Deductible Increased Theft' != NULL" is satisfied, I enter or select "{TAB}500{TAB}" in "Deductible Increased Theft"
    When if field condition "'Deductible Wind Hail' != NULL" is satisfied, I enter or select "{TAB}2%{TAB}" in "Deductible Wind Hail"
    When if field condition "'Cause Of Loss' != NULL" is satisfied, I enter or select "{TAB}Basic{TAB}" in "Cause Of Loss"
    When if field condition "Valuation != NULL" is satisfied, I enter or select "{TAB}Replacement Cost{TAB}" in "Valuation"
    When I click or select "Add Group"

    # Source step 0133: Navigate to Property Screen | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Property Main|Fill out Structure Questions | Source XTestStep: 3a13d49c-166a-fdc6-b159-e7701fc27a87
    When I click or select "Property"

    # Source step 0134: Fill out Main Property Questions | Module: Property - Main
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Property Main|Fill out Structure Questions | Source XTestStep: 3a13d49c-166a-9a24-ec4f-32f11cd3e012
    When if field condition "'Increased Pollutant Cleanup' != NULL" is satisfied, I enter or select "{TAB}Yes{TAB}" in "Increased Pollutant Cleanup"
    When if field condition "'Debris Removal Additional' != NULL" is satisfied, I enter or select "{TAB}Yes{TAB}" in "Debris Removal Additional"
    When if field condition "'Debris Removal Additional Limit' != NULL" is satisfied, I enter or select "{TAB}15,000{TAB}" in "Debris Removal Additional Limit"
    When if field condition "'Vacant Building' != NULL" is satisfied, I enter or select "{TAB}Yes{TAB}" in "Vacant Building"
    When if field condition "'% Occupied' != NULL" is satisfied, I enter or select "{TAB}75{TAB}" in "% Occupied"
    When if field condition "'Pier Or Wharf' != NULL" is satisfied, I enter or select "{TAB}Yes{TAB}" in "Pier Or Wharf"
    When if field condition "'Pier Or Wharf Construction' != NULL" is satisfied, I enter or select "{TAB}Fire Resistive Without Superstructure{TAB}" in "Pier Or Wharf Construction"
    When if field condition "'Pier Or Wharf Cause Of Loss' != NULL" is satisfied, I enter or select "{TAB}Basic{TAB}{TAB}" in "Pier Or Wharf Cause Of Loss"
    When if field condition "'Pier Or Wharf COL Options' != NULL" is satisfied, I enter or select "{TAB}{CLICK}Standard Perils{TAB}" in "Pier Or Wharf COL Options"
    When if field condition "'Vacancy Permit' != NULL" is satisfied, I enter or select "{TAB}No{TAB}" in "Vacancy Permit"
    Then if field condition "'Pier Or Wharf COL Options' != NULL" is satisfied, I wait until "Pier Or Wharf COL Options" exists

    # Source step 0135: Property Add Class | Module: Property Add Class
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Property Main|Fill out Structure Questions | Source XTestStep: 3a13d49c-166a-84e8-51f4-43748632a540
    When I click or select "Add Class"
    When if field condition "(State !=\"OR\")||(State!=\"WA\")||(State!=\"VT\")" is satisfied, I enter or select "{CLICK}[2200] Bakeries - Baking on premises - delivery to other outlets{TAB}{TAB}" in "Search Value"
    When if field condition "(State !=\"OR\")||(State!=\"WA\")||(State!=\"VT\")" is satisfied, I enter or select "{CLICK}[2200] Bakeries - Baking on premises - delivery to other outlets{ENTER}{TAB}{TAB}" in "Search Results"
    When I enter or select "{CLICK}Apartment House{TAB}" in "Occupancy Type"
    When if field condition "(State ==\"OR\")||(State==\"WA\")" is satisfied, I leave "Search Results" blank because the reusable parameter is not supplied for this iteration
    When I click or select "OK"
    When I enter or select "{TAB}{CLICK}New Rating Group{TAB}" in "Building Rating Group"
    When I enter or select "{TAB}50000{TAB}" in "Building Limit"
    When I enter or select "{TAB}New Rating Group{TAB}" in "Personal Property Rating Group"
    When I enter or select "{TAB}25000{TAB}" in "Personal Property Limit"
    When I enter or select "{TAB}New Rating Group{TAB}{TAB}" in "Property of Others Rating Group"
    When I enter or select "{TAB}10000{TAB}" in "Property of Others Limit"
    When if field condition "(State ==\"OR\")||(State==\"WA\")" is satisfied, I enter or select "{CLICK}[2459] Wine Mfg.{TAB}{TAB}" in "Search Value"

    # Source step 0136: Property Enter Building RCT | Module: Property Enter Building RCT
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Property Main|Fill out Structure Questions | Source XTestStep: 3a13d49c-166a-573a-a579-ebd326538044
    When I click or select "Detail"
    When I enter or select "{TAB}RCT{TAB}" in "Estimator Type*"
    When I enter or select "{TAB}Standard RCT - Use Defaults{TAB}" in "Valuation Type*"
    When I click or select "Create Valuation"
    When I click or select "Get Calculated Value"
    When I click or select "OK"

    # Source step 0137: Property Add Class | Module: Property Add Class
    # Section: New Application - Data Entry Process | Reusable flow: CPP|CP|Property|Ensure Property of Others Rating Group has been entered | Source XTestStep: 3a13d49c-1679-8967-d0a9-f881abad90f4
    # Runtime control: Check if Others Rating Group is populated [max=30] > Condition
    Then "Property of Others Rating Group" property "Value" should does not equal "New Rating Group"

    # Source step 0138: Property Add Class | Module: Property Add Class
    # Section: New Application - Data Entry Process | Reusable flow: CPP|CP|Property|Ensure Property of Others Rating Group has been entered | Source XTestStep: 3a13d49c-1679-7cfa-a421-aaa821c854f1
    # Runtime control: Check if Others Rating Group is populated [max=30] > Loop > If Others Rating Group is not populated > Condition
    Then "Property of Others Rating Group" property "Value" should does not equal "New Rating Group"

    # Source step 0139: Property Add Class | Module: Property Add Class
    # Section: New Application - Data Entry Process | Reusable flow: CPP|CP|Property|Ensure Property of Others Rating Group has been entered | Source XTestStep: 3a13d49c-1679-4c6d-273f-f47b0994e495
    # Runtime control: Check if Others Rating Group is populated [max=30] > Loop > If Others Rating Group is not populated > Then Populate the Others Rating Group
    When I enter or select "New Rating Group{TAB}{TAB}" in "Property of Others Rating Group"

    # Source step 0140: CP Navigation Links | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Addl Interests|Add Addl Interests | Source XTestStep: 3a13d49c-166a-d233-f2a4-bb15437635a1
    When I click or select "Addl Interests"

    # Source step 0141: Addl Interests - Main | Module: Addl Interests - Main
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Addl Interests|Add Addl Interests | Source XTestStep: 3a13d49c-166a-6fdc-11ac-5c5822d2f194
    When I click or select "Add Addl Interest"

    # Source step 0142: Addl Interests - Loss Payee | Module: Addl Interests - Loss Payee
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Addl Interests|Add Addl Interests | Source XTestStep: 3a13d49c-166a-0a2b-ee92-23fc588760e9
    When I enter or select "{TAB}{CLICK}Loss Payee{TAB}" in "Type"
    When I enter or select "{TAB}{CLICK}1234{TAB}" in "Loan Number"
    When I enter or select "{TAB}{CLICK}Individual/ Person{TAB}" in "Insured Type*"
    When I enter or select "{TAB}{CLICK}Thomas{TAB}" in "First Name*"
    When I enter or select "{TAB}{CLICK}J{TAB}" in "MI"
    When I enter or select "{TAB}{CLICK}Tester{TAB}" in "Last Name*"
    When I enter or select "{TAB}{CLICK}9 Center Road{TAB}" in "Address 1*"
    When I enter or select "{TAB}{CLICK}10541{TAB}" in "Zip Code*"
    When I enter or select "{TAB}{CLICK}Loss Payable{TAB}" in "Provisions Applicable*"
    When I enter or select "{TAB}{CLICK}Test Description {TAB}" in "Description Of Property*"
    When I click or select "Assign Locations..."
    Then I wait until "Other Interest Premises Schedule" exists
    When I click or select "New Assignment..."
    Then I wait until "New Assignment" exists
    When I click or select "Other Interest Premises Detail - OK"
    Then I wait until "Assignment Schedule for:" exists
    When I click or select "Assignment Schedule for - OK"
    When I click or select "Other Interest Premises Schedule - OK"
    When if field condition "State != \"OR\"" is satisfied, I click or select "Addl Interests Main - OK"

    # Source step 0143: Navigate to Property UW Questions | Module: CP Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Fill out Property UW Questions | Source XTestStep: 3a13d49c-166a-e5d7-e3ea-29ec59f0b1d0
    When I click or select "Property UW Questions"

    # Source step 0144: Update Answers for Property UW Questions | Module: Property UW Questions
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Fill out Property UW Questions | Source XTestStep: 3a13d49c-166a-e315-6e4e-8960df4956b4
    Then I wait until "Property UW Questions" exists
    When I enter or select "{TAB}{TAB}X{TAB}{TAB}" in "Update Answers"

    # Source step 0146: Common Navigation Links | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Return to CPP Navigation | Source XTestStep: 3a13d49c-1679-44b4-b8f5-e21c02656efb
    When I click or select "Return To CPP"

    # Source step 0147: Navigate to Policy Info | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select GL Detail | Source XTestStep: 3a13d49c-1679-cdb3-e0ba-acbbcd702729
    When I click or select "Policy Info"

    # Source step 0148: Policy Info|CPP Specific Fields | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select GL Detail | Source XTestStep: 3a13d49c-1679-97b4-cb7b-4cb0cec4826c
    When if field condition "'CPP LOB' == \"GL\"" is satisfied, I click or select "GL Detail"

    # Source step 0150: Policy Covg|GL | Module: Policy Covg|GL
    ...
    When if field condition "'Coverage Form' != \"OCP\"" is satisfied, I leave "Products Agg Limit" blank because the reusable parameter is not supplied for this iteration
    ...
    When if field condition "'Coverage Form' != \"OCP\"" is satisfied, I leave "Fire Damage" blank because the reusable parameter is not supplied for this iteration
    When if field condition "'Coverage Form' != \"OCP\"" is satisfied, I leave "Medical" blank because the reusable parameter is not supplied for this iteration
    When if field condition "'Coverage Form' != \"OCP\"" is satisfied, I leave "Pers Adv Inj" blank because the reusable parameter is not supplied for this iteration
    ...
    # Source step 0151: Navigate to CGL Screen | Module: GL Navigation Links
    ...
    # Source step 0152: CGL|Main Page | Module: CGL|Main Page
    ...
    # Source step 0153: CGL|Add Class | Module: CGL|Add Class
    ...
    # Source step 0154: CGL|Add Class Exposure | Module: CGL|Main Page
    ...
    # Source step 0155: Navigate to Endorsements Screen | Module: GL Navigation Links
    ...
    # Source step 0156: Endorsements|Main | Module: Endorsements|Main
    ...
    # Source step 0157: Add [CG0435] Employee Benefits Liability Endorsement | Module: [CG0435] Employee Benefits Liability
    ...
    # Source step 0158: Navigate to Endorsements Screen | Module: GL Navigation Links
    ...
    # Source step 0159: Endorsements|Main | Module: Endorsements|Main
    ...
    # Source step 0160: Add [CG2142] Exclusion - Explosion, Collapse and Underground Property Damage Hazard (Specified Operations) Endorsement | Module: [CG2142] Exclusion - Explosion, Collapse and Underground Property Damage Hazard (Specified Operations)
    ...
    # Source step 0161: Navigate to Endorsements Screen | Module: GL Navigation Links
    ...
    # Source step 0162: Endorsements|Main | Module: Endorsements|Main
    ...
    # Source step 0163: Add [CG 2149] Total Pollution Exclusion Endorsement | Module: [CG 2149] Total Pollution Exclusion Endorsement
    ...
    # Source step 0164: FG0055 EPLI Table | Module: FG0055 EPLI Table
    ...
    # Source step 0165: [FG0055] Employment Practices Liability Insurance Coverage Endorsement | Module: [FG0055, FG0062, FG0063, FG0069, FG0071, FG0072, FG0074, FG0077, FG0078] Employment Practices Liability Insurance Coverage Endorsement
    ...
    # Source step 0166: Navigate to Addl Interests Screen | Module: GL Navigation Links
    ...
    # Source step 0167: Select Addl Interests Button | Module: Addl Interests|Main
    ...
    # Source step 0168: Add [CG 20 07] Add'l Insured-Engineers, Architects | Module: [CG 20 07] Add'l Insured-Engineers, Architects
    ...
    # Source step 0169: Navigate to Addl Interests Screen | Module: GL Navigation Links
    ...
    # Source step 0170: Select Addl Interests Button | Module: Addl Interests|Main
    ...
    # Source step 0171: Add [CG 20 20] Add'l Insured-Charitable Institution | Module: [CG 20 20] Add'l Insured-Charitable Institution
    ...
    # Source step 0172: Navigate to Addl Interests Screen | Module: GL Navigation Links
    ...
    # Source step 0173: Select Addl Interests Button | Module: Addl Interests|Main
    ...
    # Source step 0174: Add [CG 20 23] Add'l Insured-Executors | Module: [CG 20 23] Add'l Insured-Executors 
    ...
    # Source step 0175: Navigate to Addl Interests Screen | Module: GL Navigation Links
    ...
    # Source step 0176: Select Addl Interests Button | Module: Addl Interests|Main
    ...
    # Source step 0177: Add [CG 20 25] Add'l Insured-Executive Officers | Module: [CG 20 25] Add'l Insured-Executive Officers 
    ...
    # Source step 0178: Navigate to Addl Interests Screen | Module: GL Navigation Links
    ...
    # Source step 0179: Select Addl Interests Button | Module: Addl Interests|Main
    ...
    # Source step 0180: Add [CG 20 34] Add'l Insured-Leased Equipment Automatic | Module: [CG 20 34] Add'l Insured-Leased Equipment Automatic 
    ...
    # Source step 0181: Navigate to GL UW Questions | Module: GL Navigation Links
    ...
    # Source step 0182: Answer General Liability Information Questions | Module: General Liability Information
    ...
    # Source step 0183: Navigate to GL UW Questions | Module: GL Navigation Links
    ...
    # Source step 0184: Wait for General Liability Screen to Load | Module: General Liability Information
    ...
    # Source step 0185: Answer Products/Completed Ops Question | Module: Products/Completed Ops
    ...
    # Source step 0186: Common Navigation Links | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Return to CPP Navigation | Source XTestStep: 3a13d49c-1679-44b4-b8f5-e21c02656efb
    When I click or select "Return To CPP"

    # Source step 0187: Policy Info|CPP Specific Fields | Module: Policy Info|CPP Specific Fields
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select IM Detail | Source XTestStep: 3a13d49c-1679-3b4e-0fd2-318208cff989
    When if field condition "'CPP LOB' == \"IM\"" is satisfied, I click or select "IM Detail"

    # Source step 0189: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0190: Policy Covg - Accounts Receivable | Module: Policy Covg - Accounts Receivable
    ...
    # Source step 0191: Navigate to Policy Covg Screen | Module: IM Navigation Links
    ...
    # Source step 0192: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0193: Add Policy Covg - Bailees Customers | Module: Policy Covg - Bailees Cutomers
    ...
    # Source step 0194: Policy Covg - Bailees - Property Away from Your Premises | Module: Policy Covg - Bailees - Property Away from Your Premises
    ...
    # Source step 0195: Policy Covg - Bailees Cutomers Select OK to complete coverage | Module: Policy Covg - Bailees Cutomers
    ...
    # Source step 0196: Navigate to Policy Covg Screen | Module: IM Navigation Links
    ...
    # Source step 0197: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0198: Policy Covg - Computer Systems | Module: Policy Covg - Computer Systems
    ...
    # Source step 0199: Navigate to Policy Covg Screen | Module: IM Navigation Links
    ...
    # Source step 0200: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0201: Add Policy Covg - Contractors Equipment | Module: Policy Covg - Contractors Equipment
    ...
    Then I wait until "Coverage Form Display" exists
    When I perform keyboard action "{TAB}" on "Description*"
    When I enter or select "{TAB}{CLICK}Roadbuilding  Contractors{TAB}" in "Description*"
    ...
    # Source step 0202: Navigate to Policy Covg Screen | Module: IM Navigation Links
    ...
    # Source step 0203: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0204: Policy Covg - Motor Truck Cargo | Module: Policy Covg - Motor Truck Cargo
    ...
    # Source step 0205: Navigate to Policy Covg Screen | Module: IM Navigation Links
    ...
    # Source step 0206: Policy Covg - Main | Module: Policy Covg - Main
    ...
    # Source step 0207: Policy Covg - Signs | Module: Policy Covg - Signs
    ...
    # Source step 0208: Wait for prior screen to update | Module: TBox Wait
    ...
    # Source step 0209: Navigate to Risk Screen | Module: IM Navigation Links
    ...
    # Source step 0210: Risk - Main | Module: Risk - Main
    ...
    # Source step 0211: Risk - Accounts Receivable | Module: Risk - Accounts Receivable
    ...
    # Source step 0212: If search result Alert exists | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-3a82-38c2-886be674d4da
    # Runtime control: If search result Alert exists > Condition
    Then "Show me" should exist

    # Source step 0213: Select Show me button | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-1412-5a12-ed5f79d22fe6
    # Runtime control: If search result Alert exists > Then
    When I click or select "Show me"

    # Source step 0214: Risk - Accounts Receivable | Module: Risk - Accounts Receivable
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Accounts Receivable | Source XTestStep: 3a13d49c-1679-9081-7f3d-b899e1a9a87e
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0215: Risk - Accounts Receivable | Module: Risk - Accounts Receivable
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Accounts Receivable | Source XTestStep: 3a13d49c-1679-b810-19f4-9151f035bcfc
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0216: Risk - Accounts Receivable | Module: Risk - Accounts Receivable
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Accounts Receivable | Source XTestStep: 3a13d49c-1679-5773-ac9f-497e74deda79
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Then populate with IM Class
    Then I wait until "Accounts Receivable Heading" exists
    When I enter or select "{TAB}{CLICK}A{TAB}" in "Search Value"
    When I enter or select "{TAB}{CLICK}[6009] Abrasive Wheel Mfg.{ENTER}{TAB}" in "Search Result"
    When I click or select "OK"

    # Source step 0217: Navigate to Risk Screen | Module: IM Navigation Links
    ...
    # Source step 0218: Risk - Main | Module: Risk - Main
    ...
    # Source step 0219: Risk - Bailees Customers | Module: Risk - Bailees Customers
    ...
    # Source step 0220: If search result Alert exists | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-3a82-38c2-886be674d4da
    # Runtime control: If search result Alert exists > Condition
    Then "Show me" should exist

    # Source step 0221: Select Show me button | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-1412-5a12-ed5f79d22fe6
    # Runtime control: If search result Alert exists > Then
    When I click or select "Show me"

    # Source step 0222: Risk - Bailees Customers | Module: Risk - Bailees Customers
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Bailees Customers | Source XTestStep: 3a13d49c-1679-e09d-675e-46aa28e63819
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0223: Risk - Bailees Customers | Module: Risk - Bailees Customers
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Bailees Customers | Source XTestStep: 3a13d49c-1679-10a5-8167-3b2e1c195307
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0224: Risk - Bailees Customers | Module: Risk - Bailees Customers
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Bailees Customers | Source XTestStep: 3a13d49c-1679-498e-7200-afe3512d52ec
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Then populate with IM Class
    When I enter or select "{TAB}{CLICK}B{TAB}" in "Search Value"
    When I enter or select "{TAB}{CLICK}[6009] Brick Mfg.{ENTER}{TAB}" in "Search Result"
    When I click or select "OK"

    # Source step 0225: Navigate to Risk Screen | Module: IM Navigation Links
    ...
    # Source step 0226: Risk - Main | Module: Risk - Main
    ...
    # Source step 0227: Risk - Computer Equipment | Module: Risk - Computer Systems
    ...
    # Source step 0228: If search result Alert exists | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-3a82-38c2-886be674d4da
    # Runtime control: If search result Alert exists > Condition
    Then "Show me" should exist

    # Source step 0229: Select Show me button | Module: Duck Creek Policy
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Alert msg|If search result Alert exists | Source XTestStep: 3a13d49c-1679-1412-5a12-ed5f79d22fe6
    # Runtime control: If search result Alert exists > Then
    When I click or select "Show me"

    # Source step 0230: Risk - Computer Systems | Module: Risk - Computer Systems
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Computer Systems | Source XTestStep: 3a13d49c-1679-a693-0443-4a2dc32eee1f
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0231: Risk - Computer Systems | Module: Risk - Computer Systems
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Computer Systems | Source XTestStep: 3a13d49c-1679-8edf-6d13-4e9f58cac987
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Condition
    Then "Search Result" property "Value" should equals "(select)"

    # Source step 0232: Risk - Computer Systems | Module: Risk - Computer Systems
    # Section: New Application - Data Entry Process | Reusable flow: CPP|IM|Risk|Ensure Class has been entered for Computer Systems | Source XTestStep: 3a13d49c-1679-4614-9ae4-5f590d59c6b2
    # Runtime control: Check if Search Result is populated with IM Class [max=30] > Loop > If Search Result is not populated > Then populate with IM Class
    When I enter or select "{TAB}{CLICK}H{TAB}" in "Search Value"
    When I enter or select "{TAB}{CLICK}[2300] Honey Extracting{ENTER}{TAB}{TAB}" in "Search Result"
    When I click or select "OK"

    # Source step 0233: Navigate to Risk Screen | Module: IM Navigation Links
    ...
    # Source step 0234: Risk - Main | Module: Risk - Main
    ...
    # Source step 0235: Risk - Signs | Module: Risk - Signs
    ...
    # Source step 0236: Navigate to Endorsement Screen | Module: IM Navigation Links
    ...
    # Source step 0237: Endorsement - Main | Module: Endorsement - Main
    ...
    # Source step 0238: Endorsement - CM 66 01 Exclude Named Customer | Module: Endorsement - CM 66 01 Exclude Named Customer
    ...
    # Source step 0239: Navigate to Endorsement Screen | Module: IM Navigation Links
    ...
    # Source step 0240: Endorsement - Main | Module: Endorsement - Main
    ...
    # Source step 0241: Endorsement - IF 00 02 Waterborne Equipment | Module: Endorsement - IF 00 02 Waterborne Equipment
    ...
    # Source step 0242: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0243: Navigate to Accounts Receivable UW Questions | Module: IM Navigation Links
    ...
    # Source step 0244: Specific Underwriting Questions - Accounts Receivable | Module: Specific Underwriting Questions - Accounts Receivable
    ...
    # Source step 0245: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0246: Navigate to Bailees Customers UW Questions | Module: IM Navigation Links
    ...
    # Source step 0247: Specific Underwriting Questions - Bailees Customer | Module: Specific Underwriting Questions - Bailees Customer
    ...
    # Source step 0248: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0249: Navigate to Computer Systems UW Questions | Module: IM Navigation Links
    ...
    # Source step 0250: Specific Underwriting Questions - Computer Systems | Module: Specific Underwriting Questions - Computer Systems
    ...
    # Source step 0251: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0252: Navigate to Computer Systems UW Questions | Module: IM Navigation Links
    ...
    # Source step 0253: Specific Underwriting Questions - Contractors Equipment | Module: Specific Underwriting Questions - Contractors Equipment
    ...
    # Source step 0254: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0255: Navigate to Computer Systems UW Questions | Module: IM Navigation Links
    ...
    # Source step 0256: Specific Underwriting Questions - Motor Truck Cargo(Owners) | Module: Specific Underwriting Questions - Motor Truck Cargo(Owners)
    ...
    # Source step 0257: Navigate to Specific Underwriting Questions | Module: IM Navigation Links
    ...
    # Source step 0258: Navigate to Computer Systems UW Questions | Module: IM Navigation Links
    ...
    # Source step 0259: Specific Underwriting Questions - Signs | Module: Specific Underwriting Questions - Signs
    ...
    # Source step 0260: Common Navigation Links | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Return to CPP Navigation | Source XTestStep: 3a13d49c-1679-44b4-b8f5-e21c02656efb
    When I click or select "Return To CPP"

    # Source step 0261: Check for Loading Indicator | Module: Indicators and Errors
    ...
    # Source step 0262: Wait 2 secs | Module: TBox Wait
    ...
    # Source step 0263: Wait for screen to fully refresh | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Pricing|Select GL Available Classiifcation | Source XTestStep: 3a13d49c-1679-fc60-a08e-2dce1f0f76ae
    When I wait "750" milliseconds

    # Source step 0264: Navigate to Pricing Screen | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Pricing|Select GL Available Classiifcation | Source XTestStep: 3a13d49c-1679-1804-265a-8bf5c9c2a5d2
    When I click or select "Pricing"

    # Source step 0265: CPP|Pricing|Select GL Class | Module: CPP|Pricing
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Pricing|Select GL Available Classiifcation | Source XTestStep: 3a13d49c-1679-3858-64f7-1acc07f1286b
    When I enter or select "{TAB}{CLICK}[13590] - Glass Dealers and Glaziers{TAB}{ENTER}" in "Available Classifications*"

    # Source step 0266: CPP|Basic|Navigate to Client Screen | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Navigate to Underwriting Info Screens | Source XTestStep: 3a13d49c-1679-368b-f4b0-76d8174598a9
    When I click or select "Client"

    # Source step 0267: CPP|Basic|Navigate to Underwriting Info Screen | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Navigate to Underwriting Info Screens | Source XTestStep: 3a13d49c-1679-87d4-d603-e222fdbbf81c
    When I click or select "Underwriting Info"

    # Source step 0268: CPP|Client|Underwriting Info|Navigation | Module: CPP|Client|Underwriting Info|Navigation
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer General UW Questions | Source XTestStep: 3a13d49c-1679-4a50-fce4-b84c2a8cc9e9
    When I click or select "General UW Questions"

    # Source step 0269: Underwriting Info | General UW Questions | Module: Underwriting Info | General UW Questions
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer General UW Questions | Source XTestStep: 3a13d49c-1679-813e-48c2-ef6d95a218b4
    Then I wait until "General UW Questions" exists
    When I click or select "Update Answers"

    # Source step 0270: CPP|Client|Underwriting Info|Navigation | Module: CPP|Client|Underwriting Info|Navigation
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer General Liability History Questions | Source XTestStep: 3a13d49c-1679-87b7-7415-bdb762cadc4a
    When I click or select "Commercial General Liability History"

    # Source step 0271: CPP|Client|Underwriting Info|Commercial General Liability History | Module: CPP|Client|Underwriting Info|Commercial General Liability History
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer General Liability History Questions | Source XTestStep: 3a13d49c-1679-6efa-79b9-1f268eb8e3dc
    Then I wait until "Commercial General Liability History" exists
    When I enter or select "{TAB}{CLICK}No{TAB}" in "Is there a Prior Carrier?"

    # Source step 0272: CPP|Client|Underwriting Info|Navigation | Module: CPP|Client|Underwriting Info|Navigation
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer Commercial Property History Questions | Source XTestStep: 3a13d49c-1679-a929-e700-a99e793270c4
    When I click or select "Commercial Property History"

    # Source step 0273: CPP|Client|Underwriting Info|Commercial Property History | Module: CPP|Client|Underwriting Info|Commercial Property History
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer Commercial Property History Questions | Source XTestStep: 3a13d49c-1679-010a-8cdd-78952ecb654b
    Then I wait until "Commercial Property History" exists
    When I enter or select "{TAB}{CLICK}No{TAB}" in "Is there a Prior Carrier?"

    # Source step 0274: CPP|Client|Underwriting Info|Navigation | Module: CPP|Client|Underwriting Info|Navigation
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer Other Insurance History Questions | Source XTestStep: 3a13d49c-1679-ad6f-cc24-72896164d491
    When I click or select "Other Insurance History"

    # Source step 0275: Underwriting Info | Other Insurance History | Module: Underwriting Info | Other Insurance History
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Client|Answer Other Insurance History Questions | Source XTestStep: 3a13d49c-1679-aaeb-4b66-27e0fd2b7024
    Then I wait until "Other Insurance History" exists
    When I enter or select "{TAB}{CLICK}No{TAB}" in "Is there a Prior Carrier?*"

    # Source step 0276: Common Navigation Links | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Underwting Info|Navigate back to CPP Main | Source XTestStep: 3a13d49c-1679-05c9-6f20-bd045ff1cd54
    When I click or select "Return to Quote"

    # Source step 0277: Navigate to Billing Screen | Module: Common Navigation Links
    ...
    # Source step 0278: Fill Out Required Fields on Billing Screen | Module: Billing
    ...
    # Source step 0279: Wait for Synchronization | Module: TBox Wait
    ...
    # Source step 0280: Navigate to NotePad Screen | Module: Common Navigation Links
    ...
    # Source step 0281: Add Notes/Remarks to NotePad | Module: NotePad
    ...
    # Source step 0282: Navigate to Submission Screen | Module: Common Navigation Links
    ...
    # Source step 0283: Fill out Required Fields | Module: Submission|Required and Optional Fields
    ...
    # Source step 0284: Order Audit | Module: Submission|Required and Optional Fields
    ...
    # Source step 0285: Fill out Order Audit | Module: Submission|Required and Optional Fields
    ...
    # Source step 0286: Check to see Submission Screen Header Exists | Module: Submission|Required and Optional Fields
    ...
    # Source step 0287: Navigate to Submission Screen | Module: Common Navigation Links
    ...
    # Source step 0288: Wait for Synchronization | Module: TBox Wait
    ...
    # Source step 0289: Wait on Submission Screen to Load | Module: Submission|Required and Optional Fields
    ...
    # Source step 0290: 500ms wait for syncing | Module: TBox Wait
    ...
    # Source step 0291: Check to see Coverage is bound Exists | Module: Submission|Required and Optional Fields
    ...
    # Source step 0292: Check Is Coverage bound (select) | Module: Submission|Required and Optional Fields
    ...
    # Source step 0293: Answer Is Coverage bound | Module: Submission|Required and Optional Fields
    ...
    # Source step 0294: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0295: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0296: Wait 2 Seconds | Module: TBox Wait
    ...
    # Source step 0297: Check for error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0298: Set Error Flag | Module: TBox Set Buffer
    ...
    # Source step 0342: Click First Close button on Error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0343: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0344: Click Complete App | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0345: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0346: Close Stoplight Window | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0347: Wait on Stoplight window to go away | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0351: Wait 3.5 seconds | Module: TBox Wait
    ...
    # Source step 0352: Check for Loading Indicator | Module: Indicators and Errors
    ...
    # Source step 0353: Wait 2 secs | Module: TBox Wait
    ...
    # Source step 0354: Stoplight message is visible | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0355: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0356: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0357: Wait 2 Seconds | Module: TBox Wait
    ...
    # Source step 0358: Check for error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0402: Click First Close button on Error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0403: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0404: Click Complete App | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0405: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0406: Close Stoplight Window | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0407: Wait on Stoplight window to go away | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0408: Wait 3.5 seconds | Module: TBox Wait
    ...
    # Source step 0409: Verify Stoplight Successfully Ran | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0423: Set NBPrem Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "4,360.00" as runtime value "NBPrem"

    # Source step 0424: Verify Premiums | Module: Submission|Premiums
    ...
    Then "Full Term Premium" property "value" should equals "$4,360.00"
    Then "Premium Written" property "value" should equals "4,360.00"
    Then "Prior Premium" property "value" should equals "0.00"
    Then "Premium Change" property "value" should equals "4,360.00"

    # Source step 0425: Delete LastResponseResource | Module: TBox Delete Resource
    ...
    # Source step 0426: Get Session ID & Buffer | Module: Verify JavaScript Result
    ...
    # Source step 0427: Buffer Server Address | Module: TBox Set Buffer
    ...
    # Source step 0428: Forms API Request | Module: Forms API Request
    ...
    # Source step 0429: Forms API Response | Module: Forms API Response
    ...
    # Source step 0430: Sync API | Module: TBox Wait
    ...
    # Source step 0431: Save the Response as XML file | Module: Save XML file
    ...
    When I save the source-defined file/resource for "Save the Response as XML file" using "Resource=LastResponseResource; Filepath=\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\CPP_BASIC_AZ_{B[QuoteID]}.xml"

    # Source step 0437: Sync API | Module: TBox Wait
    ...
    # Source step 0438: Buffer Powershell Arguments | Module: TBox Set Buffer
    ...
    When I derive and retain the RUNTIME-DERIVED buffer expression "powershell.exe -ExecutionPolicy Bypass -NoProfile -File FormsCheckQA.ps1 -Path \"\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\\" -FileName \"CPP_BASIC\" -State  \"AZ\" -QuoteID \"{B[QuoteID]}\"" as runtime value "PowershellArguments"

    # Source step 0439: Execute Powershell Script | Module: TBox Start Program
    ...
    # Source step 0440: Display the Results Summary | Module: TBox Clipboard
    ...
    # Source step 0441: Check and Report for Fails in the Forms Verification from the SummaryResults | Module: TBox Set Buffer
    ...
    # Source step 0442: Close Explorer Browsers | Module: TBox Start Program
    ...
    # Source step 0443: Close Chrome Browsers | Module: TBox Start Program
    ...
    # Source step 0444: Close Edge Browsers | Module: TBox Start Program
    ...
    # Source step 0445: Close Firefox Browsers | Module: TBox Start Program
    ...
    # Source step 0446: Close Edge Beta Browsers | Module: TBox Start Program
...
# Source step 0081: "Taskbar|Start Button Click Once" in module "Taskbar|Start Button" was disabled. Reason: 27.10.25 11:14:56 [ff01620@dnanico1.aniconet.com]
...
#    - INPUT "Start" with "x"
# Source step 0082: "Taskbar|Start Button Click Once" in module "Taskbar|Start Button" was disabled. Reason: 27.10.25 11:14:56 [ff01620@dnanico1.aniconet.com]
...
#    - INPUT "Start" with "x"
# Source step 0090: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 14.04.20 08:18:56 [ff01620]
...
# Source step 0091: "Click Insurance Score and wait for Loading Window" in module "Policy Info|Insurance Score" was disabled. Reason: 14.04.20 08:18:24 [ff01620]
...
# Source step 0092: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 14.04.20 08:18:31 [ff01620]
...
#    - INPUT "Duration" with "1500"
# Source step 0094: "Enter Desc in QuickSearch" in module "Dashboard|QuickSearch" was disabled. Reason: 31.05.23 14:03:32 [ff01729]
...
# Source step 0095: "Enter Info to Search by Desc" in module "Dashboard|Search for Policies / Quotes" was disabled. Reason: 31.05.23 14:03:32 [ff01729]
...
# Source step 0299: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0300: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0301: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0302: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0303: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0304: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0305: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0306: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0307: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0308: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0309: "Save changes" in module "Save JSON Resource" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0310: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0311: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0312: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0313: "Wait on Edge Browser to open" in module "Edge Browser" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0314: "Policy Load Sync" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0315: "Restart Microsoft Edge Message Exists?" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0316: "Restart Microsoft Edge Message - Click OK" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0317: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0318: "Check for Log In" in module "Logout" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0319: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0320: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0321: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0322: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0323: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0324: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0325: "Waiton Username to exist" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin] | 02.08.24 09:13:13 [Admin]
...
#    - WAIT (Exists) "UserName" with "True"
# Source step 0326: "Login" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Login" with "X"
# Source step 0327: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0328: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0329: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0330: "Set DocPath Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0331: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0332: "Enter Desc in QuickSearch" in module "Dashboard|QuickSearch" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Search Text" with "the RUNTIME-DERIVED source value {B[QuoteDescription]}{TAB}{TAB}{TAB}{TAB}"
#    - INPUT "QuickSearch Button" with "X"
# Source step 0333: "Enter Info to Search by Desc" in module "Dashboard|Search for Policies / Quotes" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "View Policy" with "{TAB}"
#    - INPUT "View Policy" with "X"
# Source step 0334: "Check for Transact Header" in module "TransACT" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0335: "Check if Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0336: "Click on Edit Policy on Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0337: "Check to see Submission Screen Header Exists" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-2c36-4c77-0509b15611cd
#    - VERIFY (Exists) "Submission Heading" with "False"
# Source step 0338: "Navigate to Submission Screen" in module "Common Navigation Links" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-6f12-3f1b-39180a24814b
#    - INPUT "Submission" with "{TAB}"
#    - INPUT "Submission" with "X"
# Source step 0339: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-4604-cd78-bb4eddf2bde6
#    - INPUT "Duration" with "1250"
# Source step 0340: "Wait on Submission Screen to Load" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-c808-873d-7350bc0ce3dd
#    - WAIT (Exists) "Submission Heading" with "True"
# Source step 0341: "500ms wait for syncing" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-669e-7efc-61fd60f4b5e8
#    - INPUT "Duration" with "500"
# Source step 0359: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Url" with "https://connect.anico.com/Pages/default.aspx"
#    - INPUT "UseActiveTab" with "a blank/null value"
# Source step 0360: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
# Source step 0361: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "UserName" with "AG0U388"
#    - INPUT "Password" with "${ENV:CL_DC_PASSWORD}"
# Source step 0362: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0363: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0364: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0365: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0366: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0367: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "Resource" with "EdgePreferences"
#    - ACTION "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
# Source step 0368: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "RootObject > profile" with "a blank/null value"
#    - INPUT "RootObject > profile > exit_type" with "none"
# Source step 0369: "Save changes" in module "Save JSON Resource" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
# Source step 0370: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0371: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Directory" with "the RUNTIME-DERIVED source value %USERPROFILE%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default"
#    - INPUT "File" with "Cookies"
# Source step 0372: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "WebDriverBrowserArguments" with "a blank/null value"
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# Source step 0373: "Wait on Edge Browser to open" in module "Edge Browser" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "BODY" with "True"
# Source step 0374: "Policy Load Sync" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "3000"
# Source step 0375: "Restart Microsoft Edge Message Exists?" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "OK" with "True"
# Source step 0376: "Restart Microsoft Edge Message - Click OK" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0377: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0378: "Check for Log In" in module "Logout" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0379: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0380: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "1000"
# Source step 0381: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
# Source step 0382: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0383: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Visible) "OK" with "True"
# Source step 0384: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0385: "Waiton Username to exist" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin] | 02.08.24 09:13:13 [Admin]
...
#    - WAIT (Exists) "UserName" with "True"
# Source step 0386: "Login" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Password" with "${ENV:TOSCA_PROTECTED_PASSWORD}"
#    - INPUT "Login" with "X"
# Source step 0387: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "Login" with "True"
# Source step 0388: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Loop Login" with "1"
# Source step 0389: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Directory" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\Screenshots"
#    - INPUT "Filename" with "Login Error"
# Source step 0390: "Set DocPath Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "DocPath" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\"
# Source step 0391: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "GetHostname" with "the RUNTIME-DERIVED source value \"\"\"${COMPUTERNAME}\"\"\""
#    - INPUT "AgentName" with "the RUNTIME-DERIVED source value {B[GetHostname]}"
# Source step 0392: "Enter Desc in QuickSearch" in module "Dashboard|QuickSearch" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Search Text" with "the RUNTIME-DERIVED source value {B[QuoteDescription]}{TAB}{TAB}{TAB}{TAB}"
#    - INPUT "QuickSearch Button" with "X"
# Source step 0393: "Enter Info to Search by Desc" in module "Dashboard|Search for Policies / Quotes" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "View Policy" with "{TAB}"
#    - INPUT "View Policy" with "X"
# Source step 0394: "Check for Transact Header" in module "TransACT" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "TransACT" with "True"
# Source step 0395: "Check if Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "Table > <Row>" with "a blank/null value"
#    - VERIFY "Table > <Row> > Status" with "Pending"
# Source step 0396: "Click on Edit Policy on Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "Table > <Row> > $1" with "a blank/null value"
#    - ACTION "Table > <Row> > $1 > Link" with "{CLICK}"
# Source step 0397: "Check to see Submission Screen Header Exists" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "Submission Heading" with "False"
# Source step 0398: "Navigate to Submission Screen" in module "Common Navigation Links" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Submission" with "{TAB}"
#    - INPUT "Submission" with "X"
# Source step 0399: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "1250"
# Source step 0400: "Wait on Submission Screen to Load" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "Submission Heading" with "True"
# Source step 0401: "500ms wait for syncing" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "500"
# Source step 0410: "Click Queue to open popup" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
#    - INPUT "Queue" with "X"
# Source step 0411: "Wait on Clear All and Click it" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
# Source step 0412: "Wait 1/2 sec" in module "TBox Wait" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
#    - INPUT "Duration" with "500"
# Source step 0413: "Click Queue to close popup" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
# Source step 0414: "Submission, select Policy Forms" in module "Submission, select Policy Forms" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
# Source step 0415: "Wait for Policy Forms to open" in module "TBox Wait" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
# Source step 0416: "Close Policy Forms" in module "TBox Send Keys" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
#    - INPUT "Keys" with "%\"{F4}\""
# Source step 0417: "Close out of PDF" in module "TBox Send Keys" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
#    - INPUT "Keys" with "\"{TAB}~\""
# Source step 0418: "Return to Submission Page" in module "Common Navigation Links" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
# Source step 0419: "Submission, select Policy Admin Forms" in module "Submission, select Policy Forms" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
# Source step 0420: "Wait for Policy Admin Forms to open" in module "TBox Wait" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
# Source step 0421: "Close Policy Admin Forms" in module "TBox Send Keys" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
#    - INPUT "Keys" with "%\"{F4}\""
# Source step 0422: "Close out of PDF" in module "TBox Send Keys" was disabled. Reason: 31.05.23 14:14:03 [ff01729]
...
#    - INPUT "Keys" with "\"{TAB}~\""
# Source step 0432: "Forms API Request" in module "Forms API Request" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
# Source step 0433: "Forms API Response" in module "Forms API Response" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
# Source step 0434: "Sync API" in module "TBox Wait" was disabled. Reason: 16.01.26 11:58:19 [ff01620@dnanico1.aniconet.com]
...
# Source step 0435: "Save the Response as XML file" in module "Save XML file" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\CPP_BASIC_AZ_{B[QuoteID]}.xml"
# Source step 0436: "Run Forms Request Get Forms on Policy" in module "Communicate with Web service" was disabled. Reason: 20.11.23 07:56:55 [ff01620]
...
#    - INPUT "Transform response > Response transformation_4 > Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CPP\\CPP_BASIC_AZ_{B[QuoteID]}.xml"
...
#    - INPUT "Choose SFP" with "{CLICK}Carrier  CommercialLines  Pages   US   (4.0.0.0){ENTER}{TAB}" when 'Product:*' == "Carrier_SpecialFarmPackage  Pages   US   (4.0.0.0)". Reason: Value condition evaluated false for the selected iteration: 'Product:*' == "Carrier_SpecialFarmPackage  Pages   US   (4.0.0.0)"
...
# Source step 0073: "Enter Primary Rating State" in module "Policy Info|Required and Optional Fields" was not executed. Reason: All source field actions are not applicable to the selected iteration.
...
# Source step 0075: "Enter Primary Rating State" in module "Policy Info|Required and Optional Fields" was not executed. Reason: All source field actions are not applicable to the selected iteration.
...
# Active source step 0077 "Tab out of Primary Rating State Field (For syncronization)" contains conditionally inapplicable field action(s):
...
# Source step 0100: "Navigate to Policy Covg Screen" in module "CP Navigation Links" was not executed. Reason: Selected-iteration condition evaluated false: 'Product' != "CPP"
# Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Policy Covg|Fill out CP Fields | Source XTestStep: 3a13d49c-166a-1e21-719b-f2de8d1dc2e2
#    - Preserved source field action: INPUT "Policy Covg" with "x"
# Source step 0105: "Policy Info|CPP Specific Fields" in module "Policy Info|CPP Specific Fields" was not executed. Reason: All source field actions are not applicable to the selected iteration.
# Section: New Application - Data Entry Process | Reusable flow: CPP|Basic|Policy Info|Select CP Detail | Source XTestStep: 3a13d49c-1679-1311-890f-9864b59c58f8
#    - Preserved source field action: INPUT "CP Detail" with "x" when 'CPP LOB' == "CP"
# Active source step 0112 "Fill out CP Location Fields - Miles from FD" contains conditionally inapplicable field action(s):
#    - INPUT "Is this property located 2 miles or less from the shore?" with "a blank/not-supplied reusable parameter ({TAB}<BLANK — reusable-block parameter is not supplied: Is this property located 2 miles or less from the shore?>{TAB})" when 'Is this property located 2 miles or less from the shore?' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Is this property located 2 miles or less from the shore?' != NULL
# Active source step 0132 "Add Rating Groups" contains conditionally inapplicable field action(s):
#    - INPUT "Hurricane Deductible" with "a blank/not-supplied reusable parameter ({TAB}<BLANK — reusable-block parameter is not supplied: Hurricane Deductible>{TAB})" when 'Hurricane Deductible' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Hurricane Deductible' != NULL
# Active source step 0134 "Fill out Main Property Questions" contains conditionally inapplicable field action(s):
#    - INPUT "Exclude Vandalism" with "a blank/not-supplied reusable parameter ({TAB}<BLANK — reusable-block parameter is not supplied: Exclude Vandalism>{TAB})" when 'Exclude Vandalism' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Exclude Vandalism' != NULL
#    - INPUT "Exclude Sprinkler Leakage" with "a blank/not-supplied reusable parameter ({TAB}<BLANK — reusable-block parameter is not supplied: Exclude Sprinkler Leakage>{TAB})" when 'Exclude Sprinkler Leakage' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Exclude Sprinkler Leakage' != NULL
# Active source step 0135 "Property Add Class" contains conditionally inapplicable field action(s):
#    - INPUT "Search Results" with "a blank/not-supplied reusable parameter ({CLICK}<BLANK — reusable-block parameter is not supplied: Class Search Results VT>{ENTER}{TAB}{TAB})" when (State =="VT"). Reason: Value condition evaluated false for the selected iteration: (State =="VT")
#    - INPUT "Search Value" with "{CLICK}[0532][10100]  Bakeries - Sales Only, No Baking{TAB}{TAB}" when (State =="VT"). Reason: Value condition evaluated false for the selected iteration: (State =="VT")
# Source step 0145: "Save for Later" in module "Common Navigation Links" was not executed. Reason: Selected-iteration condition evaluated false: 'Product'!="CPP"
# Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Fill out Property UW Questions | Source XTestStep: 3a13d49c-166a-7a6c-307e-47f4779460c9
#    - Preserved source field action: INPUT "Client" with "a blank/null value"
#    - Preserved source field action: INPUT "Save for Later" with "x"
# Source step 0149: "Navigate to Policy Coverage Screen" in module "GL Navigation Links" was not executed. Reason: Selected-iteration condition evaluated false: 'Product' != "CPP"
...
#    - Preserved source field action: INPUT "Policy Covg" with "x"
# Active source step 0150 "Policy Covg|GL" contains conditionally inapplicable field action(s):
#    - INPUT "Coverage Form" with "a blank/not-supplied reusable parameter ({CLICK}<BLANK — reusable-block parameter is not supplied: Coverage Form>{ENTER}{TAB})" when 'Coverage Form' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != NULL
#    - INPUT "Number of Buildings built prior to 1978" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Number of Buildings built prior to 1978>{TAB})" when State == "NJ" && 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: State == "NJ" && 'Coverage Form' != "OCP"
#    - INPUT "Number of Buildings built in 1978, 1979 and 1980" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Number of Buildings built in 1978, 1979 and 1980>{TAB})" when State == "NJ" && 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: State == "NJ" && 'Coverage Form' != "OCP"
#    - WAIT "Coverage Form" with "CGL" when 'Coverage Form' != NULL. Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != NULL
# Active source step 0154 "CGL|Add Class Exposure" contains conditionally inapplicable field action(s):
...
# Source step 0188: "IM Navigation Links" in module "IM Navigation Links" was not executed. Reason: Selected-iteration condition evaluated false: 'Product' != "CPP"
...
#    - Preserved source field action: INPUT "Policy Covg" with "x"
# Active source step 0211 "Risk - Accounts Receivable" contains conditionally inapplicable field action(s):
...
# Active source step 0219 "Risk - Bailees Customers" contains conditionally inapplicable field action(s):
...
# Active source step 0227 "Risk - Computer Equipment" contains conditionally inapplicable field action(s):
...
# Source step 0348: "Check for Loading Indicator" in module "Indicators and Errors" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source step 0349: "Wait 2 secs" in module "TBox Wait" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source step 0350: "Wait for Stoplight message to exist" in module "Submission|Complete Application & Stoplight Functionality" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source recovery step 0001: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-162e-e003-de76-61bcea5d1aa8
...
# Source recovery step 0002: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-162e-27d9-6d70-841f89893445
...
# Source recovery step 0003: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-162e-b9d4-63d7-4ad8f09ef6ce
...
# Source recovery step 0004: Close Explorer Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-162e-48e4-55f0-09e05bf90184
#    - I run "taskkill /f /im iexplore.exe"
# Source recovery step 0005: Close Chrome Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-162e-dcf3-83b6-d3ec58ce7ca3
#    - I run "taskkill /f /im Chrome.exe"
# Source recovery step 0006: Close Firefox Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-162e-1c20-a686-095688c11de9
#    - I run "taskkill /f /im Firefox.exe"
# Source recovery step 0007: Close Edge Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-162e-43c9-d2d7-8d0c9ee59a14
#    - I run "taskkill /f /im MicrosoftEdge.exe"
# Source recovery step 0008: Close Edge Beta Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-162e-33d7-13fb-9c0314cd2e7c
