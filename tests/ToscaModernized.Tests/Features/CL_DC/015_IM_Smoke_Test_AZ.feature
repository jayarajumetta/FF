# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 015_IM_Smoke_Test_AZ.feature
...
@CL_DC @IM @smoke @Arizona @Edge @manual @automated
Feature: Execute IM | Smoke Test for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the IM | Smoke Test workflow for Arizona (AZ)
  ...
  Scenario: IM | Smoke Test using representative iteration Arizona (AZ)
    ...
    When if field condition "'Product:*' != \"Carrier_SpecialFarmPackage  Pages   US   (4.0.0.0)\"" is satisfied, I enter or select "{CLICK}Carrier  InlandMarine  Pages   US   (4.0.0.0){ENTER}{TAB}" in "Product:*"
...
# --------------------------------------------------------------------------------------------------
# Source step 0001: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-3f63-91a3-7b494013ade6
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
# Source step 0002: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-5d5c-5139-82770bd511b0
#    - INPUT "Loop Login" with "0"
#    - INPUT "UserName" with "AG09999"
# Source step 0003: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-9ba8-716f-8a6c1ce7b068
...
# Source step 0004: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-72d2-a12f-772b1eb88582
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0005: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-2b8c-ec35-e1f17f1f125b
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0006: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-36f6-4172-050c6b7d8413
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0007: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5326-d938-8694-4fa2ba0da2e4
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0008: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-21c6-c345-c68f847da764
...
# Source step 0009: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-f12b-0b49-8d240b805207
#    - GROUP "Resource" with "EdgePreferences"
...
# Source step 0010: "Save changes" in module "Save JSON Resource" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-3116-90f8-72d4c6854d86
...
# Source step 0011: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-fb42-c9d1-34d3967d4364
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0012: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Reset Edge Preferences | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-7fbf-ee6b-9d490f6811d2
...
# Source step 0013: "OpenUrl" in module "OpenUrl" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-6530-b9ce-01c30d5e34ea
...
# Source step 0014: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-c1e6-0780-7a5e43af633e
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0015: "Check for Log In" in module "Logout" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Check to see if Logged In | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-0af5-0f3a-0b5528338b19
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0016: "Logout" in module "Logout" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-229a-70ad-ae7681332d15
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0017: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-bfc5-a5ca-adf5fcc4b09a
#    - INPUT "Duration" with "1000"
# Source step 0018: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-b70d-3977-111876cd0c82
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
# Source step 0019: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-9246-1043-86291d7ddc38
#    - INPUT "OK" with "X"
# Source step 0020: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-4725-c2c2-f7a15b483cb5
#    - WAIT (Visible) "OK" with "True"
# Source step 0021: "Logout" in module "Logout" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-88ac-c05a-4ba0d65afdec
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0022: "Waiton Username to exist" in module "Login" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com] | 02.08.24 09:13:13 [Admin]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-aa21-4b46-d19c87677757
#    - WAIT (Exists) "UserName" with "True"
# Source step 0023: "Login" in module "Login" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-dfa8-26b2-c1d648998d67
#    - INPUT "UserName" with "AG0u388{TAB}"
#    - INPUT "Password" with "${ENV:CL_DC_PASSWORD}"
#    - INPUT "Login" with "X"
# Source step 0024: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-584b-e95f-5ce1ac0bb189
#    - WAIT (Exists) "Login" with "True"
# Source step 0025: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-5338-0190-affb037ab4ca
#    - INPUT "Loop Login" with "1"
# Source step 0026: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-d902-4321-50bce5879680
#    - INPUT "Filename" with "Login Error"
# Source step 0027: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 08.12.25 08:27:17 [ff01620@dnanico1.aniconet.com]
# Section: Run New Smoke > Precondition > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5335-3aaa-138f-ddf46b74fc27
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-531f-2263-1fc694675413
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-bfe8-0b04-3ac7c4766006
#    - INPUT "Loop Login" with "0"
#    - INPUT "UserName" with "AG09999"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-45cd-eba7-2a0f2d0e142e
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-3638-cbe5-7132f7dd869d
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-a87b-735e-75acb4a579a0
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-9247-e865-7e346d1ca512
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-21fa-6dd2-7ac2c328bfcb
#    - INPUT "Path" with "taskkill"
#    - GROUP "Arguments" with "a blank/null value"
#    - INPUT "Arguments > Argument" with "/f"
#    - INPUT "Arguments > Argument" with "/im"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-5f66-2c16-c69951d5a5bd
#    - GROUP "Resource" with "EdgePreferences"
#    - GROUP "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-7e57-b22d-675c5e087d6b
#    - GROUP "Resource" with "EdgePreferences"
#    - GROUP "RootObject" with "a blank/null value"
#    - GROUP "RootObject > profile" with "a blank/null value"
#    - INPUT "RootObject > profile > exit_type" with "none"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-cba4-fe38-a369803eea33
#    - INPUT "Resource" with "EdgePreferences"
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences > Reset Exit_Type (Restore last session popup) | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-2458-79d4-c7455a336cfc
#    - INPUT "Resource" with "EdgePreferences"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Reset Edge Preferences | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-9252-017b-071949ec5600
#    - INPUT "Directory" with "the RUNTIME-DERIVED source value %USERPROFILE%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default"
#    - INPUT "File" with "Cookies"
# Source step 0111: "OpenUrl" in module "OpenUrl" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-18a2-b68e-8ac622fecdae
#    - INPUT "Url" with "https://clasq.anico.com/Express/"
#    - INPUT "UseActiveTab" with "a blank/null value"
#    - GROUP "WebDriverBrowserArguments" with "a blank/null value"
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-18df-52ee-dd1980511919
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0113: "Check for Log In" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Check to see if Logged In | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-833d-04c1-abc56d52ab27
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0114: "Logout" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-b3d0-b395-33cb9e951efe
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5506-368e-82ce-7476c9aa310a
#    - INPUT "Duration" with "1000"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-ec65-0c7d-03e7da376a97
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-3245-5404-58a181540987
#    - INPUT "OK" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-4906-9c36-35b14c142d8e
#    - WAIT (Visible) "OK" with "True"
# Source step 0119: "Logout" in module "Logout" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout > Http Error Msg | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-2d88-4515-f712bf85f5d2
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek > Common|General|Logout | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-bc57-df87-4ad903873e23
#    - WAIT (Exists) "UserName" with "True"
# Source step 0121: "Login" in module "Login" was disabled. Reason: 07.11.24 15:23:39 [FF01729@dnanico1.aniconet.com]
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-0642-1d74-861c07cb3d8a
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-3cce-12da-63fbaf4ae229
#    - WAIT (Exists) "Login" with "True"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-2e2a-a907-5f95266f50b8
#    - INPUT "Loop Login" with "1"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-c369-362f-ff424887c193
#    - INPUT "Filename" with "Login Error"
...
# Section: Run New Smoke > Smoke Process > Common|General|Log In to DuckCreek | Reusable flow: <none> | Source XTestStep: 3a161ef7-5515-d34a-5775-412fb406918b
#    - INPUT "GetHostname" with "the RUNTIME-DERIVED source value \"\"\"${COMPUTERNAME}\"\"\""
#    - INPUT "AgentName" with "the RUNTIME-DERIVED source value {B[GetHostname]}"
