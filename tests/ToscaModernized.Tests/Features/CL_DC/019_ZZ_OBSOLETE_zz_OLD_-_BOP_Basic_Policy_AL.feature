# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 019_ZZ_OBSOLETE_zz_OLD_-_BOP_Basic_Policy_AL.feature
...
@CL_DC @OLD_BOP @basic_policy @Alabama @Edge @manual @obsolete @archive @automated
Feature: Execute zz OLD - BOP | Basic Policy for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the zz OLD - BOP | Basic Policy workflow for Alabama (AL)
  ...
  Scenario: zz OLD - BOP | Basic Policy using representative iteration Alabama (AL)
    ...
    When I enter or select "01-25-2026{TAB}" in "EffectiveDate"
    ...
    # Section: New Application - Data Entry Process | Reusable flow: <none> | Source XTestStep: 3a13d49c-1430-2929-07c6-f4fb795cbbe5
    # Source template XTestStep: 3a13d49c-13a9-5401-f90c-ed20c1340788
    When I wait "750" milliseconds

    # Source step 0147: Verify Premium Amount | Module: Pricing
    # Section: New Application - Data Entry Process > BOP|Pricing|Verify Premium_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-1430-55cc-787d-d03a3293d930
...
# Source recovery step 0001: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-1430-2f6a-506c-9636810cf87d
...
# Source recovery step 0002: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-1430-5539-e9ea-dbc472846c86
...
# Source recovery step 0003: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-1430-a245-4616-28950c78a2bc
...
# Source recovery step 0004: Close Explorer Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-1430-83b6-f8ed-6c592dc1b13f
#    - I run "taskkill /f /im iexplore.exe"
# Source recovery step 0005: Close Chrome Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-1430-83b6-8214-99ae25cd95bb
#    - I run "taskkill /f /im Chrome.exe"
# Source recovery step 0006: Close Firefox Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-1430-3e12-efa6-de81ee94e072
#    - I run "taskkill /f /im Firefox.exe"
# Source recovery step 0007: Close Edge Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-1430-a512-ff8c-c89901b3fcec
#    - I run "taskkill /f /im MicrosoftEdge.exe"
# Source recovery step 0008: Close Edge Beta Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-1430-5f3b-5839-4f1e8014c31a
