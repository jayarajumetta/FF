# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 006_GL_OCP_Policy_AZ.feature
...
@CL_DC @GL @ocp @Arizona @Edge @manual @automated
Feature: Execute GL | OCP Policy for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the GL | OCP Policy workflow for Arizona (AZ)
  ...
  Scenario: GL | OCP Policy using representative iteration Arizona (AZ)
    ...
    When I retain hard-coded value "GL OCP" as runtime value "Product (LOB)"
    When I retain hard-coded value "svqw-clas21:8080" as runtime value "Server"
    When I retain hard-coded value "GL_OCP_BASIC" as runtime value "FormOnPolicyDocName"
    ...
    When if field condition "'Product (LOB)' == \"GL OCP\"" is satisfied, I enter or select "(select){TAB}" in "PrimaryRatingState"
    When if field condition "'Product (LOB)' == \"GL OCP\"" is satisfied, I enter or select "Arizona{Down}{Enter}{TAB}{TAB}" in "PrimaryRatingState"
    ...
    When I enter RUNTIME-DERIVED value "AZ GL OCP Basic {NMONTH}.{NDAY}.{NYEAR} {Time}{TAB}" in "Description of Specified Operation"
    ...
    # Section: New Application - Data Entry Process | Reusable flow: GL|Basic|Policy Covg|Fill out OCP Fields | Source XTestStep: 3a14d07e-b2ba-e9a8-cc71-dacc89c13dac
    # Step condition: 'Product' != "CPP"
    When I click or select "Policy Covg"

    # Source step 0074: Policy Covg|OCP | Module: Policy Covg|GL
    # Section: New Application - Data Entry Process | Reusable flow: GL|Basic|Policy Covg|Fill out OCP Fields | Source XTestStep: 3a14d07e-b2ba-f95d-c283-429c8499e728
    Then I wait until "Policy Covg" exists
    When if field condition "'Coverage Form' != NULL" is satisfied, I enter or select "{CLICK}OCP{ENTER}{TAB}" in "Coverage Form"
    When if field condition "'Occurence Limit' != NULL" is satisfied, I enter or select "{CLICK}$200,000{ENTER}{TAB}" in "Occurence Limit"
    When if field condition "'Aggregate Limit' != NULL" is satisfied, I enter or select "{CLICK}$600,000{ENTER}{TAB}" in "Aggregate Limit"
    When if field condition "(State == \"NJ\")||(State == \"WV\")||(State == \"MA\")||(State == \"CT\")||(State == \"ME\")||(State == \"NH\")||(State == \"OR\")||(State == \"AZ\")||(State == \"PA\")||(State == \"MD\")||(State == \"DE\")||(State == \"RI\")||(State == \"VA\")||(State == \"VT\")&& 'Coverage Form' != \"OCP\"" is satisfied, I leave "# of Full-Time Employees*" blank because the reusable parameter is not supplied for this iteration
    When if field condition "(State == \"NJ\")||(State == \"WV\")||(State == \"MA\") ||(State == \"CT\")||(State == \"ME\")||(State == \"NH\")||(State == \"OR\")||(State == \"AZ\")||(State == \"PA\")||(State == \"MD\")||(State == \"DE\")||(State == \"RI\")||(State == \"VA\")||(State == \"VT\")&& 'Coverage Form' != \"OCP\"" is satisfied, I leave "# of Part-Time Employees*" blank because the reusable parameter is not supplied for this iteration
    When if field condition "(State == \"NJ\")||(State == \"WV\")||(State == \"MA\")||(State == \"CT\")||(State == \"ME\")||(State == \"NH\")||(State == \"OR\") ||(State == \"AZ\")||(State == \"PA\")||(State == \"MD\")||(State == \"DE\")||(State == \"RI\")||(State == \"VA\")||(State == \"VT\")&& 'Coverage Form' != \"OCP\"" is satisfied, I leave "# of Seasonal/Temporary Employees*" blank because the reusable parameter is not supplied for this iteration
    Then if field condition "'Coverage Form' != NULL" is satisfied, I wait until "Coverage Form" property "value" equals "OCP"

    # Source step 0075: Navigate to OCP Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-96b9-f2b9-b4b2253286e8
    When I click or select "OCP"

    # Source step 0076: GL OCP|Risk | Module: GL OCP|Risk
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-f593-e164-b71a5aa0f8d3
    Then I wait until "Risk Heading" exists
    When I enter or select "{CLICK}Owners Contractors{ENTER}{TAB}" in "Type"
    When I enter or select "{CLICK}}{TAB}[16291] Construction Operations - Contractor{TAB}" in "Class Code"
    When I enter or select "{TAB}Arizona{TAB}" in "State"
    When I enter or select "{TAB}1000{TAB}" in "Total Cost of Work*"
    When I enter or select "{TAB}Tulsa{TAB}" in "Location Of Covered Operations"
    When I enter or select "{TAB}Bob Keeshan{TAB}" in "Policy Holder Name"
    When I enter or select "{TAB}9 Center Road{TAB}" in "Address 1"
    When I enter or select "{TAB}{CLICK}10541{TAB}" in "Zip Code"

    # Source step 0077: Select Next Button | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-8505-8587-77a5b4e7efb3
    When I click or select "Next"

    # Source step 0078: Navigate to OCP Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-96b9-f2b9-b4b2253286e8
    When I click or select "OCP"

    # Source step 0079: GL OCP|Risk | Module: GL OCP|Risk
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-f593-e164-b71a5aa0f8d3
    Then I wait until "Risk Heading" exists
    When I enter or select "{CLICK}Owners Contractors{ENTER}{TAB}" in "Type"
    When I enter or select "{CLICK}}{TAB}[16292] Construction Operations - Owner{TAB}" in "Class Code"
    When I enter or select "{TAB}Arizona{TAB}" in "State"
    When I leave "Total Cost of Work*" blank because the reusable parameter is not supplied for this iteration
    When I enter or select "{TAB}Tulsa{TAB}" in "Location Of Covered Operations"
    When I enter or select "{TAB}Bob Keeshan{TAB}" in "Policy Holder Name"
    When I enter or select "{TAB}9 Center Road{TAB}" in "Address 1"
    When I enter or select "{TAB}{CLICK}10541{TAB}" in "Zip Code"

    # Source step 0080: Select Next Button | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-8505-8587-77a5b4e7efb3
    When I click or select "Next"

    # Source step 0081: Navigate to OCP Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-96b9-f2b9-b4b2253286e8
    When I click or select "OCP"

    # Source step 0082: GL OCP|Risk | Module: GL OCP|Risk
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-f593-e164-b71a5aa0f8d3
    Then I wait until "Risk Heading" exists
    When I enter or select "{CLICK}Owners Contractors{ENTER}{TAB}" in "Type"
    When I enter or select "{CLICK}}{TAB}[17982] Operations{TAB}" in "Class Code"
    When I enter or select "{TAB}Arizona{TAB}" in "State"
    When I leave "Total Cost of Work*" blank because the reusable parameter is not supplied for this iteration
    When I enter or select "{TAB}Tulsa{TAB}" in "Location Of Covered Operations"
    When I enter or select "{TAB}Bob Keeshan{TAB}" in "Policy Holder Name"
    ...
    # Source step 0083: Select Next Button | Module: Common Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Fill out OCP Risk Fields | Source XTestStep: 3a13d49c-1679-8505-8587-77a5b4e7efb3
    When I click or select "Next"

    # Source step 0084: Navigate to Endorsements Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement|[CG0424] Coverage for Injury to Leased Workers | Source XTestStep: 3a13d49c-1679-39a5-dfab-513741fdfe38
    When I click or select "Endorsements"

    # Source step 0085: Endorsements|Main | Module: Endorsements|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement|[CG0424] Coverage for Injury to Leased Workers | Source XTestStep: 3a13d49c-1679-47fa-bc13-36ef4858f32c
    Then I wait until "Endorsements" exists
    When I click or select "Add Endorsement"

    # Source step 0086: [CG0424] Coverage for Injury to Leased Workers | Module: [CG0424] Coverage for Injury to Leased Workers
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement|[CG0424] Coverage for Injury to Leased Workers | Source XTestStep: 3a13d49c-1679-1229-6e94-475d7ccc7461
    When if field condition "'Endorsement Type' != NULL" is satisfied, I enter or select "{TAB}[CG0424] Coverage for Injury to Leased Workers{TAB}" in "Endorsement Type"
    When I enter or select "{TAB}I started a company and use temp workers.{TAB}" in "Why is this coverage desired?"
    When I click or select "OK"

    # Source step 0087: Navigate to Endorsements Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2401] Non-Binding Arbitration | Source XTestStep: 3a13d49c-1679-8b48-4cf7-d06f447789e5
    When I click or select "Endorsements"

    # Source step 0088: Endorsements|Main | Module: Endorsements|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2401] Non-Binding Arbitration | Source XTestStep: 3a13d49c-1679-77f6-4fbc-5e16d0010d49
    Then I wait until "Endorsements" exists
    When I click or select "Add Endorsement"

    # Source step 0089: [CG2401] Non-Binding Arbitration | Module: [CG2401] Non-Binding Arbitration
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2401] Non-Binding Arbitration | Source XTestStep: 3a13d49c-1679-96cb-a839-acd13c8f99b9
    When if field condition "'Endorsement Type' != NULL" is satisfied, I enter or select "{TAB}[CG2401] Non-Binding Arbitration{TAB}" in "Endorsement Type"
    When I click or select "OK"

    # Source step 0090: Navigate to Endorsements Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2812] Pesticide or Herbicide Applicator Coverage | Source XTestStep: 3a13d49c-1679-94cd-2023-3dac989aa7c7
    When I click or select "Endorsements"

    # Source step 0091: Endorsements|Main | Module: Endorsements|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2812] Pesticide or Herbicide Applicator Coverage | Source XTestStep: 3a13d49c-1679-bac3-0ff4-1983485dce4f
    Then I wait until "Endorsements" exists
    When I click or select "Add Endorsement"

    # Source step 0092: [CG2812] Pesticide or Herbicide Applicator Coverage | Module: [CG2812] Pesticide or Herbicide Applicator Coverage
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG2812] Pesticide or Herbicide Applicator Coverage | Source XTestStep: 3a13d49c-1679-7794-9d9c-8513842c09b9
    When if field condition "'Endorsement Type' != NULL" is satisfied, I enter or select "{TAB}[CG2812] Pesticide or Herbicide Applicator Coverage{TAB}" in "Endorsement Type"
    When I enter or select "{TAB}HVAC{TAB}" in "Description of Operations"
    When I click or select "OK"

    # Source step 0093: GL Navigation Links | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG3132] Limited Fungi or Bacteria Coverage | Source XTestStep: 3a13d49c-1679-31b9-b653-d63c6677c948
    When I click or select "Endorsements"

    # Source step 0094: Endorsements|Main | Module: Endorsements|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG3132] Limited Fungi or Bacteria Coverage | Source XTestStep: 3a13d49c-1679-1784-4a31-3214c6a73983
    Then I wait until "Endorsements" exists
    When I click or select "Add Endorsement"

    # Source step 0095: [CG3132] Limited Fungi or Bacteria Coverage | Module: [CG3132] Limited Fungi or Bacteria Coverage
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Endorsement| [CG3132] Limited Fungi or Bacteria Coverage | Source XTestStep: 3a13d49c-1679-5920-0a16-42a2e78420c2
    When if field condition "'Endorsement Type' != NULL" is satisfied, I enter or select "{TAB}[CG3132] Limited Fungi or Bacteria Coverage{TAB}" in "Endorsement Type"
    When I click or select "OK"

    # Source step 0096: Navigate to Addl Interests Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest| [CG 20 31] Add'l Insured-Engineers, Architects OCP | Source XTestStep: 3a13d49c-1679-fe9f-5cc1-edeef18ee245
    When I click or select "Addl Interests"

    # Source step 0097: Addl Interests|Main | Module: Addl Interests|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest| [CG 20 31] Add'l Insured-Engineers, Architects OCP | Source XTestStep: 3a13d49c-1679-3432-a163-05a0a861244a
    Then I wait until "Addl Interests" exists
    When I click or select "Add Addl Interest"

    # Source step 0098: [CG 20 31] Add'l Insured-Engineers, Architects OCP | Module: [CG 20 31] Add'l Insured-Engineers, Architects OCP 
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest| [CG 20 31] Add'l Insured-Engineers, Architects OCP | Source XTestStep: 3a13d49c-1679-a23d-63ab-d36b5cf9bb4c
    When I enter or select "{TAB}[CG 20 31] Add'l Insured-Engineers, Architects OCP {TAB}" in "Type"
    When I click or select "OK"

    # Source step 0099: Navigate to Addl Interests Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[CG 29 35] Add'l Insured-State or Political (Permits) | Source XTestStep: 3a13d49c-1679-7cd6-ae96-000c344a6321
    When I click or select "Addl Interests"

    # Source step 0100: Addl Interests|Main | Module: Addl Interests|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[CG 29 35] Add'l Insured-State or Political (Permits) | Source XTestStep: 3a13d49c-1679-e502-2c0e-772eb2c17942
    Then I wait until "Addl Interests" exists
    When I click or select "Add Addl Interest"

    # Source step 0101: [CG 29 35] Add'l Insured-State or Political (Permits) | Module: [CG 29 35] Add'l Insured-State or Political (Permits)
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[CG 29 35] Add'l Insured-State or Political (Permits) | Source XTestStep: 3a13d49c-1679-6ca1-9a35-40f14f9f1fd1
    When I enter or select "{TAB}[CG 29 35] Add'l Insured-State or Political (Permits){TAB}" in "Type"
    When I enter or select "{TAB}New York{TAB}" in "State or Political Subdivision*"
    When I enter or select "{TAB}9 Center Road{TAB}" in "Address 1"
    When I enter or select "{TAB}10541{TAB}" in "Zip Code"
    When I click or select "OK"

    # Source step 0102: Navigate to Addl Interests Screen | Module: GL Navigation Links
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[FG0013] - Automatic Additional Insured - Specific | Source XTestStep: 3a13d49c-1679-c350-74bd-697664569b6b
    When I click or select "Addl Interests"

    # Source step 0103: Addl Interests|Main | Module: Addl Interests|Main
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[FG0013] - Automatic Additional Insured - Specific | Source XTestStep: 3a13d49c-1679-f93f-466d-b22a00ccbb80
    Then I wait until "Addl Interests" exists
    When I click or select "Add Addl Interest"

    # Source step 0104: [FG 00 13] Automatic Additional Insured - Specific Relationship | Module: [FG 00 13] Automatic Additional Insured - Specific Relationship
    # Section: New Application - Data Entry Process | Reusable flow: GL OCP|Basic|Add OCP Additional Interest|[FG0013] - Automatic Additional Insured - Specific | Source XTestStep: 3a13d49c-1679-a529-bb46-f4577c060b3f
    When I enter or select "{TAB}[FG 00 13] Automatic Additional Insured - Specific Relationship{TAB}" in "Type"
    When I enter or select "{TAB}Yes{TAB}" in "Does the insured ever enter into contracts for tasks not contemplated in the current liability classifications on the policy?"
    When I enter or select "{TAB}Yes, when warranted.{TAB}" in "If yes, explain."
    When I enter or select "{TAB}No{TAB}" in "Does the insured/applicant request Additional Insured status without a written contract requirement?"
    When I enter or select "{TAB}No{TAB}" in "Does the insured enter into contracts involving Commercial Snow Removal, including snow removal from residential roofs?"
    When I click or select "OK"

    # Source step 0105: Navigate to GL UW Questions | Module: GL Navigation Links
    ...
    # Source step 0106: Answer General Liability Information Questions | Module: General Liability Information
    ...
    # Source step 0108: Wait for General Liability Screen to Load | Module: General Liability Information
    ...
    # Source step 0109: Answer Products/Completed Ops Question | Module: Products/Completed Ops
    ...
    # Source step 0110: Navigate to Billing Screen | Module: Common Navigation Links
    ...
    # Source step 0111: Fill Out Required Fields on Billing Screen | Module: Billing
    ...
    # Source step 0113: Navigate to NotePad Screen | Module: Common Navigation Links
    ...
    # Source step 0114: Add Notes/Remarks to NotePad | Module: NotePad
    ...
    When I retain hard-coded value "810.00" as runtime value "NBPrem"
    ...
    Then "Full Term Premium" property "value" should equals "$810.00"
    Then "Premium Written" property "value" should equals "810.00"
    Then "Prior Premium" property "value" should equals "0.00"
    Then "Premium Change" property "value" should equals "810.00"
    ...
    When I save the source-defined file/resource for "Save the Response as XML file" using "Resource=LastResponseResource; Filepath=\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\GL_OCP_BASIC_AZ_{B[QuoteID]}.xml"
    ...
    When I derive and retain the RUNTIME-DERIVED buffer expression "powershell.exe -ExecutionPolicy Bypass -NoProfile -File FormsCheckQA.ps1 -Path \"\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\\" -FileName \"GL_OCP_BASIC\" -State  \"AZ\" -QuoteID \"{B[QuoteID]}\"" as runtime value "PowershellArguments"
...
#    - INPUT "Directory" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\Screenshots"
#    - INPUT "Filename" with "Login Error"
...
#    - INPUT "DocPath" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\"
...
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\GL_OCP_BASIC_AZ_{B[QuoteID]}.xml"
...
#    - INPUT "Transform response > Response transformation_4 > Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\GL_OCP\\GL_OCP_BASIC_AZ_{B[QuoteID]}.xml"
...
# Active source step 0060 "Enter Effective Date" contains conditionally inapplicable field action(s):
...
#    - INPUT "PrimaryRatingState" with "Arizona{Down}{Enter}{TAB}{TAB}" when 'Product (LOB)' == "GL". Reason: Value condition evaluated false for the selected iteration: 'Product (LOB)' == "GL"
...
# Active source step 0074 "Policy Covg|OCP" contains conditionally inapplicable field action(s):
#    - INPUT "Products Agg Limit" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Products Agg Limit>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Ded Type" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Ded Type>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Deductible Basis" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Deductible Basis>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "PremOp Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: PremOp Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "PremOp PD Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: PremOp PD Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Split BI Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Split BI Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Split PD Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Split PD Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Prod BI Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Prod BI Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Prod PD Ded" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Prod PD Ded>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Fire Damage" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Fire Damage>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Medical" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Medical>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Pers Adv Inj" with "a blank/not-supplied reusable parameter (<BLANK — reusable-block parameter is not supplied: Pers Adv Inj>{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
#    - INPUT "Is the Insured engaged in any Snow or Ice Removal Operations?*" with "a blank/not-supplied reusable parameter ({CLICK}<BLANK — reusable-block parameter is not supplied: Is the Insured engaged in any Snow or Ice Removal Operations?>{ENTER}{TAB})" when 'Coverage Form' != "OCP". Reason: Value condition evaluated false for the selected iteration: 'Coverage Form' != "OCP"
...
# Source recovery step 0001: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-163d-1985-d910-a9c3d6958fc3
...
# Source recovery step 0002: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-163d-f71e-0ad8-8943b42ade3b
...
# Source recovery step 0003: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-163d-5ba4-52b9-7d8c634e4006
...
# Source recovery step 0004: Close Explorer Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-163d-356a-5280-800253c8b743
#    - I run "taskkill /f /im iexplore.exe"
# Source recovery step 0005: Close Chrome Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-163d-5bd6-8aa6-e0e588110c92
#    - I run "taskkill /f /im Chrome.exe"
# Source recovery step 0006: Close Firefox Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-163d-b8fe-1033-aee95b53acbc
#    - I run "taskkill /f /im Firefox.exe"
# Source recovery step 0007: Close Edge Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-163d-bafd-bda7-bfa367f764f2
#    - I run "taskkill /f /im MicrosoftEdge.exe"
# Source recovery step 0008: Close Edge Beta Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-163d-42ee-6ccb-036501d47382
