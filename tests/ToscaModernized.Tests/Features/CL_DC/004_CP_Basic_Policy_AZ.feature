# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 004_CP_Basic_Policy_AZ.feature
...
@CL_DC @CP @basic_policy @Arizona @Edge @manual @automated
Feature: Execute CP | Basic Policy for one representative CL|DC iteration
  As a CL|DC policy processing user
  I want to complete the CP | Basic Policy workflow for Arizona (AZ)
  ...
  Scenario: CP | Basic Policy using representative iteration Arizona (AZ)
    ...
    When I enter or select "AZ CP Testing, Inc.{TAB}" in "Business Name"
    ...
    When I retain hard-coded value "CP_BASIC" as runtime value "FormOnPolicyDocName"
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-48dd-3fac-50fa0bd78b36
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-5308-b8a4-b70540bfb829
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-6854-7934-b78ecde8c4b2
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-f6fb-3810-1004addb02b8
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-f832-4594-868f0689fdbf
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-9dff-1dd2-d6d5cf672e9a
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-9683-30d2-693900d8ce81
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-bc1c-43dd-1d77f1b141f0
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-b714-e76c-187f0137e6a7
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-014c-7991-4cc5ecbcfdcd
    ...
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-829e-1a2f-f808b3f763a6
    # Source template XTestStep: 3a13d49c-165b-f6d6-53ae-4d4d2d531699
    Then I wait until "Client Search" exists
    When I click or select "Client Search"

    # Source step 0065: Click Ok | Module: Client Search Results
    # Section: New Application - Data Entry Process > Common|Enter Business Client > Common|Client|Add Associated Client Information_Reference | Reusable flow: <none> | Source XTestStep: 3a13d49c-14a8-9808-20e7-9abc2f3b07b8
    ...
    # Source step 0067: Underwriting Info | General UW Questions | Module: Underwriting Info | General UW Questions
    ...
    # Source step 0099: Navigate to Policy Covg Screen | Module: CP Navigation Links
    ...
    # Source step 0100: Answer CP Policy Covg  Private Windmills question | Module: Policy Covg
    ...
    # Source step 0101: Taskbar|Start Button Click Once | Module: Taskbar|Start Button
    ...
    # Source step 0103: Fill out CP Policy Covg Fields | Module: Policy Covg
    ...
    When if field condition "Fungus != NULL" is satisfied, I leave "Fungus" blank because the reusable parameter is not supplied for this iteration

    # Source step 0104: Navigate to Location Screen | Module: CP Navigation Links
    ...
    # Source step 0105: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    ...
    # Source step 0106: Check for Loading Indicator | Module: Indicators and Errors
    ...
    # Source step 0107: Wait 2 secs | Module: TBox Wait
    ...
    # Source step 0110: Fill out CP Location Fields - Miles from FD | Module: Location
    ...
    # Source step 0111: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0112: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0113: Verify Ft from Hydrant | Module: Location
    ...
    # Source step 0114: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    ...
    # Source step 0115: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0116: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0117: Fill out CP Location Fields - Call ISO and Select PPC | Module: Location
    ...
    # Source step 0118: Check for Loading Indicator | Module: Indicators and Errors
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-e5b6-99ea-0884937944de
    # Runtime control: While Loading Indicator is Visible [max=60] > Condition
    Then "Loading Message" should be visible

    # Source step 0119: Wait 2 secs | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: CP|Basic|Location|Fill out CP Fields > Common|General|Wait on Loading Indicator | Source XTestStep: 3a13d49c-165b-d159-8ea2-a672b547d024
    # Runtime control: While Loading Indicator is Visible [max=60] > Loop
    When I wait "2000" milliseconds

    # Source step 0120: Verify Ft from Hydrant | Module: Location
    ...
    # Source step 0121: Fill out CP Location Fields - Ft from Hydrant | Module: Location
    ...
    # Source step 0124: Click OK on CP Location Fields - Call ISO and Select PPC | Module: Location
    ...
    # Source step 0125: Navigate to Building Screen | Module: CP Navigation Links
    ...
    # Source step 0126: Building - Add Building | Module: Building - Main
    ...
    # Source step 0127: Building - Select Building Detail | Module: Building - Main
    ...
    # Source step 0128: Building - Fill in Building Detail Fields | Module: Building - Detail
    ...
    # Source step 0129: Navigate to Rating Groups Screen | Module: CP Navigation Links
    ...
    # Source step 0130: Add Rating Groups | Module: Rating Groups
    ...
    # Source step 0131: Navigate to Property Screen | Module: CP Navigation Links
    ...
    # Source step 0132: Fill out Main Property Questions | Module: Property - Main
    ...
    # Source step 0133: Property Add Class | Module: Property Add Class
    ...
    # Source step 0134: Property Enter Building RCT | Module: Property Enter Building RCT
    ...
    # Source step 0135: CP Navigation Links | Module: CP Navigation Links
    ...
    # Source step 0136: Addl Interests - Main | Module: Addl Interests - Main
    ...
    # Source step 0137: Addl Interests - Loss Payee | Module: Addl Interests - Loss Payee
    ...
    # Source step 0138: Navigate to Billing Screen | Module: Common Navigation Links
    ...
    # Source step 0139: Fill Out Required Fields on Billing Screen | Module: Billing
    ...
    # Source step 0140: Wait for Synchronization | Module: TBox Wait
    ...
    # Source step 0141: Navigate to NotePad Screen | Module: Common Navigation Links
    ...
    # Source step 0142: Add Notes/Remarks to NotePad | Module: NotePad
    ...
    # Source step 0145: Save for Later | Module: Common Navigation Links
    ...
    # Step condition: 'Product'!="CPP"
    When I leave "Client" blank
    When I click or select "Save for Later"

    # Source step 0146: Get Quote ID and Buffer | Module: Verify JavaScript Result
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Get Quote ID and Buffer | Source XTestStep: 3a13d49c-165b-6bdf-2cdc-5846c562c6d2
    When I enter or select "*" in "Title"
    When I enter or select "return 1+2" in "JavaScript"
    Then "Result" property "value" should equals "3"

    # Source step 0147: OpenUrl | Module: OpenUrl
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a178739-6c2a-7f96-bdeb-c75256d37be8
    When I open "https://connect.anico.com/Pages/default.aspx" in the active browser tab

    # Source step 0148: Check the Loop Login | Module: TBox Evaluation Tool
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-e5fd-3e81-f0c163b45bec
    ...
    # Source step 0149: Set Loop Buffer | Module: TBox Set Buffer
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-3cce-e902-ad26cde48dad
    ...
    When I retain hard-coded value "FFQA008" as runtime value "UserName"
    When I retain RUNTIME-CONFIGURED value "CL_DC_PASSWORD" as runtime value "Password"

    # Source step 0150: Close Explorer Browsers | Module: TBox Start Program
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-e3da-d6b5-08c35a43f04d
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0151: Close Chrome Browsers | Module: TBox Start Program
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-9cc6-4a8f-338b7b667ec2
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0152: Close Firefox Browsers | Module: TBox Start Program
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-a67c-6795-e63970f56d0b
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0153: Close Edge Browsers | Module: TBox Start Program
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-cf23-15a2-7a8ef9e564eb
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0154: Close Edge Beta Browsers | Module: TBox Start Program
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-acaf-d111-26d7d113b4a9
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0155: Open Edge Preferences file | Module: Open/Create JSON file
    # Section: New Application - Data Entry Process > Reset Exit_Type (Restore last session popup) | Reusable flow: Common|General|Log In to DuckCreek > CL|DC|Common|Reset Edge Preferences | Source XTestStep: 3a13d49c-139a-51a2-e30a-875085d7293d
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0156: Change Exit Type | Module: Edge Preferences File
    # Section: New Application - Data Entry Process > Reset Exit_Type (Restore last session popup) | Reusable flow: Common|General|Log In to DuckCreek > CL|DC|Common|Reset Edge Preferences | Source XTestStep: 3a13d49c-139a-3bfc-0f17-941d4e508586
    # Runtime control: Loop for the Login [max=30] > Loop
    When I enter or select "EdgePreferences" in "Resource"
    When I enter or select "none" in "RootObject > profile > exit_type"

    # Source step 0157: Save changes | Module: Save JSON Resource
    # Section: New Application - Data Entry Process > Reset Exit_Type (Restore last session popup) | Reusable flow: Common|General|Log In to DuckCreek > CL|DC|Common|Reset Edge Preferences | Source XTestStep: 3a13d49c-139a-ddc0-eab3-528e14fa8530
    # Runtime control: Loop for the Login [max=30] > Loop
    When I save JSON resource "EdgePreferences" to "%userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"

    # Source step 0158: Delete EdgePreferences Resource | Module: TBox Delete Resource
    # Section: New Application - Data Entry Process > Reset Exit_Type (Restore last session popup) | Reusable flow: Common|General|Log In to DuckCreek > CL|DC|Common|Reset Edge Preferences | Source XTestStep: 3a13d49c-139a-2343-7a4a-f38e82d101b1
    # Runtime control: Loop for the Login [max=30] > Loop
    When I remove runtime resource "EdgePreferences"

    # Source step 0159: Delete Cookies File | Module: TBox Delete File
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > CL|DC|Common|Reset Edge Preferences | Source XTestStep: 3a13d49c-139a-5462-86d0-b2918ffe99fb
    # Runtime control: Loop for the Login [max=30] > Loop
    When I delete file "Cookies" from "%USERPROFILE%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default"

    # Source step 0160: OpenUrl | Module: OpenUrl
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a14f870-cc24-f954-1ce4-f66a4de25344
    # Runtime control: Loop for the Login [max=30] > Loop
    ...
    # Source step 0161: Wait on Edge Browser to open | Module: Edge Browser
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a1ec4ae-079b-3cc6-1506-4d54e5cd3412
    # Runtime control: Loop for the Login [max=30] > Loop
    Then I wait until "BODY" exists

    # Source step 0162: Policy Load Sync | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a1eab8e-7f31-b52e-d7c3-e0d6284edd4a
    # Runtime control: Loop for the Login [max=30] > Loop
    When I wait "3000" milliseconds

    # Source step 0163: Restart Microsoft Edge Message Exists? | Module: Restart Microsoft Edge Message
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > CL|EQ|Common|General|Restart Edge Popup | Source XTestStep: 3a20f668-6621-606d-8342-675b674aceca
    ...
    # Source step 0164: Restart Microsoft Edge Message - Click OK | Module: Restart Microsoft Edge Message
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > CL|EQ|Common|General|Restart Edge Popup | Source XTestStep: 3a20f668-6621-f75e-9950-268125ca8a2f
    # Runtime control: Loop for the Login [max=30] > Loop > If Edge Popup is showing > Then
    When I click or select "OK"

    # Source step 0165: Maximize Window | Module: TBox Window Operation
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-2b97-0140-17239ab3f79d
    # Runtime control: Loop for the Login [max=30] > Loop
    When I perform window operation "Maximize" on window "Duck Creek*"

    # Source step 0166: Check for Log In | Module: Logout
    # Section: New Application - Data Entry Process > Check to see if Logged In | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-1049-ff4e-2462353be58e
    # Runtime control: Loop for the Login [max=30] > Loop > If Still Logged In > Condition
    Then "Logged In User" should exist

    # Source step 0167: Logout | Module: Logout
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13d49c-165b-f91a-b5de-ec24851f1092
    ...
    # Source step 0168: Sync for Log out | Module: TBox Wait
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13fd82-ee13-a8e3-e990-700201b7767f
    # Runtime control: Loop for the Login [max=30] > Loop > If Still Logged In > Then
    When I wait "1000" milliseconds

    # Source step 0169: Check for Http Error Msg | Module: Http Error Msg
    # Section: New Application - Data Entry Process > Http Error Msg | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13fd63-0d6f-62aa-95ff-f6d8b76c90b1
    ...
    # Source step 0170: Click OK on Http Error Msg | Module: Http Error Msg
    # Section: New Application - Data Entry Process > Http Error Msg | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13fd63-0d6f-53c6-4142-f9728cfaee2b
    # Runtime control: Loop for the Login [max=30] > Loop > If Still Logged In > Then > If Error Msg Exists > Then
    When I click or select "OK"

    # Source step 0171: Check Http Error Msg does not exist | Module: Http Error Msg
    # Section: New Application - Data Entry Process > Http Error Msg | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13fd63-0d6f-117a-0c2b-317a4b5a0333
    # Runtime control: Loop for the Login [max=30] > Loop > If Still Logged In > Then > If Error Msg Exists > Then
    Then I wait until "OK" no longer is visible

    # Source step 0172: Logout | Module: Logout
    # Section: New Application - Data Entry Process > Http Error Msg | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13fd63-bec2-69ea-d0bf-57cc476fc9b2
    # Runtime control: Loop for the Login [max=30] > Loop > If Still Logged In > Then > If Error Msg Exists > Then
    When I click or select "Logged In User"
    When I click or select "Logged In User > Logout"

    # Source step 0174: Login | Module: Login
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-bf72-8b9d-330f6a10d897
    # Runtime control: Loop for the Login [max=30] > Loop
    When I enter or select "FFQA008{TAB}" in "UserName"
    When I enter or select "${ENV:TOSCA_PROTECTED_PASSWORD}" in "Password"
    When I click or select "Login"

    # Source step 0175: Wait for Login Screen to Go Away | Module: Login
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-95d4-9641-ecd18d77dd9b
    ...
    # Source step 0176: Set Loop Buffer to Exit Loop | Module: TBox Set Buffer
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-ef41-eb0d-3bbe94d20cf1
    ...
    # Source step 0177: Take Screenshot of Login | Module: TBox Take Screenshot
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-31b6-f0c0-5913076be452
    # Runtime control: Loop for the Login [max=30] > Loop > If Login Screen goes away > Else Take Screenshot and Loop
    When I capture a "Desktop" screenshot at "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\Screenshots\\Login Error"

    # Source step 0178: Set DocPath Buffer | Module: TBox Set Buffer
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a13d49c-165b-4b72-914c-3b3f207c9615
    # Step condition: DocPath != NULL
    When I retain hard-coded value "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\" as runtime value "DocPath"

    # Source step 0179: Retrieve Dex Agent Name | Module: TBox Set Buffer
    # Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek | Source XTestStep: 3a14206f-dfa2-d0fa-2115-a328697615e9
    ...
    # Source step 0180: Enter Desc in QuickSearch | Module: Dashboard|QuickSearch
    ...
    When I enter captured RUNTIME-DERIVED value "{B[QuoteDescription]}{TAB}{TAB}{TAB}{TAB}" in "Search Text"
    When I click or select "QuickSearch Button"

    # Source step 0181: Enter Info to Search by Desc | Module: Dashboard|Search for Policies / Quotes
    ...
    When I enter or select "Description{TAB}" in "Search Method (e.g. Description/Policy#)"
    When I click or select "Search Button"
    Then I wait until "View Policy" exists
    When I perform keyboard action "{TAB}" on "View Policy"
    When I click or select "View Policy"

    # Source step 0182: Navigate to Submission Screen | Module: Common Navigation Links
    ...
    # Source step 0183: Fill out Required Fields | Module: Submission|Required and Optional Fields
    ...
    # Source step 0184: Order Audit | Module: Submission|Required and Optional Fields
    ...
    # Source step 0185: Fill out Order Audit | Module: Submission|Required and Optional Fields
    ...
    # Source step 0186: Check to see Submission Screen Header Exists | Module: Submission|Required and Optional Fields
    ...
    # Source step 0188: Wait for Synchronization | Module: TBox Wait
    ...
    # Source step 0189: Wait on Submission Screen to Load | Module: Submission|Required and Optional Fields
    ...
    # Source step 0190: 500ms wait for syncing | Module: TBox Wait
    ...
    # Source step 0191: Check to see Coverage is bound Exists | Module: Submission|Required and Optional Fields
    ...
    # Source step 0192: Check Is Coverage bound (select) | Module: Submission|Required and Optional Fields
    ...
    # Source step 0193: Answer Is Coverage bound | Module: Submission|Required and Optional Fields
    ...
    # Source step 0194: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0195: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0196: Wait 2 Seconds | Module: TBox Wait
    ...
    # Source step 0197: Check for error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0198: Set Error Flag | Module: TBox Set Buffer
    ...
    # Source step 0242: Click First Close button on Error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0243: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0244: Click Complete App | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0245: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0246: Close Stoplight Window | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0247: Wait on Stoplight window to go away | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0251: Wait 3.5 seconds | Module: TBox Wait
    ...
    # Source step 0252: Check for Loading Indicator | Module: Indicators and Errors
    ...
    # Source step 0253: Wait 2 secs | Module: TBox Wait
    ...
    # Source step 0254: Stoplight message is visible | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0255: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0256: Run Stoplight | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0257: Wait 2 Seconds | Module: TBox Wait
    ...
    # Source step 0258: Check for error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0302: Click First Close button on Error | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0303: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0304: Click Complete App | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0305: Wait 3 Seconds | Module: TBox Wait
    ...
    # Source step 0306: Close Stoplight Window | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0307: Wait on Stoplight window to go away | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0308: Wait 3.5 seconds | Module: TBox Wait
    ...
    # Source step 0309: Verify Stoplight Successfully Ran | Module: Submission|Complete Application & Stoplight Functionality
    ...
    # Source step 0323: Set NBPrem Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "550.00" as runtime value "NBPrem"

    # Source step 0324: Verify Premiums | Module: Submission|Premiums
    ...
    Then "Full Term Premium" property "value" should equals "$550.00"
    Then "Premium Written" property "value" should equals "550.00"
    Then "Prior Premium" property "value" should equals "0.00"
    Then "Premium Change" property "value" should equals "550.00"

    # Source step 0325: Delete LastResponseResource | Module: TBox Delete Resource
    ...
    # Source step 0326: Get Session ID & Buffer | Module: Verify JavaScript Result
    ...
    # Source step 0327: Buffer Server Address | Module: TBox Set Buffer
    ...
    # Source step 0328: Forms API Request | Module: Forms API Request
    ...
    # Source step 0329: Forms API Response | Module: Forms API Response
    ...
    # Source step 0330: Sync API | Module: TBox Wait
    ...
    # Source step 0331: Save the Response as XML file | Module: Save XML file
    ...
    When I save the source-defined file/resource for "Save the Response as XML file" using "Resource=LastResponseResource; Filepath=\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\CP_BASIC_AZ_{B[QuoteID]}.xml"

    # Source step 0337: Sync API | Module: TBox Wait
    ...
    # Source step 0338: Buffer Powershell Arguments | Module: TBox Set Buffer
    ...
    When I derive and retain the RUNTIME-DERIVED buffer expression "powershell.exe -ExecutionPolicy Bypass -NoProfile -File FormsCheckQA.ps1 -Path \"\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\\" -FileName \"CP_BASIC\" -State  \"AZ\" -QuoteID \"{B[QuoteID]}\"" as runtime value "PowershellArguments"

    # Source step 0339: Execute Powershell Script | Module: TBox Start Program
    ...
    # Source step 0340: Display the Results Summary | Module: TBox Clipboard
    ...
    # Source step 0341: Check and Report for Fails in the Forms Verification from the SummaryResults | Module: TBox Set Buffer
...
#    - INPUT "Duration" with "1500"
# Source step 0173: "Waiton Username to exist" in module "Login" was disabled. Reason: 02.08.24 09:13:13 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|General|Log In to DuckCreek > Common|General|Logout | Source XTestStep: 3a13d49c-165b-5d28-b7d5-c93c8b451278
#    - WAIT (Exists) "UserName" with "True"
# Source step 0199: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0200: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0201: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0202: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0203: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0204: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0205: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0206: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0207: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0208: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0209: "Save changes" in module "Save JSON Resource" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0210: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0211: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0212: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0213: "Wait on Edge Browser to open" in module "Edge Browser" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0214: "Policy Load Sync" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0215: "Restart Microsoft Edge Message Exists?" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0216: "Restart Microsoft Edge Message - Click OK" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0217: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0218: "Check for Log In" in module "Logout" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0219: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0220: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0221: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0222: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0223: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0225: "Waiton Username to exist" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin] | 02.08.24 09:13:13 [Admin]
...
#    - WAIT (Exists) "UserName" with "True"
# Source step 0226: "Login" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
#    - INPUT "Login" with "X"
# Source step 0227: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0228: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0229: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0230: "Set DocPath Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0231: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0232: "Enter Desc in QuickSearch" in module "Dashboard|QuickSearch" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0233: "Enter Info to Search by Desc" in module "Dashboard|Search for Policies / Quotes" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0234: "Check for Transact Header" in module "TransACT" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0235: "Check if Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0236: "Click on Edit Policy on Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:08:57 [Admin]
...
# Source step 0237: "Check to see Submission Screen Header Exists" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-2c36-4c77-0509b15611cd
#    - VERIFY (Exists) "Submission Heading" with "False"
# Source step 0238: "Navigate to Submission Screen" in module "Common Navigation Links" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-6f12-3f1b-39180a24814b
#    - INPUT "Submission" with "{TAB}"
#    - INPUT "Submission" with "X"
# Source step 0239: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-4604-cd78-bb4eddf2bde6
#    - INPUT "Duration" with "1250"
# Source step 0240: "Wait on Submission Screen to Load" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-c808-873d-7350bc0ce3dd
#    - WAIT (Exists) "Submission Heading" with "True"
# Source step 0241: "500ms wait for syncing" in module "TBox Wait" was disabled. Reason: 24.01.23 06:08:57 [Admin]
# Section: New Application - Data Entry Process | Reusable flow: Common|Submission|Run Stoplight > Common|Submission|Determine if on Submission Page | Source XTestStep: 3a13d49c-165b-669e-7efc-61fd60f4b5e8
#    - INPUT "Duration" with "500"
# Source step 0259: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Url" with "https://connect.anico.com/Pages/default.aspx"
#    - INPUT "UseActiveTab" with "a blank/null value"
# Source step 0260: "Check the Loop Login" in module "TBox Evaluation Tool" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY "Expression" with "the RUNTIME-DERIVED source value {B[Loop Login]} = 0"
# Source step 0261: "Set Loop Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "UserName" with "AG0U388"
#    - INPUT "Password" with "${ENV:CL_DC_PASSWORD}"
# Source step 0262: "Close Explorer Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0263: "Close Chrome Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0264: "Close Firefox Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0265: "Close Edge Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0266: "Close Edge Beta Browsers" in module "TBox Start Program" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "WaitForExit" with "True"
#    - INPUT "WaitForExit > TimeoutForExit" with "5"
# Source step 0267: "Open Edge Preferences file" in module "Open/Create JSON file" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "Resource" with "EdgePreferences"
#    - ACTION "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
# Source step 0268: "Change Exit Type" in module "Edge Preferences File" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "RootObject > profile" with "a blank/null value"
#    - INPUT "RootObject > profile > exit_type" with "none"
# Source step 0269: "Save changes" in module "Save JSON Resource" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value %userprofile%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\Preferences"
# Source step 0270: "Delete EdgePreferences Resource" in module "TBox Delete Resource" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Resource" with "EdgePreferences"
# Source step 0271: "Delete Cookies File" in module "TBox Delete File" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Directory" with "the RUNTIME-DERIVED source value %USERPROFILE%\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default"
#    - INPUT "File" with "Cookies"
# Source step 0272: "OpenUrl" in module "OpenUrl" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "WebDriverBrowserArguments" with "a blank/null value"
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# Source step 0273: "Wait on Edge Browser to open" in module "Edge Browser" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "BODY" with "True"
# Source step 0274: "Policy Load Sync" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "3000"
# Source step 0275: "Restart Microsoft Edge Message Exists?" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "OK" with "True"
# Source step 0276: "Restart Microsoft Edge Message - Click OK" in module "Restart Microsoft Edge Message" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0277: "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Caption" with "Duck Creek*"
#    - INPUT "Operation" with "Maximize"
# Source step 0278: "Check for Log In" in module "Logout" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "Logged In User" with "True"
# Source step 0279: "Logout" in module "Logout" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0280: "Sync for Log out" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "1000"
# Source step 0281: "Check for Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "The browser was unable to communicate with the server. HTTP Status Error - , HTTP Status - 0" with "True"
# Source step 0282: "Click OK on Http Error Msg" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "OK" with "X"
# Source step 0283: "Check Http Error Msg does not exist" in module "Http Error Msg" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Logged In User" with "{Click}"
#    - INPUT "Logged In User > Logout" with "X"
# Source step 0285: "Waiton Username to exist" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin] | 02.08.24 09:13:13 [Admin]
...
#    - WAIT (Exists) "UserName" with "True"
# Source step 0286: "Login" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Password" with "${ENV:TOSCA_PROTECTED_PASSWORD}"
#    - INPUT "Login" with "X"
# Source step 0287: "Wait for Login Screen to Go Away" in module "Login" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "Login" with "True"
# Source step 0288: "Set Loop Buffer to Exit Loop" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Loop Login" with "1"
# Source step 0289: "Take Screenshot of Login" in module "TBox Take Screenshot" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Directory" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\Screenshots"
#    - INPUT "Filename" with "Login Error"
# Source step 0290: "Set DocPath Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "DocPath" with "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\"
# Source step 0291: "Retrieve Dex Agent Name" in module "TBox Set Buffer" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "GetHostname" with "the RUNTIME-DERIVED source value \"\"\"${COMPUTERNAME}\"\"\""
#    - INPUT "AgentName" with "the RUNTIME-DERIVED source value {B[GetHostname]}"
# Source step 0292: "Enter Desc in QuickSearch" in module "Dashboard|QuickSearch" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Search Text" with "the RUNTIME-DERIVED source value {B[QuoteDescription]}{TAB}{TAB}{TAB}{TAB}"
#    - INPUT "QuickSearch Button" with "X"
# Source step 0293: "Enter Info to Search by Desc" in module "Dashboard|Search for Policies / Quotes" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "View Policy" with "{TAB}"
#    - INPUT "View Policy" with "X"
# Source step 0294: "Check for Transact Header" in module "TransACT" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "TransACT" with "True"
# Source step 0295: "Check if Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - ACTION "Table > <Row>" with "a blank/null value"
#    - VERIFY "Table > <Row> > Status" with "Pending"
# Source step 0296: "Click on Edit Policy on Pending Transaction" in module "TransACT|Transaction List Table" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - GROUP "Table > <Row> > $1" with "a blank/null value"
#    - ACTION "Table > <Row> > $1 > Link" with "{CLICK}"
# Source step 0297: "Check to see Submission Screen Header Exists" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - VERIFY (Exists) "Submission Heading" with "False"
# Source step 0298: "Navigate to Submission Screen" in module "Common Navigation Links" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Submission" with "{TAB}"
#    - INPUT "Submission" with "X"
# Source step 0299: "Wait for Synchronization" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "1250"
# Source step 0300: "Wait on Submission Screen to Load" in module "Submission|Required and Optional Fields" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - WAIT (Exists) "Submission Heading" with "True"
# Source step 0301: "500ms wait for syncing" in module "TBox Wait" was disabled. Reason: 24.01.23 06:13:06 [Admin]
...
#    - INPUT "Duration" with "500"
# Source step 0310: "Click Queue to open popup" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
#    - INPUT "Queue" with "X"
# Source step 0311: "Wait on Clear All and Click it" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
# Source step 0312: "Wait 1/2 sec" in module "TBox Wait" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
#    - INPUT "Duration" with "500"
# Source step 0313: "Click Queue to close popup" in module "Queue in CLAS QLTY" was disabled. Reason: 08.03.23 14:59:48 [Admin]
...
# Source step 0314: "Submission, select Policy Forms" in module "Submission, select Policy Forms" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
# Source step 0315: "Wait for Policy Forms to open" in module "TBox Wait" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
# Source step 0316: "Close Policy Forms" in module "TBox Send Keys" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
#    - INPUT "Keys" with "%\"{F4}\""
# Source step 0317: "Close out of PDF" in module "TBox Send Keys" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
#    - INPUT "Keys" with "\"{TAB}~\""
# Source step 0318: "Return to Submission Page" in module "Common Navigation Links" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
# Source step 0319: "Submission, select Policy Admin Forms" in module "Submission, select Policy Forms" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
# Source step 0320: "Wait for Policy Admin Forms to open" in module "TBox Wait" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
# Source step 0321: "Close Policy Admin Forms" in module "TBox Send Keys" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
#    - INPUT "Keys" with "%\"{F4}\""
# Source step 0322: "Close out of PDF" in module "TBox Send Keys" was disabled. Reason: 02.12.21 10:41:04 [ff01729]
...
#    - INPUT "Keys" with "\"{TAB}~\""
# Source step 0332: "Forms API Request" in module "Forms API Request" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
# Source step 0333: "Forms API Response" in module "Forms API Response" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
# Source step 0334: "Sync API" in module "TBox Wait" was disabled. Reason: 16.01.26 11:58:19 [ff01620@dnanico1.aniconet.com]
...
# Source step 0335: "Save the Response as XML file" in module "Save XML file" was disabled. Reason: 18.09.25 11:22:06 [ff01620@dnanico1.aniconet.com]
...
#    - INPUT "Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\CP_BASIC_AZ_{B[QuoteID]}.xml"
# Source step 0336: "Run Forms Request Get Forms on Policy" in module "Communicate with Web service" was disabled. Reason: 20.11.23 07:56:55 [ff01620]
...
#    - INPUT "Transform response > Response transformation_4 > Filepath" with "the RUNTIME-DERIVED source value \\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Forms_Check\\CP\\CP_BASIC_AZ_{B[QuoteID]}.xml"
...
# Active source step 0110 "Fill out CP Location Fields - Miles from FD" contains conditionally inapplicable field action(s):
...
# Active source step 0130 "Add Rating Groups" contains conditionally inapplicable field action(s):
...
# Active source step 0132 "Fill out Main Property Questions" contains conditionally inapplicable field action(s):
...
# Active source step 0133 "Property Add Class" contains conditionally inapplicable field action(s):
...
# Source step 0248: "Check for Loading Indicator" in module "Indicators and Errors" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source step 0249: "Wait 2 secs" in module "TBox Wait" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source step 0250: "Wait for Stoplight message to exist" in module "Submission|Complete Application & Stoplight Functionality" was not executed. Reason: Selected-iteration condition evaluated false: 'Stoplight Error' == "True"
...
# Source recovery step 0001: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-14a8-e110-2265-0605f4c00980
#    - I capture a "Desktop" screenshot at "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Screenshots\\CP\\CP BASIC TestCase"
# Recovery scenario: Recovery Scenario for TestSteps
# Source recovery step 0002: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-14a8-5f4e-8ac1-e91ea0169768
#    - I capture a "Desktop" screenshot at "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Screenshots\\CP\\CP BASIC TestStep"
# Recovery scenario: Recovery Scenario for TestStepValues
# Source recovery step 0003: Take Screenshot when Error Occurs | Module: TBox Take Screenshot | Source XTestStep: 3a13d49c-14a8-63e5-efcf-a3d9d71e743d
#    - I capture a "Desktop" screenshot at "\\\\mis\\sys\\QLTY\\Test_Automation\\Tricentis_Tosca\\Screenshots\\CP\\CP BASIC TSV"
# Recovery scenario: CleanUp Scenario
# Source recovery step 0004: Close Explorer Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-14a8-8201-8367-dea55901c3f7
#    - I run "taskkill /f /im iexplore.exe"
# Source recovery step 0005: Close Chrome Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-14a8-40c1-bb54-36515afa2559
#    - I run "taskkill /f /im Chrome.exe"
# Source recovery step 0006: Close Firefox Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-14a8-d9b6-30af-14ff9ba3844f
#    - I run "taskkill /f /im Firefox.exe"
# Source recovery step 0007: Close Edge Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-14a8-82b6-cb7c-336999f12cd8
#    - I run "taskkill /f /im MicrosoftEdge.exe"
# Source recovery step 0008: Close Edge Beta Browsers | Module: TBox Start Program | Source XTestStep: 3a13d49c-14a8-5f35-8761-76a8b28d2b6c
