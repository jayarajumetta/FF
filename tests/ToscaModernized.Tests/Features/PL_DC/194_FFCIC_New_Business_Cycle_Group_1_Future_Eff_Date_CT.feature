# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 194_FFCIC_New_Business_Cycle_Group_1_Future_Eff_Date_CT.feature
...
Feature: Execute FFCIC New Business Cycle Group 1 Future Eff Date for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Cycle Group 1 Future Eff Date workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Cycle Group 1 Future Eff Date using representative iteration Connecticut (CT)
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9518-4781-3c26-4447b840710d
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9518-6e1d-95aa-1371fb0ddbb5
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9518-7559-8069-866408e18c2d
    Then I wait until "Loading ..." exists

    # Source step 0077: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9518-dadb-1058-eeb8b69294b5
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9518-4d9d-4ddd-2b71419452b0
    ...
    # Source step 0115: Cycle Additional Coverages | Module: EQ|| Cycle| Additional Coverages
    ...
    # Source step 0116: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    ...
    # Source step 0117: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0118: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0119: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0120: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0121: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0123: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0124: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0125: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0130: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0131: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0132: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0133: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0153: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0154: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0155: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0156: EU||Home | Module: EU||Home
    ...
    # Source step 0157: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0158: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0159: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0161: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0162: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0170: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0171: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0172: EU||Home | Module: EU||Home
    ...
    # Source step 0173: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0174: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0175: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0180: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0181: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0182: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0183: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0184: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0185: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0186: TBox Save As | Module: TBox Save As
    ...
    # Source step 0187: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0189: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0190: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0191: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0193: TBox Save As | Module: TBox Save As
    ...
    # Source step 0194: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0196: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0197: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0199: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0200: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0201: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9528-0c4d-7836-19f7313773cb
    ...
    # Source step 0202: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9528-3678-d006-bce90d19afaf
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Cycle_FutureEffDate"
    ...
    # Source step 0203: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bbaa3-9528-d51c-4bfd-27298c1bb60b
    When I close the active browser
...
#    - INPUT "Next" with "X"
# 25. Source step 0123 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 26. Source step 0126 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 27. Source step 0127 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 28. Source step 0128 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 29. Source step 0129 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 30. Source step 0136 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 31. Source step 0137 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 32. Source step 0138 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 33. Source step 0139 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 34. Source step 0140 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 35. Source step 0141 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 36. Source step 0142 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 37. Source step 0143 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 38. Source step 0144 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 39. Source step 0145 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 40. Source step 0146 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 41. Source step 0147 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 42. Source step 0148 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 43. Source step 0149 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 44. Source step 0150 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 45. Source step 0151 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 46. Source step 0152 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 47. Source step 0155 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 48. Source step 0155 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 49. Source step 0163 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 50. Source step 0164 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 51. Source step 0165 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 52. Source step 0167 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 53. Source step 0168 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 54. Source step 0169 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 55. Source step 0171 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 56. Source step 0171 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 57. Source step 0175 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 58. Source step 0175 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 59. Source step 0175 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 60. Source step 0175 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 61. Source step 0176 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 62. Source step 0176 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 63. Source step 0176 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 64. Source step 0176 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 65. Source step 0177 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 66. Source step 0177 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 67. Source step 0177 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 68. Source step 0177 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 69. Source step 0178 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 70. Source step 0179 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 71. Source step 0184 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 72. Source step 0188 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 73. Source step 0195 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 74. Source step 0202 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 75. Source step 0202 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
#
