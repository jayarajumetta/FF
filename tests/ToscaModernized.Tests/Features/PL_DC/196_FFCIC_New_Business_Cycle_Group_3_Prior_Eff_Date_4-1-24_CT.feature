# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 196_FFCIC_New_Business_Cycle_Group_3_Prior_Eff_Date_4-1-24_CT.feature
...
Feature: Execute FFCIC New Business Cycle Group 3 Prior Eff Date_4-1-24 for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Cycle Group 3 Prior Eff Date_4-1-24 workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Cycle Group 3 Prior Eff Date_4-1-24 using representative iteration Connecticut (CT)
    ...
    When I derive and retain the RUNTIME-DERIVED date from Tosca expression "{Date[04.01.2024][][MM/dd/yyyy]}" as runtime value "EffectiveDate"
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0a9b-dbdb-d561-3dc57222401e
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0a9b-9cde-56f8-3219ea47539b
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0aa0-0a4d-ef14-e2ad4836e7cf
    Then I wait until "Loading ..." exists

    # Source step 0081: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0aa0-75f5-d3a8-3e087761d301
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0aa0-c69c-5dd7-7e3e844bdbd3
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0ac7-4ad2-e007-82653115fc79
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0ac7-8d53-1e18-f765b75723a9
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Cycle_PriorEffDate_4-1-24"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-0ac7-b820-1b53-217ae9d5f91b
    When I close the active browser
...
#    - INPUT "Duration" with "12000"
# 81. Source step 0193 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 82. Source step 0194 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 83. Source step 0195 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 84. Source step 0196 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 85. Source step 0197 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 86. Source step 0198 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 104. Source step 0216 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with the unresolved source parameter "Express URL" (not supplied by this reusable-block invocation)
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 105. Source step 0217 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 106. Source step 0218 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 107. Source step 0219 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 108. Source step 0220 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 109. Source step 0221 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 110. Source step 0222 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 111. Source step 0223 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 112. Source step 0224 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 113. Source step 0225 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
...
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 117. Source step 0229 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 118. Source step 0230 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 119. Source step 0231 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 120. Source step 0232 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 121. Source step 0233 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 122. Source step 0234 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Duration" with "12000"
# 124. Source step 0236 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:15:10 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
