# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 184_Auto_Rate_Filings_Common_Policy_NB_Prior_Eff_Date_AL.feature
...
Feature: Execute Auto Rate Filings Common Policy NB_Prior Eff Date for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Auto Rate Filings Common Policy NB_Prior Eff Date workflow for the selected source iteration
  ...
  Scenario: Auto Rate Filings Common Policy NB_Prior Eff Date using representative iteration Alabama (AL)
    ...
    When I derive and retain the RUNTIME-DERIVED date from Tosca expression "{Date[08.08.2024][][MM/dd/yyyy]}" as runtime value "EffectiveDate"
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-4ab7-902c-30e9f636fc33
    ...
    When I retain the unresolved source parameter "State" (not supplied by this reusable-block invocation) as runtime value "State"
    When I retain the unresolved source parameter "Company" (not supplied by this reusable-block invocation) as runtime value "Company"
    ...
    # Source step 0085: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-e829-c1e5-12c8916bfc5e
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-f151-7ec9-9ce368e30fba
    ...
    # Source step 0087: EQ||Vehicle Vin | Module: EQ||Vehicle Auto Vin_1
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-77a7-f3e2-0dec2b2a22e9
    ...
    # Source step 0088: EQ||Vehicle Summary Auto Use | Module: EQ||Vehicle Summary Auto/Motor Home Use
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-2afa-6d97-8ac24d2651a2
    ...
    When I enter or select "\"^{a}\"" in "txt_annual_mileage" when "State != \"KS\"" is satisfied
    When I enter or select "8500" in "txt_annual_mileage" when "State != \"KS\"" is satisfied
    When I click "btnSave_Continue"

    # Source step 0092: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-b2bb-af02-96975b777e59
    When I click "btn_Add_Vehicle"

    # Source step 0093: EQ||Vehicle Summary Auto Additional | Module: EQ||Vehicle Summary Auto Additional
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-aa81-7af2-9e322b2f140b
    ...
    When I click "Classic"
    When I enter or select "21,000" in "Agreed Value"
    When I click "Own"
    When I click "CONTINUE"
    When I click "Restricted Use" when "State != \"KS\"" is satisfied
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-80a2-1edd-6a9331722932
    When I click "btn_Add_Vehicle"

    # Source step 0095: EQ||Vehicle Summary Auto Additional | Module: EQ||Vehicle Summary Auto Additional
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-88e1-ace0-e987fac27978
    Then I wait until "VIN" is enabled
    ...
    # Source step 0096: EQ || CA Verified Mileage | Module: EQ || CA Verified Mileage
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-db8c-54a6-12f4f6007dc5
    When I click "Opt Out" when "State == \"CA\"" is satisfied

    # Source step 0097: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing_Common Auto | Source XTestStep: 3a1cfb6e-4727-ee3e-3a0b-2b24e8b38a20
    When I click "btn_Next"
    ...
    # Source step 0099: (New) EQ || Multiple Driver Assignment_1 | Module: (New) EQ || Multiple Driver Assignment
    ...
    # Source step 0100: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75a6-6dab-606c-f54104b47457
    ...
    # Source step 0101: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75a6-f0c1-66ac-e5b39fdd8d31
    ...
    # Source step 0102: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75a6-fd06-9584-732d5196acbd
    Then I wait until "Loading ..." exists

    # Source step 0103: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75a6-94a2-223e-2586d667b627
    ...
    # Source step 0104: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75a6-9343-c5a3-e0e0993164a3
    ...
    # Source step 0105: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0106: Check for claims/violations needing edited | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0107: Edit Item(s) | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0109: If Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0110: Edit Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0111: Edit Violation | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0112: Check for PopUp | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0113: Select Continue | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0114: Next | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0115: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0116: EQ||Discount - Rate Tier Questions | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0117: EQ||Discount - Rate Tier Questions | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0119: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0120: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0121: EQ||Discount | Module: EQ||Discount(NEW)
    ...
    # Source step 0123: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0124: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0125: Select Policy Coverage Option | Module: Coverages (New)
    ...
    # Source step 0126: Edit Coverage Option | Module: Edit Coverage Option (New)
    ...
    # Source step 0127: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 09 Coverages | Reusable flow: Auto | 09 EQ | Coverages | Source XTestStep: 3a19dd55-d452-32f7-1e44-9a9fe0dd9489
    Then I wait until "Loading ..." exists

    # Source step 0128: Navigate down screen to V1 | Module: Coverages (New)
    ...
    # Source step 0129: Select V1 Coverages | Module: Coverages (New)
    ...
    # Source step 0130: Navigate down screen to V2 | Module: Coverages (New)
    ...
    # Source step 0131: Select V2 Coverages | Module: Coverages (New)
    ...
    # Source step 0132: Navigate down screen to V3 | Module: Coverages (New)
    ...
    # Source step 0133: Select V3 Coverages | Module: Coverages (New)
    ...
    # Source step 0134: Navigate down screen to V4 | Module: Coverages (New)
    ...
    # Source step 0135: Select V4 Coverages | Module: Coverages (New)
    ...
    # Source step 0145: EQ || Other Policy Coverages Section | Module: EQ || Other Policy Coverages Section (New)
    ...
    # Source step 0146: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0147: EQ || Personal Injury Protection Section  | Module: EQ || Personal Injury Protection Section (New)
    ...
    # Source step 0148: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0149: EQ || Vehicle Coverages Section | Module:  EQ || Vehicle Coverages Section
    ...
    # Source step 0150: Additional Coverages Next | Module: EQ || Additional Coverages Next (New)
    ...
    # Source step 0151: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    ...
    # Source step 0152: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0153: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0154: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0155: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0156: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0157: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0158: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0160: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0165: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0166: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0167: OpenUrl | Module: OpenUrl
    ...
    # Source step 0171: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0172: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0173: EU||Home | Module: EU||Home
    ...
    # Source step 0174: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0175: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0176: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0177: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0178: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0182: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0183: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0220: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0221: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0222: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0243: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0244: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0245: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0246: EU||Home | Module: EU||Home
    ...
    # Source step 0247: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0248: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0249: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0250: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0251: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0252: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0256: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0257: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0258: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0259: TBox Save As | Module: TBox Save As
    ...
    # Source step 0260: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0262: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0265: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0266: TBox Save As | Module: TBox Save As
    ...
    # Source step 0267: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0269: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0270: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0275: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75e5-eec1-9fb2-fd66ae3f7f02
    ...
    # Source step 0276: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75e5-13d6-3266-62f5319c57dc
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Auto_PolicyData_RateFilings_CommonAuto_PriorEffDate"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb57-75e5-e126-4f56-9d02ba235640
    When I close the active browser
...
#    - CONTAINER "Coverages" with "Rate Filings"
# 22. Source step 0087 field "btn_vehicle1" in "EQ||Vehicle Vin" was disabled. Reason:  
#    - Preserved source value: "=True"
# 23. Source step 0089 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - WAIT "txt_annual_mileage" with "True"
# 24. Source step 0090 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - INPUT "txt_annual_mileage" with "\"^{a}\""
#    - INPUT "txt_annual_mileage" with "8500"
#    - INPUT "btnSave_Continue" with "X"
# 25. Source step 0091 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - INPUT "btnSave_Continue" with "X"
# 26. Source step 0093 field "Veh1" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "==True"
# 27. Source step 0095 field "Veh 3" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "==True"
# 28. Source step 0110 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 29. Source step 0118 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Less than $15,000/$30,000" with "{Click}"
# 30. Source step 0136 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 31. Source step 0137 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 32. Source step 0138 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 33. Source step 0139 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 34. Source step 0140 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 35. Source step 0141 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 36. Source step 0142 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 37. Source step 0143 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 38. Source step 0149 field "Cycle Accessories_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 39. Source step 0149 field "Original Parts_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 40. Source step 0149 field "Endorsement Limit V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1398 $5,000"
# 41. Source step 0149 field "Cycle Accessories_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 42. Source step 0149 field "Original Parts_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 43. Source step 0149 field "Endorsement Limit V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1399 $7,000"
# 44. Source step 0158 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 45. Source step 0161 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 46. Source step 0162 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 47. Source step 0163 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 48. Source step 0164 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 49. Source step 0168 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 50. Source step 0169 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 51. Source step 0170 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 52. Source step 0172 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 53. Source step 0172 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 54. Source step 0176 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 55. Source step 0176 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 56. Source step 0176 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 57. Source step 0176 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 58. Source step 0177 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 59. Source step 0177 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 60. Source step 0177 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 61. Source step 0177 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 62. Source step 0178 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 63. Source step 0178 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 64. Source step 0178 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 65. Source step 0178 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 66. Source step 0179 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
# 67. Source step 0180 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 68. Source step 0184 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 69. Source step 0185 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 70. Source step 0186 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 71. Source step 0187 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 72. Source step 0188 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 73. Source step 0189 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ReferUW" with "X"
#    - INPUT "SaveExit_1" with "X"
# 74. Source step 0190 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 75. Source step 0191 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 76. Source step 0192 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 77. Source step 0193 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 78. Source step 0194 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 79. Source step 0195 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 80. Source step 0196 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 81. Source step 0197 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 82. Source step 0198 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 83. Source step 0199 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 84. Source step 0200 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 85. Source step 0201 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 86. Source step 0202 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 87. Source step 0203 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 88. Source step 0204 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 89. Source step 0205 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 90. Source step 0206 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 91. Source step 0207 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 92. Source step 0208 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 93. Source step 0209 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 94. Source step 0210 "EU||Home" in module "EU||Home" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 95. Source step 0211 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 96. Source step 0212 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 97. Source step 0213 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 98. Source step 0214 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 99. Source step 0215 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 100. Source step 0216 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 101. Source step 0217 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 102. Source step 0218 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 103. Source step 0219 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 104. Source step 0226 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpst-auto.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "UseActiveTab" with a blank value
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# 105. Source step 0227 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 106. Source step 0228 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 107. Source step 0229 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 108. Source step 0230 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 109. Source step 0231 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 110. Source step 0232 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 111. Source step 0233 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 112. Source step 0234 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 113. Source step 0235 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 114. Source step 0236 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 115. Source step 0237 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 116. Source step 0238 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 117. Source step 0239 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 118. Source step 0240 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 119. Source step 0241 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 120. Source step 0242 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 121. Source step 0245 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 122. Source step 0245 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 123. Source step 0253 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 124. Source step 0254 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 125. Source step 0255 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 126. Source step 0257 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 127. Source step 0261 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 128. Source step 0268 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 129. Source step 0274 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:26 [pa2096@dnanico1.aniconet.com]
...
# 130. Source step 0276 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 131. Source step 0276 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 132. Source step 0277 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:31 [pa2096@dnanico1.aniconet.com]
