# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 051_Activity_Points_-_Experience_Period_Auto_-_Post_-_ALL_AZ.feature
...
Feature: Execute Activity Points - Experience Period (Auto) - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Experience Period (Auto) - Post - ALL workflow for the selected source iteration
  ...
  Scenario: Activity Points - Experience Period (Auto) - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-48c5-6406-60a38bce33e3
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-d831-576b-8abde715c369
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-4ff5-bc93-2058a03d62ba
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-64f0-c133-ffe4f2e91a0c
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-7399-9194-e31b9aea16d3
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-a8a9-ab8a-553b966bac57
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-36a2-54cf-9d96d8808931
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-1317-167d-387a605d5eb2
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a64-60d7-43ee-4c5ed0594e17
