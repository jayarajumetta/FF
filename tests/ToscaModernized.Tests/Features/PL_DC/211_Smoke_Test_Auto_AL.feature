# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 211_Smoke_Test_Auto_AL.feature
...
@PL_DC @Auto @smoke @Alabama @Edge @manual @automated
Feature: Execute Smoke Test Auto for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Smoke Test Auto workflow for the selected source iteration
  ...
  Scenario: Smoke Test Auto using representative iteration Alabama (AL)
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1883-1142-ce28-23ecc0a20ea3
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1886-9249-c81c-7ab03ed3aa8f
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1886-041e-72d2-8f90d7c47f54
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1886-d7f0-e208-d9ef670976e4
