# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 097_UW_Cancellation_Auto_-_MD_UW_Cancellation_Auto_-_MD.feature
...
Feature: Execute UW Cancellation Auto - MD for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Cancellation Auto - MD workflow for the selected source iteration
  ...
  Scenario: UW Cancellation Auto - MD using representative iteration UW Cancellation Auto - MD
    # Source step 0009: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-dd34-6bec-7dc00df8e29f
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-9e9d-7e0c-f277345b3e45
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-711f-78fc-da8a46a95acc
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-565d-0f7a-4f4a171bcc9f
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-f021-a43f-bb1ebad6ec12
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0220-7f4b-ecd06ff51234
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-da61-517c-c963a0690926
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-a62f-a4c2-65f19defec1b
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-5537-7bf3-cc3e51e014a8
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0757-cfd0-e4c9d2e8ff13
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-8f00-28c8-f16e2aaee7d2
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-d0b6-6b24-69da6f97232e
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-76fe-c140-b10946139cd2
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-5257-5e38-49e5c5594ee1
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-7b02-32e8-743490e031b8
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-1206-4dc8-7f085fce0af3
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0029: EQ||Driver Summary | Module: EQ||Driver Summary
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-e0d2-5177-05681a1ab511
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-fc87-b683-480562bc2ead
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0e80-2891-2da72ea13039
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-5c8e-7097-1d8e6d45c7d1
    When I click "Btn_Next"

    # Source step 0034: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-3190-0b89-5fecaadd452f
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-138f-f8ff-56a420fbccad
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-de7a-c39e-db31c15ab69f
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-4266-92bf-6796b785f45b
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-ad20-6ea5-38ab3fa45557
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-f120-18d9-ad0c636fddd2
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-1a9c-6e95-bf2d8c91d8b5
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-4318-7c82-41ea31a0593b
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-3f06-1734-29b51f81b284
    ...
    # Section: Process > Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-dc1a-8bc2-800e03ecb84d
    When I click "Btn_Next"
    ...
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-cdcd-5034-7fb09289c8c7
    ...
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-7034-ccad-5bcee312d0f0
    ...
    # Section: Process > Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-a942-47d8-8af54e2ac822
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0049: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3070-d830-7995-7eeaae8225d9
    When I click "<unnamed value>"
    ...
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-82c5-bc36-93dd4a3580fa
    When I click "btn_Next"
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-2013-0e7c-496f5941f79a
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-2505-24db-ab86eda856d8
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-e3ed-502b-ee2067253ed1
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-92fd-1956-5660ec2cdf7d
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-a0db-77c0-57913f76b6ef
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-f762-f0d7-efa7ddd51298
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-26ca-9c93-a95e03718aea
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-45c7-58ed-74973b4f6ef5
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-c0ef-1fd8-a2d99d32b6c9
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-8dbe-5b05-5eedd7f99909
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-7e3a-8344-58485615ba3c
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-8fe6-4b71-63d25d4ba0cd
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-2fe8-47b4-e3bedf2083c5
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-ef5b-c21f-fb233d252e01
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-9a10-4e4e-d0a8fb1751f6
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-3452-1138-43e958caaeb0
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-ef61-cc8e-29c15ab9461a
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-72d9-f8e6-88c65d67a4f5
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-6021-5734-e7fda3938fcf
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-af4b-e1ce-5599bbc3db9a
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-0478-6313-5168bcd2820c
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-71e8-6fd8-e34fcff24125
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-4149-46e8-859befaed90f
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-d04c-30be-b9a72a875248
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-b12c-a083-4d289ed9b5ef
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-ff71-3e78-2ce4c9c26f77
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-5bf3-7559-927786064f78
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-c35e-73f7-4d142d74f5ac
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-8da2-41a1-0a9a6872f048
    When I click "Btn_Launch To Checklist"

    # Source step 0119: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-d824-be91-99a472b25f09
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-da8b-a109-1bcf69c8ab7d
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-c78e-2ed4-e3b2d00d5382
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-10c7-e02e-2cf5ac8ef026
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-c1ea-a65d-bb6088a053f1
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-5627-e582-da2d47cec825
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0126: TBox Save As_1 | Module: TBox Save As
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-c2fa-ec1d-5f2d07d6e1d3
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-e4cc-10c1-5e5a802dcf34
    When I close the active browser

    # Source step 0129: EQ||Click on Transmit | Module: EQ||Submission
    # Section: Process > Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-f85a-b9e9-e042612b962b
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-5dc9-7561-c8258a0b23fe
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-307f-2d2a-517c-c2811fbf9f01
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-1aaf-2b7d-b87f347577e2
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-7dd1-4736-e1cf0057728f
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-9e2c-3bd9-a85ff55c1115
    # Runtime control: If_ExpressUI Sign on page showed up or not > Condition - if signon page is displayed
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-a7a5-85fe-c634bfa121c1
    # Runtime control: If_ExpressUI Sign on page showed up or not > Then - Enter Sign On Credentials
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-5e39-4413-3d33a06d13a9
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-ff92-9da0-947803534bb9
    When I click "Lnk_Insured Name"
    When I click "Lnk_PersonalAuto"

    # Source step 0158: Click Transaction Type | Module: EU|Transaction Type
    # Section: Process > UW Cancellation > UW cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-f7af-3634-c3ba69140dcb
    When I click "expand"
    When I click "Cancel"
    When I click "Go"

    # Source step 0159: Click Transaction Reason & Detailed Reason | Module: Check if Value too High appears
    # Section: Process > UW Cancellation > UW cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3087-01cd-acf3-f8f3945e4a0e
    ...
    # Section: Process > UW Cancellation > UW cancellation Transaction > Difference Between Two Dates | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-5932-81d1-84153d707d1a
    ...
    # Section: Process > UW Cancellation > UW cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-629a-da6c-2b6696e858c2
    When I enter or select "True" in "MVR_1"
    When I click "Schedule"

    # Source step 0174: TBox Wait | Module: TBox Wait
    # Section: Process > UW Cancellation > UW cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-8cb4-4b71-de107545de8c
    When I wait "5000" milliseconds

    # Source step 0175: Close the Express UI Page | Module: CloseBrowser
    # Section: Process > UW Cancellation > UW cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-5236-3f43-eeba482676e8
    When I close the active browser
...
# 5. Source step 0011 "Enter Client Selection" in module "EQ || Client Selection" was disabled. Reason: 01.06.24 14:51:43 [ct2634]
...
# 6. Source step 0012 "Enter Account Details" in module "EQ||Account Details" was disabled. Reason: 01.06.24 14:51:43 [ct2634]
...
#    - Preserved source value: "X"
# 122. Source step 0134 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 123. Source step 0135 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 124. Source step 0136 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 125. Source step 0137 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 126. Source step 0138 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 127. Source step 0139 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 128. Source step 0140 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 129. Source step 0141 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 130. Source step 0142 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 131. Source step 0151 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 132. Source step 0152 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 133. Source step 0153 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 134. Source step 0172 "Close Cancel Page" in module "Check if Value too High appears" was disabled. Reason: 13.06.24 19:10:58 [ct2634]
#    - INPUT "Exit Without Saving" with "X"
# 135. Source step 0176 "Click on Transmit Button" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:48 [ct2634]
#    - WAIT "Btn_Transmit" with "True"
#    - VERIFY "Btn_Transmit" with "Transmit"
#    - INPUT "Btn_Transmit" with "X"
# 136. Source step 0177 "Buffer Tranmit Premiums" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:48 [ct2634]
...
#    - VERIFY "Btn_Transmit" with "Transmit"
#    - INPUT "Btn_Transmit" with "X"
# 137. Source step 0178 "TestData - Create & provide new item" in module "TestData - Create & provide new item" was disabled. Reason: 30.05.24 19:09:05 [ct2634]
...
#    - INPUT "Data structure > TestCase" with "UW Cancellation Auto - MD"
#    - INPUT "Data structure > Endorsement" with "N"
# 138. Source step 0179 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 30.05.24 19:09:05 [ct2634]
