# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 215_Smoke_Test_RV_AL.feature
...
@PL_DC @RV @smoke @Alabama @Edge @manual @automated
Feature: Execute Smoke Test RV for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Smoke Test RV workflow for the selected source iteration
  ...
  Scenario: Smoke Test RV using representative iteration Alabama (AL)
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1a67-5961-2ab5-bfe81e64c9b1
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1a67-1577-f4ff-8ea20980f6bc
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1a67-3daf-9c5d-d30a2d90820a
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-1a67-a107-d0a6-8790d52cf3b1
