# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 116_UW_Non-Renewal_-_Auto_-_CA_AZ.feature
...
Feature: Execute UW Non-Renewal - Auto - CA for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Non-Renewal - Auto - CA workflow for the selected source iteration
  ...
  Scenario: UW Non-Renewal - Auto - CA using representative iteration Arizona (AZ)
    # Source step 0009: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-55f4-44d7-0ab7ed911885
    ...
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-ed1a-84e8-14ff9a3937ad
    ...
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-38db-22f2-3a3bc03d96d0
    # Runtime control: EQ||Enter Sign On Credentials > Then - Enter Sign On Credentials
    ...
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-227d-417a-dbac2e6b757f
    ...
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-ed5c-653f-09b0909f67dc
    ...
    # Section: Process > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-c8c3-1e7a-8d2cd208af77
    ...
    # Section: Process > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f13-d07b-56c3-9202b719f84b
    ...
    # Section: Process > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f22-3c2a-8a5b-5b9cffcb9dd1
    ...
    # Section: Process > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-78f6-10a7-6ceffb4e42d9
    ...
    # Section: Process > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-b8ec-4065-02bd0f046589
    ...
    # Section: Process > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-6272-a370-9f8770ab160b
    When I select "Btn_Chk box_check_boxNone Of The Above"
    When I click "Btn_Next"

    # Source step 0023: EQ||Tabs - Capturing Quote Number | Module: EQ||Tabs
    # Section: Process > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-8c82-1b0e-9f114b6ae805
    ...
    # Section: Process > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-f1da-d016-8e7eaafc8bae
    ...
    # Section: Process > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-99ea-db16-e91b5ce1e55e
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0026: Driver Summary - Enter Driver Details | Module: EQ||Driver Summary
    # Section: Process > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a5e2-f032-f2bfb9c4ada9
    ...
    # Section: Process > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-d365-7149-027a89a966e2
    When I click "Btn_Next"

    # Source step 0028: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-9c7c-e7da-df2444e4a7ff
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-fd1d-e074-eff840edee8a
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-b0fb-5f55-5e0e750ed177
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-1259-e1ab-900ac9fae1d6
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-fcab-89b5-4b6878a55802
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a6ac-ab70-6a1bd1b4e3e3
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-1b23-a743-af6a313d3a85
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-04a0-b872-0f0717abdde6
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-4341-491d-c270c3b8379a
    ...
    # Section: Process > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-3091-9d90-1338c01c771b
    When I click "Btn_Next"

    # Source step 0038: Coverages - Select Coverages & Continue | Module: <unresolved module>
    # Section: Process > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-355f-f57a-3200660dee80
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    ...
    # Section: Process > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-253d-af8a-3822b8f3e0f3
    When I click "Btn_Next"
    ...
    # Section: Process > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-12e0-a1b9-86bdd6560d43
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0042: Enter Underwriting | Module: <unresolved module>
    # Section: Process > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-dadb-5c96-eca4bff8e2d7
    When I click "<unnamed value>"
    ...
    # Section: Process > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-df8e-d9da-dec070535238
    When I click "btn_Next"
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-1c48-fd1d-fc100d139ad7
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-4d92-403f-9f32a6926243
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-296e-15ea-cde1f2e57f05
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-bdf5-a840-3d5457428b42
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-decd-5cd9-790016f99315
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-c08a-4003-532c8f0d103a
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-c97a-0ecb-b581d0636164
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-70dd-8221-7d6615536b3f
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a012-f227-38457928e125
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-7837-1e80-09e52a093605
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-c770-bcdc-c0d64566c096
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-5369-6715-f52d8427e774
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-3dd5-c88b-15a518a19b07
    ...
    # Section: Process > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-4362-f56f-c97ab5955593
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-8cea-9572-0cf94bc3fb18
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a16d-7585-49af425bca31
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-dbfa-7749-4d69509956d3
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-7edb-2039-4b39ba045bfc
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-dc52-631a-a4683ee6945d
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-2584-0d35-2642deb278d7
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a602-ea4b-da9911637975
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-7535-8b3a-5cb4b14e0018
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-9465-1df2-3c059eac34c6
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-77e5-c143-b2a05898fe56
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-fd85-a716-3b3223f77e0e
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a53d-9e94-e54bae5c5837
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-6b05-33ec-70e2eb094d83
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a560-0ed4-710d8c35f2a4
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-ad6d-ef2c-8fdeb7cad577
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-9343-2f74-89e922859787
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-8fcb-3b36-fdef22875740
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-c040-45e0-79834f2d72d8
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-486d-df0e-2779f7579156
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-9d8a-a63e-6ab65f61f0b5
    ...
    # Section: Process > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-80c0-cb1b-e07c30607e83
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0118: TBox Save As_1 | Module: TBox Save As
    # Section: Process > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-a211-8f85-beb415dbc010
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-c5a5-3b01-be75d8bd7be0
    When I close the active browser

    # Source step 0122: EQ||Click on Transmit | Module: EQ||Submission
    # Section: Process > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-9f88-863e-984bc7b6ec72
    ...
    # Section: Process > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-6025-eb03-8e4b1307bdae
    ...
    # Section: Process > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f24-94f1-1c64-0110bbcfbf32
    ...
    # Section: Process > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-ac7e-3958-87646d23d059
    ...
    # Section: Process > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-ce8d-5b7f-beeb563cc45a
    ...
    # Section: Process > UW Non Renewal > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-b0c3-9178-5fe0a47f2521
    ...
    # Section: Process > UW Non Renewal > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-8fe9-a7a1-65d63444bee3
    ...
    # Section: Process > UW Non Renewal > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-6346-23d1-807dd99dab40
    ...
    # Section: Process > UW Non Renewal > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-7aa2-3385-3509d1e4e6d3
    When I click "Lnk_Insured Name"
    Then I wait until "Lnk_PersonalAuto" is visible
    When I click "Lnk_PersonalAuto"

    # Source step 0151: Click Non-Renew Transaction | Module: EU|Transaction Type
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-7350-3815-34039fc57ac4
    When I click "expand"
    When I select "Non-Renew"
    When I click "Go"

    # Source step 0152: Capturing Eff Date & Schedule date | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Difference Between Two Dates | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-5a35-2ab1-aefa615a2512
    ...
    # Source step 0153: Set Dates | Module: TBox Set Buffer
    ...
    # Source step 0154: Start PowerShell | Module: TBox Start Program
    ...
    # Source step 0155: Execute PowerShellCommand 1 | Module: TBox Send Keys
    ...
    # Source step 0156: Execute PowerShellCommand 2  | Module: TBox Send Keys
    ...
    # Source step 0157: TBox Wait | Module: TBox Wait
    ...
    # Source step 0158: Get Days Difference | Module: TBox Clipboard
    ...
    # Source step 0159: TestData - Find & provide item | Module: Old_TestData - Find & provide item
    ...
    And I use TDM parameter "Data search filter > TCName" with "UW Non-Renewal - Auto - NY"
    And I use TDM parameter "Data search filter > State" with "NY"
    And I use TDM parameter "Data search filter > LOB" with "Auto"

    # Source step 0160: Retriving Expected No.of days from TDM | Module: TBox Set Buffer
    ...
    # Source step 0161: TBox Evaluation Tool | Module: TBox Evaluation Tool
    ...
    # Source step 0162: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0164: Add 60 days | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-6d9e-10e5-20718715cc34
    ...
    # Source step 0165: Set the Scheduled Date after the Effective date | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-bd12-8f9a-c1668e2cd136
    When I enter the RUNTIME-DERIVED buffer expression "{CLICK}{SENDKEYS[\"^{a}\"]}{SENDKEYS[{B[Future Date]}]}{TAB}" in "Schedule Date (optional):"

    # Source step 0166: Value too High | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-5be2-4496-ed2fef91eb05
    ...
    # Source step 0167: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-07f9-d6d1-0754450946e3
    ...
    # Source step 0168: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-799f-acae-0b44066159b9
    ...
    # Source step 0169: Set the Scheduled Date to Current Date | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-826c-bb90-7a7719116afc
    ...
    # Source step 0170: Value too High | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-f52b-f65c-391951fb61f2
    # Runtime control: Check if System Prevents > Condition
    Then if the source runtime condition "Check if System Prevents > Condition" is satisfied, "Value too high" should equal "ValueTooHigh"

    # Source step 0171: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-b83b-e801-ec0cfb56c8f6
    # Runtime control: Check if System Prevents > Then
    When if the source runtime condition "Check if System Prevents > Then" is satisfied, I retain hard-coded value "Pop up displayed" as runtime value "Pass"

    # Source step 0172: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to Current Date | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-8e40-a33a-b645084ec738
    # Runtime control: Check if System Prevents > Else
    When if the source runtime condition "Check if System Prevents > Else" is satisfied, I retain hard-coded value "No pop up displayed" as runtime value "Fail"

    # Source step 0173: Exit the TransACT Page | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Go Back to TransACT Page & Click Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-da4e-f81f-b6cecfad3151
    When I click "Exit Without Saving"

    # Source step 0174: Select Non Renew TransACT | Module: EU|Transaction Type
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Go Back to TransACT Page & Click Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-6e74-e36b-b80484956180
    When I click "expand"
    When I select "Non-Renew"
    When I click "Go"

    # Source step 0175: Capturing Eff Date & Schedule date | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Go Back to TransACT Page & Click Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-3a4a-4cb1-287c789e9627
    When I capture "Value" from "Effective Date" as runtime value "EffectiveDate"
    When I capture "Value" from "Schedule Date (optional):" as runtime value "Schedule Date"

    # Source step 0176: Set the date to Less than Expected No of days | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-c627-f11c-afddcc2f4cdf
    ...
    # Source step 0177: Set the Scheduled Date less than Expected No.of Days | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-1f7d-828b-7c61da1c01a8
    When I enter the RUNTIME-DERIVED buffer expression "{CLICK}{SENDKEYS[\"^{a}\"]}{SENDKEYS[{B[Add 8 Days]}]}{TAB}" in "Schedule Date (optional):"

    # Source step 0178: Value too High | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-af03-2ea4-90abd0035e39
    # Runtime control: Check if System Prevents > Condition
    Then if the source runtime condition "Check if System Prevents > Condition" is satisfied, "Value too high" should equal "ValueTooHigh"

    # Source step 0179: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-a394-9460-7da1a168acd0
    # Runtime control: Check if System Prevents > Then
    When if the source runtime condition "Check if System Prevents > Then" is satisfied, I retain hard-coded value "Pop up displayed" as runtime value "Pass"

    # Source step 0180: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-58e3-eb76-a49f1fdf5318
    # Runtime control: Check if System Prevents > Else
    When if the source runtime condition "Check if System Prevents > Else" is satisfied, I retain hard-coded value "No pop up displayed" as runtime value "Fail"

    # Source step 0181: Set the date to More than Expected No of days | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-7e91-78d1-f4964cc7903a
    ...
    # Source step 0182: Set the Scheduled Date more than Expected No.of Days | Module: Schedule Dates for Non-Renewal
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-dfcb-f6e6-3a496418d532
    ...
    # Source step 0183: Value too High | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-3331-f15d-fc916c4ebd88
    # Runtime control: Check if System Prevents > Condition
    Then if the source runtime condition "Check if System Prevents > Condition" is satisfied, "Value too high" should equal "ValueTooHigh"

    # Source step 0184: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-4edc-83d7-dc1f67f01c88
    # Runtime control: Check if System Prevents > Then
    When if the source runtime condition "Check if System Prevents > Then" is satisfied, I retain hard-coded value "Pop up displayed" as runtime value "Pass"

    # Source step 0185: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction > Set the Scheduled Date to less than or more than Expected Days | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-7b29-22c1-ac5356eb48b2
    # Runtime control: Check if System Prevents > Else
    When if the source runtime condition "Check if System Prevents > Else" is satisfied, I retain hard-coded value "No pop up displayed" as runtime value "Fail"

    # Source step 0186: click Non Renew Detailed reason | Module: Check if Value too High appears
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-8982-b34b-da31898799e2
    When I click "Detailed Reason_expand"
    When I click "Claims Review"

    # Source step 0187: Select  & Cick Schedule | Module: EU|Schedule
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-6c31-0818-fa9fc7d7e77a
    When I enter or select "True" in "MVR_1"
    When I click "Schedule"

    # Source step 0188: TBox Wait | Module: TBox Wait
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-0849-f237-b046cc03a4bf
    When I wait "5000" milliseconds

    # Source step 0189: Close the Express UI Page | Module: CloseBrowser
    # Section: Process > UW Non Renewal > UW Non Renewal Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2f33-c5fd-9be4-f1158900d688
    When I close the active browser
...
# 5. Source step 0013 "Client Selection-Enter Client Info of New or Exisiting Clients" in module "EQ || Client Selection" was disabled. Reason: 01.06.24 14:11:59 [ct2634]
...
# 6. Source step 0014 "Account Details-Enter new Account Information" in module "EQ||Account Details" was disabled. Reason: 01.06.24 14:11:59 [ct2634]
...
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 92. Source step 0190 "LogOut" in module "EQ||Log Out" was disabled. Reason: 02.11.23 15:20:44 [ct2451]
...
# 1. Source recovery step 0191 TBox Take Screenshot of failure(during recovery run): I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Home\\UW Non-Renewal-Auto_CA_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 2. Source recovery step 0192 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 3. Source recovery step 0193 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 4. Source recovery step 0194 CloseBrowser: I close the active browser
# Recovery scenario: CleanUp Scenario - EQ sign out and close browser
# 5. Source recovery step 0195 TBox Take Screenshot of failure(during recovery run): I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Home\\UW Non-Renewal-Auto_CA_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 6. Source recovery step 0196 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 7. Source recovery step 0197 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 8. Source recovery step 0198 CloseBrowser: I close the active browser
