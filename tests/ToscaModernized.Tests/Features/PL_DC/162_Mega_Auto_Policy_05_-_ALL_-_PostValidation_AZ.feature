# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 162_Mega_Auto_Policy_05_-_ALL_-_PostValidation_AZ.feature
...
Feature: Execute Mega Auto Policy 05 - ALL - PostValidation for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto Policy 05 - ALL - PostValidation workflow for the selected source iteration
  ...
  Scenario: Mega Auto Policy 05 - ALL - PostValidation using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-9f12-aab3-72084e4a94d6
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-d99c-9e09-c305dae286b5
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-c43f-4b05-b879a2c90da0
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-5858-6a99-a1bcea5ecddb
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-44f0-984f-c103d3fe04fc
    When I retain hard-coded value "Mega Auto Policy 05-AZ" as runtime value "TCName"

    # Source step 0018: TBox Save As_1-To Upload the file | Module: TBox Save As
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-aa82-8764-b0428d68f9f1
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-55ef-b543-48494d1becd5
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-ce80-ef65-69956280e1fc
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-dbb1-8351-6426f554ee25
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-5792-ddab-6d7db7d0ad85
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fb4-f4a3-1c80-85fb15aca54f
    When I close the active browser
