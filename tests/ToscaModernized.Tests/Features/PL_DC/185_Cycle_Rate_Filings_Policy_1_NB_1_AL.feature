# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 185_Cycle_Rate_Filings_Policy_1_NB_1_AL.feature
...
Feature: Execute Cycle Rate Filings Policy 1 NB_1 for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Cycle Rate Filings Policy 1 NB_1 workflow for the selected source iteration
  ...
  Scenario: Cycle Rate Filings Policy 1 NB_1 using representative iteration Alabama (AL)
    ...
    # Source step 0081: Cycle Selection | Module: EQ || CyclePreFillSelection
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary 1st Cycle Summary | Source XTestStep: 3a19dd55-d452-820d-17ff-04bcb0a0ba43
    # Runtime control: If Cycles Listed > Condition
    Then if the source runtime condition "If Cycles Listed > Condition" is satisfied, I wait until "Select Vehicle" is visible

    # Source step 0082: Cycle Selection | Module: EQ || CyclePreFillSelection
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary 1st Cycle Summary | Source XTestStep: 3a19dd55-d452-524e-4426-5a9919eab33b
    # Runtime control: If Cycles Listed > Then
    When if the source runtime condition "If Cycles Listed > Then" is satisfied, I click "AdditionalVehicle(s)"
    When I click "Next"

    # Source step 0083: Cycle Summary | Module: EQ || 1st Cycle
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary 1st Cycle Summary | Source XTestStep: 3a19dd55-d452-c2e4-959b-f50dd8f76d7c
    Then I wait until "VIN" is enabled
    When I enter or select "1HD1FCM10DB623649" in "VIN"
    When I press "Tab" while focused on "VIN"
    Then I wait until "Please select the vehicle" is visible
    When I click "Cycle_1"
    When I click "Pleasure Use" when "'Primary Use' == \"Pleasure Use\"" is satisfied
    When I select "Not Pleasure Use" when "'Primary Use' == \"Not Pleasure Use\"" is satisfied
    When I click "Under Construction" when "'Primary Use' == \"Under Construction\"" is satisfied
    When I click "Loan" when "'Loan/Leased/Own' == \"Loan\"" is satisfied
    When I click "Leased" when "'Loan/Leased/Own' == \"Leased\"" is satisfied
    When I click "Own" when "'Loan/Leased/Own' == \"Own\"" is satisfied
    When I select "No_RegisteredFedTribe" when "State == \"OK\"" is satisfied
    Then I wait until "Does this vehicle have any Non-Factory Additions, Alterations, or Modifications?" is visible
    When I select "Yes" when "'NonFactory Mods?' == \"Yes\"" is satisfied
    When I select "No" when "'NonFactory Mods?' == \"No\"" is satisfied
    Then I wait until "Lbl_Description of Mods" is visible when "'NonFactory Mods?' == \"Yes\"" is satisfied
    When I enter or select "Misc" in "Description of Mods" when "'NonFactory Mods?' == \"Yes\"" is satisfied
    When I enter the unresolved source parameter "Current Value(UnderConstruction)" (not supplied by this reusable-block invocation) in "Current Value" when "'Primary Use' == \"Under Construction\"" is satisfied
    When I enter or select "5000" in "Annual Mileage" when "State == \"NY\" OR State == \"NJ\" OR State == \"CA\"" is satisfied
    When I click "Save and Continue"

    # Source step 0084: Add Cycle/Next | Module: EQ || Add Cycle/Next
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary Add Cycle/Next | Source XTestStep: 3a19dd55-d461-bc9f-3f11-bebdfcdd5d88
    When I click "Add Additional Vehicle" when "'Additional Cycle?' == \"Yes\"" is satisfied
    When I click "Next" when "'Additional Cycle?' == \"No\"" is satisfied

    # Source step 0085: Vintage Cycle | Module: EQ || Vintage Cycle
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary Vintage Cycle | Source XTestStep: 3a19dd55-d452-bb33-0211-7d0ea44826b7
    Then I wait until "Cycle VIN" is enabled
    When I enter or select "1HD1CAN14HY114419" in "Cycle VIN"
    When I press "Tab" while focused on "Cycle VIN"
    Then I wait until "Please select the vehicle" is visible
    When I click "Cycle_1"
    Then I wait until "Vehicle Type" is visible
    When I click "Vintage"
    Then I wait until "Is this vehicle owned or financed?" is visible
    When I click "Loan" when "'Loan/Leased/Own' == \"Loan\"" is satisfied
    When I click "Leased" when "'Loan/Leased/Own' == \"Leased\"" is satisfied
    When I click "Own" when "'Loan/Leased/Own' == \"Own\"" is satisfied
    Then I wait until "Does this vehicle have any Non-Factory Additions, Alterations, or Modifications?" is visible
    ...
    # Source step 0086: Owned Popup | Module: EQ || Owned Popup
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary Vintage Cycle | Source XTestStep: 3a19dd55-d452-7546-9190-af9ba8b087dc
    # Runtime control: If > Condition
    Then if the source runtime condition "If > Condition" is satisfied, "Lbl_Owned Popup" should be visible

    # Source step 0087: Owned Popup | Module: EQ || Owned Popup
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary Vintage Cycle | Source XTestStep: 3a19dd55-d452-8598-68f8-b5ce42225b8e
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I click "CONTINUE"

    # Source step 0088: Add Cycle/Next | Module: EQ || Add Cycle/Next
    # Section: Process > 05 Cycle Summary | Reusable flow: Auto | 05 EQ |Vehicle Summary Add Cycle/Next | Source XTestStep: 3a19dd55-d461-bc9f-3f11-bebdfcdd5d88
    When I click "Add Additional Vehicle" when "'Additional Cycle?' == \"Yes\"" is satisfied
    When I click "Next" when "'Additional Cycle?' == \"No\"" is satisfied
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cb892-7ca8-2015-a13b-6fc87559b498
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cb892-7ca8-66b9-708d-9fe3dea2aa29
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cb892-7ca8-f165-3159-6257c8658182
    Then I wait until "Loading ..." exists

    # Source step 0094: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cb892-7ca8-c712-fe52-07f76afad693
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cb892-7ca8-55b4-9d8b-cf3f599c5c9f
    ...
    When I retain hard-coded value "1,000" as runtime value "V1_CollDed"
    ...
    When I retain hard-coded value "1,000" as runtime value "V2_CompDed"
    ...
    # Source step 0144: EQ || Cycle Underwriting | Module: EQ || Cycle Underwriting
    ...
    # Source step 0145: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0146: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0147: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0152: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0153: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0154: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0155: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0175: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0176: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0177: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0178: EU||Home | Module: EU||Home
    ...
    # Source step 0179: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0180: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0182: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0183: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0184: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0188: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0189: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0190: OpenUrl | Module: OpenUrl
    ...
    # Source step 0194: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0195: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0196: EU||Home | Module: EU||Home
    ...
    # Source step 0197: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0198: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0199: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0200: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0206: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0243: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0244: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0245: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0246: TBox Save As | Module: TBox Save As
    ...
    # Source step 0247: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0250: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0251: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0252: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0253: TBox Save As | Module: TBox Save As
    ...
    # Source step 0256: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0257: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0259: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0260: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0262: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cb892-7cc8-f261-cfdc-84bcfbf3abf6
    When I capture "InnerText" from "Policy Number" as runtime value "Policy Number"
    When I use source configuration "Effective Date" = the RUNTIME-DERIVED date from Tosca expression "{DATE}" for "Transmit Confirmation"

    # Source step 0263: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cb892-7cc8-404c-b613-4ee25008c9f6
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Cycle_PolicyData_RateFilings_Policy1"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cb892-7cc8-fac7-dbeb-ac83092964c5
    When I close the active browser
...
# 19. Source step 0101 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 20. Source step 0109 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Less than $15,000/$30,000" with "{Click}"
# 21. Source step 0127 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 22. Source step 0128 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 23. Source step 0129 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 24. Source step 0130 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 25. Source step 0131 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 26. Source step 0132 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 27. Source step 0133 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 28. Source step 0134 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 29. Source step 0140 field "Cycle Accessories_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 30. Source step 0140 field "Original Parts_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 31. Source step 0140 field "Endorsement Limit V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1398 $5,000"
# 32. Source step 0140 field "Cycle Accessories_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 33. Source step 0140 field "Original Parts_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 34. Source step 0140 field "Endorsement Limit V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1399 $7,000"
# 35. Source step 0145 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 36. Source step 0148 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 37. Source step 0149 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 38. Source step 0150 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 39. Source step 0151 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 40. Source step 0158 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 41. Source step 0159 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 42. Source step 0160 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 43. Source step 0161 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 44. Source step 0162 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 45. Source step 0163 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 46. Source step 0164 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 47. Source step 0165 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 48. Source step 0166 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 49. Source step 0167 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 50. Source step 0168 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 51. Source step 0169 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 52. Source step 0170 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 53. Source step 0171 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 54. Source step 0172 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 55. Source step 0173 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 56. Source step 0174 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 57. Source step 0177 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 58. Source step 0177 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 59. Source step 0185 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 60. Source step 0186 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 61. Source step 0187 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 62. Source step 0191 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 63. Source step 0192 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 64. Source step 0193 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 65. Source step 0195 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 66. Source step 0195 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 67. Source step 0199 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 68. Source step 0199 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 69. Source step 0199 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0199 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 71. Source step 0200 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 72. Source step 0200 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 73. Source step 0200 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 74. Source step 0200 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 75. Source step 0201 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 76. Source step 0201 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 77. Source step 0201 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 78. Source step 0201 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 79. Source step 0202 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 80. Source step 0203 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 81. Source step 0207 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 82. Source step 0208 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 83. Source step 0209 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 84. Source step 0210 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 85. Source step 0211 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 86. Source step 0212 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ReferUW" with "X"
#    - INPUT "SaveExit_1" with "X"
# 87. Source step 0213 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "UseActiveTab" with a blank value
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# 88. Source step 0214 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 89. Source step 0215 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 90. Source step 0216 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 91. Source step 0217 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 92. Source step 0218 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 93. Source step 0219 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 94. Source step 0220 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 95. Source step 0221 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 96. Source step 0222 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 97. Source step 0223 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 98. Source step 0224 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 99. Source step 0225 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 100. Source step 0226 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 101. Source step 0227 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 102. Source step 0228 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 103. Source step 0229 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 104. Source step 0230 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 105. Source step 0231 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 106. Source step 0232 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 107. Source step 0233 "EU||Home" in module "EU||Home" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 108. Source step 0234 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 109. Source step 0235 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 110. Source step 0236 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 111. Source step 0237 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 112. Source step 0238 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 113. Source step 0239 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 114. Source step 0240 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 115. Source step 0241 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 116. Source step 0242 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 117. Source step 0244 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 118. Source step 0248 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 119. Source step 0255 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 120. Source step 0261 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:26 [pa2096@dnanico1.aniconet.com]
...
# 121. Source step 0263 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 122. Source step 0263 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 123. Source step 0264 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:31 [pa2096@dnanico1.aniconet.com]
