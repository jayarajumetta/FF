# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 096_UW_Cancellation_Auto_-_PA_UW_Cancellation_Auto_-_PA.feature
...
Feature: Execute UW Cancellation Auto - PA for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Cancellation Auto - PA workflow for the selected source iteration
  ...
  Scenario: UW Cancellation Auto - PA using representative iteration UW Cancellation Auto - PA
    # Source step 0009: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-6d78-2ba0-422795bed822
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-7acf-60a8-2ef568fc3d55
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-fac6-7298-f631fa52cbe9
    # Runtime control: EQ||Sign On Credentials Page > Then - Enter Sign On Credentials
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-7b4a-f6c8-f62ac280016a
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-5a78-7e1a-0971e6d2fc13
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-2f99-7c48-908522b32a84
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-8b6f-bcfa-faabb5497d64
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-3a29-8712-898e1cfa7837
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-0f25-d8e0-21b63c69c7ce
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-6160-5286-75faa2734335
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-52c9-d7ce-ba5ca910af9f
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-df37-acd0-6bf25357ebe1
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-5aab-7cc6-eeffe35e3f72
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-8a9b-2434-27b2bdf33ca6
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-0e85-493a-ddd27e4ecb39
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-7575-f464-f77be7d34013
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-b9c2-3be3-208141abd203
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-51f3-be27-8c454d3765c3
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0031: EQ||Driver Summary | Module: EQ||Driver Summary
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-01a9-2839-5263473a3bf4
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-65be-55c4-93c69230f36c
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-490b-b4b9-ee39554742d2
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-175f-9678-c484b50898e6
    When I click "Btn_Next"

    # Source step 0036: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-ce16-0b71-49a30fd7a842
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-ee9c-04cf-80c84992c3c7
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-e299-ca01-c0b76b559798
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-ea09-fa49-38f11c723f22
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-7285-5b0d-5b4d55751c82
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-d4f4-0ff4-e5ea80915e9a
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-a95b-26f9-5ab7a4a4d566
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-694d-8e8f-9ff3528359d3
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-12cc-e746-4792422e846e
    ...
    # Section: Process > Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-32a4-3ccf-6f0e7c44de29
    When I click "Btn_Next"
    ...
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-79fb-b937-d72c1a6cd720
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0049: Additional Coverages_New | Module: EQ||Additional Coverages
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-0d79-7de8-29dff23ed281
    ...
    # Section: Process > Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-4f7e-fae8-619070c78d2e
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0051: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-6877-0897-5b04fa1e66c2
    When I click "<unnamed value>"
    ...
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-c202-582f-79aff4e19ce7
    When I click "btn_Next"
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-83f4-6e8d-164de8eb3221
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-0716-91da-9b3ef5125583
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-c4f1-e7f0-0128dfaaeb86
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-cacc-f23b-9b15fd4223fb
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-9134-4aba-c12ff03e658f
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-91ab-b279-a455d5141fb5
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-e6d6-f2a1-a4961a2e2b3e
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-4741-e1ac-5edcb1f1a1a1
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-dcc2-5f56-22847dfd3e59
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-304f-35e8-e2ce-270d9b225c93
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-a906-4441-0b703c7bc8ff
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-1666-a748-d322cb452794
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-9215-ebe6-d4c256e8a387
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-4ffd-8d8f-7fe9a24cb2de
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-f022-0bf5-02034939331b
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-305f-f028-f90e-0adeb15a7ed1
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-3b76-adb8-275dba12e395
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-d280-9760-6f9f256d7d4c
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-a037-2e6c-406f41f55fe5
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-54d5-98c3-a2f79cfbe999
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-70bc-89c9-4aff42441408
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-7863-e1a6-4acf3afe65d4
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-4f00-9bb1-11953c24ab3f
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-99f9-7a1e-1813dd3095b5
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-3e62-9cdb-bac23b5e7553
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-5d48-4062-e6c9889ade11
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-6c36-0a9c-186d7081812c
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0659-18b1-707fab454024
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-5ab2-f17b-973388cef3ce
    When I click "Btn_Launch To Checklist"

    # Source step 0121: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-b620-ca75-2ad4abb6af7f
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-94c3-1724-b760b6029753
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-35f9-4853-fb2cbfd1db5b
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-51f6-98fa-8ff44807b1bc
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0ade-b091-6497e9a84a04
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-2233-c338-29e6b41ef1dc
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0128: TBox Save As_1 | Module: TBox Save As
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-93e0-ab05-6123edfc2055
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-bd86-9ced-c976876e2a9c
    When I close the active browser

    # Source step 0131: EQ||Click on Transmit | Module: EQ||Submission
    # Section: Process > Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-0a75-bdfd-7e3a1b10d2e3
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-8a1a-b46c-1b2c2e9cf6f3
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-b511-82d1-392fe790ed2c
    ...
    # Source step 0135: Set LOB & State | Module: TBox Set Buffer
    ...
    # Source step 0145: TestData - Find & provide item from TDM | Module: Old_TestData - Find & provide item
    ...
    # Source step 0146: Get Validated Premium from TDM | Module: TBox Set Buffer
    ...
    # Source step 0147:  Compare Actual Premium vs Expected Premium | Module: TBox Set Buffer
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-5615-47c5-645703b9d286
    ...
    # Source step 0149: Submission - Save & Exit Policy | Module: EQ||Submission
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-1bdf-4328-7ba5b7563146
    When I click "Btn_Save and Exit"

    # Source step 0150: Log Out- Exist from the Quote/Policy | Module: EQ||Log Out
    ...
    # Source step 0151: CloseBrowser | Module: CloseBrowser
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-d3b7-d4b0-059803d13436
    # Runtime control: If_ExpressUI Sign on page showed up or not > Condition - if signon page is displayed
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-f50e-3cec-07a07879c39e
    # Runtime control: If_ExpressUI Sign on page showed up or not > Then - Enter Sign On Credentials
    ...
    # Source step 0158: Search Policy | Module: EU||Home
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-b718-e56f-6a636d273625
    When I enter or select "\"^{a}\"" in "Txt_Search Text"
    When I enter captured runtime value "Policy Number" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0159: Click Policy holder name | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-484e-3ade-b40ea0853702
    When I click "Lnk_Insured Name"
    When I click "Lnk_PersonalAuto"

    # Source step 0160: Click Transaction Type | Module: EU|Transaction Type
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-07bd-6875-27b460d1422a
    When I click "expand"
    When I click "Cancel"
    When I click "Go"

    # Source step 0161: Click Transaction Reason & Detailed Reason | Module: Check if Value too High appears
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-25fd-d559-f31e6658b1b5
    ...
    # Source step 0162: Capture Effective and Scheduled Dates | Module: Schedule Dates for Cancellation_Rejection
    # Section: Process > UW Cancellation > UW Cancellation Transaction > Difference Between Two Dates | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-1966-dde3-99242db737dd
    ...
    # Source step 0163: Set Dates | Module: TBox Set Buffer
    ...
    # Source step 0164: Start PowerShell | Module: TBox Start Program
    ...
    # Source step 0165: Execute PowerShellCommand 1 | Module: TBox Send Keys
    ...
    # Source step 0166: Execute PowerShellCommand 2  | Module: TBox Send Keys
    ...
    # Source step 0168: Get Days Difference | Module: TBox Clipboard
    ...
    # Source step 0169: TestData - Find & provide item | Module: Old_TestData - Find & provide item
    ...
    And I use TDM parameter "Data search filter > TCName" with "UW Cancellation Auto - PA"
    And I use TDM parameter "Data search filter > State" with "PA"
    And I use TDM parameter "Data search filter > LOB" with "Auto"

    # Source step 0170: Retriving Expected No.of days from TDM | Module: TBox Set Buffer
    ...
    # Source step 0171: TBox Evaluation Tool | Module: TBox Evaluation Tool
    ...
    # Source step 0173: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0175: Select  & Cick Schedule | Module: EU|Schedule
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-b139-acdb-951e98375700
    When I enter or select "True" in "MVR_1"
    When I click "Schedule"

    # Source step 0176: TBox Wait | Module: TBox Wait
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-329a-c9f8-06812b495e5f
    When I wait "5000" milliseconds

    # Source step 0177: Close the Express UI Page | Module: CloseBrowser
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3060-9110-a84e-d8007a942c85
    When I close the active browser
...
# 5. Source step 0013 "Enter Client Selection" in module "EQ || Client Selection" was disabled. Reason: 01.06.24 14:51:16 [ct2634]
...
# 6. Source step 0014 "Enter Account Details" in module "EQ||Account Details" was disabled. Reason: 01.06.24 14:51:16 [ct2634]
...
#    - Preserved source value: "X"
# 110. Source step 0136 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 111. Source step 0137 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 112. Source step 0138 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 113. Source step 0139 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 114. Source step 0140 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 115. Source step 0141 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 116. Source step 0142 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 117. Source step 0143 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 119. Source step 0153 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 120. Source step 0154 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 121. Source step 0155 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 122. Source step 0174 "Close Cancel Page" in module "Check if Value too High appears" was disabled. Reason: 13.06.24 19:10:42 [ct2634]
#    - INPUT "Exit Without Saving" with "X"
# 123. Source step 0178 "Click on Transmit Button" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:39 [ct2634]
#    - WAIT "Btn_Transmit" with "True"
#    - VERIFY "Btn_Transmit" with "Transmit"
#    - INPUT "Btn_Transmit" with "X"
# 124. Source step 0179 "Buffer Tranmit Premiums" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:39 [ct2634]
...
# 1. Source recovery step 0180 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\UW Cancellation Auto_NM_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 2. Source recovery step 0181 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 3. Source recovery step 0182 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 4. Source recovery step 0183 CloseBrowser: I close the active browser
# Recovery scenario: CleanUp Scenario - EQ sign out and close browser
# 5. Source recovery step 0184 TBox Take Screenshot of failure(during recovery run): I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\UW Cancellation Auto_NM_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 6. Source recovery step 0185 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 7. Source recovery step 0186 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 8. Source recovery step 0187 CloseBrowser: I close the active browser
