# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 198_FFCIC_New_Business_Cycle_Group_5_ANPAC_Writing_Company_CT.feature
...
@PL_DC @Cycle @new_business @Connecticut @Edge @manual @obsolete @automated
Feature: Execute FFCIC New Business Cycle Group 5 ANPAC Writing Company for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Cycle Group 5 ANPAC Writing Company workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Cycle Group 5 ANPAC Writing Company using representative iteration Connecticut (CT)
    ...
    When I derive and retain the RUNTIME-DERIVED date from Tosca expression "{Date[01.01.2025][][MM/dd/yyyy]}" as runtime value "EffectiveDate"
    ...
    # Source step 0072: Cycle Selection | Module: EQ || CyclePreFillSelection
    ...
    # Source step 0073: Cycle Selection | Module: EQ || CyclePreFillSelection
    ...
    # Source step 0074: Cycle Summary | Module: EQ || 1st Cycle
    ...
    # Source step 0075: Add Cycle/Next | Module: EQ || Add Cycle/Next
    ...
    # Source step 0077: (New) EQ || Multiple Driver Assignment_1 | Module: (New) EQ || Multiple Driver Assignment
    ...
    # Source step 0078: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f400-7fcd-0fac-a3c4bf40152d
    ...
    # Source step 0079: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f400-fae5-ac9e-3271932928bc
    ...
    # Source step 0080: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f400-92e3-34fb-aa4d0dcbe5de
    Then I wait until "Loading ..." exists

    # Source step 0081: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f400-4905-127e-ebb293c6b625
    ...
    # Source step 0082: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f404-0dbc-6997-69abb112063e
    ...
    # Source step 0083: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0084: Check for claims/violations needing edited | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0085: Edit Item(s) | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0087: If Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0088: Edit Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0089: Edit Violation | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0090: Check for PopUp | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0091: Select Continue | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0092: Next | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0093: EQ||Discount- Rate Tier Questions Cycle(NEW) | Module: EQ||Discount- Rate Tier Questions Cycle(NEW)
    # Section: Process > 08 Discounts | Reusable flow: Cycle | 08 EQ | Discount(NEW) | Source XTestStep: 3a19dd55-d49d-8201-7d2f-9dccd34b3f4b
    # Runtime control: State =="MD" OR State == "NJ"
    When if the source runtime condition "State ==\"MD\" OR State == \"NJ\"" is satisfied, I click "Residential_Property"
    When I enter the RUNTIME-DERIVED date from Tosca expression "{SENDKEYS[{DATE}]}" in "policyLapseDate"
    When I select "No_Proof"
    When I select "No_Proof"

    # Source step 0094: EQ||Discount - Rate Tier Questions(NEW) | Module: EQ||Discount - Rate Tier Questions(NEW)
    # Section: Process > 08 Discounts | Reusable flow: Cycle | 08 EQ | Discount(NEW) | Source XTestStep: 3a1ca799-78e5-0327-38d3-77aabab305dd
    # Runtime control: If NY > Condition
    When if the source runtime condition "If NY > Condition" is satisfied, I click "Residentia_ Property (old)"
    When I click "Less Than or Equal to $25,000/$50,000 (old)"

    # Source step 0096: EQ||Discount-Cycle (NEW) | Module: EQ||Discount-Cycle (NEW)
    # Section: Process > 08 Discounts | Reusable flow: Cycle | 08 EQ | Discount(NEW) | Source XTestStep: 3a19dd55-d49d-0ef6-f78d-a145577c1b05
    When I select "None_DefensiveDriverDiscount" when "State == \"DE\"" is satisfied
    When I select "Safe_CycleNo"
    When I click "Next"

    # Source step 0097: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0098: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0100: Select Policy Coverage Option | Module: Coverages (New)
    ...
    # Source step 0101: Edit Coverage Option | Module: Edit Coverage Option (New)
    ...
    # Source step 0103: Navigate down screen to V1 | Module: Coverages (New)
    ...
    # Source step 0104: Select V1 Coverages | Module: Coverages (New)
    ...
    # Source step 0105: Navigate down screen to V2 | Module: Coverages (New)
    ...
    # Source step 0106: Select V2 Coverages | Module: Coverages (New)
    ...
    # Source step 0107: Navigate down screen to V3 | Module: Coverages (New)
    ...
    # Source step 0108: Select V3 Coverages | Module: Coverages (New)
    ...
    # Source step 0109: Navigate down screen to V4 | Module: Coverages (New)
    ...
    # Source step 0110: Select V4 Coverages | Module: Coverages (New)
    ...
    # Source step 0119: Cycle Additional Coverages | Module: EQ|| Cycle| Additional Coverages
    # Section: Process > 10 Additional Coverage | Reusable flow: Auto | 10 EQ | Cycle_AdditionalCoverages | Source XTestStep: 3a19dd55-d48e-7043-bc22-4420b11ff99b
    Then I wait until "H1_Additional Coverages" exists
    When I click "Full" when "State == \"KY\"" is satisfied
    When I select "No Coverage_PIP KS, OR, TX" when "State == \"KS\" OR State == \"OR\" OR State == \"TX\"" is satisfied
    When I click "Basic - $15,000 per person/$30,000 per accident_DE PIP" when "State == \"DE\"" is satisfied
    When I select "IncomeLoss_No Coverage" when "State == \"AR\"" is satisfied
    When I select "ADD_No Coverage AR" when "State == \"AR\"" is satisfied
    When I select "Yes_Spouse Liability" when "State == \"NY\"" is satisfied
    When I select "No_Spouse Liability" when "State == \"NY\"" is satisfied
    When I click "BASIC_PIP" when "State == \"NY\" OR State == \"KY\"" is satisfied
    When I select "No Deductible KY" when "State == \"KY\"" is satisfied
    When I select "No" when "State == \"MD\"" is satisfied
    When I select "No_UMPD VT" when "State == \"VT\"" is satisfied
    When I click "ACV UM/UIMPD TX" when "State == \"TX\"" is satisfied
    When I select "More Options UM/UIMPD OR" when "State == \"OR\"" is satisfied
    When I select "More Options" when "State == \"MD\" OR State == \"NJ\" OR State == \"NM\" OR State == \"IL\" OR State == \"RI\" OR State == \"TN\" OR State == \"VA\"" is satisfied
    When I click "$100,000" when "State == \"SC\" OR State == \"MS\" OR State == \"AR\" OR State == \"IN\" OR State == \"MD\" OR State == \"NJ\" OR State == \"NM\" OR State == \"IL\" OR State == \"OR\" OR State == \"RI\" OR State == \"TN\" OR State == \"VA\" OR State == \"WV\"" is satisfied
    When I select "No UIMPD SC" when "State == \"SC\"" is satisfied
    When I select "No UIMPD WV" when "State == \"WV\"" is satisfied
    When I select "No Coverage_TransportationExpense VA" when "State == \"VA\"" is satisfied
    When I select "No Coverage_RR" when "State != \"VA\"" is satisfied
    When I select "No Coverage _Theft Deductible" when "State == \"PA\"" is satisfied
    When I select "No Coverage T&L NY FFCIC" when "State == \"NY\" AND 'NY Writing Company' == \"FFCIC\"" is satisfied
    When I select "No Coverage_Roadside" when "State != \"NY\" AND 'NY Writing Company' != \"FFCIC\"" is satisfied
    When I click "Next"

    # Source step 0120: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    ...
    # Source step 0121: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0122: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0123: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0124: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0125: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0127: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0128: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0129: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0134: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0135: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0136: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0137: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0138: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0139: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0157: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0158: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0159: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0160: EU||Home | Module: EU||Home
    ...
    # Source step 0161: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0162: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0163: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0165: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0166: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0231: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0232: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0233: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0234: TBox Save As | Module: TBox Save As
    ...
    # Source step 0235: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0237: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0238: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0239: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0240: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0241: TBox Save As | Module: TBox Save As
    ...
    # Source step 0242: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0244: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0245: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0246: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0247: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0248: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0249: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f429-4799-7a0f-2e4bc8efe125
    ...
    # Source step 0250: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f429-4166-c2af-5ae4418dd505
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Cycle_ANPAC_WritingCompany"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bacc9-f429-a7b6-d7a2-c14194e8b08e
    When I close the active browser
...
#    - CONTAINER "Vehicle Summary" with "FFCIC New Business Auto Group 2 Future Eff Date"
...
#    - CONTAINER "Coverages" with "FFCIC New Business Auto Group 1"
# 18. Source step 0088 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 19. Source step 0095 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
# 20. Source step 0096 field "Multi_Cycle_Yes" in "EQ||Discount-Cycle (NEW)" was disabled. Reason:  
#    - Preserved source value: "True"
# 21. Source step 0111 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 22. Source step 0112 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 23. Source step 0113 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 24. Source step 0114 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 25. Source step 0115 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 26. Source step 0116 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 27. Source step 0117 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 28. Source step 0118 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 29. Source step 0127 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 30. Source step 0130 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 31. Source step 0131 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 32. Source step 0132 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 33. Source step 0133 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 34. Source step 0140 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 35. Source step 0141 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 36. Source step 0142 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 37. Source step 0143 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 38. Source step 0144 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 39. Source step 0145 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 40. Source step 0146 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 41. Source step 0147 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 42. Source step 0148 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 43. Source step 0149 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 44. Source step 0150 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 45. Source step 0151 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 46. Source step 0152 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 47. Source step 0153 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 48. Source step 0154 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 49. Source step 0155 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 50. Source step 0156 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 51. Source step 0159 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 52. Source step 0159 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 53. Source step 0167 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 54. Source step 0168 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 55. Source step 0169 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 56. Source step 0171 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 57. Source step 0172 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 58. Source step 0173 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 59. Source step 0175 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 60. Source step 0175 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 61. Source step 0179 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 62. Source step 0179 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 63. Source step 0179 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 64. Source step 0179 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 65. Source step 0180 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 66. Source step 0180 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 67. Source step 0180 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 68. Source step 0180 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 69. Source step 0181 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0181 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 71. Source step 0181 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 72. Source step 0181 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 73. Source step 0182 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 74. Source step 0183 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 75. Source step 0187 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 76. Source step 0188 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 77. Source step 0189 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 78. Source step 0190 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 79. Source step 0191 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 80. Source step 0192 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ReferUW" with "X"
#    - INPUT "SaveExit_1" with "X"
# 81. Source step 0193 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "UseActiveTab" with a blank value
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# 82. Source step 0194 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 83. Source step 0195 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 84. Source step 0196 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 85. Source step 0197 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 86. Source step 0198 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 87. Source step 0199 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 88. Source step 0200 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 89. Source step 0201 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 90. Source step 0202 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 91. Source step 0203 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 92. Source step 0204 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 93. Source step 0205 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 94. Source step 0206 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 95. Source step 0207 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 96. Source step 0208 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 97. Source step 0209 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 98. Source step 0210 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 99. Source step 0211 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 100. Source step 0212 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 101. Source step 0213 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 102. Source step 0214 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 103. Source step 0215 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 104. Source step 0216 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 105. Source step 0217 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 106. Source step 0218 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 107. Source step 0219 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 108. Source step 0220 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 109. Source step 0221 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 110. Source step 0222 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 111. Source step 0223 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 112. Source step 0224 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 113. Source step 0225 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 114. Source step 0226 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 115. Source step 0227 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 116. Source step 0228 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Bypass Level 9B Rules" with "True"
#    - INPUT "Bypass Level 9B Rules Comments" with "{Click}{SENDKEYS[Approved]}"
#    - INPUT "Home" with "X"
# 117. Source step 0229 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 118. Source step 0230 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:16:57 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 119. Source step 0232 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 120. Source step 0236 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 121. Source step 0243 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 122. Source step 0250 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 123. Source step 0250 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
#
