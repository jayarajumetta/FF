# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 164_Mega_Auto_Policy_07_-_ALL_-_PostValidation_AZ.feature
...
Feature: Execute Mega Auto Policy 07 - ALL - PostValidation for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto Policy 07 - ALL - PostValidation workflow for the selected source iteration
  ...
  Scenario: Mega Auto Policy 07 - ALL - PostValidation using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-5f02-3f5e-9b2df14f6b09
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-74be-3fa5-3b4b0948243b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-c0c4-fd77-23c717dd6167
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-b418-90e7-5e5df98dfdbd
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-f522-467c-6c8e42612df9
    When I retain hard-coded value "Mega Auto Policy 07-AZ" as runtime value "TCName"

    # Source step 0018: TBox Save As_1-To Upload the file | Module: TBox Save As
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-5032-409a-2130b4e88735
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-9da3-e174-8fa42ac47547
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-3c4e-cb1b-e847b4311375
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-46cb-5ed5-0b58dbd8fb84
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-c98b-d778-19889d598649
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ff3-8909-bb2e-fc99eba91074
    When I close the active browser
