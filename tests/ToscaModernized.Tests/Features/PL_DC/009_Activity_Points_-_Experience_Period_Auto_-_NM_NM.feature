# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 009_Activity_Points_-_Experience_Period_Auto_-_NM_NM.feature
...
Feature: Execute Activity Points - Experience Period (Auto) - NM for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Experience Period (Auto) - NM workflow for the selected source iteration
  ...
  Scenario: Activity Points - Experience Period (Auto) - NM using representative iteration New Mexico (NM)
    # Source step 0023: Client Selection-Enter Client Info of New or Exisiting Clients | Module: EQ || Client Selection
    # Section: Process > Generating Auto Policy > 01 Enter Client & Account Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-d08e-2e36-7a3ca8f674b6
    ...
    # Section: Process > Generating Auto Policy > 01 Enter Client & Account Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-e23a-932d-37b3d98a5e66
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-d92f-29b6-60c32dc1fb50
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-6a71-b1b7-ff121efcd38e
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-1b2f-927f-01fb96b5dc67
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-b0cd-a782-5efabff5006c
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-2ce4-4958-dc45a117749f
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-1238-8209-ab465fb62d86
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-00da-05f4-676ab411a15f
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-6217-6720-8f370c8da240
    ...
    # Section: Process > Generating Auto Policy > 03 Prequalification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-1671-de65-d3b292d4f769
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-3120-1f2a-db157a5c3bbe
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-a910-35f1-9a45a6747c8d
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-4681-b15c-a0e4d1a8a8db
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-e795-82ec-82f211b72f58
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-6c09-5528-9e3ba4a8e53b
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-9064-6c13-3134a400647f
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-9659-1123-b5324e563b4b
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-55a9-5ac5-19fdf72c4ed2
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d06-5412-bffc-685f257b7fbf
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-b85d-2f94-506f2254ec52
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0047: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-42fa-333b-a5193f7f8866
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-9a9a-9e3d-fff99d538791
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-a107-2fa1-b24e8aa75fd6
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-e930-2ec2-f4a3c7a2b678
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-6564-d426-17076279d3df
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-ba73-319e-3afbf605496f
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-0f16-e0f4-2438d54aab76
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-3876-0fac-74ee15b559fb
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0b-f08e-723e-4bc8c64f0af5
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-dec1-fe3f-02cb048b02db
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-6b71-ccda-d28d7edd2af4
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-5918-972e-13949ace88c1
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-da51-338f-4dd97db08290
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-80de-de12-9f3c82421624
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-846f-be3d-0b16840a889c
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-3438-1b93-446408178c14
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-33a9-b55b-485b4f5b3ca1
    ...
    # Section: Process > Generating Auto Policy > 10 Additional Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-75dd-2ab5-c07a5b5a591d
    ...
    # Section: Process > Generating Auto Policy > 11 Pricing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-9799-e440-78a2ac8f0d04
    ...
    # Section: Process > Generating Auto Policy > 12 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-2233-e088-1756118722ec
    ...
    # Section: Process > Generating Auto Policy > 12 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-217c-a53e-c84485037ba9
    When I click "btn_Next"
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-1b5e-3a86-134ff32e292f
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-5c87-e025-7cf53014566e
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-ba29-4cb5-48db173fa096
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-af91-859f-96a084b8cb92
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-3431-ff25-fccf833617cb
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-feb4-1cdb-bfe059e52ae0
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-bfdf-340e-db167091cb90
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-0b6c-60d5-edeea8633a65
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: zz Open URL | Source XTestStep: 3a19dd55-d3bc-f112-92ef-4713bf05610b
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-201e-bea7-be546b11c371
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-33cb-0418-40837c4e4f8f
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-687b-1d3e-ba7351ed6e19
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-2cc7-5b3a-b43d80227f8d
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-55c0-7cd3-7a82ba83e56a
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-258d-751c-cca02cb4d8b1
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-99f2-6fa2-0310224a1465
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-75c0-f0f1-f3308cff4e0f
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-95de-a25e-e966f4e175b7
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Submission > Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-ab3b-8997-8e6581dfffc0
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-3667-87ba-c7b303523c32
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-1869-fac4-e1f8361eacdb
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d0d-b7c5-984f-356310b5af21
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-3444-f077-798961212bed
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-8216-61a9-ffe0e0c823ad
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-b19f-0cd3-dd7b734e49ab
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-77ed-2e47-5a5d25cd4965
    # Runtime control: Upload the remaining Checklist documents [max=30] > Loop
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-13bf-f063-7828d28d2c1f
    When I close the active browser

    # Source step 0112: Back to Submission page and click ok | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-f280-8b36-efdce4278987
    ...
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-9701-ea4a-ddeb4a61f72a
    ...
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-d219-cd89-5f0eb1bde205
    ...
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-2315-8352-3237a976404d
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-3817-655e-0e7fe1f01501
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-ffe6-570b-2d26dad12180
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-1741-1dec-bc79f45f3f0c
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-1358-4c53-a1402fd9ff1d
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-882d-b324-7f671cc8ea7f
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0126: EU||Pricing | Module: EU||Pricing
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-9666-cd3b-31908ef8bf0c
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-e7ce-a9fa-da10e76d736d
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-f941-54e6-6b73e996d983
    # Runtime control: Evaluating Activity Points is 0 or not > Then
    When if the source runtime condition "Evaluating Activity Points is 0 or not > Then" is satisfied, I retain hard-coded value "Activity Points -Experience Period(Auto)_NM is as pass" as runtime value "Activity Point_PA"

    # Source step 0129: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-6cac-86df-2b73cb7ddf66
    # Runtime control: Evaluating Activity Points is 0 or not > Else
    When if the source runtime condition "Evaluating Activity Points is 0 or not > Else" is satisfied, I retain hard-coded value "Activity Points -Experience Period(Auto)_NM is as Fail" as runtime value "Activity Point_PA"

    # Source step 0130: Click on Driver History | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-7aeb-ff76-d71c09435438
    When I click "Btn_Left arror Button"
    When I click "Lnk_Driver History"

    # Source step 0131: Click on Detail  | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-df22-07b1-7a92d649e2c3
    When I click "Lnk_Detail"

    # Source step 0132: Add over 36 months | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-635f-6248-5f4398de35d8
    ...
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-f8f9-1409-c0d835f23f14
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0134: EU||Pricing | Module: EU||Pricing
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-10c4-d410-735db201051d
    When I click "Btn_Activity Point Total"
    When I capture "InnerText" from "Hdr_DC-SECTION > Activitypoints Score" as runtime value "ActivityPoints"
    When I click "Btn_Close"

    # Source step 0135: TBox Evaluation Tool | Module: TBox Evaluation Tool
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-892d-0f22-050f0439f46b
    ...
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-6b9d-f6ec-58edce84bbc7
    # Runtime control: Evaluating Activity Points is 5 or not > Then
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Then" is satisfied, I retain hard-coded value "Activity Points -Experience Period(Auto)_NM is Pass" as runtime value "Activity Point_PA"

    # Source step 0137: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-0c39-9b10-ce5ca54c1e49
    # Runtime control: Evaluating Activity Points is 5 or not > Else
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Else" is satisfied, I retain hard-coded value "Activity Points -Experience Period(Auto)_NM is as Fail" as runtime value "Activity Point_PA"

    # Source step 0138: Close the RCT Express Page | Module: CloseBrowser
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-ee71-fec9-862d92b85e85
    When I close the active browser

    # Source step 0139: CloseBrowser | Module: CloseBrowser
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d16-7d5d-caaf-9a3353416f45
    When I close the active browser
