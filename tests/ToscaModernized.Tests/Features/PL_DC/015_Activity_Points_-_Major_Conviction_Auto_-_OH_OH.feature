# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 015_Activity_Points_-_Major_Conviction_Auto_-_OH_OH.feature
...
Feature: Execute Activity Points - Major Conviction (Auto) - OH for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Major Conviction (Auto) - OH workflow for the selected source iteration
  ...
  Scenario: Activity Points - Major Conviction (Auto) - OH using representative iteration Ohio (OH)
    # Source step 0011: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-2d5a-00cc-2a2915264404
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-922e-d169-c66c588bb10a
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-89fc-13ae-43fc0b579dfe
    # Runtime control: Enter Sign On Credentials > Then
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-a6ed-da65-98cb66c13c78
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-53a6-38c0-5eabe99002a7
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-a0d1-2b20-c4827575aa2a
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-1dfb-9e60-1a013a6bf097
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-59e8-2b52-bc0040731997
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-2091-3c6c-8ef4c4135993
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-fc32-1e74-bab876b55619
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-ac1a-b4be-83e9825a6303
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-ee5e-7992-ff34db449a73
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-fc09-439e-5cafea4c052c
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-11c8-d1cd-21e1e631c5a9
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-2ade-bd8a-99ea7b4b6ec3
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-96be-a9be-9f914ab3cda2
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-f524-06b5-f00c208a5459
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-5d63-1de6-0ef48f4c2848
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0031: EQ||Driver Summary | Module: EQ||Driver Summary
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-96c5-40e4-87772247507a
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-99c5-6572-9d45ed7ce144
    ...
    When I capture "InnerText" from "Txt_DL Number" as runtime value "Driver License Number"
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-e629-934f-5eb5cd7be143
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-ff6d-bd08-9cd0072ce8bd
    When I click "Btn_Next"

    # Source step 0036: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-2157-fe38-96599f1b6d1b
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-6ae2-9969-e44d0be63f31
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-c762-d867-d0df1c03f374
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-a506-9d9a-302dbd463aac
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-c40a-787d-53d2d6986dc1
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-c054-42f5-59191ed60a35
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-a01d-e5bc-4dabed9f6bcc
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-82b1-f098-4275f1ecdab1
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-8194-a1a4-d035af81025a
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-8768-6798-173673a51c77
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-fb15-0962-2d27c4f54d65
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-ce5d-5fae-0be24fc64b08
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-04dd-e396-80b999368dc0
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-60d7-4b70-e2f420f0573e
    ...
    # Section: Process > Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-d8dd-41ba-e8758c12a30a
    When I click "Btn_Next"
    ...
    # Source step 0055: Coverages-Select Coverages & Continue | Module: <unresolved module>
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-4a00-6cee-c1c20ea7b36c
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0056: Additional Coverages-Select Additional Coverages & Continue | Module: EQ||Additional Coverages
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-73fd-b45a-f8a84c172c4d
    ...
    # Source step 0058: Enter Pricing Details | Module: EQ||Pricing Details
    # Section: Process > Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-236b-7351-00391e749e1c
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0059: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-7b9f-f3d3-54346d6497bd
    When I click "<unnamed value>"
    ...
    # Source step 0061: Enter Additional Interest Summary | Module: EQ||Additional Interest Summary
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-aa0d-7bf9-95863fb04dff
    When I click "btn_Next"
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-852f-0605-97f901bd540d
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-fa82-2345-819013549013
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-0518-ad31-941f710a7db4
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-90de-dc00-dc01c92d5ab2
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-6d41-d9c0-afaa07b3dada
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-1310-67a8-3da1380c8803
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-b592-1b4d-51fd6d4ed93c
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-14b3-5971-773fa8eea8bc
    ...
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-32fc-4251-0f053b10de1b
    ...
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-3091-dace-e12e1a0fac8a
    ...
    # Source step 0109: Search  Policy Number | Module: EU||Home
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-08c1-95d2-0dcbe5209651
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Source step 0110: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-66fc-1980-8f21ba68f188
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-04c5-96c0-93db15675afd
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-9203-21e8-c2ad37993ed2
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Source step 0113: Close the RCT Express Page | Module: CloseBrowser
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-097d-71f5-99dfb799fb98
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Source step 0114: Submission_2-Back to Submission page | Module: EQ||Submission
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-736d-8871-3eea68614588
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-a228-3f40-a4fbbae6189b
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Source step 0116: Click on Submission | Module: EQ | Side Menu
    # Section: Process > Auto Policy > 13 Submission > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-8130-49a9-9be6fdfeb0e1
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-39d6-3273-7df50daad7d1
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d96-ac27-f6a2-ceb1dead940e
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da5-130d-7ef2-8035ee903fd2
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da5-4979-3b23-213935b90321
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da5-893f-42b5-e5316f93e5bc
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-ecfb-ad5b-e273096b0312
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-664f-866f-39898d195112
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0126: TBox Save As_1 | Module: TBox Save As
    # Section: Process > Auto Policy > 15 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-23fe-6208-48f2a986e805
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > Auto Policy > 15 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-4f3a-ec6a-e2ebefa3d888
    ...
    # Source step 0131: Click Transmit | Module: EQ||Submission
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-2237-153a-1f9fcc31c8f7
    ...
    # Source step 0132: Transmit Confirmation-Get Policy Number, Premium details | Module: EQ||Submission
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-4998-00bb-a25226ba2e7f
    ...
    # Source step 0133: Save & Exit | Module: EQ||Submission
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-b9c7-eef9-4ecd5b0fd7ab
    When I click "Btn_Save and Exit"

    # Source step 0134: Push Quote Data & Policy Information to TDS_Reference | Module: TestData - Create & provide new item
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-3f0e-3644-ccd4c0d5dfec
    ...
    And I use TDM parameter "Data structure > TestCase" with "Activity Points - Major Conviction (Auto) - OH"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "OH"

    # Source step 0135: Push Quote Data & Policy Information to TDS Regression_Temp_Data | Module: TestData - Create & provide new item
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-f8ea-95f6-12c7b0c8dea4
    ...
    And I use TDM parameter "Data structure > EffectiveDate" with captured runtime value "Effective Date"
    And I use TDM parameter "Data structure > Date_Time" with the RUNTIME-DERIVED date from Tosca expression "{DATE} {TIME}"
    And I use TDM parameter "Data structure > TestCaseName" with "Activity Points - Major Conviction (Auto) - OH"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "OH"

    # Source step 0136: CloseBrowser | Module: CloseBrowser
    # Section: Process > Auto Policy > TDS Validations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-a611-c1f9-546160791da6
    When I close the active browser

    # Source step 0137: OpenUrl | Module: OpenUrl
    ...
    # Source step 0141: Verify ExpressUI Sign on page showed up | Module: EU||Login
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-67dd-d4b2-9de5d584b607
    ...
    # Source step 0142: Provide Sign on credentials | Module: EU||Login
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-fa92-700a-67bfcc3aaca1
    ...
    # Source step 0143: Search  Policy Number | Module: EU||Home
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-1091-87cd-feb598cac90d
    When I enter or select "\"^{a}\"" in "Txt_Search Text"
    When I enter captured runtime value "Policy Number" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0144: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-3aec-2250-9297172c95fc
    ...
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-e794-f406-9944a306892c
    Then I wait until "Btn_ViewPolicy" exists
    When I click "Btn_ViewPolicy"

    # Source step 0146: EU||Transact | Module: EU||Transact
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-7880-3935-f61cff536af7
    ...
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-c6e2-abfd-e41df0e9fb2f
    ...
    # Source step 0148: EU||Applicant | Module: EU||Applicant
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-b9d4-fec4-0cedf5dd81d5
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0149: EU||Pricing | Module: EU||Pricing
    # Section: Process > Activity Points MAjor | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2da6-e38c-5bef-c429c7e7f1f6
    ...
    # Source step 0159: Set LOB & State | Module: TBox Set Buffer
    ...
    # Source step 0169: TestData - Find & provide item from TDM | Module: Old_TestData - Find & provide item
    ...
    # Source step 0170: Get Validated Premium from TDM | Module: TBox Set Buffer
    ...
    # Source step 0171:  Compare Actual Premium vs Expected Premium | Module: TBox Set Buffer
...
#    - Preserved source value: "X"
# 10. Source step 0018 field "Btn_PROCEED" in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
# 11. Source step 0023 field "Lnk_USE EXISTING ACCOUNT" in "EQ||Proposal Start Proceed & SSN" was disabled. Reason:  
#    - Preserved source value: "X"
# 12. Source step 0026 "Proposal Start-Invalid Address,SSN,Client already exists" in module "EQ||Proposal Start Proceed & SSN" was disabled. Reason: 05.11.23 11:06:58 [ct2453]
#    - INPUT "Lnk_CREATE NEW ACCOUNT" with "X"
# 13. Source step 0030 field "Btn_(Existing Client)*" in "Enter Driver Information" was disabled. Reason:  
#    - Preserved source value: "X"
# 14. Source step 0032 field "Lbl_Gender" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "True"
# 15. Source step 0032 field "Lbl_Gender" in "EQ||Driver Summary" was disabled. Reason:  
...
#    - Preserved source value: "True"
# 18. Source step 0032 field "Btn_Male" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 19. Source step 0032 field "Btn_Single" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 20. Source step 0032 field "Capture Driver's License Number" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "Driver's License Number"
# 21. Source step 0032 field "Txt_Months Licensed in Current State" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "1"
# 22. Source step 0032 field "Btn_PriorInsurance_Yes" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 23. Source step 0032 field "Btn_Did Not Have Insurance" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 24. Source step 0032 field "Lnk_UWR_CONTINUE" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
...
#    - Preserved source value: "X"
# 30. Source step 0033 field "Btn_Single" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 31. Source step 0033 field "Btn_Assigned" in "EQ||Driver Summary" was disabled. Reason:  
...
# 47. Source step 0033 field "Lnk_UWR_CONTINUE" in "EQ||Driver Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 48. Source step 0035 field "Btn_Add Additional Driver" in "EQ||Driver Information Next" was disabled. Reason:  
#    - Preserved source value: "X"
# 49. Source step 0036 field "Btn_Vehicle" in "EQ||Vehicle Information" was disabled. Reason:  
#    - Preserved source value: "True"
# 50. Source step 0036 field "Btn_Vehicle" in "EQ||Vehicle Information" was disabled. Reason:  
#    - Preserved source value: "True"
# 51. Source step 0037 field "Btn_Vehicle" in "EQ||Vehicle Information" was disabled. Reason:  
#    - Preserved source value: "X"
# 52. Source step 0039 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 53. Source step 0039 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 54. Source step 0039 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 55. Source step 0039 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 56. Source step 0041 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 57. Source step 0041 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 58. Source step 0041 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 59. Source step 0041 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 60. Source step 0048 field "Hdr_Claims" in "EQ||Claims\\Violations" was disabled. Reason:  
#    - Preserved source value: "True"
# 61. Source step 0049 field "Btn_+ ADD CLAIM" in "EQ||Claims\\Violations" was disabled. Reason:  
#    - Preserved source value: "X"
# 62. Source step 0053 field "Btn_D1_No" in "EQ||Discounts_New" was disabled. Reason:  
#    - Preserved source value: "X"
# 63. Source step 0053 field "Hdr_Discounts page" in "EQ||Discounts_New" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 64. Source step 0056 field "Btn_UMPD_No Coverage_V1" in "Additional Coverages-Select Additional Coverages & Continue" was disabled. Reason:  
#    - Preserved source value: "x"
# 65. Source step 0056 field "Lbl_Uninsured Motorist PD" in "Additional Coverages-Select Additional Coverages & Continue" was disabled. Reason:  
#    - Preserved source value: "True"
# 66. Source step 0056 field "Btn_UMPD Limits" in "Additional Coverages-Select Additional Coverages & Continue" was disabled. Reason:  
#    - Preserved source value: "No Coverage_1"
# 67. Source step 0061 field "Btn_Next" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 68. Source step 0061 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "True"
# 69. Source step 0061 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 70. Source step 0063 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 71. Source step 0064 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 72. Source step 0065 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 73. Source step 0066 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 74. Source step 0070 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 75. Source step 0071 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 76. Source step 0072 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 77. Source step 0102 field "Txt_Agent_Cmnts_Refer to UW_3" in "EQ||Submission" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[Review Completed]}"
# 78. Source step 0104 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 79. Source step 0105 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 80. Source step 0106 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 81. Source step 0118 "Verify ExpressUI Sign on page showed up" in module "EU||Login" was disabled. Reason: 14.12.23 20:50:20 [ct2518]
#    - VERIFY "Lbl_Login ID" with "True"
#    - VERIFY "Lbl_Password" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - VERIFY "Lnk_LOGIN" with "True"
# 82. Source step 0119 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 83. Source step 0119 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "YD2102"
# 84. Source step 0119 field "Txt_Password" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 85. Source step 0120 "Provide Sign on credentials" in module "EU||Login" was disabled. Reason: 14.12.23 20:51:55 [ct2518]
#    - INPUT "Txt_Login ID_1" with "\"^{a}\""
#    - INPUT "Txt_Login ID_1" with "CT2451"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "X"
# 86. Source step 0122 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 87. Source step 0127 "EQ||Agent List count capture" in module "EQ||Agent List count capture" was disabled. Reason: 04.01.24 15:56:23 [ct2518]
#    - BUFFER "DIV_Agent Documents Count" with "count"
# 88. Source step 0138 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 89. Source step 0139 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 90. Source step 0140 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 91. Source step 0145 field "Btn_Yes" in "EU||Transact" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 92. Source step 0149 field "Hdr_DC-SECTION" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: a blank value
# 93. Source step 0149 field "Btn_Close" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 94. Source step 0150 "Close the RCT Express Page" in module "CloseBrowser" was disabled. Reason: 15.04.24 16:56:29 [ct2634]
#    - INPUT "Title" with "Pricing*"
# 95. Source step 0151 "TBox Evaluation Tool" in module "TBox Evaluation Tool" was disabled. Reason: 15.04.24 16:56:29 [ct2634]
#    - VERIFY "Expression" with the RUNTIME-DERIVED buffer expression "'{B[ActivityPoints]}'=='5'"
# 96. Source step 0152 "TBox Set Buffer" in module "TBox Set Buffer" was disabled. Reason: 15.04.24 16:56:29 [ct2634]
#    - INPUT "Activity Point_OH" with "Activity points for Atfault_OH is as Expected"
# 97. Source step 0153 "TBox Set Buffer" in module "TBox Set Buffer" was disabled. Reason: 15.04.24 16:56:29 [ct2634]
#    - INPUT "Activity Point_OH" with "Activity points for At fault_OH is as Fail"
# 98. Source step 0154 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 06.03.24 13:07:42 [ct2634]
...
# 99. Source step 0155 "TestData - Create & provide new item" in module "TestData - Create & provide new item" was disabled. Reason: 04.06.24 12:10:51 [ct2634]
...
# 100. Source step 0156 "TestData-Save PolicyNumber, Date to TDM for Post XML validation" in module "TestData - Create & provide new item" was disabled. Reason: 04.06.24 12:10:51 [ct2634]
...
#    - INPUT "Data structure > State" with "OH"
# 101. Source step 0157 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 06.03.24 13:07:46 [ct2634]
#    - INPUT "Btn_Save and Exit" with "X"
# 102. Source step 0158 "LogOut" in module "EQ||Log Out" was disabled. Reason: 02.11.23 15:20:44 [ct2451]
#    - INPUT "Btn_Log Out icon" with "X"
#    - INPUT "Btn_Log Out pop-up" with "X"
# 103. Source step 0160 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 104. Source step 0161 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 105. Source step 0162 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 106. Source step 0163 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 107. Source step 0164 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 108. Source step 0165 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 109. Source step 0166 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 110. Source step 0167 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 111. Source step 0168 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 112. Source step 0172 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 04.06.24 12:10:56 [ct2634]
