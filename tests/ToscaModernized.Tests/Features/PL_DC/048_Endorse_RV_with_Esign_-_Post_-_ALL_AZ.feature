# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 048_Endorse_RV_with_Esign_-_Post_-_ALL_AZ.feature
...
Feature: Execute Endorse RV with Esign - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Endorse RV with Esign - Post - ALL workflow for the selected source iteration
  ...
  Scenario: Endorse RV with Esign - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-cb7c-e56c-217f1b0c51bd
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0011: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-a604-15f9-263b18a40db0
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-b7e4-148d-990498d4aeb5
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-52b7-c8a7-f6eda99fa0e4
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-2a00-4869-b692ebdeb66c
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-bd0a-31cd-9f23e675e437
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-8e92-eabf-3c9b4853ad36
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-ab86-fa92-e14da8940838
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-fb8f-0fb2-6baa8b99c6d3
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a36-49e7-36fc-a8dd12323f6a
