# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 002_Activity_Points_-_At_fault_Auto_-_NY_NY.feature
...
Feature: Execute Activity Points - At fault (Auto) - NY for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - At fault (Auto) - NY workflow for the selected source iteration
  ...
  Scenario: Activity Points - At fault (Auto) - NY using representative iteration New York (NY)
    # Source step 0030: Enter Client Selection | Module: EQ || Client Selection
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c08-f1dd-0daf-9d4b61e76d97
    ...
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c08-d309-df22-02b865be4c14
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c08-89a9-e43f-24a8e26e61da
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c08-5a4e-1ea1-055e6411e2d9
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c08-e90b-707e-783ecfce6f19
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-734d-dc28-f38cacf849d6
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-8539-a58f-ae00e0d8892c
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-7f53-6db1-9c0a2040ba9b
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-26cb-b76f-25608a629e4b
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-42ea-33f8-e759fb33a4fe
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-c26f-9d48-813a79f9692c
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-dc52-732a-8f03ef6fe230
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-d556-df00-d30e3f46a6bf
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-77f4-9506-8df3422922cc
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0044: Verify - If prior insurance is visible | Module: EQ||Driver Summary
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-9689-b7a7-246bdfbaa8c0
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-cfb7-5c45-5284e117f385
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-5494-b278-80cd85d7b2e3
    # Runtime control: If_Driver Sumary_Prior Insurance > Enter details in prior insurance page
    When if the source runtime condition "If_Driver Sumary_Prior Insurance > Enter details in prior insurance page" is satisfied, I click "Btn_Primary Named Insured"
    Then I wait until "Txt_Years Licensed in Current State" is enabled
    When I select "Txt_Years Licensed in Current State"
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-d371-70e7-507ef2973e00
    When I click "Btn_Next"

    # Source step 0049: Verify vehicles are visible | Module: EQ||Vehicle Information
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-2923-eb88-9e3dfb36dda1
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-c6a6-7316-3c9e090913f1
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-3095-611e-955b043e4d45
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-cbf9-2020-6df53584c78e
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-21aa-19b5-0d62017393bc
    # Runtime control: Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details
    Then if the source runtime condition "Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details" is satisfied, "Lbl_VIN LABEL" should exist
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-64ab-8556-cc2c694b1c5f
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-9c4e-806d-b52f56f1382f
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-57e7-03c1-98dfa4dca905
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-1c71-f752-1b979e1b12ee
    # Runtime control: Driver Summary-UW Popup > Driver Summary-Enter Driver Summary Details
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-20d3-97e8-79fb2d530321
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-4437-207b-4b80735fbfaf
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-b194-8d27-9e5f42d5c15c
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fb90-1c2d-42766be2ceea
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-7d3a-7fdc-cfa21ebd2eee
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-11bc-26bf-b02201e2aeac
    When I click "Btn_Next"

    # Source step 0065: Verify if coverage is visible | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-9da4-0d22-8efad5664f85
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-5c3c-7c85-8a35b4aed7e1
    ...
    # Source step 0067: Select Coverages & Continue | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-8ca3-87f6-6077f7e490ef
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0068: Verify if Additional Coverage is visible | Module: EQ||Additional Coverages
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-bc0f-8b53-e54759d82399
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-bbcd-004b-048243ca02b7
    ...
    # Source step 0070: Enter Additional Coverage Details | Module: EQ||Additional Coverages
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-1faf-ac67-8582a2863045
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-16ba-d68d-198f443902ea
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-5d09-da5c-d2983aa4537b
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-5831-50dd-8df7d83b9f8e
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0074: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-febf-04c5-a1d5f658b4e2
    ...
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-41e3-278a-7995e214944e
    When I click "btn_Next"
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-08f2-6122-b9c956242c16
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-8da0-5169-38eaa0b095c0
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fdb5-224f-0b5a103ae130
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-4f74-8616-c37efaefe71a
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-56b9-a323-d14201113654
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-d38b-4ebd-cdc37f4ed47a
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-61fc-2479-ee9ef8d33cbb
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fc0d-f17a-400e95708c5a
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-75d4-6fb5-2561830da863
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-5e58-cbe2-f379a027bd52
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-6a30-8169-9c6f07b0684e
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-edae-193a-2463c2e83eaf
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-b420-0d03-3b6f88a952c4
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-b88b-f0fa-a18ca08b3bb3
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fc0f-1ef7-ffcc96500444
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fc52-fdf8-f67efd924441
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-e6e1-8e30-e3c886462787
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-f799-28aa-3f6c34ad80c4
    # Runtime control: Upload the remaining Checklist documents [max=30] > Loop
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-715a-18a6-2e9949a09c7d
    When I close the active browser

    # Source step 0145: Back to Submission page and click ok | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-61db-cd97-e33c3d42c6ac
    Then I wait until "Btn_Ok" exists
    When I click "Btn_Ok"

    # Source step 0146: Submission-Transmit and issue Policy | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-075c-daef-9e0dbe6312d7
    ...
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-e2d5-a717-b915189d43ed
    ...
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-db8b-ce71-6aca71a06af2
    ...
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-04b3-d55b-9b95541ea461
    ...
    And I use TDM parameter "Data structure > TestCase" with "Activity Points - At fault (Auto) - NY"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "NY"

    # Source step 0151: Push Quote Data & Policy Information to TDS_Regression_Temp_Data | Module: TestData - Create & provide new item
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fa9a-b438-39bf6c943569
    ...
    And I use TDM parameter "Data structure > EffectiveDate" with captured runtime value "Effective Date"
    And I use TDM parameter "Data structure > Date_Time" with the RUNTIME-DERIVED date from Tosca expression "{DATE} {TIME}"
    And I use TDM parameter "Data structure > TestCaseName" with "Activity Points - At fault (Auto) - NY"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "NY"
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-fd58-b3c2-206e0932dd97
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-2d1c-e1a3-0256752d6805
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-49ae-c5df-8af467123522
    When I enter or select "\"^{a}\"" in "Txt_Search Text"
    When I enter captured runtime value "Policy Number" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0159: Click on Auto | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-63e5-8c73-a816fa25901d
    When I click "Lnk_Insured Name"
    Then I wait until "Lnk_PersonalAuto" is visible
    When I click "Lnk_PersonalAuto"

    # Source step 0160: Click on View policy | Module: EU||Transact
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-4133-2388-288b5fa718d1
    Then I wait until "Btn_ViewPolicy" exists
    When I click "Btn_ViewPolicy"

    # Source step 0161: EU||Transact | Module: EU||Transact
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-7529-f363-559b60ec19e9
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-b6b3-f747-2e9aa08d5443
    ...
    # Source step 0163: Click on Pricing  | Module: EU||Applicant
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-9642-72b8-7cd840c8927c
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0164: Buffer Activity points | Module: EU||Pricing
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-1931-f6b0-a11c433ecb56
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-f632-b4e3-d87f52668dd2
    When I close the active browser

    # Source step 0166: Verify Activity Points is 4 or not | Module: TBox Evaluation Tool
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-107b-4653-832e6753e869
    # Runtime control: Evaluating Activity Points is 4 or not > Verify Activity Points is 4 or not
    Then if the source runtime condition "Evaluating Activity Points is 4 or not > Verify Activity Points is 4 or not" is satisfied, "Expression" should equal the RUNTIME-DERIVED buffer expression "'{B[ActivityPoints]}'=='4'"

    # Source step 0167: Activity points for Not at fault_NY is as Expected | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-03b3-aad0-f54ad0d3bfab
    # Runtime control: Evaluating Activity Points is 4 or not > Activity points for Not at fault_NY is as Expected
    When if the source runtime condition "Evaluating Activity Points is 4 or not > Activity points for Not at fault_NY is as Expected" is satisfied, I retain hard-coded value "Activity points for Not at fault_NY is as Expected" as runtime value "Activity Point_NY"

    # Source step 0168: Activity points for Not at fault_NY is as Fail | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c18-f983-bd3d-b632b4e10b2b
    # Runtime control: Evaluating Activity Points is 4 or not > Activity points for Not at fault_NY is as Fail
    When if the source runtime condition "Evaluating Activity Points is 4 or not > Activity points for Not at fault_NY is as Fail" is satisfied, I retain hard-coded value "Activity points for Not at fault_NY is as Fail" as runtime value "Activity Point_NY"
...
#    - Preserved source value: "X"
# 6. Source step 0032 field "Btn_Motorcycle" in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
# 7. Source step 0032 field "Btn_Recreational Vehicle" in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
# 8. Source step 0032 field "Btn_PROCEED" in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
# 9. Source step 0043 field "Btn_(Existing Client)*" in "Enter Driver Information" was disabled. Reason:  
#    - Preserved source value: "X"
# 10. Source step 0046 field "Btn_PriorInsurance_Yes" in "Enter details in prior insurance page" was disabled. Reason:  
...
# 12. Source step 0046 field "Btn_priorCarrierName" in "Enter details in prior insurance page" was disabled. Reason:  
...
#    - Preserved source value: "\"^{a}\""
# 15. Source step 0046 field "Btn_priorPolicyNumber" in "Enter details in prior insurance page" was disabled. Reason:  
...
#    - Preserved source value: "\"^{a}\""
# 18. Source step 0046 field "Btn_yearsWithPriorCarrier" in "Enter details in prior insurance page" was disabled. Reason:  
...
#    - Preserved source value: "\"^{a}\""
# 21. Source step 0046 field "Btn_monthsWithPriorCarrier" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[0]}"
# 22. Source step 0048 field "Btn_Add Additional Driver" in "Click Next" was disabled. Reason:  
#    - Preserved source value: "X"
# 23. Source step 0052 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 24. Source step 0052 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 25. Source step 0052 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 26. Source step 0052 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 27. Source step 0053 field "Btn_Automobile" in "Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 28. Source step 0053 field "Btn_Leased" in "Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 29. Source step 0053 field "Txt_Odometer" in "Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 30. Source step 0053 field "Txt_AnnualMileage" in "Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 31. Source step 0064 field "Btn_D1_No" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "X"
# 32. Source step 0064 field "Hdr_Discounts page" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 33. Source step 0075 field "Btn_Next" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 34. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "True"
# 35. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 36. Source step 0077 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 37. Source step 0078 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 38. Source step 0079 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 39. Source step 0080 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 40. Source step 0084 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 41. Source step 0085 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 42. Source step 0086 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 43. Source step 0116 field "Txt_Agent_Cmnts_Refer to UW_3" in "EQ||Submission" was disabled. Reason:  
...
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 47. Source step 0122 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 48. Source step 0122 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 49. Source step 0126 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 50. Source step 0126 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 51. Source step 0126 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 52. Source step 0126 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 53. Source step 0127 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 54. Source step 0127 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 55. Source step 0127 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 56. Source step 0127 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 57. Source step 0128 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 58. Source step 0128 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 59. Source step 0128 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 60. Source step 0128 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 61. Source step 0129 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
# 62. Source step 0130 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 63. Source step 0136 "Verify ExpressUI Sign on page showed up" in module "EU||Login" was disabled. Reason: 14.12.23 20:50:20 [ct2518]
#    - VERIFY "Lbl_Login ID" with "True"
#    - VERIFY "Lbl_Password" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - VERIFY "Lnk_LOGIN" with "True"
# 64. Source step 0137 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 65. Source step 0137 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "YD2102"
# 66. Source step 0137 field "Txt_Password" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 67. Source step 0138 "Provide Sign on credentials" in module "EU||Login" was disabled. Reason: 14.12.23 20:51:55 [ct2518]
#    - INPUT "Txt_Login ID_1" with "\"^{a}\""
#    - INPUT "Txt_Login ID_1" with "CT2451"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "X"
# 68. Source step 0141 field "H4" in "eChecklist-Verify if 'Application' links in the checklist are completed" was disabled. Reason:  
#    - Preserved source value: "True"
# 69. Source step 0142 field "H4" in "eChecklist-Click the 'drag/drop' link to upload the documents in the checklist" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0153 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 71. Source step 0154 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 72. Source step 0155 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 73. Source step 0160 field "Btn_Yes" in "Click on View policy" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 74. Source step 0170 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 75. Source step 0171 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 76. Source step 0172 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 77. Source step 0173 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 78. Source step 0174 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 79. Source step 0175 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 80. Source step 0176 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 81. Source step 0177 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 82. Source step 0178 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#
# RECOVERY BEHAVIOR FROM TOSCA — automation support, not normal manual business flow
# Recovery scenario: Recovery Scenario - Take screenshot, EQ sign out and Close browser
# 1. Source recovery step 0001 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\Activity Points - At fault (Auto) - NY_{DATE[][][MM/dd/yyyy]}_{TIME}"
