# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 182_Auto_Rate_Filings_Policy_3_NB_Prior_Eff_Date_AL.feature
...
@PL_DC @Auto @manual_conversion @Alabama @Edge @manual @automated
Feature: Execute Auto Rate Filings Policy 3 NB_Prior Eff Date for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Auto Rate Filings Policy 3 NB_Prior Eff Date workflow for the selected source iteration
  ...
  Scenario: Auto Rate Filings Policy 3 NB_Prior Eff Date using representative iteration Alabama (AL)
    ...
    When I derive and retain the RUNTIME-DERIVED date from Tosca expression "{Date[08.08.2025][][MM/dd/yyyy]}" as runtime value "EffectiveDate"
    ...
    # Section: Process > 04 Driver Information | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info | Source XTestStep: 3a1c608e-30ed-c2b9-f8be-a56e7a5735a8
    # Runtime control: If > Condition
    Then if the source runtime condition "If > Condition" is satisfied, "Ineligible Quote" should be visible
    When I click "CLOSE QUOTE"

    # Source step 0036: EQ || OpenUrl | Module: EQ || OpenUrl
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B > Open URL | Source XTestStep: 3a1abacb-9c11-d635-aec9-d96efada9152
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I open "https://dcpst-auto.dnanico1.aniconet.com/express/express.aspx"

    # Source step 0037: Verify if ExpressUI login page is shown | Module: EU||Login
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-0109-07d3-e73931df168b
    # Runtime control: If > Then > If_ExpressUI Login Page showed up > Condition
    Then if the source runtime condition "If > Then > If_ExpressUI Login Page showed up > Condition" is satisfied, "Lbl_Login ID" should be visible

    # Source step 0038: Provide Express UI Login credentials | Module: EU||Login
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-29a2-266a-98497ae4fb58
    # Runtime control: If > Then > If_ExpressUI Login Page showed up > Then
    Then if the source runtime condition "If > Then > If_ExpressUI Login Page showed up > Then" is satisfied, I wait until "Txt_Login ID_1" exists
    ...
    # Source step 0039: EU||Home | Module: EU||Home
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-5d83-ad0b-a96596c043b4
    # Runtime control: If > Then
    Then if the source runtime condition "If > Then" is satisfied, I wait until "Txt_Search Type" is visible
    When I enter captured runtime value "QuoteNumber" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0040: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-a9df-7b04-09de9844f8a1
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I click "Policy/Quote#"

    # Source step 0041: EU||Applicant | Module: EU||Applicant
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-e0fe-033d-e3fa33456b6e
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I enter or select "True" in "Bypass Level 9B Rules"
    When I enter or select "{Click}{SENDKEYS[Approved]}" in "Bypass Level 9B Rules Comments"
    When I click "Home"

    # Source step 0043: CloseBrowser | Module: CloseBrowser
    # Section: Process > 04 Driver Information > Approve in Express UI | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info > Express|Approve Level 9B | Source XTestStep: 3a1bb5f4-beb4-d8b3-0efa-a476976c6f04
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I close the active browser

    # Source step 0044: Recall Quote\Policy | Module: EQ||New Quote
    # Section: Process > 04 Driver Information | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info | Source XTestStep: 3a1c5fdf-d632-e5d5-e6fd-accec987b02c
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I enter or select "\"^{a}\"" in "Txt_Quote\\Policy Search"
    ...
    # Section: Process > 04 Driver Information | Reusable flow: Auto | Ineligible Quote (9B)_Driver Info | Source XTestStep: 3a1c6063-65f9-d11a-8e02-1f659b3638ac
    # Runtime control: If > Then
    When if the source runtime condition "If > Then" is satisfied, I click "Btn_Next"

    # Source step 0048: Driver Information-Enter Driver Details | Module: EQ||Driver Information
    ...
    # Source step 0049: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0055: DriverEducationLevel | Module: EQ || DriverEducationLevel
    ...
    # Source step 0056: DriverEducationLevel | Module: EQ || DriverEducationLevel
    ...
    # Source step 0057: NamedIns_Operator Status | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0059: NamedIns_Operator Status | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0062: NamedIns_Operator Status_Cycle | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0063: NamedIns_Operator Status | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0064: License Info | Module: EQ || DriverLicense_Time
    ...
    When I enter the RUNTIME-DERIVED TDM value "AL_ClientData.State" in "License State" when "'State Licensed(XX)' != NULL" is satisfied
    ...
    # Source step 0065: NamedIns_Operator Status | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0066: NamedIns_Operator Status | Module: EQ || NamedIns_Operator Status
    ...
    # Source step 0067: Prior Insurance Info | Module: EQ || Prior Insurance Info
    ...
    # Source step 0068: Prior Insurance Info | Module: EQ || Prior Insurance Info
    ...
    # Source step 0069: Prior Insurance Info | Module: EQ || Prior Insurance Info
    ...
    # Source step 0070: Prior Insurance Info | Module: EQ || Prior Insurance Info
    ...
    # Source step 0071: Save & Continue | Module: EQ || Prior Insurance Info
    ...
    # Source step 0072: EQ || Expired License Pop Up | Module: EQ || Expired License Pop Up
    ...
    # Source step 0073: EQ || Expired License Pop Up | Module: EQ || Expired License Pop Up
    ...
    # Source step 0074: EQ | Side Menu | Module: EQ | Side Menu
    ...
    # Source step 0076: Prefil Household Drivers | Module: EQ || Prefil Household Drivers
    ...
    # Source step 0077: Prefil Household Drivers | Module: EQ || Prefil Household Drivers
    ...
    # Source step 0078: Save & Continue | Module: EQ || Prefil Household Drivers
    ...
    # Source step 0079: Prefil Household Drivers | Module: EQ || Prefil Household Drivers
    ...
    # Source step 0080: Prefil Household Drivers | Module: EQ || Prefil Household Drivers
    ...
    # Source step 0084: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcd2-9730-0d41-a7c3-afa901201bb2
    ...
    When I retrieve and retain the RUNTIME-DERIVED TDM value "AL_ClientData.State" as runtime value "State"
    When I retain hard-coded value "American National Property And Casualty Co." as runtime value "Company"
    ...
    # Source step 0085: EQ || CA Verified Mileage | Module: EQ || CA Verified Mileage
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1b6f0e-61dc-2d45-6bd6-247e9d4a83d9
    When I perform the source-defined operation "EQ || CA Verified Mileage" in module "EQ || CA Verified Mileage"

    # Source step 0086: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcd2-c921-f061-6021-b5ca3b25b678
    # Runtime control: Vehicles prefilled > Condition
    Then if the source runtime condition "Vehicles prefilled > Condition" is satisfied, I wait until "MORE OPTIONS" is visible

    # Source step 0087: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcd2-c921-b7af-d930-d681ee78be92
    # Runtime control: Vehicles prefilled > Then
    When if the source runtime condition "Vehicles prefilled > Then" is satisfied, I select "MORE OPTIONS"
    When I click "Additional Vehicle(s)"
    When I click "Btn_Next"

    # Source step 0088: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a210f89-3d63-ebe1-03e3-78438d1989e8
    # Runtime control: Vehicles prefilled > Else
    When if the source runtime condition "Vehicles prefilled > Else" is satisfied, I click "Btn_Additional Vehicle"
    When I click "Btn_Next"

    # Source step 0089: EQ||Vehicle Vin | Module: EQ||Vehicle Auto Vin_1
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcd3-e1d2-4049-5a80-c883f22671a6
    ...
    # Source step 0090: EQ||Vehicle Summary Auto Use | Module: EQ||Vehicle Summary Auto/Motor Home Use
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcd3-e1d2-6ec5-295c-8a26f0cbcbde
    ...
    # Source step 0094: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcda-8979-e975-6126-1964a12580ef
    When I click "btn_Add_Vehicle"

    # Source step 0095: EQ||Vehicle Summary Auto Additional | Module: EQ||Vehicle Summary Auto Additional
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afcdb-0783-1559-f690-143bb5a5f6f5
    Then I wait until "VIN" is enabled
    When I enter or select "4762900534" in "VIN"
    When I press "Tab" while focused on "VIN"
    When I click "Veh1"
    When I enter or select "{Click}{Scroll[1]}" in "Vehicle_More_ Options"
    When I click "CollectorCar"
    When I select "Collector Car Type_More Options"
    When I enter or select "{Click}{scroll[3]}" in "Classic"
    When I enter or select "21,000" in "Agreed Value"
    When I enter or select "{scroll[3]}{Click}" in "Own"
    When I click "Continue"
    When I enter or select "{scroll[2]}{Click}" in "Restricted Use"
    When I enter or select "\"^{a}\"" in "Appraisal Date"
    When I enter or select "06/06/2025" in "Appraisal Date"
    When I enter or select "\"^{a}\"" in "Total_annual_mileage"
    When I enter or select "3000" in "Total_annual_mileage"
    When I click "Save_Continue"

    # Source step 0096: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afd1b-cac1-6277-b630-38961836dee8
    When I click "btn_Add_Vehicle"

    # Source step 0097: EQ||Vehicle Summary Auto Additional | Module: EQ||Vehicle Summary Auto Additional
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afd1e-0563-fbc4-8f8d-5813d335456e
    Then I wait until "VIN" is enabled
    When I enter or select "2G1FF3D37E9195082" in "VIN"
    When I press "Tab" while focused on "VIN"
    When I click "Veh 3"
    When I select "Vehicle_More_ Options"
    When I enter or select "{Click}{scroll[1]}" in "CollectorCar"
    When I enter or select "{Click}{scroll[2]}" in "Modern Classic"
    When I enter or select "17,000" in "Agreed Value"
    When I enter or select "{scroll[2]}{Click}{scroll[2]}" in "Own"
    When I click "Continue"
    When I enter or select "{Click}{END}" in "Restricted Use"
    When I enter or select "\"^{a}\"" in "Appraisal Date"
    When I enter or select "06/06/2025" in "Appraisal Date"
    ...
    # Source step 0098: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afd23-cfcd-7702-ad65-43aaef9f588f
    When I click "btn_Add_Vehicle"

    # Source step 0099: EQ||Vehicle Summary Auto Additional | Module: EQ||Vehicle Summary Auto Additional
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afd23-e975-4481-f1eb-601679736ede
    Then I wait until "VIN" is enabled
    When I enter the unresolved source parameter "VIN 4" (not supplied by this reusable-block invocation) in "VIN"
    When I press "Tab" while focused on "VIN"
    When I click "Veh1"
    When I enter or select "{Click}{scroll[2]}" in "Own"
    When I click "Continue"
    When I enter or select "08/08/2006" in "Purchase_date"
    When I enter or select "\"^{a}\"" in "Odometer"
    When I enter or select "60000" in "Odometer"
    When I enter or select "\"^{a}\"" in "Total_annual_mileage"
    When I enter the unresolved source parameter "Annual Mileage Veh 4" (not supplied by this reusable-block invocation) in "Total_annual_mileage"
    When I click "Save_Continue"

    # Source step 0100: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Automobile_Rate Filing | Source XTestStep: 3a1afd29-ace8-62e9-4b7f-c8344c432a6d
    ...
    # Source step 0102: (New) EQ || Multiple Driver Assignment_1 | Module: (New) EQ || Multiple Driver Assignment
    ...
    # Source step 0103: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a211526-124c-f4ad-53cf-7c50ebad80ec
    ...
    # Source step 0104: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a211526-124d-e519-0220-0821efba9ccd
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a211526-124d-0d0d-2f43-838a5fb0d876
    Then I wait until "Loading ..." exists

    # Source step 0106: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a211526-124d-73ec-9ac0-00098ea002ad
    ...
    # Source step 0107: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a211526-124d-051c-e932-e4cc7e618fcc
    ...
    # Source step 0108: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0109: Check for claims/violations needing edited | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0110: Edit Item(s) | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0112: If Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0113: Edit Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0114: Edit Violation | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0115: Check for PopUp | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0116: Select Continue | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0117: Next | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0119: EQ||Discount - Rate Tier Questions | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0120: EQ||Discount - Rate Tier Questions | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0122: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0123: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "No" as runtime value "Special Farm Package"
    ...
    # Source step 0124: EQ||Discount | Module: EQ||Discount(NEW)
    ...
    # Source step 0125: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0126: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0127: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "500" as runtime value "V3_CompDed"
    ...
    When I retain hard-coded value "500" as runtime value "V3_CollDed"
    ...
    When I retain hard-coded value "500" as runtime value "V4_CompDed"
    ...
    When I retain hard-coded value "500" as runtime value "V4_CollDed"
    ...
    # Source step 0128: Select Policy Coverage Option | Module: Coverages (New)
    ...
    # Source step 0129: Edit Coverage Option | Module: Edit Coverage Option (New)
    ...
    # Source step 0130: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 09 Coverages | Reusable flow: Auto | 09 EQ | Coverages | Source XTestStep: 3a19dd55-d452-32f7-1e44-9a9fe0dd9489
    Then I wait until "Loading ..." exists

    # Source step 0131: Navigate down screen to V1 | Module: Coverages (New)
    ...
    # Source step 0132: Select V1 Coverages | Module: Coverages (New)
    ...
    # Source step 0133: Navigate down screen to V2 | Module: Coverages (New)
    ...
    # Source step 0134: Select V2 Coverages | Module: Coverages (New)
    ...
    # Source step 0135: Navigate down screen to V3 | Module: Coverages (New)
    ...
    # Source step 0136: Select V3 Coverages | Module: Coverages (New)
    ...
    # Source step 0137: Navigate down screen to V4 | Module: Coverages (New)
    ...
    # Source step 0138: Select V4 Coverages | Module: Coverages (New)
    ...
    # Source step 0147: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0148: EQ || Other Policy Coverages Section | Module: EQ || Other Policy Coverages Section (New)
    ...
    # Source step 0149: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0150: EQ || Personal Injury Protection Section  | Module: EQ || Personal Injury Protection Section (New)
    ...
    # Source step 0151: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "No Coverage" as runtime value "Roadside Assistance Coverage_V2"
    ...
    When I retain hard-coded value "No Coverage" as runtime value "Roadside Assistance Coverage_V3"
    ...
    # Source step 0152: EQ || Vehicle Coverages Section | Module:  EQ || Vehicle Coverages Section
    ...
    # Source step 0153: Additional Coverages Next | Module: EQ || Additional Coverages Next (New)
    ...
    # Source step 0154: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    ...
    # Source step 0156: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0157: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0158: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0159: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0160: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0161: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0162: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0163: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0168: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0169: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Runtime control: If Correction Needed > Then go to Express to bypass L9
    When if the source runtime condition "If Correction Needed > Then go to Express to bypass L9" is satisfied, I open "https://dcpst-auto.dnanico1.aniconet.com/express/express.aspx"

    # Source step 0174: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0175: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0177: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0178: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0179: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0180: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0181: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0184: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0185: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0186: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0223: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0224: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0225: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0226: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0227: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0228: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0246: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Runtime control: If Referral Button  > Then
    When if the source runtime condition "If Referral Button > Then" is satisfied, I open "https://dcpst-auto.dnanico1.aniconet.com/express/express.aspx"
    ...
    # Source step 0249: EU||Home | Module: EU||Home
    ...
    # Source step 0250: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0251: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0252: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0253: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0254: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0255: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0259: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0260: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0261: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0262: TBox Save As | Module: TBox Save As
    ...
    # Source step 0263: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0265: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0267: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0269: TBox Save As | Module: TBox Save As
    ...
    # Source step 0270: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0272: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0273: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0274: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0275: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0276: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0278: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a211526-12a0-a225-c1d3-0a95aa28d1c9
    Then I wait until "Policy Number" has "InnerText" equal to "“Policy Number:”"
    When I capture "InnerText" from "Policy Number" as runtime value "Policy Number"
    When I use source configuration "Effective Date" = "08.08.2025" for "Transmit Confirmation"

    # Source step 0279: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a211526-12a0-a59f-4cb0-521fd6671271
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Auto_PolicyData_RateFilings_PriorEffDate"
    And I use TDM parameter "Data structure > PolicyNumber" with captured runtime value "Policy Number"
    And I use TDM parameter "Data structure > EffectiveDate" with captured runtime value "EffectiveDate"
    ...
    # Source step 0281: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a211526-12a0-160b-5139-97127fadd4e6
    When I close the active browser
...
#    - INPUT "Start Quote" with "X"
# 8. Source step 0038 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 9. Source step 0038 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 10. Source step 0042 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 11. Source step 0046 "Driver Information-Enter Driver Details" in module "EQ||Driver Information" was disabled. Reason: 11.09.25 13:57:25 [pa2096@dnanico1.aniconet.com]
#    - INPUT "(Existing Client)_1" with "{Click}"
#    - INPUT "Btn_Next" with "{Click}"
# 12. Source step 0047 "Enter PreQualification" in module "EQ||PreQualification" was disabled. Reason: 15.09.25 16:13:49 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Btn_Chk box_check_boxNone Of The Above" with "{CLICK}"
#    - INPUT "Btn_Next" with "{CLICK}"
# 13. Source step 0050 "NamedIns_Operator Status_MT" in module "EQ || NamedIns_Operator Status" was disabled. Reason: 03.06.26 09:09:31 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "DOB_Driver1" with the RUNTIME-DERIVED TDM value "AL_ClientData.DOB"
...
# 14. Source step 0051 "Gender Enabled?" in module "EQ || NamedIns_Operator Status" was disabled. Reason: 01.06.26 16:18:37 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Gender" with "True"
# 15. Source step 0052 "NamedIns_Operator Status" in module "EQ || NamedIns_Operator Status" was disabled. Reason: 01.06.26 16:18:37 [pa2096@dnanico1.aniconet.com]
#    - CONTAINER "Gender" with "True"
#    - INPUT "Male" with "X"
#    - INPUT "Female" with "X"
# 16. Source step 0062 field "More Options (Operator Status)" in "NamedIns_Operator Status_Cycle" was disabled. Reason:  
#    - Preserved source value: "X"
# 17. Source step 0063 field "More Options (Operator Status)" in "NamedIns_Operator Status" was disabled. Reason:  
#    - Preserved source value: "X"
# 18. Source step 0064 field "Driver Name" in "License Info" was disabled. Reason:  
#    - Preserved source value: "Driver_1"
# 19. Source step 0081 "EQ | Side Menu" in module "EQ | Side Menu" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Driver Information" with "X"
#    - CONTAINER "Vehicle Summary" with "AL"
#    - CONTAINER "Coverages" with "Rate Filings"
# 20. Source step 0082 "EQ|| Add Additional Driver 1" in module "EQ|| Add Additional Driver 1" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
#    - BUFFER "Driver_1" with "Driver_1"
# 21. Source step 0083 "EQ | Side Menu" in module "EQ | Side Menu" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Vehicle Summary" with "X"
#    - CONTAINER "Coverages" with "Rate Filings"
# 22. Source step 0089 field "btn_vehicle1" in "EQ||Vehicle Vin" was disabled. Reason:  
#    - Preserved source value: "=True"
# 23. Source step 0091 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - WAIT "txt_annual_mileage" with "True"
# 24. Source step 0092 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - INPUT "txt_annual_mileage" with "\"^{a}\""
#    - INPUT "txt_annual_mileage" with "8500"
#    - INPUT "btnSave_Continue" with "X"
# 25. Source step 0093 "EQ||Vehicle Summary Auto/Motor Home Use" in module "EQ||Vehicle Summary Auto/Motor Home Use" was disabled. Reason: 08.07.25 14:21:41 [pa2096@dnanico1.aniconet.com]
#    - INPUT "btnSave_Continue" with "X"
# 26. Source step 0095 field "Veh1" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "=True"
# 27. Source step 0095 field "CONTINUE" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "X"
# 28. Source step 0097 field "Veh 3" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "==True"
# 29. Source step 0097 field "CONTINUE" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "X"
# 30. Source step 0099 field "Veh1" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "==True"
# 31. Source step 0099 field "CONTINUE" in "EQ||Vehicle Summary Auto Additional" was disabled. Reason:  
#    - Preserved source value: "X"
# 32. Source step 0113 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 33. Source step 0121 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Less than $15,000/$30,000" with "{Click}"
# 34. Source step 0139 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 35. Source step 0140 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 36. Source step 0141 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 37. Source step 0142 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 38. Source step 0143 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 39. Source step 0144 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 40. Source step 0145 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 41. Source step 0146 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 42. Source step 0152 field "Cycle Accessories_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 43. Source step 0152 field "Original Parts_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 44. Source step 0152 field "Endorsement Limit V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1398 $5,000"
# 45. Source step 0152 field "Cycle Accessories_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 46. Source step 0152 field "Original Parts_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 47. Source step 0152 field "Endorsement Limit V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1399 $7,000"
# 48. Source step 0161 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 49. Source step 0164 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 50. Source step 0165 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 51. Source step 0166 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 52. Source step 0167 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 53. Source step 0171 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 54. Source step 0172 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 55. Source step 0173 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 56. Source step 0175 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 57. Source step 0175 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 58. Source step 0179 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 59. Source step 0179 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 60. Source step 0179 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 61. Source step 0179 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 62. Source step 0180 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 63. Source step 0180 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 64. Source step 0180 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 65. Source step 0180 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 66. Source step 0181 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 67. Source step 0181 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 68. Source step 0181 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 69. Source step 0181 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 70. Source step 0182 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
# 71. Source step 0183 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 72. Source step 0187 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 73. Source step 0188 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 74. Source step 0189 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 75. Source step 0190 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 76. Source step 0191 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 77. Source step 0192 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ReferUW" with "X"
#    - INPUT "SaveExit_1" with "X"
# 78. Source step 0193 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 79. Source step 0194 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 80. Source step 0195 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 81. Source step 0196 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 82. Source step 0197 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 83. Source step 0198 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 84. Source step 0199 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 85. Source step 0200 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 86. Source step 0201 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 87. Source step 0202 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 88. Source step 0203 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 89. Source step 0204 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 90. Source step 0205 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 91. Source step 0206 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 92. Source step 0207 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 93. Source step 0208 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 94. Source step 0209 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 95. Source step 0210 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 96. Source step 0211 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 97. Source step 0212 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 98. Source step 0213 "EU||Home" in module "EU||Home" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 99. Source step 0214 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 100. Source step 0215 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 101. Source step 0216 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 102. Source step 0217 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 103. Source step 0218 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 104. Source step 0219 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 23.10.25 15:32:02 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 105. Source step 0220 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 106. Source step 0221 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 107. Source step 0222 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 108. Source step 0229 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpst-auto.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "UseActiveTab" with a blank value
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# 109. Source step 0230 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 110. Source step 0231 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 111. Source step 0232 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 112. Source step 0233 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 113. Source step 0234 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 114. Source step 0235 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 115. Source step 0236 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 116. Source step 0237 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 117. Source step 0238 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 118. Source step 0239 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 119. Source step 0240 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 120. Source step 0241 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 121. Source step 0242 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 122. Source step 0243 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 123. Source step 0244 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 124. Source step 0245 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 125. Source step 0248 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 126. Source step 0248 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 127. Source step 0256 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 128. Source step 0257 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 129. Source step 0258 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 130. Source step 0260 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 131. Source step 0264 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 132. Source step 0271 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 133. Source step 0277 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:26 [pa2096@dnanico1.aniconet.com]
...
# 134. Source step 0279 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 135. Source step 0279 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 136. Source step 0280 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:31 [pa2096@dnanico1.aniconet.com]
