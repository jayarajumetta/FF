# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 189_FFCIC_New_Business_Auto_Group_3_Prior_Eff_Date_3-1-25_CT.feature
...
Feature: Execute FFCIC New Business Auto Group 3  Prior Eff Date_3-1-25 for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Auto Group 3  Prior Eff Date_3-1-25 workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Auto Group 3  Prior Eff Date_3-1-25 using representative iteration Connecticut (CT)
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8e0-20a1-a1fd-757064eb0d5c
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8e0-773d-8c0a-f7afd8808fba
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8e0-9561-3004-99a7a07eb1cd
    Then I wait until "Loading ..." exists

    # Source step 0093: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8e0-19d4-46b2-649dd71502ee
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8e0-bf8f-68a6-81628025dc0f
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8ff-2ecd-9d4a-fbb0c2b1e38c
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8ff-8ecb-2b50-398a3957af5b
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Auto_PriorEffDate_3-1-25"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bac91-f8ff-8104-f96b-a8e6dcd3d3d0
    When I close the active browser
