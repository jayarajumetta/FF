# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 054_UW_Non-Renewal_-_Auto_-_Post_-_ALL_AZ.feature
...
Feature: Execute UW Non-Renewal - Auto - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Non-Renewal - Auto - Post - ALL workflow for the selected source iteration
  ...
  Scenario: UW Non-Renewal - Auto - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-b86b-de84-15190b6f47df
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-adb5-a4d0-d415c763aa0e
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-180d-1ab9-a8e555d06fef
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-74e1-717a-7d51d6240bfa
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-b32c-8cd4-61217933ce10
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-ca32-6a1e-c943593a5eb5
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3aa5-c6ca-56f6-de30aad719ba
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ab4-88e8-f3e4-4e90b339c893
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ab4-cc08-5baa-332ab57cce1e
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ab4-6019-a81b-bbad7511fc03
    When I close the active browser

    # Source step 0027: OpenUrl | Module: OpenUrl
    ...
    # Source step 0032: TestData - Find & provide item | Module: Old_TestData - Find & provide item
    ...
    # Source step 0033: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0034: EU||Login | Module: EU||Login
    ...
    # Source step 0035: EU||Home | Module: EU||Home
    ...
    # Source step 0036: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0038: EU||Transact | Module: EU||Transact
    ...
    # Source step 0039: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0040: EU||Policy Term-Verify Rate Date/Rate Effective Date | Module: EU||Policy Term
    ...
    # Source step 0042: CloseBrowser | Module: CloseBrowser
    # Section:  PostCondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ab4-7390-986a-602f5112e592
    When I close the active browser
...
# 6. Source step 0025 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 29.05.24 19:19:11 [ct2634]
#    - INPUT "Title" with "*"
# 7. Source step 0028 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 8. Source step 0029 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 9. Source step 0030 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 10. Source step 0035 field "Lbl_Insured Name" in "EU||Home" was disabled. Reason:  
#    - Preserved source value: "X"
# 11. Source step 0036 field "Lbl_Insured Name" in "EU|Home" was disabled. Reason:  
#    - Preserved source value: "True"
# 12. Source step 0036 field "Lbl_Insured Name" in "EU|Home" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 13. Source step 0037 "Client Information Page" in module "EU||Client Information Page" was disabled. Reason: 03.04.24 21:30:42 [ct2451]
#    - WAIT "lnk_PersonalAuto" with "True"
#    - INPUT "lnk_PersonalAuto" with "X"
#    - WAIT "btn_ViewDetailsandHistory" with "True"
# 14. Source step 0041 "EU||Home" in module "EU||Home" was disabled. Reason: 06.12.23 10:36:47 [ct2453]
