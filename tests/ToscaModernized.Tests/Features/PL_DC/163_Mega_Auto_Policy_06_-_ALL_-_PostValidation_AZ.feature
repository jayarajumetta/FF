# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 163_Mega_Auto_Policy_06_-_ALL_-_PostValidation_AZ.feature
...
Feature: Execute Mega Auto Policy 06 - ALL - PostValidation for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto Policy 06 - ALL - PostValidation workflow for the selected source iteration
  ...
  Scenario: Mega Auto Policy 06 - ALL - PostValidation using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-88a8-5f17-e197561af0d0
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-8308-19f9-763fb6c93198
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-3cda-cb81-c6921d3832f4
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-ace9-db4d-5dd30dec43ee
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-0a40-9b9b-1407fe112639
    When I retain hard-coded value "Mega Auto Policy 06-AZ" as runtime value "TCName"

    # Source step 0018: TBox Save As_1-To Upload the file | Module: TBox Save As
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-0963-1afa-b54941ed4578
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-bec7-8823-3dbac62451ae
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-8f1e-410f-823b8c6f3f61
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd5-19c2-3865-a47dbc254343
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd7-e67f-634e-4b2b025d05ee
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3fd7-0b9d-cdc6-a97d89c82bc1
    When I close the active browser
