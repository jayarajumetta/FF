# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 180_ROP_Regression_Testing_SD1_Scenario_2_-_PA_-_Unbound_ROP_Regression_Testing_SD1_Scenario_2_-_.feature
...
Feature: Execute ROP Regression Testing SD1 Scenario #2 - PA - Unbound for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the ROP Regression Testing SD1 Scenario #2 - PA - Unbound workflow for the selected source iteration
  ...
  Scenario: ROP Regression Testing SD1 Scenario #2 - PA - Unbound using representative iteration ROP Regression Testing SD1 Scenario #2 - PA - Unbound
    # Source step 0025: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-4fb5-28cc-f785362f163b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-78ca-f1c5-59cade356867
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-fa1b-0935-f22a426f39ec
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-9eb5-5bed-88954fca731e
    Then "<unnamed value>" should exist
    Then "<unnamed value>" should exist
    Then "<unnamed value>" should exist
    When I enter captured runtime value "DOB" in "<unnamed value>"
    When I enter or select "7000000000" in "<unnamed value>"
    When I enter or select "Wuldfer@aol.com" in "<unnamed value>"
    Then "Lbl_Marital Status:" should exist
    When I click "<unnamed value>"
    When I enter or select "254 Limestone Dr, Bellefonte, PA 16823" in "<unnamed value>"
    Then I wait until "<unnamed value>" exists
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-8d0d-9f27-a9327c2f46fc
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-20e0-9a0f-1dff426d7780
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-d842-19e3-433ba51fc7b9
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-7cb0-0e2c-153e398a586b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-c5f5-f756-85c3b39303fe
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-de5e-8a4e-2fa68c9215bf
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-59ad-b274-d5c44fefc728
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-a8a3-b5af-de189fec9969
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-e257-2276-67d811e99d0b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-eb01-d62d-93eba96b9c4c
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-4a73-e24c-282fdf76d225
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-b954-4c06-6a3ad193795b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-9a42-5ff6-dfcb0cb6d785
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-d172-0667-bb052f31fa78
    Then I wait until "Lbl_Home in City Limits?" is visible
    When I click "Btn_IN"
    When I click "Btn_NEXT"

    # Source step 0048: Home Characteristics_SD3/SD1-Cost Estimator info till Get Valuation | Module: EQH||Home Characteristics_SD3/SD1
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-2912-8cbb-ed520c8418d0
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-daad-2ef6-a282b34f9490
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-9ae1-3d7d-9c9c20014ff5
    Then I wait until "Btn_Save" is visible
    When I click "Btn_Save"

    # Source step 0052: RCT||Complete page | Module: RCT | Complete page
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-a9ad-b1a8-5dcd121a22a5
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-c48a-5712-8ec10588bc9e
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-f51a-2a7f-1a010fce8a7b
    ...
    # Source step 0056: Home Characteristics_SD3/SD1-Property Information | Module: EQH||Home Characteristics_SD3/SD1
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-a77c-c34f-9347d315ee08
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-8d26-e100-1f418dae2b85
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-a9f8-a6e0-ba9fe13b3366
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-4a0f-73bc-e3b51d497166
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-5794-9488-c07cae2f27d4
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-9a54-b7c2-d616509e76b3
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-7ea1-af8f-9c7225c3e749
    Then I wait until "Claims History Header" is visible
    Then I wait until "Btn_ADD CLAIM" exists
    When I click "Btn_NEXT"

    # Source step 0066: Discounts/Adjustments-Choose any discounts applied | Module: EQH||Discounts/Adjustments
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-f8f1-d120-59a995819450
    ...
    # Source step 0068: EQH||Coverages-Edit-Option 1-All Other Peril Deductible $3000 | Module: EQH||Coverages-Edit-Option 1
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-d9d1-75f0-fca6c8972c14
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-1816-a1dd-c5a1428239b7
    ...
    # Source step 0071: Additional Coverages-Add 'Theft Coverage On Dwelling Under Construction' coverage/endorsement | Module: EQH||Additional Coverages
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-fe7f-71b3-719a95424bde
    ...
    # Source step 0073: Additional Coverages-Add 'Fire Department Service Charge' coverage/endorsement | Module: EQH||Additional Coverages
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3ef7-18bb-aabb-1b6502dde739
    Then I wait until "Additional Coverages Header" is visible
    When I enter or select "{SCROLL[11][1000px][None][HorizontalFirst][300ms]}" in "Lbl_Coverage Catalog"
    When I enter or select "Fire Department" in "Txt_Search by Name-Coverage Catalog"
    When I click "Btn_Search-Coverage Catalog"
    ...
    # Source step 0075: Additional Coverages-click next to move to Pricing Details | Module: EQH||Additional Coverages
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-4c63-6af6-6366d0940372
    Then I wait until "Additional Coverages Header" is visible
    When I enter or select "{SCROLL[11][1000px][None][HorizontalFirst][300ms]}" in "Lbl_Coverage Catalog"
    Then I wait until "Btn_NEXT" is visible
    When I click "Btn_NEXT"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-3941-bb88-4a9c39ea7158
    ...
    # Source step 0079: Mortgage/Additional Interest-Add/Edit Additional Interest, if needed | Module: EQH||Mortgage/Additional Interest
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-7128-6bf3-6bd85bc068e9
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-f85f-da7b-09675bed30cf
    ...
    # Source step 0119: TestData-Save PolicyNumber, Premium and other details to TDM | Module: TestData - Create & provide new item
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-e55c-1d56-0d952340eafa
    ...
    # Source step 0120: TestData-Save PolicyNumber, Date to TDM for Post XML validation | Module: TestData - Create & provide new item
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-ed3f-7de5-e94a45203c97
    ...
    # Source step 0121: Log Out- Exist from the Quote/Policy | Module: EQ||Log Out
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-683a-d3c3-a09d106f670d
    When I click "Btn_Log Out icon"
    When I click "Btn_Log Out pop-up"

    # Source step 0122: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f06-5289-1183-6ef4ca23e8c3
...
# 14. Source step 0034 field "Btn_ANY ANIMALS ON PREMISES WITH A BITE HISTORY" in "Pre-Qualification-Select Client and Property Eligibility Restrictions" was disabled. Reason:  
#    - Preserved source value: "True"
...
#    - Preserved source value: "True"
# 16. Source step 0037 field "Lbl_Select the client type" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: "True"
# 17. Source step 0037 field "Btn_C/O" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: "True"
# 18. Source step 0037 field "Btn_Home" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: a blank value
# 19. Source step 0037 field "Txt_Email Address" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: a blank value
# 20. Source step 0037 field "Btn_Pager_Email Type" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: a blank value
# 21. Source step 0037 field "Btn_Married" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: "True"
# 22. Source step 0037 field "Btn_Son" in "Add or Edit Named Insured-Existing Client" was disabled. Reason:  
#    - Preserved source value: "True"
# 23. Source step 0040 field "Btn_Hide Google Maps" in "EQH||Location-till miles to fire station" was disabled. Reason:  
#    - Preserved source value: a blank value
# 24. Source step 0040 field "7.1-10.0" in "EQH||Location-till miles to fire station" was disabled. Reason:  
#    - Preserved source value: a blank value
# 25. Source step 0042 field "Location Header" in "EQH||Location-till feet to hydrant" was disabled. Reason:  
#    - Preserved source value: a blank value
# 26. Source step 0042 field "Lbl_How long have you owned or occupied location?" in "EQH||Location-till feet to hydrant" was disabled. Reason:  
#    - Preserved source value: a blank value
...
#    - Preserved source value: a blank value
# 29. Source step 0042 field "Btn_Hide Google Maps" in "EQH||Location-till feet to hydrant" was disabled. Reason:  
#    - Preserved source value: a blank value
# 30. Source step 0042 field "Drp List_Miles to Fire Station-need to check" in "EQH||Location-till feet to hydrant" was disabled. Reason:  
#    - Preserved source value: a blank value
# 31. Source step 0042 field "0-3.0" in "EQH||Location-till feet to hydrant" was disabled. Reason:  
#    - Preserved source value: a blank value
# 32. Source step 0044 field "Location Header" in "Verify Order Wildfire Risk Score is enabled" was disabled. Reason:  
#    - Preserved source value: "True"
# 33. Source step 0044 field "Lbl_How long have you owned or occupied location?" in "Verify Order Wildfire Risk Score is enabled" was disabled. Reason:  
#    - Preserved source value: "True"
...
#    - Preserved source value: "True"
# 36. Source step 0044 field "Btn_Hide Google Maps" in "Verify Order Wildfire Risk Score is enabled" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[9][1000px][None][HorizontalFirst][300ms]}"
# 37. Source step 0044 field "Drp List_Miles to Fire Station-need to check" in "Verify Order Wildfire Risk Score is enabled" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 38. Source step 0044 field "0-3.0" in "Verify Order Wildfire Risk Score is enabled" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 39. Source step 0045 field "Location Header" in "Get the the Wildfore Risk Score for property" was disabled. Reason:  
#    - Preserved source value: a blank value
# 40. Source step 0045 field "Lbl_How long have you owned or occupied location?" in "Get the the Wildfore Risk Score for property" was disabled. Reason:  
#    - Preserved source value: a blank value
...
#    - Preserved source value: a blank value
# 43. Source step 0045 field "Btn_Hide Google Maps" in "Get the the Wildfore Risk Score for property" was disabled. Reason:  
#    - Preserved source value: a blank value
# 44. Source step 0045 field "Drp List_Miles to Fire Station-need to check" in "Get the the Wildfore Risk Score for property" was disabled. Reason:  
#    - Preserved source value: a blank value
# 45. Source step 0045 field "0-3.0" in "Get the the Wildfore Risk Score for property" was disabled. Reason:  
#    - Preserved source value: a blank value
# 46. Source step 0047 field "Location Header" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 47. Source step 0047 field "Lbl_How long have you owned or occupied location?" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
...
#    - Preserved source value: a blank value
# 50. Source step 0047 field "Btn_Hide Google Maps" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 51. Source step 0047 field "Drp List_Miles to Fire Station-need to check" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 52. Source step 0047 field "0-3.0" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 53. Source step 0047 field "Drp List_Feet to Hydrant-need to check" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 54. Source step 0047 field "< 601" in "EQH||Location-provide other details and complete" was disabled. Reason:  
#    - Preserved source value: a blank value
# 55. Source step 0048 field "Manufactured Home Type" in "Home Characteristics_SD3/SD1-Cost Estimator info till Get Valuation" was disabled. Reason:  
#    - Preserved source value: "True"
# 56. Source step 0048 field "Singlewide" in "Home Characteristics_SD3/SD1-Cost Estimator info till Get Valuation" was disabled. Reason:  
#    - Preserved source value: "X"
# 57. Source step 0051 field "Btn_Close" in "RCT||Pop up-Save,Discard,Close" was disabled. Reason:  
#    - Preserved source value: a blank value
# 58. Source step 0056 field "Tenant" in "Home Characteristics_SD3/SD1-Property Information" was disabled. Reason:  
#    - Preserved source value: "X"
# 59. Source step 0060 field "Lbl_Roof UL Rating" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[5][1000px][None][HorizontalFirst][300ms]}"
# 60. Source step 0060 field "Btn_None_Roof UL Rating" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 61. Source step 0060 field "Btn_UL3" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 62. Source step 0060 field "Btn_Chk box_Roof Damaged or Needs repair including worn shingles or granule loss." in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 63. Source step 0060 field "Btn_Chk box_Roof is T-Lock or simliar Interlocking Shingle" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 64. Source step 0060 field "Btn_Chk box_Roof overlaid with more than two layers of shingles" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 65. Source step 0060 field "Btn_Chk box_Roof overlaid on wood shake or shingle" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 66. Source step 0060 field "Btn_Chk box_Wood roof overlaid on composition shingles" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[5][1000px][None][HorizontalFirst][300ms]}"
# 67. Source step 0060 field "Btn_Chk box_Include Loss Settlement for Roofs Damaged by Windstorm or Hail Endorsement" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "PGDN"
# 68. Source step 0060 field "Btn_NEXT" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 69. Source step 0061 field "Lbl_Roof UL Rating" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0061 field "Lbl_Roof UL Rating" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[5][1000px][None][HorizontalFirst][300ms]}"
# 71. Source step 0061 field "Btn_None_Roof UL Rating" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 72. Source step 0061 field "Btn_UL3" in "Home Characteristics-Roof Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 73. Source step 0062 field "Btn_ Add Other Structure" in "On Premise Exposures-Provide details regarding any exposures" was disabled. Reason:  
#    - Preserved source value: a blank value
# 74. Source step 0066 field "Btn_Chk box_AUTO-HOME" in "Discounts/Adjustments-Choose any discounts applied" was disabled. Reason:  
#    - Preserved source value: "True"
# 75. Source step 0066 field "Lbl_Three Line Discount?" in "Discounts/Adjustments-Choose any discounts applied" was disabled. Reason:  
#    - Preserved source value: "True"
# 76. Source step 0068 field "Txt_C.Personal Property" in "EQH||Coverages-Edit-Option 1-All Other Peril Deductible $3000" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[5][1000px][None][HorizontalFirst][300ms]}"
# 77. Source step 0071 field "Chk Box_Increase For Theft Of Service Sets_SH-91045" in "Additional Coverages-Add 'Theft Coverage On Dwelling Under Construction' coverage/endorsement" was disabled. Reason:  
#    - Preserved source value: a blank value
# 78. Source step 0071 field "Btn_NEXT" in "Additional Coverages-Add 'Theft Coverage On Dwelling Under Construction' coverage/endorsement" was disabled. Reason:  
#    - Preserved source value: "True"
# 79. Source step 0071 field "Btn_NEXT" in "Additional Coverages-Add 'Theft Coverage On Dwelling Under Construction' coverage/endorsement" was disabled. Reason:  
#    - Preserved source value: "X"
# 80. Source step 0075 field "Chk Box_Increase For Theft Of Service Sets_SH-91045" in "Additional Coverages-click next to move to Pricing Details" was disabled. Reason:  
#    - Preserved source value: a blank value
# 81. Source step 0077 field "Lbl_Proposal" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "True"
# 82. Source step 0077 field "Lbl_Coverage Option Overview" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "True"
# 83. Source step 0077 field "Lbl_Home Binder" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "True"
# 84. Source step 0077 field "Btn_Print/Open Home Binder document" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "X"
# 85. Source step 0077 field "Lbl_PDF Viewer-Proposal/CoverageOption/HomeBinder documents header" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "True"
# 86. Source step 0077 field "Btn_OK_PDF Viewer Close-Proposal/CoverageOption/HomeBinder documents" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "X"
# 87. Source step 0077 field "Btn_NEXT" in "Pricing Details-Verify Pricing summary and View Documents" was disabled. Reason:  
#    - Preserved source value: "{SCROLL[1][1000px][None][HorizontalFirst][300ms]}"
# 88. Source step 0079 field "Btn_ADD MORTGAGE / ADD'L INTEREST" in "Mortgage/Additional Interest-Add/Edit Additional Interest, if needed" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 89. Source step 0081 field "Btn_Direct Bill - 2 Payments" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "True"
# 90. Source step 0081 field "Btn_Direct Bill - 4 Payments" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "True"
# 91. Source step 0081 field "Txt_Due Date" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "True"
# 92. Source step 0081 field "Txt_Due Date" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 93. Source step 0081 field "Txt_Due Date" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "\"{DEL}\""
# 94. Source step 0081 field "Txt_Due Date" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "25"
# 95. Source step 0081 field "Lbl_Select a payment amount." in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: a blank value
# 96. Source step 0081 field "Btn_QUICK PAY" in "Billing-Create and Update Billing details" was disabled. Reason:  
#    - Preserved source value: "True"
# 97. Source step 0083 "Submission- Land on Submission page and UW referral" in module "EQ||Submission" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
...
# 98. Source step 0084 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
#    - INPUT "Duration" with "8000"
# 99. Source step 0085 "OpenUrl" in module "OpenUrl" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
...
# 100. Source step 0086 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 101. Source step 0087 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 102. Source step 0088 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 103. Source step 0089 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
#    - VERIFY "Lbl_Login ID" with "True"
# 104. Source step 0090 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
...
# 105. Source step 0091 "EU||Home" in module "EU||Home" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
...
# 106. Source step 0092 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:03 [ct2452]
#    - INPUT "Duration" with "12000"
# 107. Source step 0093 "Close the Express UI page/tab in browser" in module "TBox Send Keys" was disabled. Reason: 08.03.24 16:39:53 [ct2452]
#    - INPUT "Caption" with "Home*"
#    - INPUT "Keys" with "^(w)"
# 108. Source step 0094 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Title" with "Home"
# 109. Source step 0095 "EQH||Quote Actions-Save and Exit the current Quote" in module "EQH||Side Menu and Quote Actions" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Btn_QUOTE ACTIONS" with "X"
#    - WAIT "Btn_Quote Actions_Save and Exit" with "True"
#    - INPUT "Btn_Quote Actions_Save and Exit" with "X"
# 110. Source step 0096 "Search for the Quote in EQ" in module "EQ||New Quote" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
...
# 111. Source step 0097 "EQH||Side Menu and Quote Actions-Navigate to Submission page" in module "EQH||Side Menu and Quote Actions" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Submission" with "{Click}"
# 112. Source step 0098 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Duration" with "5000"
# 113. Source step 0099 "Submission- Launch to Checklist" in module "EQ||Submission" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - VERIFY "Hdr_Submission Header" with "True"
...
# 114. Source step 0100 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Duration" with "10000"
# 115. Source step 0101 "Verify eChecklist Sign on page showed up" in module "EQH||eChecklist-Sign On" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - VERIFY "Lbl_Sign On" with "True"
#    - VERIFY "Btn_Sign On" with "True"
# 116. Source step 0102 "Provide the Sign on credentials" in module "EQH||eChecklist-Sign On" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
...
# 117. Source step 0103 "eChecklist-Click the documents/links in the checklist" in module "EQH||eChecklist-Home Page" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - WAIT "H4" with "True"
...
# 118. Source step 0104 "eChecklist-TBox Save As-Upload sample pdf document from shared path" in module "TBox Save As" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Caption" with "Open*"
#    - INPUT "FilePath" with "\\\\fs1\\public\\Tosca\\PL DC Automation\\Samplechecklist3.pdf"
#    - INPUT "Button" with "Open"
# 119. Source step 0105 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Duration" with "10000"
# 120. Source step 0106 "eChecklist-Verify if 'Application' links in the checklist are completed" in module "EQH||eChecklist-Home Page" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - VERIFY "Drag and Drop files here to upload (or click here to open a file explorer)" with "True"
# 121. Source step 0107 "eChecklist-Click the drag/drop link to upload the file in the checklist" in module "EQH||eChecklist-Home Page" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - WAIT "H4" with "True"
#    - INPUT "Drag and Drop files here to upload (or click here to open a file explorer)" with "{Click}"
# 122. Source step 0108 "TBox Wait" in module "TBox Wait" was disabled. Reason: 19.03.24 12:52:29 [ct2452]
#    - INPUT "Duration" with "2000"
# 123. Source step 0109 "eChecklist-TBox Save As-Upload sample pdf document from shared path" in module "TBox Save As" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Caption" with "Open*"
#    - INPUT "FilePath" with "\\\\fs1\\public\\Tosca\\PL DC Automation\\Samplechecklist3.pdf"
#    - INPUT "Button" with "Open"
# 124. Source step 0110 "Close the eChecklist page/tab in browser" in module "TBox Send Keys" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Caption" with "American*"
#    - INPUT "Keys" with "^(w)"
# 125. Source step 0111 "TBox Wait" in module "TBox Wait" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Duration" with "10000"
# 126. Source step 0112 "Verify eChecklist opened Pop up is shown on submission page" in module "EQH||eChecklist-Pop up" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - VERIFY "Header_Checklist Opened" with "True"
# 127. Source step 0113 "Click OK to close the eChecklist opened Pop up" in module "EQH||eChecklist-Pop up" was disabled. Reason: 20.03.24 17:54:10 [ct2452]
#    - INPUT "Btn_Ok" with "{Invoke[Click]}"
# 128. Source step 0115 "Submission-Transmit and issue Policy" in module "EQ||Submission" was disabled. Reason: 17.03.24 18:43:15 [ct2452]
#    - VERIFY "Hdr_Submission Header" with "True"
#    - WAIT "Lbl_Step 3. Attach Supporting Documentation" with "True"
...
#    - VERIFY "Btn_Save and Exit_1" with "True"
# 129. Source step 0117 "Transmit Confirmation-Get Policy Number, Premium details" in module "EQH||Transmit Confirmation" was disabled. Reason: 17.03.24 18:43:21 [ct2452]
...
#    - INPUT "Submission" with "{Click}"
# 130. Source step 0119 field "Data structure > PolicyNumber" in "TestData-Save PolicyNumber, Premium and other details to TDM" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Policy Number"
# 131. Source step 0119 field "Data structure > Premium" in "TestData-Save PolicyNumber, Premium and other details to TDM" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 132. Source step 0119 field "Data structure > EffectiveDate" in "TestData-Save PolicyNumber, Premium and other details to TDM" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Effective Date"
# 133. Source step 0120 field "Data structure > PolicyNumber" in "TestData-Save PolicyNumber, Date to TDM for Post XML validation" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Policy Number"
# 134. Source step 0120 field "Data structure > EffectiveDate" in "TestData-Save PolicyNumber, Date to TDM for Post XML validation" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Effective Date"
#
