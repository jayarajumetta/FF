# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 190_FFCIC_New_Business_Auto_Group_4_Prior_Eff_Date_4-1-24_CT.feature
...
Feature: Execute FFCIC New Business Auto Group 4 Prior Eff Date_4-1-24 for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Auto Group 4 Prior Eff Date_4-1-24 workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Auto Group 4 Prior Eff Date_4-1-24 using representative iteration Connecticut (CT)
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf8f-2c85-4df5-921d45e5827c
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf8f-4195-c9da-7d0c09a5057c
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf8f-1c90-fde1-aa7ad3b06406
    Then I wait until "Loading ..." exists

    # Source step 0093: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf8f-f214-05da-c9d1791130d4
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf8f-72be-656f-97b801308a6c
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf9f-9b2a-3f8d-21ae40eeb466
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf9f-eebb-a749-fcb545dd61b6
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Auto_PriorEffDate_4-1-24"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b9730-cf9f-43ef-aa10-bb0134a6064e
    When I close the active browser
