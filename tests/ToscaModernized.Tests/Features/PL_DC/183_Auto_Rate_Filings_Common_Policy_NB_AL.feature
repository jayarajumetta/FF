# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 183_Auto_Rate_Filings_Common_Policy_NB_AL.feature
...
Feature: Execute Auto Rate Filings Common Policy NB for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Auto Rate Filings Common Policy NB workflow for the selected source iteration
  ...
  Scenario: Auto Rate Filings Common Policy NB using representative iteration Alabama (AL)
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d4a-bb9f-bc97-db5a3acf5ee4
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d4a-a96a-c0fd-e7c37037f1fd
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d4a-3ada-4b67-82a66947926d
    Then I wait until "Loading ..." exists

    # Source step 0103: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d4a-2f0b-b0f7-2ed4d3c8a620
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d4a-1289-73bc-860c883ba576
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d7a-ff05-b86e-f022f5d7be35
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d7c-33e2-ff4e-8bedbeedab38
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Auto_PolicyData_RateFilings_CommonAuto"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1cfb4e-9d7c-f6d8-3827-cda17ea1a8c9
    When I close the active browser
