# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 003_Activity_Points_-_At_fault_Auto_-_OH_OH.feature
...
Feature: Execute Activity Points - At fault (Auto) - OH for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - At fault (Auto) - OH workflow for the selected source iteration
  ...
  Scenario: Activity Points - At fault (Auto) - OH using representative iteration Ohio (OH)
    # Source step 0030: Enter Client Selection | Module: EQ || Client Selection
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-bb2d-99a8-39e5d61c51c9
    ...
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-a238-2189-4fc1cec7d812
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-8822-b2a6-15f88b9a8db9
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-4569-26b1-d7a9eee4da93
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-6b0e-3288-e1c6f2f0b3bf
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-3de4-168a-b144018ca9ba
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-fb9b-763b-7a033bb03db7
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-d83e-399d-1f7f8bd1cd5f
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-2126-4331-542f84ae361c
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-6ba8-1d89-b8ca59494c98
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-ac1d-ac13-fd0df37c615b
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-2c1e-2f37-7a79b5867d5e
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-135a-6416-8f599d988254
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-cd19-50be-0bc5795bafe8
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0044: Verify - If prior insurance is visible | Module: EQ||Driver Summary
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-5d0b-5806-f9deb8e8c349
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-919e-0ea3-83804c4c8fa3
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c27-0fe6-ae34-635254cc8f04
    # Runtime control: If_Driver Sumary_Prior Insurance > Enter details in prior insurance page
    When if the source runtime condition "If_Driver Sumary_Prior Insurance > Enter details in prior insurance page" is satisfied, I click "Btn_Primary Named Insured"
    Then I wait until "Txt_Years Licensed in Current State" is enabled
    When I select "Txt_Years Licensed in Current State"
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-fe9c-ea21-4f27f8fdb132
    When I click "Btn_Next"

    # Source step 0049: Verify vehicles are visible | Module: EQ||Vehicle Information
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-49d7-194c-c7f5d549b57e
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-a1ce-328d-a43e53b355a0
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-8e5b-7bc3-44fbf70545f0
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-10f7-3666-504ecfbbe703
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-30ab-b737-04b45211f881
    # Runtime control: Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details
    Then if the source runtime condition "Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details" is satisfied, "Lbl_VIN LABEL" should exist
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-8037-985b-5eff7d361b49
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-6d76-9e7a-6aaf83e36253
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-a5b7-e324-7c80a638ec85
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-5183-02d8-ddc85e73aa27
    # Runtime control: Driver Summary-UW Popup > Driver Summary-Enter Driver Summary Details
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-c8a4-87a7-fc75aa889d9d
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-d514-5b02-b9c3e67291b6
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-11a0-697c-a38947149ea1
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-5d62-5e32-d6af4d5c3faf
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-a4c6-ba6a-c932be8f9467
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-f366-f1b4-e8fb11fc6b6d
    When I click "Btn_Next"

    # Source step 0065: Verify if coverage is visible | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-c1cd-be73-0a5ef46600ce
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-7284-0588-cdbedc44d81f
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-920c-4fed-0c0ca504c409
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0068: Verify if Additional Coverage is visible | Module: EQ||Additional Coverages
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-84d8-9c0b-49b038323957
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-b68e-245c-e8933b7485fe
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-0438-37be-e79a139003dd
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-6128-fe50-ccdd2e55f533
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-568f-e011-dad607364d24
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-ac0f-6eb1-9ce3d3bf6fad
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0074: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-4802-c69f-99b95803b418
    ...
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-e9ff-733f-23c07604c25d
    When I click "btn_Next"
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-ea79-c88b-c4c78d6c0cc5
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-eba7-f179-1bb510d13787
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-a003-0ff9-b01f83727fa1
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-d617-bb1f-fd13f1bed8fe
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-1e35-b3a8-a9c8a7dc8a67
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-befb-5109-63c8ac7851c0
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-aa8d-e6ac-0afdff00641e
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-1ccd-4587-c14588d9408f
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-6aec-de12-c1737cd6f158
    # Runtime control: Submission-Check for Refer UW Condition > Enter Agent comments
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-454d-8dd8-3da20e03e86f
    # Runtime control: Submission-Check for Refer UW Condition > Enter Agent comments
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-5c3d-33c8-a8a752421b7c
    # Runtime control: Submission-Check for Refer UW Condition > Enter Agent comments
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-e688-5958-38b62cd69d7c
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-ad28-35c5-4becbd1bbbeb
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-7d5c-6bac-89196ec13ca9
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-c808-468d-2686ce95e127
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-f4ec-7a0e-ff013b315f4f
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-fa38-81a0-c5e94cf88064
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-ab75-95e5-79606a059bc7
    # Runtime control: Upload the remaining Checklist documents [max=30] > Loop
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-4a96-7e95-d08ded5dbdb8
    When I close the active browser

    # Source step 0145: Back to Submission page and click ok | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-a5fa-ef88-2aff0667490b
    Then I wait until "Btn_Ok" exists
    When I click "Btn_Ok"

    # Source step 0146: Submission-Transmit and issue Policy | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-8586-14b1-4535aa16dcd3
    ...
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-4900-7b3c-9acffdc78412
    ...
    # Section: Process > Generating Auto Policy > 15 Transmit  | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-f6c0-41ed-11438d1630e3
    ...
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-8ea3-ef3b-08cca2a88aa3
    ...
    And I use TDM parameter "Data structure > TestCase" with "Activity Points - At fault (Auto) - OH"
    ...
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-d509-0a7a-9c09d54787c5
    ...
    And I use TDM parameter "Data structure > EffectiveDate" with captured runtime value "Effective Date"
    And I use TDM parameter "Data structure > Date_Time" with the RUNTIME-DERIVED date from Tosca expression "{DATE} {TIME}"
    And I use TDM parameter "Data structure > TestCaseName" with "Activity Points - At fault (Auto) - OH"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "OH"
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-7945-6457-2ff0823f5027
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-cf94-f806-ee4bb5134952
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-cf0f-4a77-8f58814d9435
    When I enter or select "\"^{a}\"" in "Txt_Search Text"
    When I enter captured runtime value "Policy Number" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0159: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c2e-7fe0-c32c-3d446227173a
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-3f2d-2358-ca3fc5be538f
    Then I wait until "Btn_ViewPolicy" exists
    When I click "Btn_ViewPolicy"

    # Source step 0161: EU||Transact | Module: EU||Transact
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-dec9-527d-e31dcec3a46c
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-a177-bd79-6fae71f2b0d3
    ...
    # Source step 0163: EU||Applicant | Module: EU||Applicant
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-cb61-cffa-31e643310c93
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0164: EU||Pricing | Module: EU||Pricing
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-0bdf-7d75-e1abd2c24789
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-e09d-3751-9ae35d4b689b
    When I close the active browser

    # Source step 0166: Verify Activity Points is 5 or not | Module: TBox Evaluation Tool
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-09ed-3910-b07b5f3355a1
    ...
    # Source step 0167: Activity points for Atfault_OH is as Expected | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-f7ca-fe9a-8cc932353f62
    # Runtime control: Evaluating Activity Points is 5 or not > Activity points for Atfault_OH is as Expected
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Activity points for Atfault_OH is as Expected" is satisfied, I retain hard-coded value "Activity points for Atfault_OH is as Expected" as runtime value "Activity Point_OH"

    # Source step 0168: Activity points for At fault_OH is as Fail | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-1ab5-407c-d618c0ada81d
    # Runtime control: Evaluating Activity Points is 5 or not > Activity points for At fault_OH is as Fail
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Activity points for At fault_OH is as Fail" is satisfied, I retain hard-coded value "Activity points for At fault_OH is as Fail" as runtime value "Activity Point_OH"
...
#    - Preserved source value: "X"
# 7. Source step 0032 field "Lbl_United Farm Family Insurance Co." in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
...
#    - Preserved source value: "X"
# 10. Source step 0048 field "Btn_Add Additional Driver" in "Click Next" was disabled. Reason:  
#    - Preserved source value: "X"
# 11. Source step 0052 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 12. Source step 0052 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 13. Source step 0052 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 14. Source step 0052 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 15. Source step 0053 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 16. Source step 0053 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 17. Source step 0053 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 18. Source step 0053 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 19. Source step 0064 field "Btn_D1_No" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "X"
# 20. Source step 0064 field "Hdr_Discounts page" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 21. Source step 0070 field "Btn_UMPD Limits" in "Enter Additional Coverages Details & Continue" was disabled. Reason:  
#    - Preserved source value: "No Coverage_1"
# 22. Source step 0075 field "Btn_Next" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 23. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "True"
# 24. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 25. Source step 0077 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 26. Source step 0078 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 27. Source step 0079 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 28. Source step 0080 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 29. Source step 0084 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 30. Source step 0085 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 31. Source step 0086 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 32. Source step 0116 field "Txt_Agent_Cmnts_Refer to UW_3" in "EQ||Submission" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[Review Completed]}"
# 33. Source step 0118 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 34. Source step 0119 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 35. Source step 0120 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 36. Source step 0122 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 37. Source step 0122 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 38. Source step 0126 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 39. Source step 0126 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 40. Source step 0126 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 41. Source step 0126 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 42. Source step 0127 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 43. Source step 0127 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 44. Source step 0127 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 45. Source step 0127 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 46. Source step 0128 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 47. Source step 0128 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 48. Source step 0128 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 49. Source step 0128 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 50. Source step 0129 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
# 51. Source step 0130 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 52. Source step 0136 "Verify ExpressUI Sign on page showed up" in module "EU||Login" was disabled. Reason: 14.12.23 20:50:20 [ct2518]
#    - VERIFY "Lbl_Login ID" with "True"
#    - VERIFY "Lbl_Password" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - VERIFY "Lnk_LOGIN" with "True"
# 53. Source step 0137 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 54. Source step 0137 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "YD2102"
# 55. Source step 0137 field "Txt_Password" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 56. Source step 0138 "Provide Sign on credentials" in module "EU||Login" was disabled. Reason: 14.12.23 20:51:55 [ct2518]
#    - INPUT "Txt_Login ID_1" with "\"^{a}\""
#    - INPUT "Txt_Login ID_1" with "CT2451"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "X"
# 57. Source step 0141 field "H4" in "eChecklist-Verify if 'Application' links in the checklist are completed" was disabled. Reason:  
#    - Preserved source value: "True"
# 58. Source step 0142 field "H4" in "eChecklist-Click the 'drag/drop' link to upload the documents in the checklist" was disabled. Reason:  
#    - Preserved source value: "True"
# 59. Source step 0153 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 60. Source step 0154 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 61. Source step 0155 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 62. Source step 0160 field "Btn_Yes" in "EU||Transact" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 63. Source step 0170 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 64. Source step 0171 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 65. Source step 0172 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 66. Source step 0173 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 67. Source step 0174 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 68. Source step 0175 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 69. Source step 0176 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 70. Source step 0177 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 71. Source step 0178 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#
# RECOVERY BEHAVIOR FROM TOSCA — automation support, not normal manual business flow
# Recovery scenario: Recovery Scenario - Take screenshot, EQ sign out and Close browser
# 1. Source recovery step 0001 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\Activity Points - At fault (Auto) - OH_{DATE[][][MM/dd/yyyy]}_{TIME}"
