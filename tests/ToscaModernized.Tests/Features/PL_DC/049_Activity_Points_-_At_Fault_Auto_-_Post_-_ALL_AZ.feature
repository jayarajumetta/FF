# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 049_Activity_Points_-_At_Fault_Auto_-_Post_-_ALL_AZ.feature
...
Feature: Execute Activity Points - At Fault (Auto) -  Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - At Fault (Auto) -  Post - ALL workflow for the selected source iteration
  ...
  Scenario: Activity Points - At Fault (Auto) -  Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-97e1-5dab-52a064c40dcf
    When I enter or select "CT2628" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0011: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-ac5e-4d1c-1af165d5c57d
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-674f-5cbe-2df46293ec0a
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-2787-4653-9ef6780ee710
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-7fef-4f3b-54e5d4702a7b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-e863-9e28-8e4eccba0145
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-c074-6299-e6e9f5ed5d7a
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-09e9-4de2-229cd97fdc50
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-3555-2d26-e8c76bb512d8
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a46-8881-2cdf-9cdaa5b71962
