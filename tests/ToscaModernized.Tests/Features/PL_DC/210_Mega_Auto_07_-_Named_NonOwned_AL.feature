# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 210_Mega_Auto_07_-_Named_NonOwned_AL.feature
...
@PL_DC @Auto @mega_policy @Alabama @Edge @manual @automated
Feature: Execute Mega Auto 07 - Named NonOwned for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto 07 - Named NonOwned workflow for the selected source iteration
  ...
  Scenario: Mega Auto 07 - Named NonOwned using representative iteration Alabama (AL)
    # Source step 0012: Click on New Quote button | Module: EQ||New Quote
    # Section: Process > 01 Client Selection & Account Details for New Client > Start New Quote | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Common | 01 EQ - Start New Quote | Source XTestStep: 3a19dd55-d443-6b95-2414-e782dd27e3e3
    ...
    # Section: Process > 01 Client Selection & Account Details for New Client | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Auto | 01 EQ | Client Selection (NEW) | Source XTestStep: 3a19dd55-d49d-6991-8246-f114ce750615
    ...
    # Section: Process > 01 Client Selection & Account Details for New Client | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Auto | 01 EQ | Account Details (NEW) | Source XTestStep: 3a1a96b2-e11f-e48e-9f6e-bb78c0d69fc1
    ...
    # Section: Process > 01 Client Selection & Account Details for New Client | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Auto | 01 EQ | Account Details (NEW) | Source XTestStep: 3a19dd55-d4bb-5344-2b53-6fbb792cb2ce
    ...
    # Section: Process > 01 Client Selection & Account Details for New Client | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Auto | 01 EQ | Account Details (NEW) | Source XTestStep: 3a20ccea-6d87-3233-e1a5-8febbb16c0cb
    ...
    # Section: Process > 01 Client Selection & Account Details for New Client | Reusable flow: Auto | 01 EQ | Client Selection & Account Details for New Client_1 > Auto | 01 EQ | Account Details (NEW) | Source XTestStep: 3a20cced-453c-5ea2-16e9-ff5272653480
    ...
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4bb-e587-62b8-b699125e7a84
    When I retain hard-coded value "AL" as runtime value "State"
    When I retain hard-coded value "ANPAC" as runtime value "Company"
    When I retain hard-coded value "Pleasure/Work Use" as runtime value "Vehicle Summary"

    # Source step 0077: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4bb-1c03-cee6-677d6d29f4ec
    When I select "More Options_Vehicle Type"
    When I select "Named Non-Owned"
    When I click "Pleasure" when "State == \"CA\" OR State == \"KS\"" is satisfied

    # Source step 0078: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4bb-d039-185c-953cca60a6de
    # Runtime control: If OK Native American Tribe > Condition
    Then if the source runtime condition "If OK Native American Tribe > Condition" is satisfied, "Is this vehicle registered with a Federally recognized Native American tribe?" should exist

    # Source step 0079: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4bb-d8f8-c6b2-e232a9870b44
    # Runtime control: If OK Native American Tribe > Then
    When if the source runtime condition "If OK Native American Tribe > Then" is satisfied, I select "Native_American_Register_NO"
    When I click "Save and Continue"
    When I click "CONTINUE"

    # Source step 0081: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-df97-d89a-48c72065ee6d
    # Runtime control: If Total Annual Mileage exists > Condition
    Then if the source runtime condition "If Total Annual Mileage exists > Condition" is satisfied, "Total Annual Mileage" should exist

    # Source step 0082: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-7a00-bb39-70fb46119c06
    # Runtime control: If Total Annual Mileage exists > Then
    When if the source runtime condition "If Total Annual Mileage exists > Then" is satisfied, I enter or select "50" in "Total Annual Mileage Value"

    # Source step 0083: EQ||Vehicle Summary Auto/Motor Home Use | Module: EQ||Vehicle Summary Auto/Motor Home Use
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-ce76-a7d4-2264a3d73090
    # Runtime control: If NJ Title Transfer exists > Condition
    Then if the source runtime condition "If NJ Title Transfer exists > Condition" is satisfied, "Title_transfer_No" should be visible

    # Source step 0084: EQ||Vehicle Summary Auto/Motor Home Use | Module: EQ||Vehicle Summary Auto/Motor Home Use
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-6530-52da-ff07b9cc7129
    # Runtime control: If NJ Title Transfer exists > Then
    When if the source runtime condition "If NJ Title Transfer exists > Then" is satisfied, I select "Title_transfer_Yes"

    # Source step 0085: EQ|| Vehicle Summary Named NonOwned | Module: EQ|| Vehicle Summary Named NonOwned
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-e593-664a-40b489e6f1dd
    When I click "Save and Continue"
    When I click "CONTINUE"

    # Source step 0086: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 05 Vehicle Summary | Reusable flow: Auto | 05 EQ | Vehicle Summary Named NonOwned | Source XTestStep: 3a19dd55-d4ca-b360-7e63-234bfe079a4a
    Then I wait until "Loading ..." exists

    # Source step 0087: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0088: EQ || CA Verified Mileage | Module: EQ || CA Verified Mileage
    ...
    # Source step 0089: EQ||Vehicle Summary Next/Add  | Module: EQ||Vehicle Summary Next/Add 
    ...
    # Source step 0090: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain hard-coded value "2025 Named NonOwned" as runtime value "Driver 1 Vehicle"
    ...
    # Source step 0091: (New) EQ || Multiple Driver Assignment_1 | Module: (New) EQ || Multiple Driver Assignment
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a5211-21ed-502d-1b19-7bf787017564
    ...
    # Source step 0093: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a5211-21ed-8c31-0ead-885ef822497c
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a5211-21ed-cbb6-9eaa-122dc40b3743
    Then I wait until "Loading ..." exists

    # Source step 0095: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a5211-21ed-8c95-2433-7eaabdf15669
    ...
    # Source step 0096: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a5211-21ed-df76-9bb7-d429ee4af3c7
    ...
    # Source step 0098: Check for claims/violations needing edited | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0099: Edit Item(s) | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0100: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0101: If Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0102: Edit Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0103: Edit Violation | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0104: Check for PopUp | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0105: Select Continue | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0106: Next | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0107: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0109: EQ||Discount - Rate Tier Questions | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0113: EQ||Discount | Module: EQ||Discount(NEW)
    ...
    # Source step 0116: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain the unresolved source parameter "V1_CompDed" (not supplied by this reusable-block invocation) as runtime value "V1_CompDed"
    ...
    When I retain the unresolved source parameter "V1_CollDed" (not supplied by this reusable-block invocation) as runtime value "V1_CollDed"
    ...
    # Source step 0117: Select Policy Coverage Option | Module: Coverages (New)
    ...
    # Source step 0118: Edit Coverage Option | Module: Edit Coverage Option (New)
    ...
    # Source step 0120: Navigate down screen to V1 | Module: Coverages (New)
    ...
    # Source step 0121: Select V1 Coverages | Module: Coverages (New)
    ...
    # Source step 0122: Navigate down screen to V2 | Module: Coverages (New)
    ...
    # Source step 0123: Select V2 Coverages | Module: Coverages (New)
    ...
    # Source step 0124: Navigate down screen to V3 | Module: Coverages (New)
    ...
    # Source step 0125: Select V3 Coverages | Module: Coverages (New)
    ...
    # Source step 0126: Navigate down screen to V4 | Module: Coverages (New)
    ...
    # Source step 0127: Select V4 Coverages | Module: Coverages (New)
    ...
    # Source step 0138: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0139: EQ || Other Policy Coverages Section | Module: EQ || Other Policy Coverages Section (New)
    ...
    # Source step 0140: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0141: EQ || Personal Injury Protection Section  | Module: EQ || Personal Injury Protection Section (New)
    ...
    # Source step 0142: TBox Set Buffer | Module: TBox Set Buffer
    ...
    When I retain the unresolved source parameter "Roadside Assistance Coverage_V1" (not supplied by this reusable-block invocation) as runtime value "Roadside Assistance Coverage_V1"
    ...
    # Source step 0143: EQ || Vehicle Coverages Section | Module:  EQ || Vehicle Coverages Section
    ...
    # Source step 0144: Additional Coverages Next | Module: EQ || Additional Coverages Next (New)
    ...
    # Source step 0145: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 11 Pricing | Reusable flow: Auto | 11 EQ | Named NonOwned_Pricing Page  | Source XTestStep: 3a19dd55-d4bb-50d7-ce00-80997d56e99f
    Then I wait until "Loading ..." exists

    # Source step 0146: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    # Section: Process > 11 Pricing | Reusable flow: Auto | 11 EQ | Named NonOwned_Pricing Page  | Source XTestStep: 3a19dd55-d4bb-5b33-4424-f5b616b7eaba
    Then I wait until "Header Pricing Details" exists
    When I click "Next"

    # Source step 0147: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0148: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0149: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0150: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0152: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0153: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0154: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0162: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0163: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0182: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0185: EU||Home | Module: EU||Home
    ...
    # Source step 0186: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0187: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0188: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0189: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0190: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0191: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0195: OpenUrl | Module: OpenUrl
    ...
    # Source step 0199: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0200: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0201: EU||Home | Module: EU||Home
    ...
    # Source step 0202: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0203: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0204: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0205: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0206: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0209: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0210: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0211: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0213: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0214: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0215: TBox Save As | Module: TBox Save As
    ...
    # Source step 0216: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0218: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0219: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0220: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0221: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0222: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b2b12-a78d-3550-2daf-13aa6b259d6c
    When I capture "InnerText" from "Policy Number" as runtime value "Policy Number"

    # Source step 0223: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b2fee-e45f-a235-d49b-0f745878bc5c
    When I derive and retain the RUNTIME-DERIVED buffer expression "{STRINGREPLACE[{B[Policy Number]}][\"PERSONAL AUTO \\(\"][\"\"]}" as runtime value "Policy Number"

    # Source step 0224: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b2b12-a78d-2324-460f-3ead2d565c11
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Auto_PolicyData_NamedNonOwned"
    ...
    # Source step 0225: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b2b12-a78d-dd6b-356a-30f1f63fb82a
    When I close the active browser
...
#    - CONTAINER "Coverages" with "Named NonOwned"
...
#    - CONTAINER "Coverages" with "Named NonOwned"
# 18. Source step 0080 "EQ|| Vehicle Summary Named NonOwned" in module "EQ|| Vehicle Summary Named NonOwned" was disabled. Reason: 23.04.25 15:16:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Save and Continue" with "X"
#    - INPUT "CONTINUE" with "X"
# 19. Source step 0102 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 20. Source step 0110 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Less than $15,000/$30,000" with "{Click}"
# 21. Source step 0128 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 22. Source step 0129 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 23. Source step 0130 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 24. Source step 0131 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 25. Source step 0132 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 26. Source step 0133 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 27. Source step 0134 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 28. Source step 0135 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 29. Source step 0136 "TBox Set Buffer" in module "TBox Set Buffer" was disabled. Reason: 24.04.25 08:48:12 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Tort Option" with the unresolved source parameter "Tort Option" (not supplied by this reusable-block invocation)
#    - INPUT "Income Loss Coverage" with the unresolved source parameter "Income Loss Coverage" (not supplied by this reusable-block invocation)
#    - INPUT "UMPD" with the unresolved source parameter "UMPD" (not supplied by this reusable-block invocation)
#    - INPUT "UIMPD" with the unresolved source parameter "UIMPD" (not supplied by this reusable-block invocation)
#    - INPUT "AD&D Coverage" with the unresolved source parameter "AD&D Coverage" (not supplied by this reusable-block invocation)
#    - INPUT "Inc Liab Claims Fam Mem" with the unresolved source parameter "Inc Liab Claims Fam Mem" (not supplied by this reusable-block invocation)
#    - INPUT "Extraordinary Medical Benefit" with the unresolved source parameter "Extraordinary Medical Benefit" (not supplied by this reusable-block invocation)
# 30. Source step 0137 "EQ || Other Policy Coverages Section" in module "EQ || Other Policy Coverages Section (New)" was disabled. Reason: 24.04.25 08:48:12 [pa2096@dnanico1.aniconet.com]
#    - WAIT "H1_Additional Coverages" with "True"
#    - INPUT "Tort Option" with "{home}x"
#    - INPUT "Income Loss Coverage" with "{Home}x"
#    - INPUT "UMPD" with "X"
#    - INPUT "UIMPD" with "X"
#    - WAIT "AD&D Coverage" with "True"
#    - INPUT "AD&D Coverage" with "{Click}{scroll[3]}"
#    - INPUT "AD&D_Driver1" with "X"
#    - INPUT "AD&D_Driver2" with "X"
#    - INPUT "AD&D_Driver3" with "X"
#    - INPUT "AD&D_Driver4" with "X"
#    - INPUT "AD&D_Driver5" with "X"
#    - INPUT "Loss Of Income_Driver1" with "True"
#    - INPUT "Loss Of Income_Driver2" with "True"
#    - INPUT "Loss Of Income_Driver3" with "True"
#    - INPUT "Loss Of Income_Driver4" with "True"
#    - INPUT "Loss Of Income_Driver5" with "True"
#    - INPUT "Total Disability Coverage_Driver1" with "X"
#    - INPUT "Inc Liability Claims of Family Members" with "X"
#    - INPUT "Extraordinary Medical Benefit" with "X"
#    - INPUT "Work_Loss_No" with "X"
# 31. Source step 0143 field "Cycle Accessories_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 32. Source step 0143 field "Original Parts_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 33. Source step 0143 field "Endorsement Limit V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1398 $5,000"
# 34. Source step 0143 field "Cycle Accessories_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 35. Source step 0143 field "Original Parts_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 36. Source step 0143 field "Endorsement Limit V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1399 $7,000"
# 37. Source step 0152 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 38. Source step 0155 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 39. Source step 0156 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 40. Source step 0157 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 41. Source step 0158 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 42. Source step 0165 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 43. Source step 0166 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 44. Source step 0167 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 45. Source step 0168 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 46. Source step 0169 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 47. Source step 0170 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 48. Source step 0171 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 49. Source step 0172 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 50. Source step 0173 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 51. Source step 0174 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 52. Source step 0175 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 53. Source step 0176 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 54. Source step 0177 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 55. Source step 0178 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 56. Source step 0179 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 57. Source step 0180 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 58. Source step 0181 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 59. Source step 0184 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 60. Source step 0184 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 61. Source step 0192 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 62. Source step 0193 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 63. Source step 0194 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 64. Source step 0196 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 65. Source step 0197 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 66. Source step 0198 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 67. Source step 0200 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 68. Source step 0200 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 69. Source step 0204 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0204 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 71. Source step 0204 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 72. Source step 0204 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 73. Source step 0205 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 74. Source step 0205 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 75. Source step 0205 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 76. Source step 0205 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 77. Source step 0206 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 78. Source step 0206 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 79. Source step 0206 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 80. Source step 0206 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 81. Source step 0207 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 82. Source step 0208 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 83. Source step 0213 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 84. Source step 0217 "TBox Wait" in module "TBox Wait" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "30000"
# 85. Source step 0224 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 86. Source step 0224 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
#
