# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 186_Cycle_Rate_Filings_Policy_3_NB_Prior_Eff_Date_AL.feature
...
@PL_DC @Cycle @manual_conversion @Alabama @Edge @manual @automated
Feature: Execute Cycle Rate Filings Policy 3 NB_Prior Eff Date for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Cycle Rate Filings Policy 3 NB_Prior Eff Date workflow for the selected source iteration
  ...
  Scenario: Cycle Rate Filings Policy 3 NB_Prior Eff Date using representative iteration Alabama (AL)
    ...
    When I enter the unresolved source parameter "First Name" (not supplied by this reusable-block invocation) in "Txt_First"
    When I enter the unresolved source parameter "Last Name" (not supplied by this reusable-block invocation) in "Txt_Last"
    ...
    When I enter the unresolved source parameter "DOB" (not supplied by this reusable-block invocation) in "Txt_DOB"
    ...
    When if the source runtime condition "If SSN Pop Up Confirm Exist > Else > If SSN Pops Up > Then" is satisfied, I enter the unresolved source parameter "SSN" (not supplied by this reusable-block invocation) in "Txt_SSN"
    ...
    When I enter the unresolved source parameter "Drivers License #" (not supplied by this reusable-block invocation) in "Driver's License Number" when "'Drivers License #' != NULL" is satisfied
    ...
    When I enter or select "1HD1FCM10DB623649" in "txt_VIN"
    ...
    When I enter or select "1HD1CAN14HY114419" in "VIN"
    ...
    When I enter or select "5,919" in "Agreed Value"
    ...
    Then I wait until "VIN" is enabled
    When I enter the unresolved source parameter "VIN 3" (not supplied by this reusable-block invocation) in "VIN"
    When I press "Tab" while focused on "VIN"
    When I click "Veh 3"
    ...
    When I enter the unresolved source parameter "Agreed Value Veh 3" (not supplied by this reusable-block invocation) in "Agreed Value"
    ...
    When I enter or select "\"^{a}\"" in "Total_annual_mileage"
    When I enter the unresolved source parameter "Annual Mileage Veh 3" (not supplied by this reusable-block invocation) in "Total_annual_mileage"
    When I click "Save_Continue"
    ...
    When I retain hard-coded value "2013 Harley Davidson FLHTCU UL CLSC" as runtime value "Driver 1 Vehicle"
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5a9-9147-a744-1a4380a4cc1f
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5a9-c5a8-d1d9-9ca25f6f06c9
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5a9-b7e2-b228-425df4a9215b
    Then I wait until "Loading ..." exists

    # Source step 0106: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5a9-648c-c7ea-a8fba24fbc39
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5a9-5ff8-0591-8ff937d1d982
    ...
    When I retain hard-coded value "Yes" as runtime value "Safe Cycle Discount"
    ...
    When I enter or select "08.01.2025" in "Safe Cycle Discount Date"
    ...
    When I retain hard-coded value "$40 Per Day" as runtime value "Rental Reimbursement Coverage_V1"
    ...
    When I retain hard-coded value "$40 Per Day" as runtime value "Rental Reimbursement Coverage_V2"
    ...
    # Source step 0156: EQ || Cycle Underwriting | Module: EQ || Cycle Underwriting
    # Section: Process > 12 Underwriting | Reusable flow: Auto | 12 EQ | Underwriting Page Cycle | Source XTestStep: 3a1cb2c8-4b7d-ac72-26f2-69e03c99e7fa
    Then I wait until "Have you or any household member ever been convicted of a felony?" exists
    When I select "No"
    Then I wait until "Is any Vintage cycle garaged in a different location?" exists
    When I select "No_1"
    When I click "Next"

    # Source step 0157: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0159: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0164: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0165: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0166: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0167: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0168: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0169: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0187: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0188: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0189: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0190: EU||Home | Module: EU||Home
    ...
    # Source step 0191: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0192: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0193: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0195: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0196: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0200: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0201: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0202: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0203: TBox Save As | Module: TBox Save As
    ...
    # Source step 0204: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0206: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0207: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0208: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0209: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0210: TBox Save As | Module: TBox Save As
    ...
    # Source step 0211: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0213: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0214: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0215: CloseBrowser | Module: CloseBrowser
    ...
    # Source step 0216: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0217: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0219: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5c6-8b2c-86c4-a82ead8c28ad
    When I capture "InnerText" from "Policy Number" as runtime value "Policy Number"

    # Source step 0220: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5c6-305b-1101-5a5aefb416cf
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Cycle_PolicyData_RateFilings_PriorEffDate"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1c990c-b5c6-899e-31e6-d7ea8fd1fa97
    When I close the active browser
...
#    - INPUT "First Name_Driver1" with the unresolved source parameter "First Name" (not supplied by this reusable-block invocation)
#    - INPUT "Last Name_Driver1" with the unresolved source parameter "Last Name" (not supplied by this reusable-block invocation)
...
#    - INPUT "SSN" with the unresolved source parameter "SSN" (not supplied by this reusable-block invocation)
...
# 48. Source step 0157 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 49. Source step 0160 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 50. Source step 0161 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 51. Source step 0162 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 52. Source step 0163 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 53. Source step 0170 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 54. Source step 0171 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 55. Source step 0172 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 56. Source step 0173 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 57. Source step 0174 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 58. Source step 0175 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 59. Source step 0176 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 60. Source step 0177 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 61. Source step 0178 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 62. Source step 0179 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 63. Source step 0180 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 64. Source step 0181 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 65. Source step 0182 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 66. Source step 0183 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 67. Source step 0184 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 68. Source step 0185 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 69. Source step 0186 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 70. Source step 0189 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 71. Source step 0189 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 72. Source step 0197 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 73. Source step 0198 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 74. Source step 0199 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 75. Source step 0201 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 76. Source step 0205 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 77. Source step 0212 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 78. Source step 0218 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:26 [pa2096@dnanico1.aniconet.com]
...
# 79. Source step 0220 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 80. Source step 0220 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 81. Source step 0221 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:31 [pa2096@dnanico1.aniconet.com]
