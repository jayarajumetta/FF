# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 159_Mega_Auto_Policy_02_-_ALL_-_PostValidation_AZ.feature
...
Feature: Execute Mega Auto Policy 02 - ALL - PostValidation for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto Policy 02 - ALL - PostValidation workflow for the selected source iteration
  ...
  Scenario: Mega Auto Policy 02 - ALL - PostValidation using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-ea56-6d0d-fa0165a41cfd
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-6623-2b3f-885cfb41efb6
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-08ea-a6eb-c18ff916e3fe
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-5dfc-5c6c-bf2a63fa0ec0
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-c963-2e8e-409daada3c52
    When I retain hard-coded value "Mega Auto Policy 02-AZ" as runtime value "TCName"

    # Source step 0018: TBox Save As_1-To Upload the file | Module: TBox Save As
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-7ced-d133-a2fa5882182b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-8993-877a-791608914a19
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-bcba-d008-c2ae747f7979
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-2c92-63dd-e61b2cd9364d
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-1c83-6aa2-d60a9180a901
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f45-1a9c-18f7-cb74763aad2b
    When I close the active browser
