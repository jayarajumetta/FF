# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 188_FFCIC_New_Business_Auto_Group_2_Future_Eff_Date_CT.feature
...
Feature: Execute FFCIC New Business Auto Group 2 Future Eff Date for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Auto Group 2 Future Eff Date workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Auto Group 2 Future Eff Date using representative iteration Connecticut (CT)
    ...
    When I retain hard-coded value "Farm Family Casualty Insurance Co." as runtime value "Company"
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a66c0-172e-8250-a1a7-9e23d37217a6
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a66c0-172e-207e-5911-d71bf402b8d5
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a66c0-172e-c1f6-099e-eb35db98fd87
    Then I wait until "Loading ..." exists

    # Source step 0093: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a66c0-172e-403f-ce7c-b6b71bc60047
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a66c0-172e-a847-eebd-208ddcb35e8d
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1abedc-9731-bfee-705c-3edcb7d0c716
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a66c0-173d-e431-deec-44a6b901b8d3
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Auto_FutureEffDate"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a66c0-174d-e127-1d9e-519ed3d759a4
    When I close the active browser
