# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 064_New_Business_Eligibility_-_Cycle_-_Post_-_ALL_AZ.feature
...
Feature: Execute New Business Eligibility - Cycle - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the New Business Eligibility - Cycle - Post - ALL workflow for the selected source iteration
  ...
  Scenario: New Business Eligibility - Cycle - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-01e0-204d-443350744202
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-7081-e101-4c3e5b716ead
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-c960-eaff-fa90b91adf49
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-e8b2-10bc-e0dc6649fb99
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-ca44-d23e-37d260cf9dba
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-9e45-bcab-40b143e64866
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-f659-9bd3-fc806259d0a8
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-ecc8-9132-429bb7eaf33d
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3bc0-941a-e3d0-2d28b828b0e9
