# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 057_UW_Non-Renewal_-_Cycle_-_Post_-_ALL_AZ.feature
...
Feature: Execute UW Non-Renewal - Cycle - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Non-Renewal - Cycle - Post - ALL workflow for the selected source iteration
  ...
  Scenario: UW Non-Renewal - Cycle - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b02-0069-eadf-f486b7876d36
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-32cb-fa50-fb5577655424
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-028e-576c-56e374931925
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-d7a0-5f95-659c527d4bd1
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-9d35-a5b1-1e735d56a7be
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-36e6-84d9-27c2bf4ee3a4
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-ea5a-f669-7b753a4f0569
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-2ec2-a009-145704a02d18
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-3329-12ea-4ea80c4847b7
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-9a81-8d00-e7a30c52e4df
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b03-fab8-c017-f5efe2d9ea50
    When I close the active browser
