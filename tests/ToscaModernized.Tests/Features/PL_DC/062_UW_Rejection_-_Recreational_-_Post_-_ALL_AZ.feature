# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 062_UW_Rejection_-_Recreational_-_Post_-_ALL_AZ.feature
...
Feature: Execute UW Rejection - Recreational - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Rejection - Recreational - Post - ALL workflow for the selected source iteration
  ...
  Scenario: UW Rejection - Recreational - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-e55a-d388-6eac58d69ff2
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-2393-8637-6a188f48f068
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-b66f-bddb-2fc6f7013211
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-b286-27e5-5032426f3ada
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-aa0b-4a7a-5c0f54e5a0d7
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-260e-3825-6e958c89556b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-95fd-7fbb-764c682d031b
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-491e-7b14-1814263810d2
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b82-f2fa-545e-1e7784d26b58
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b90-6e48-15a0-5cc553e3411a
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b90-4be1-941c-db3996fef970
    When I close the active browser
