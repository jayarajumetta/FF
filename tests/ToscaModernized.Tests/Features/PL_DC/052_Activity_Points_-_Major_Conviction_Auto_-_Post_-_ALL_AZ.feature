# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 052_Activity_Points_-_Major_Conviction_Auto_-_Post_-_ALL_AZ.feature
...
Feature: Execute Activity Points - Major Conviction (Auto) - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Major Conviction (Auto) - Post - ALL workflow for the selected source iteration
  ...
  Scenario: Activity Points - Major Conviction (Auto) - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-e3e0-eb92-79a39643157a
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-87fa-a6cc-2f8bd44e7e71
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-7e6c-50e4-590e0181da75
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-1ab9-1733-430a94413436
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-88f8-5efa-7cc7d67f5380
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a77-5fc1-05fc-c0d266a57660
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a84-81de-77e3-b8c063e381ac
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a84-86c4-f632-ee3899f873cc
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a84-e026-4fb8-67db0e055163
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a84-e3c1-3294-fdb2c1847ef2
    ...
    # Section:  Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3a84-7730-ffcd-538aea07ae87
    When I close the active browser
