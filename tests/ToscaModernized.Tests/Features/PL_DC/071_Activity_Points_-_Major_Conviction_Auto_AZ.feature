# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 071_Activity_Points_-_Major_Conviction_Auto_AZ.feature
...
Feature: Execute Activity Points - Major Conviction (Auto) for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Major Conviction (Auto) workflow for the selected source iteration
  ...
  Scenario: Activity Points - Major Conviction (Auto) using representative iteration Arizona (AZ) — selected from TestCase-Design; no concrete instantiated TestCase was exported
    # Source step 0010: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-e611-5a30-09fdc140b61f
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-7431-4aff-aca969847d1f
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-3073-203e-386fd99da3c0
    # Runtime control: Enter Sign On Credentials > Then
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-6e9c-ff86-13e6a25c9697
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-6f9d-2e6f-8c1489f5ee89
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-0574-9e1a-aa1d3fd9d3f3
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-0eb6-eb93-9fba526a1e2a
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-0a52-5d78-bd02115c2ef0
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-1277-b461-b51e228372ca
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-29c0-43a9-4dbd45011276
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-73be-1c98-ffd7a8ff4f38
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-75d2-67c6-b81611a01b27
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-0def-f6d2-031243b5cd86
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-a1cf-4bb6-15eed0629051
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-5367-3c52-cbdae096b140
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-7921-477b-311c8544db0f
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-5ecb-9b46-60f3d5985a43
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-5ba0-01fc-eb45a16a6c82
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0030: EQ||Driver Summary | Module: EQ||Driver Summary
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-bf08-8f0f-d1f46c363c8c
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-3393-2f0e-cb83cffeb0ac
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-6267-3a83-058f03e78220
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-53e9-5b5f-c0b4c18df2f3
    When I click "Btn_Next"

    # Source step 0035: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-3a4f-afdc-cba0f0d24010
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-95f1-3575-b0d46895f0e9
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c5e-fa91-604e-e8209bf0ba7c
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-8b75-197f-1f0235c68ef1
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-3ff8-7c4e-40289e39dce2
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-825f-0abd-ec7d9d7385fc
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-4de1-329b-84851897d985
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-a205-571a-ad2c61b29e12
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-0fc5-6fd7-8f2f9380847c
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-731c-bb11-e2035892e9b9
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-8a45-5f94-5cfffab3f965
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-00b6-200b-a4324a130612
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-332a-9b49-6c224a0b6f57
    When I click "Btn_Next"
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-d997-d7e5-b3a1a17f9abe
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0051: Additional Coverages_New | Module: EQ||Additional Coverages
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-8642-5b30-57095d5f96bc
    When I click "Btn_BASIC"
    When I click "Btn_Next"

    # Source step 0052: Enter Pricing Details | Module: EQ||Pricing Details
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-c6e3-dd6b-0ef814b7f2e1
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0053: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-d514-7458-d9cee06205b5
    When I click "<unnamed value>"
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-fb56-a4fd-38a4dbcb00bc
    When I click "btn_Next"

    # Source step 0056: Billing-Enter Billing Details & Continue | Module: EQ||Billing
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-43b6-f4a3-c41c5925e9e8
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-3fc9-bfd3-bef9992601a5
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-03d9-4cbc-e13d63f7ec63
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-63c8-1afe-631dc5ce694f
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-3769-7324-854c0780acd6
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-b73d-7d4b-9a9e9356efc3
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-2ff0-ccbd-07cbe6653b67
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-4889-5db7-37def7537b9d
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-8a8a-c9c5-4d9b7126ede5
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-8c32-7641-1c20694636d9
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-3fe2-a071-b2f1522f50dc
    ...
    # Section: Process > Cycle Policy > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-702a-80f8-b038f21571af
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0071: TBox Save As_1 | Module: TBox Save As
    # Section: Process > Cycle Policy > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-35f7-62d1-336ced43cc7f
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-db7a-ff0d-a65a05d86131
    When I close the active browser

    # Source step 0075: EQ||Submission_1 | Module: EQ||Submission
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-b2ea-6140-dd1f4a811bc0
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-b77c-8fdd-e081a89a3cb3
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-beff-3b5c-baf6b64980b9
    ...
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-0b18-32dd-1ed54d15d205
    When I click "Btn_Save and Exit"

    # Source step 0080: CloseBrowser | Module: CloseBrowser
    # Section: Process > Cycle Policy | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-187c-23cd-98e3f74a0a8c
    When I close the active browser
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-72cc-f3fa-1acc8b995e50
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-0bbf-bd89-ba49e88be595
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-b5cc-34b3-c121d1987d69
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-38b9-87ff-3efaf5e832ff
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-2d61-5951-12ee5839615f
    Then I wait until "Btn_ViewPolicy" exists
    When I click "Btn_ViewPolicy"

    # Source step 0090: EU||Transact | Module: EU||Transact
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-1d9e-8f18-72209818c5ff
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-ac70-aaf8-70b74b6556e8
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-76b5-32cf-e2acf9dd1344
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0093: EU||Pricing | Module: EU||Pricing
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-21ce-1ae6-07fa79da15c3
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-6d24-96a9-6fd2d2f99ce7
    When I close the active browser

    # Source step 0095: TBox Evaluation Tool | Module: TBox Evaluation Tool
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-e57e-f2e7-41073a907539
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-f8a7-da03-adbf54552dad
    ...
    # Section: Process > UW Non Renewal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3c6e-2b00-0b31-913e3362901c
