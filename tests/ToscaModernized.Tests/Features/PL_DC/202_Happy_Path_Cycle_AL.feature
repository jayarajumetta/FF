# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 202_Happy_Path_Cycle_AL.feature
...
@PL_DC @Cycle @happy_path @Alabama @Edge @manual @automated
Feature: Execute Happy Path Cycle for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Happy Path Cycle workflow for the selected source iteration
  ...
  Scenario: Happy Path Cycle using representative iteration Alabama (AL)
    ...
    When I enter the unresolved source parameter "VIN" (not supplied by this reusable-block invocation) in "VIN"
    ...
    When I retain hard-coded value "2014 Harley Davidson FLHXS" as runtime value "Driver 1 Vehicle"
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1d2-7c23-2d2e-edd492e62a8f
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1d2-7e54-561f-616bc3ac847f
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1d2-1a45-0ad3-ba0eb4360b59
    Then I wait until "Loading ..." exists

    # Source step 0077: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1d2-f063-b510-e516140f4f28
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1d2-b2ae-c42b-3c0ae69967d2
    ...
    # Source step 0117: EQ || Personal Injury Protection Section  | Module: EQ || Personal Injury Protection Section (New)
    ...
    # Source step 0118: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > 10 Additional Coverage | Reusable flow: Cycle || Additional Coverage | Source XTestStep: 3a19e1e5-0ccf-f89a-4b76-d36609aa2aca
    ...
    When I retain the unresolved source parameter "UMPD Coverage_Vehicle1" (not supplied by this reusable-block invocation) as runtime value "UMPD Coverage_Vehicle1"
    When I retain the unresolved source parameter "UMPD Coverage_Vehicle2" (not supplied by this reusable-block invocation) as runtime value "UMPD Coverage_Vehicle2"
    ...
    When I retain hard-coded value "No Coverage" as runtime value "ADD Coverage"

    # Source step 0119: ExpertQuote | Module: ExpertQuote
    # Section: Process > 10 Additional Coverage | Reusable flow: Cycle || Additional Coverage | Source XTestStep: 3a19e1e5-0ccf-c180-07c1-b2be399ee786
    Then I wait until "H1" exists
    When I click "Income Loss Coverage" when "'Income Loss Coverage' != NULL" is satisfied
    When I click "ADD Coverage" when "'ADD Coverage' != NULL" is satisfied
    When I select "Tort Option Value" when "'Tort Option' != NULL" is satisfied
    When I click "UMPD Coverage V1" when "'UMPD Coverage_Vehicle1' != NULL" is satisfied
    When I select "More Options_Uninsured/UnderInsured Motorists PD V1" when "'UMPD/UIMPD_V1' != NULL" is satisfied
    When I click "Uninsured/UnderInsured V1" when "'UMPD/UIMPD_V1' != NULL" is satisfied
    When I click "Rental Reimbursement V1" when "'Rental Reimbursement Coverage_V1' != NULL" is satisfied
    When I click "Theft Deductible V1" when "'Theft Deductible_V1' != NULL" is satisfied
    When I click "Roadside Assistance V1" when "'Roadside Assistance Coverage_V1' != NULL" is satisfied
    When I click "Next"
    ...
    # Source step 0187: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0188: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0189: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0190: TBox Save As | Module: TBox Save As
    ...
    # Source step 0191: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0193: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0195: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0196: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0197: Submission_1-Back to Submission page | Module: EQ||Submission
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1f1-12e3-8520-e1f66b6095b9
    ...
    # Source step 0198: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1f1-9d18-cec5-ddf8b057c26d
    ...
    And I use TDM parameter "Data structure > TestCase" with "TC03_Verify Policy in Expert Quote with 1 V 1 D for Cycle LOB"

    # Source step 0199: Submission_2-Save & Exit | Module: EQ||Submission
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1f1-85c8-0ae3-d9f172c6c693
    When I click "Btn_Save and Exit"

    # Source step 0200: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1a521e-f1f1-ce18-cbbb-9532e4d47cca
    When I close the active browser
...
#    - INPUT "Next" with "X"
# 25. Source step 0115 "Cycle Additional Coverages" in module "EQ|| Cycle| Additional Coverages" was disabled. Reason: 01.04.25 10:57:17 [pa3462@dnanico1.aniconet.com]
#    - WAIT "H1_Additional Coverages" with "True"
#    - INPUT "Full" with "X"
#    - INPUT "No Coverage_PIP KS, OR, TX" with "X"
#    - INPUT "Basic - $15,000 per person/$30,000 per accident_DE PIP" with "X"
#    - INPUT "IncomeLoss_No Coverage" with "X"
#    - INPUT "ADD_No Coverage AR" with "X"
#    - INPUT "Yes_Spouse Liability" with "X"
#    - INPUT "No_Spouse Liability" with "X"
#    - INPUT "BASIC_PIP" with "X"
#    - INPUT "No Deductible KY" with "X"
#    - INPUT "No" with "X"
#    - INPUT "No_UMPD VT" with "X"
#    - INPUT "ACV UM/UIMPD TX" with "X"
#    - INPUT "More Options UM/UIMPD OR" with "X"
#    - INPUT "More Options" with "X"
#    - INPUT "$100,000" with "X"
#    - INPUT "No UIMPD SC" with "X"
#    - INPUT "No UIMPD WV" with "X"
#    - INPUT "No Coverage_TransportationExpense VA" with "X"
#    - INPUT "No Coverage_RR" with "X"
#    - INPUT "No Coverage _Theft Deductible" with "X"
#    - INPUT "No Coverage T&L NY FFCIC" with "X"
#    - INPUT "No Coverage_Roadside" with "X"
#    - INPUT "Next" with "X"
# 26. Source step 0127 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 27. Source step 0130 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 28. Source step 0131 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 29. Source step 0132 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 30. Source step 0133 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 31. Source step 0140 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 32. Source step 0141 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 33. Source step 0142 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 34. Source step 0143 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 35. Source step 0144 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 36. Source step 0145 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 37. Source step 0146 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 38. Source step 0147 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 39. Source step 0148 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 40. Source step 0149 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 41. Source step 0150 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 42. Source step 0151 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 43. Source step 0152 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 44. Source step 0153 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 45. Source step 0154 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 46. Source step 0155 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 47. Source step 0156 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 48. Source step 0159 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 49. Source step 0159 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 50. Source step 0167 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 51. Source step 0168 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 52. Source step 0169 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
...
#    - INPUT "Duration" with "12000"
# 72. Source step 0188 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 73. Source step 0192 "TBox Wait" in module "TBox Wait" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "30000"
# 74. Source step 0197 field "Btn_Transmit" in "Submission_1-Back to Submission page" was disabled. Reason:  
#    - Preserved source value: "True"
# 75. Source step 0197 field "Btn_Transmit" in "Submission_1-Back to Submission page" was disabled. Reason:  
#    - Preserved source value: "Transmit"
# 76. Source step 0197 field "Btn_Transmit" in "Submission_1-Back to Submission page" was disabled. Reason:  
#    - Preserved source value: "X"
# 77. Source step 0198 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 78. Source step 0198 field "Data structure > State" in "TestData - Create & provide new item" was disabled. Reason:  
...
# 1. Source recovery step 0201 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Smoke\\TC03_Smoke_Auto_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 2. Source recovery step 0202 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 3. Source recovery step 0203 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 4. Source recovery step 0204 CloseBrowser: I close the active browser
# Recovery scenario: CleanUp Scenario - Take screenshot, EQ sign out and Close browser
# 5. Source recovery step 0205 TBox Take Screenshot of failure(during recovery run): I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Smoke\\TC03_Smoke_Auto_{DATE[][][MM/dd/yyyy]}_{TIME}"
# 6. Source recovery step 0206 Log Out from the ExpertQuote EQ: I click "Btn_Log Out icon"
#    And I wait until "Btn_Log Out pop-up" is visible
#    And I click "Btn_Log Out pop-up"
# 7. Source recovery step 0207 Wait Until EQ-Log In page shows up: I wait until "Txt_Username_1" is visible
#    And I wait until "Btn_Sign On_1" is visible
# 8. Source recovery step 0208 CloseBrowser: I close the active browser
