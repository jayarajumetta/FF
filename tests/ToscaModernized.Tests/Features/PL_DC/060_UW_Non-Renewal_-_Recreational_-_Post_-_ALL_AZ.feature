# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 060_UW_Non-Renewal_-_Recreational_-_Post_-_ALL_AZ.feature
...
Feature: Execute UW Non-Renewal - Recreational - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Non-Renewal - Recreational - Post - ALL workflow for the selected source iteration
  ...
  Scenario: UW Non-Renewal - Recreational - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-1e1a-8a42-b4f3979e44b0
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-0776-3e10-3df7f4dcbd5b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-ab9c-c12f-2500d7d9627d
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-f77f-2af2-9a33a571a64e
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-a085-c658-e045e3aeb043
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-d5cc-27f5-e63265a259b0
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-522b-63b6-a0b5bca2074f
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-d5ef-51a4-5b99ff0b1d8f
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-00ac-6c31-cce90ff9adae
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-a101-41b5-7ac8cbde53e5
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b51-af92-a18f-c84c7b4b1c64
    When I close the active browser
