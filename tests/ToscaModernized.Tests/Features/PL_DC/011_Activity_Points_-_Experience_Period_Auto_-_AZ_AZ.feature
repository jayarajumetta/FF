# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 011_Activity_Points_-_Experience_Period_Auto_-_AZ_AZ.feature
...
Feature: Execute Activity Points - Experience Period (Auto) - AZ for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - Experience Period (Auto) - AZ workflow for the selected source iteration
  ...
  Scenario: Activity Points - Experience Period (Auto) - AZ using representative iteration Arizona (AZ)
    # Source step 0023: Client Selection-Enter Client Info of New or Exisiting Clients | Module: EQ || Client Selection
    # Section: Process > Generating Auto Policy > 01 Enter Client & Account Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-2029-d7ff-d15214435f8e
    ...
    # Section: Process > Generating Auto Policy > 01 Enter Client & Account Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-6a69-aaf8-addc90b03c16
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-30da-03fa-00bfe206a1af
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-943d-3664-a47580337580
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-0eb2-6fc4-2dd4be45942c
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d25-a20d-da7e-cd696f857002
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-0972-a004-e2f629ca1186
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-934d-d6c7-114d67e683a7
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-7328-4446-e378094efd46
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-08f8-b138-5bda4f8fe398
    ...
    # Section: Process > Generating Auto Policy > 03 Prequalification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-326b-8097-df563056561a
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-0a66-04b8-4ba5a7d2295d
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-70ae-d84d-4afe7da65f9f
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-ad94-47dd-6567ad238724
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-4eb0-ff76-a2c5eceb6efa
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-7a2a-9f5a-d3cb4b363064
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-2a9b-3d72-d4c6987c87ae
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-eb79-6292-0bd3c01d329e
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-6d4d-573e-99e7abaebbf2
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-d3d4-225e-9da0c2f36305
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-c3a3-8977-652e1058bd09
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0047: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-80f5-7e9e-b3ff5422030c
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-624e-9510-7810ec97a598
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-5870-4d62-e938d2fee575
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-2807-2b27-13eca99f8615
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d35-29f5-bbfb-99e2410bdbe1
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-1c97-1fcf-c98f32d5ffb4
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-be75-ff59-b914e6653845
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-fb18-67c8-fa7ec2e2f4aa
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-d1d5-78aa-caa8228134ee
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-4d88-b577-ae8167c37d38
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-ec03-f902-eaf4e2cc56c0
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-f6db-1b25-793087b8f9c4
    # Runtime control: Claims/Violations Popup > Then
    ...
    # Section: Process > Generating Auto Policy > 07 Claims & Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-75b9-c46b-38f3f46bdb82
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-2eb0-0ed3-12e2217d702b
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-5348-6f63-baa988007ae0
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-8b3e-06fe-7a6fbf257d9c
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-cc6b-ecf0-57552d14fb17
    ...
    # Section: Process > Generating Auto Policy > 10 Additional Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-fb1e-e045-0f743b682d89
    ...
    # Section: Process > Generating Auto Policy > 11 Pricing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-e2d8-620c-6d170417d869
    ...
    # Section: Process > Generating Auto Policy > 12 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-6070-d875-ebf732a56fdd
    ...
    # Section: Process > Generating Auto Policy > 12 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-faa6-0120-f6e3decb1981
    When I click "btn_Next"
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-12c1-8475-c8dda29aded0
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-bb45-1a85-b61729062708
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-1f00-f00c-71930c7c05ff
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-04a5-de2e-390e56f55415
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-c3a7-00c6-6ad10e54103a
    ...
    # Section: Process > Generating Auto Policy > 14 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-a41a-78dd-e5e5a287f7f7
    ...
    # Source step 0088: Launch To Checklist | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-7c3b-efbd-3dfceb767aba
    Then "Btn_Launch To Checklist" should exist
    When I click "Btn_Launch To Checklist"

    # Source step 0090: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-1474-edef-ad7a2a5a52cb
    ...
    # Source step 0092: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-14d1-de14-ee46ae58e465
    ...
    # Source step 0093: EQ||ECheckList | Module: EQ||ECheckList
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-6682-61e6-2a527505da86
    When I select "Lnk_No Need-Prior Ins"

    # Source step 0094: eChecklist-Verify if 'Application' links in the checklist are completed | Module: EQH||eChecklist-Home Page
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-f909-8721-902454cf356c
    ...
    # Source step 0095: eChecklist-Click the 'drag/drop' link to upload the documents in the checklist  | Module: EQH||eChecklist-Home Page
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-edff-8319-5aee59d4e85d
    ...
    # Source step 0096: eChecklist-TBox Save As-Upload sample pdf document from shared path | Module: TBox Save As
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-656d-defc-d7a638659b9a
    # Runtime control: Upload the remaining Checklist documents [max=30] > Loop
    ...
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-1414-f5fe-508bcae66912
    When I close the active browser

    # Source step 0098: Back to Submission page and click ok | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Launch Checklist > Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-f765-74fc-8aabe5fbd521
    ...
    # Source step 0100: Transmit Confirmation-Get Policy Number, Premium details | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-c6d7-e240-c2cb4a8f9113
    ...
    # Source step 0101: Push Quote Data & Policy Information to TDS_Reference | Module: TestData - Create & provide new item
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-b7b2-1441-fc992238db68
    ...
    # Source step 0102: Push Quote Data & Policy Information to TDS_Regression_Temp_Data | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 17 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-dabf-6fcd-af521f83267e
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-64f1-81f5-932dcba3e6d1
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-c68c-674c-871b26f1a2cf
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-196f-3aab-3fbc4ff950dc
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-2176-c623-555d790ed842
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-93c3-df1d-d802b06a1d9a
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0112: EU||Pricing | Module: EU||Pricing
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-7748-9a12-3d85b87dffd2
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-fe54-5ed9-c47a2ae4374b
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-0eb2-e7c9-69f63bb6a9d1
    ...
    # Section: Process > UW Non Renewal > Before 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-f905-273e-980cb253b1ff
    ...
    # Source step 0116: Click on Driver History | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-3f6a-34ff-cc19c0243b36
    When I click "Btn_Left arror Button"
    When I click "Lnk_Driver History"

    # Source step 0117: Click on Detail  | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-ee46-bb0b-94128fd5908d
    When I click "Lnk_Detail"

    # Source step 0118: Add over 36 months | Module: EU||Applicant
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-dae0-4932-107d62e8dcc1
    ...
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-a6b0-f9ce-0474ffe1f840
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0120: EU||Pricing | Module: EU||Pricing
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-fdde-c31c-abd82e8de8e5
    When I click "Btn_Activity Point Total"
    When I capture "InnerText" from "Hdr_DC-SECTION > Activitypoints Score" as runtime value "ActivityPoints"
    When I click "Btn_Close"

    # Source step 0121: TBox Evaluation Tool | Module: TBox Evaluation Tool
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-2dd1-1965-5ae566b0decd
    ...
    # Source step 0122: TBox Set Buffer | Module: TBox Set Buffer
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d3e-93c0-cf22-98641b412186
    ...
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d45-8433-bf45-0ce1923285c6
    ...
    # Source step 0124: Close the RCT Express Page | Module: CloseBrowser
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d45-edf6-59af-e6e360b62aaf
    When I close the active browser

    # Source step 0125: CloseBrowser | Module: CloseBrowser
    # Section: Process > UW Non Renewal > After 36 Months Capturing Experience period | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2d45-b0c1-3ec1-08a90630ded6
    When I close the active browser
    ...
    # Source step 0139: Log Out- Exist from the Quote/Policy | Module: EQ||Log Out
    ...
    # Source step 0140: CloseBrowser | Module: CloseBrowser
...
#    - INPUT "<unnamed value>" with "X"
# 27. Source step 0086 "EQ||Submission" in module "EQ||Submission" was disabled. Reason: 07.04.24 20:11:13 [ct2518]
#    - VERIFY "Txt_Agent_Cmnts_Refer to UW" with "True"
#    - VERIFY "Txt_Agent_Cmnts_Refer to UW_2" with "True"
# 28. Source step 0087 "EQ||Submission" in module "EQ||Submission" was disabled. Reason: 07.04.24 20:11:13 [ct2518]
#    - INPUT "Txt_Agent_Cmnts_Refer to UW" with "{Invoke[Click]}{SENDKEYS[Review Completed]}"
#    - INPUT "Btn_Refer to UW" with "{Invoke[Click]}"
# 29. Source step 0089 "Verify ExpressUI Sign on page showed up" in module "EU||Login" was disabled. Reason: 14.12.23 20:50:20 [ct2518]
#    - VERIFY "Lbl_Login ID" with "True"
#    - VERIFY "Lbl_Password" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - VERIFY "Lnk_LOGIN" with "True"
# 30. Source step 0090 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 31. Source step 0090 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "YD2102"
# 32. Source step 0090 field "Txt_Password" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 33. Source step 0091 "Provide Sign on credentials" in module "EU||Login" was disabled. Reason: 14.12.23 20:51:55 [ct2518]
#    - INPUT "Txt_Login ID_1" with "\"^{a}\""
#    - INPUT "Txt_Login ID_1" with "CT2451"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "X"
# 34. Source step 0094 field "H4" in "eChecklist-Verify if 'Application' links in the checklist are completed" was disabled. Reason:  
#    - Preserved source value: "True"
# 35. Source step 0095 field "H4" in "eChecklist-Click the 'drag/drop' link to upload the documents in the checklist" was disabled. Reason:  
#    - Preserved source value: "True"
# 36. Source step 0100 field "Lbl_Value_Effective Date" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "Effective Date"
# 37. Source step 0100 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "True"
# 38. Source step 0100 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "Transmit"
# 39. Source step 0100 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "X"
# 40. Source step 0104 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 41. Source step 0105 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 42. Source step 0106 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 43. Source step 0112 field "DIV_Risk Score" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "RiskScore"
# 44. Source step 0120 field "DIV_Risk Score" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "RiskScore"
# 45. Source step 0127 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 46. Source step 0128 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 47. Source step 0129 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 48. Source step 0130 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 49. Source step 0131 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 50. Source step 0132 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 51. Source step 0133 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 52. Source step 0134 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 53. Source step 0135 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#
