# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 191_FFCIC_New_Business_Auto_Group_5_AIC_Writing_Company_CT.feature
...
Feature: Execute FFCIC New Business Auto Group 5 AIC Writing Company for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Auto Group 5 AIC Writing Company workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Auto Group 5 AIC Writing Company using representative iteration Connecticut (CT)
    ...
    When I retain hard-coded value "Argonaut Insurance Co." as runtime value "Company"
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1adec5-84ca-ebc9-15e4-22b0f2cb1789
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1adec5-84ca-062f-b9a2-e411dc0a836e
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1adec5-84ca-687a-b8c8-492fab81c269
    Then I wait until "Loading ..." exists

    # Source step 0093: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1adec5-84ca-45b8-abff-24c4b2633aea
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1adec5-84ca-43eb-29bc-0ea3175e4fde
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1b927e-f9d6-f3b2-6464-dbc01011f92b
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1adec5-84fa-2e5e-7449-82aaa0f3c014
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Auto_AIC_WritingCompany"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1adec5-84fa-105b-efc3-7bae01300d3a
    When I close the active browser
...
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 87. Source step 0228 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 88. Source step 0228 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
#
