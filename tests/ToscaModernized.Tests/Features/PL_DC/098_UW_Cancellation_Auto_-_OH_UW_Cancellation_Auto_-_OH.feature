# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 098_UW_Cancellation_Auto_-_OH_UW_Cancellation_Auto_-_OH.feature
...
Feature: Execute UW Cancellation Auto - OH for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Cancellation Auto - OH workflow for the selected source iteration
  ...
  Scenario: UW Cancellation Auto - OH using representative iteration UW Cancellation Auto - OH
    # Source step 0009: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-9f73-ec0d-d7e20d6d25c9
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-4b40-711b-4b4255a97529
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-e0ff-7b14-fb90d58135a1
    ...
    # Section: Process > Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-3dd1-4503-911edf7b1959
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-1e68-aa3a-b1aa7bde5b78
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-fce6-5b64-9629143f9dad
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-377b-2139-1f485d5cddf8
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-7601-4bdd-e79604a3b419
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-bdad-e956-54405b3f83f3
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-e11e-13c0-6befcd96ec04
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-3c44-f229-b0f6aed2e6b6
    ...
    # Section: Process > Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-0d20-70b4-19a299391180
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-92eb-dbd1-182af028a067
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-90f2-5a57-d70b4b8be82a
    ...
    # Section: Process > Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-5722-699e-bf1c479e3437
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-55f5-e3b0-b13524f0adeb
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0029: EQ||Driver Summary | Module: EQ||Driver Summary
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-1df2-0b78-d1ed42c3e2b1
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-0c25-e48f-e06b0ee0f1b8
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-edce-1dc9-b9a7194f3aba
    ...
    # Section: Process > Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-1f34-6df6-1a79a7435f60
    When I click "Btn_Next"

    # Source step 0034: EQ||Vehicle Information | Module: EQ||Vehicle Information
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-11f0-dd82-2d4d34691244
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-9a89-a625-e0096eefa7b2
    ...
    # Section: Process > Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-4c80-8d9c-e2c48ed65674
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-3406-0246-05ad52cbd5ae
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-88c1-d539-6c65827b6b81
    ...
    # Section: Process > Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-75eb-4bbf-a0990005f13f
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-170b-daf9-4bb383528a75
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-6df7-20de-6d4602c42c2f
    ...
    # Section: Process > Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-0705-eb51-0e4bf2d58cd3
    ...
    # Section: Process > Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-dc67-8e3d-3de080800837
    When I click "Btn_Next"
    ...
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-1d0d-eab5-7119fee774cc
    ...
    # Section: Process > Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-44a9-443b-e3c766ac8d84
    ...
    # Section: Process > Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-086f-f695-b371b27b96df
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0049: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-a163-5ea6-ea4f90a05a0b
    When I click "<unnamed value>"
    ...
    # Section: Process > Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-279c-d0b4-9b6441eebedd
    When I click "btn_Next"
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-972b-a699-4c19a6a007c3
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-fe16-118f-36115a1e6534
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-967d-780c-9e10df05f58a
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-48de-98f0-94affe8e0df2
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-d4a0-5899-ef2844f92df3
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-f3cf-dd5b-6ba71a8be448
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-9851-e136-870aa89e48ed
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-337e-0bec-b9480c1b3c82
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-06b3-8bf3-aba89cd4f7a5
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-0bf3-664c-43f4c5a916a5
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-059f-3799-60c08eb7f067
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-4b31-6730-50ae873a3429
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-3e15-80ab-deb948080763
    ...
    # Section: Process > Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-308e-7f30-55b7-d8f4443b6010
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-52f6-0e8d-2dec11877247
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-35a3-dba1-f6288febb491
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-4405-b512-cc62d5a2d092
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-69ac-80cc-8ed9622cbd12
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-6516-91ac-94ccc59990e8
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-f847-1c10-94ec310a1ed0
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-a17e-0bdb-6e1e9d6a5d74
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-ae4d-86eb-f7fb56adb7e6
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-00c0-2c66-94778b3170ef
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-d17b-7af8-1a4c821f5780
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-eb38-3b27-1b698476a403
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-7a8a-8ece-447bf46253e9
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-4a7a-638e-004bb5500b6a
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 13 Submission > Express UI - UW Approval in Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-a4c6-56e9-e769d3972c28
    # Runtime control: Check UW comments for level 2 > Then-Enter Agent Comments and Proceed with Express UI
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-5da6-9eea-d8d0cb39d28b
    When I click "Btn_Launch To Checklist"

    # Source step 0119: Enter Sign On Credentials | Module: EQ||Sign On
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-1c2a-19c0-fbfe09662a47
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-6194-dabe-430ce83fcb64
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-b07c-8cf9-f67109cf3885
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-b0f9-a68a-1fae3d279de5
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-2b55-dc84-8c476a999d81
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-2865-3857-b9846db5c8ce
    When I click "DIV_Drag and Drop files here to upload (or click here to open a file explorer)"

    # Source step 0126: TBox Save As_1 | Module: TBox Save As
    # Section: Process > Auto Policy > 14 Launch Checklist > EU||Uploading_Docs | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-c7b4-578c-807c241ef6fb
    When I enter or select "Open" in "Caption"
    ...
    # Section: Process > Auto Policy > 14 Launch Checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-ce46-4239-df0eebd75d43
    When I close the active browser

    # Source step 0129: EQ||Click on Transmit | Module: EQ||Submission
    # Section: Process > Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-18b9-0ee7-f6910d85ed08
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-2f8a-068f-ec1ea6ae3da3
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-b1a3-7079-ba6b09535d44
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-3a58-c5d2-da152376619e
    ...
    # Section: Process > Auto Policy > 16 TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-c0b5-687f-fed408922ac1
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-31c8-a7a7-06ac0f54821e
    # Runtime control: If_ExpressUI Sign on page showed up or not > Condition - if signon page is displayed
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-0a29-1df2-772b0ac655a5
    # Runtime control: If_ExpressUI Sign on page showed up or not > Then - Enter Sign On Credentials
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-d1ea-a7da-c8524402e790
    ...
    # Section: Process > UW Cancellation > Launch Express UI | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-a21c-40b0-5f708e476edd
    When I click "Lnk_Insured Name"
    When I click "Lnk_PersonalAuto"

    # Source step 0158: Click Transaction Type | Module: EU|Transaction Type
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-3aac-bdf8-3bdaf2f322ab
    When I click "expand"
    When I click "Cancel"
    When I click "Go"

    # Source step 0159: Click Transaction Reason & Detailed Reason | Module: Check if Value too High appears
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-729c-cb06-96fac96e9943
    ...
    # Section: Process > UW Cancellation > UW Cancellation Transaction > Difference Between Two Dates | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-5740-9595-971246de2873
    ...
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-f2ea-7fa5-815de3297128
    When I enter or select "True" in "MVR_1"
    When I click "Schedule"

    # Source step 0174: TBox Wait | Module: TBox Wait
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-b80b-54a4-7673c07e1e46
    When I wait "5000" milliseconds

    # Source step 0175: Close the Express UI Page | Module: CloseBrowser
    # Section: Process > UW Cancellation > UW Cancellation Transaction | Reusable flow: <none> | Source XTestStep: 3a19e1e5-309e-926a-5875-c56773b83939
    When I close the active browser
...
# 5. Source step 0011 "Enter Client Selection" in module "EQ || Client Selection" was disabled. Reason: 01.06.24 14:52:05 [ct2634]
...
# 6. Source step 0012 "Enter Account Details" in module "EQ||Account Details" was disabled. Reason: 01.06.24 14:52:05 [ct2634]
...
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 132. Source step 0151 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 133. Source step 0152 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 134. Source step 0153 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 135. Source step 0172 "Close Cancel Page" in module "Check if Value too High appears" was disabled. Reason: 13.06.24 19:11:15 [ct2634]
#    - INPUT "Exit Without Saving" with "X"
# 136. Source step 0176 "Click on Transmit Button" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:58 [ct2634]
#    - WAIT "Btn_Transmit" with "True"
#    - VERIFY "Btn_Transmit" with "Transmit"
#    - INPUT "Btn_Transmit" with "X"
# 137. Source step 0177 "Buffer Tranmit Premiums" in module "EQ||Submission" was disabled. Reason: 16.04.24 10:06:58 [ct2634]
...
#    - VERIFY "Btn_Transmit" with "Transmit"
#    - INPUT "Btn_Transmit" with "X"
# 138. Source step 0178 "TestData - Create & provide new item" in module "TestData - Create & provide new item" was disabled. Reason: 30.05.24 19:31:48 [ct2634]
...
#    - INPUT "Data structure > TestCase" with "UW Cancellation Auto - OH"
#    - INPUT "Data structure > Endorsement" with "N"
# 139. Source step 0179 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 30.05.24 19:31:48 [ct2634]
#    - INPUT "Title" with "ExpertQuote*"
#
# RECOVERY BEHAVIOR FROM TOSCA — automation support, not normal manual business flow
# Recovery scenario: Recovery Scenario - EQ sign out and close browser
# 1. Source recovery step 0180 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\UW Cancellation Auto_MD_{DATE[][][MM/dd/yyyy]}_{TIME}"
...
# 5. Source recovery step 0184 TBox Take Screenshot of failure(during recovery run): I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\UW Cancellation Auto_MD_{DATE[][][MM/dd/yyyy]}_{TIME}"
