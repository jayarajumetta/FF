# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 004_Activity_Points_-_At_fault_Auto_-_NJ_NJ.feature
...
Feature: Execute Activity Points - At fault (Auto) - NJ for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Activity Points - At fault (Auto) - NJ workflow for the selected source iteration
  ...
  Scenario: Activity Points - At fault (Auto) - NJ using representative iteration New Jersey (NJ)
    # Source step 0030: Enter Client Selection | Module: EQ || Client Selection
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-a2a6-c195-54498059d353
    ...
    # Section: Process > Generating Auto Policy > 01 Client Slection & Account Details for New Client | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-cd61-6f42-b648c6084b3c
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-db1f-b91f-d4f3e093b8c1
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-712b-866f-0128bc5d4496
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-688f-9b10-6f194f80e545
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-79f1-9d6d-21c299aebedb
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-a9a4-f5f7-9738cad147b4
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-c4e2-ee6e-37a3dd90c774
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-fcbf-fe7b-e918290d0785
    ...
    # Section: Process > Generating Auto Policy > 02 Proposal Start | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-5050-2f32-4a923519c567
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-75db-545a-8f22e0dc5eca
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-910d-b73d-8cf1084c8535
    ...
    # Section: Process > Generating Auto Policy > 03 Pre-Qualification | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-5b46-1704-5379f34167e1
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-9ffc-cc5c-d3a0a9b8ff96
    When I click "Btn_(Existing Client)"
    When I click "Btn_Next"

    # Source step 0044: Verify - If prior insurance is visible | Module: EQ||Driver Summary
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-b713-30e5-3f07a3d82bfc
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-d67b-a69d-fd8ba2b4c0fe
    ...
    When I enter or select "{Invoke[Click]}{SENDKEYS[62084761007]}" in "Btn_priorPolicyNumber"
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-8dfa-e716-cc773eab6449
    # Runtime control: If_Driver Sumary_Prior Insurance > Enter details in prior insurance page
    When if the source runtime condition "If_Driver Sumary_Prior Insurance > Enter details in prior insurance page" is satisfied, I click "Btn_Primary Named Insured"
    Then I wait until "Txt_Years Licensed in Current State" is enabled
    When I select "Txt_Years Licensed in Current State"
    ...
    # Section: Process > Generating Auto Policy > 04 Driver Information | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-9e01-7113-f07fd6b8d3ab
    When I click "Btn_Next"

    # Source step 0049: Verify vehicles are visible | Module: EQ||Vehicle Information
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-a2bf-8117-1e532dd335b3
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-8461-d41b-49fe7711e90e
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-562d-da78-900662dbf8c1
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-f43d-2ce9-f6ae6788267a
    ...
    # Section: Process > Generating Auto Policy > 05 Vehicle Summary | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-474f-ef47-75113658db29
    # Runtime control: Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details
    Then if the source runtime condition "Vehicle Summary-Enter Vehicle Summary Details - Conditional > Enter Vehicle Summary Details" is satisfied, "Lbl_VIN LABEL" should exist
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-b1c4-d6be-d83a49ee84c0
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-603f-1c20-f9aee73fcf4f
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-f450-73f2-22c6bec0000e
    ...
    # Section: Process > Generating Auto Policy > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-a2dd-9f86-ab2245b3b60d
    # Runtime control: Driver Summary-UW Popup > Driver Summary-Enter Driver Summary Details
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c3a-cb8d-8ce7-937e4c37d2f3
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-5c2a-db04-b0809e89fc48
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-17f9-8ae6-9c91a0be387d
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-eb32-18f0-dd89924076d8
    # Runtime control: Claims/Violations Popup > Add Claim 
    ...
    # Section: Process > Generating Auto Policy > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9734-e7e3-ecbb4b153535
    ...
    # Section: Process > Generating Auto Policy > 08 Discounts | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-330d-5f19-a46391a05cbc
    When I select "Btn_Not Residential Property Owner"
    When I click "Btn_Next"

    # Source step 0065: Verify if coverage is visible | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-a245-c13d-238bac179725
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-d609-fcd4-a5e960c622ad
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-29da-f53f-0089cfe1c7b5
    When I click "<unnamed value>"
    When I click "<unnamed value>"
    When I click "<unnamed value>"

    # Source step 0068: Verify if Additional Coverage is visible | Module: EQ||Additional Coverages
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-3f17-27e7-d790c43c50a6
    ...
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-74eb-6b31-4c227e28639e
    ...
    # Source step 0070: Enter Additional Coverages Details | Module: EQ||Additional Coverages
    # Section: Process > Generating Auto Policy > 09 Coverages | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-5226-3e01-34c987abdb1e
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9968-48d5-86a48c4ae8a7
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9f19-992d-4f5583c5d79a
    ...
    # Section: Process > Generating Auto Policy > 10 Pricing | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-4626-229e-8059f5ac4029
    Then I wait until "Btn_Next" is visible
    When I click "Btn_Next"

    # Source step 0074: Enter Underwriting | Module: <unresolved module>
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-d75f-84ae-546328ee1054
    ...
    # Section: Process > Generating Auto Policy > 11 Underwriting & Additional Interest | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9409-f1c5-61ec2608da30
    When I click "btn_Next"
    ...
    # Section: Process > Generating Auto Policy > 12 Billing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9f9f-1e6e-969ee1ca138d
    ...
    # Source step 0082: Click on VIOLATION DETAIL - MVR VIOLATION CODE | Module: EQ||Claims\Violations
    # Section: Process > Generating Auto Policy > 12 Billing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-19a6-c058-716bd8f54e1a
    ...
    # Source step 0083: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > Generating Auto Policy > 12 Billing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-dd66-b723-b91231e9ec09
    # Runtime control: VIOLATION DETAIL - MVR VIOLATION CODE > Then
    ...
    # Section: Process > Generating Auto Policy > 12 Billing Details | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-1876-caf1-f88a7fea424e
    # Runtime control: VIOLATION DETAIL - MVR VIOLATION CODE > Then
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-a6d0-e8d1-7b6e0033aeb6
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-807f-d54d-b0fe5db4e278
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-4647-039a-a1b9ee47ad1c
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-dd11-5cb4-9ae20fa82b7d
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9519-263a-677c372fae14
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-27a6-dc1d-b776938ff38e
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-0e92-daba-e478026de206
    ...
    # Section: Process > Generating Auto Policy > 13 Submission | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-2740-6b52-68c8cdd9b8e1
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-6f0e-14e2-12a4fc7d2dba
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-2d66-8df3-e024d1dce5be
    # Runtime control: Submission-Check for Refer UW Condition > Then
    ...
    # Section: Process > Generating Auto Policy > 13 Submission > Save and Exit Current Quote | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-138b-6139-fd668d2d1c81
    # Runtime control: Submission-Check for Refer UW Condition > Then
    When if the source runtime condition "Submission-Check for Refer UW Condition > Then" is satisfied, I click "Submission"

    # Source step 0139: Launch To Checklist | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-950e-c835-29a1544c388b
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-0e47-e571-ccc46f30c7a7
    ...
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-eda2-59b4-07ec835f949d
    ...
    # Source step 0144: Clicn on Agent in checklist | Module: EQ||ECheckList
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-26e8-9c86-dd7776a6cc4b
    When I click "Lnk_Auto/Cycle/RV Application"

    # Source step 0145: eChecklist-Verify if 'Application' links in the checklist are completed | Module: EQH||eChecklist-Home Page
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-c404-93f0-db1315fa9ed1
    ...
    # Source step 0146: eChecklist-Click the 'drag/drop' link to upload the documents in the checklist  | Module: EQH||eChecklist-Home Page
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-72cb-3aeb-48c2122942bc
    ...
    # Source step 0147: eChecklist-TBox Save As-Upload sample pdf document from shared path | Module: TBox Save As
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-e1c7-dddd-319963fe84de
    # Runtime control: Upload the remaining Checklist documents [max=30] > Loop
    ...
    # Source step 0148: CloseBrowser | Module: CloseBrowser
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-dc03-416f-2e44ea8d6824
    When I close the active browser

    # Source step 0149: Back to Submission page and click ok | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 14 Launch checklist | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-ac8b-5e12-06ee4cb9e2fa
    Then I wait until "Btn_Ok" exists
    When I click "Btn_Ok"

    # Source step 0150: Submission-Transmit and issue Policy | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-30f8-aa6e-7fcaafbe084b
    ...
    # Source step 0152: Transmit Confirmation-Get Policy Number, Premium details | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-7b36-e69f-82e4f4888963
    ...
    # Source step 0153: Click on Save and Exit | Module: EQ||Submission
    # Section: Process > Generating Auto Policy > 15 Transmit | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-2813-fad5-0f50912dd5d5
    When I click "Btn_Save and Exit"

    # Source step 0154: Push Quote Data & Policy Information to TDS_Reference | Module: TestData - Create & provide new item
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-7d6a-35a1-fe88e65ac82e
    ...
    And I use TDM parameter "Data structure > TestCase" with "Activity Points - At fault (Auto) - NJ"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "NJ"

    # Source step 0155: Push Quote Data & Policy Information to TDS_Regression_Temp_Data | Module: TestData - Create & provide new item
    # Section: Process > Generating Auto Policy > TDS Validation | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-1c42-7aa8-b57eaa33b49b
    ...
    And I use TDM parameter "Data structure > EffectiveDate" with captured runtime value "Effective Date"
    And I use TDM parameter "Data structure > Date_Time" with the RUNTIME-DERIVED date from Tosca expression "{DATE} {TIME}"
    And I use TDM parameter "Data structure > TestCaseName" with "Activity Points - At fault (Auto) - NJ"
    And I use TDM parameter "Data structure > Endorsement" with "N"
    And I use TDM parameter "Data structure > State" with "NJ"
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-3634-b030-e295395577c0
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-7ccc-2c75-8a524e207a34
    ...
    # Source step 0162: Search  Policy Number | Module: EU||Home
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-a91c-c55a-af9f645e0b27
    When I enter or select "\"^{a}\"" in "Txt_Search Text"
    When I enter captured runtime value "Policy Number" in "Txt_Search Text"
    When I click "Btn_Search"

    # Source step 0163: Click on Auto | Module: EU|Home/Motorcycle/PersonalAuto
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-26ee-634e-db56d6324148
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-da34-6718-ac01cfbea97c
    Then I wait until "Btn_ViewPolicy" exists
    When I click "Btn_ViewPolicy"

    # Source step 0165: EU||Transact | Module: EU||Transact
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-4a6c-3a59-5031572618ce
    ...
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-5e8f-f646-c9a674e1b119
    ...
    # Source step 0167: Click Pricing | Module: EU||Applicant
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-768b-ceb6-adac923bd20c
    When I click "Btn_Ok"
    When I click "Lnk_Pricing"

    # Source step 0168: Buffer Activity points | Module: EU||Pricing
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-5a5b-16e2-a0199040981d
    ...
    # Source step 0169: Close the RCT Express Page | Module: CloseBrowser
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-d0a2-25c9-773c563df3de
    When I close the active browser

    # Source step 0170: Verify Activity Points is 5 or not | Module: TBox Evaluation Tool
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-8a37-6760-b53eb56300a2
    # Runtime control: Evaluating Activity Points is 5 or not > Verify Activity Points is 5 or not
    Then if the source runtime condition "Evaluating Activity Points is 5 or not > Verify Activity Points is 5 or not" is satisfied, "Expression" should equal the RUNTIME-DERIVED buffer expression "'{B[ActivityPoints]}'=='5'"

    # Source step 0171: Activity points for At fault_NJ is as Expected | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-b241-faa6-9a62b420ed9e
    # Runtime control: Evaluating Activity Points is 5 or not > Activity points for At fault_NJ is as Expected
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Activity points for At fault_NJ is as Expected" is satisfied, I retain hard-coded value "Activity points for At fault_NJ is as Expected" as runtime value "Activity Point_NJ"

    # Source step 0172: Activity points for At  fault_NJ is as Fail | Module: TBox Set Buffer
    # Section: Process > Validate Activity Points | Reusable flow: <none> | Source XTestStep: 3a19e1e5-2c48-9240-4fee-61706e53169b
    # Runtime control: Evaluating Activity Points is 5 or not > Activity points for At  fault_NJ is as Fail
    When if the source runtime condition "Evaluating Activity Points is 5 or not > Activity points for At fault_NJ is as Fail" is satisfied, I retain hard-coded value "Activity points for At fault_NJ is as Fail" as runtime value "Activity Point_NJ"

    # Source step 0173: Set LOB & State | Module: TBox Set Buffer
    ...
    # Source step 0183: TestData - Find & provide item from TDM | Module: Old_TestData - Find & provide item
    ...
    # Source step 0184: Get Validated Premium from TDM | Module: TBox Set Buffer
    ...
    # Source step 0185:  Compare Actual Premium vs Expected Premium | Module: TBox Set Buffer
    ...
    # Source step 0186: Log Out- Exist from the Quote/Policy | Module: EQ||Log Out
...
# 2. Source step 0031 field "Txt_Enter a location" in "Enter Account Details" was disabled. Reason:  
...
# 4. Source step 0031 field "Btn_Yes_client resides" in "Enter Account Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 5. Source step 0032 field "Btn_Recreational Vehicle" in "EQ||Proposal Start" was disabled. Reason:  
#    - Preserved source value: "X"
# 6. Source step 0043 field "Btn_(Existing Client)*" in "Enter Driver Information" was disabled. Reason:  
#    - Preserved source value: "X"
# 7. Source step 0045 field "Lbl_Gender" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 8. Source step 0045 field "Lbl_Gender" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "Gender"
# 9. Source step 0045 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 10. Source step 0045 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 11. Source step 0045 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 12. Source step 0045 field "Btn_Single" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 13. Source step 0045 field "Btn_Assigned" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 14. Source step 0045 field "Txt_DL Number" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 15. Source step 0045 field "Txt_DL Number" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[885502570]}"
# 16. Source step 0045 field "Txt_Months Licensed in Current State" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "1"
# 17. Source step 0045 field "Txt_Date License" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "1/1/2015"
# 18. Source step 0045 field "Btn_PriorInsurance_No" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 19. Source step 0045 field "Btn_Did Not Have Insurance" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 20. Source step 0045 field "Lnk_UWR_CONTINUE" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 21. Source step 0046 field "Lbl_Gender" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 22. Source step 0046 field "Lbl_Gender" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "Gender"
# 23. Source step 0046 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 24. Source step 0046 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 25. Source step 0046 field "Btn_Male" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 26. Source step 0046 field "Btn_Single" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 27. Source step 0046 field "Btn_Assigned" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 28. Source step 0046 field "Txt_DL Number" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "True"
# 29. Source step 0046 field "Txt_DL Number" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[885502570]}"
# 30. Source step 0046 field "Txt_Months Licensed in Current State" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "1"
# 31. Source step 0046 field "Txt_Date License" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "1/1/2015"
# 32. Source step 0046 field "Btn_PriorInsurance_No" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 33. Source step 0046 field "Btn_Did Not Have Insurance" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 34. Source step 0046 field "Lnk_UWR_CONTINUE" in "Enter details in prior insurance page" was disabled. Reason:  
#    - Preserved source value: "X"
# 35. Source step 0048 field "Btn_Add Additional Driver" in "Click Next" was disabled. Reason:  
#    - Preserved source value: "X"
# 36. Source step 0052 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 37. Source step 0052 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 38. Source step 0052 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 39. Source step 0052 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 40. Source step 0053 field "Btn_Automobile" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 41. Source step 0053 field "Btn_Leased" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 42. Source step 0053 field "Txt_Odometer" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "60000"
# 43. Source step 0053 field "Txt_AnnualMileage" in "Vehicle Summary-Enter Vehicle Summary Details" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 44. Source step 0064 field "Btn_D1_No" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "X"
# 45. Source step 0064 field "Hdr_Discounts page" in "Enter Details in Discount page" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 46. Source step 0067 field "<unnamed value>" in "Select Coverage & Continue" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 47. Source step 0067 field "<unnamed value>" in "Select Coverage & Continue" was disabled. Reason:  
#    - Preserved source value: "X"
# 48. Source step 0067 field "<unnamed value>" in "Select Coverage & Continue" was disabled. Reason:  
#    - Preserved source value: "X"
# 49. Source step 0067 field "<unnamed value>" in "Select Coverage & Continue" was disabled. Reason:  
#    - Preserved source value: "X"
# 50. Source step 0067 field "<unnamed value>" in "Select Coverage & Continue" was disabled. Reason:  
#    - Preserved source value: "X"
# 51. Source step 0070 field "Btn_No Coverage_UMPD" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 52. Source step 0070 field "Btn_check_box_outline_blankDjfak Wopntz" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "{Click}"
# 53. Source step 0070 field "Btn_check_box_outline_blankKcmgw Unzp" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 54. Source step 0070 field "Btn_No Coverage_Accidental Death & Dismemberment" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 55. Source step 0070 field "Lbl_Uninsured Motorist PD" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "True"
# 56. Source step 0070 field "Btn_UMPD Limits" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "No Coverage_1"
# 57. Source step 0070 field "Btn_No Coverage_Vehicle3" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 58. Source step 0070 field "Btn_UMPD_No Coverage_V3" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 59. Source step 0070 field "Btn_UMPD_No Coverage_V4" in "Enter Additional Coverages Details" was disabled. Reason:  
#    - Preserved source value: "X"
# 60. Source step 0075 field "Btn_Next" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 61. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "True"
# 62. Source step 0075 field "<unnamed value>" in "Enter Additional Interest Summary" was disabled. Reason:  
#    - Preserved source value: "X"
# 63. Source step 0077 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 64. Source step 0078 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 65. Source step 0079 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 66. Source step 0080 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 67. Source step 0088 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 68. Source step 0089 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 69. Source step 0090 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 70. Source step 0120 field "Txt_Agent_Cmnts_Refer to UW_3" in "EQ||Submission" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}{SENDKEYS[Review Completed]}"
# 71. Source step 0122 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 72. Source step 0123 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 73. Source step 0124 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 74. Source step 0126 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 75. Source step 0126 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 76. Source step 0130 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 77. Source step 0130 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 78. Source step 0130 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 79. Source step 0130 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 80. Source step 0131 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 81. Source step 0131 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 82. Source step 0131 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 83. Source step 0131 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 84. Source step 0132 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 85. Source step 0132 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 86. Source step 0132 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 87. Source step 0132 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 88. Source step 0133 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
# 89. Source step 0134 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 90. Source step 0140 "Verify ExpressUI Sign on page showed up" in module "EU||Login" was disabled. Reason: 14.12.23 20:50:20 [ct2518]
#    - VERIFY "Lbl_Login ID" with "True"
#    - VERIFY "Lbl_Password" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - VERIFY "Lnk_LOGIN" with "True"
# 91. Source step 0141 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "\"^{a}\""
# 92. Source step 0141 field "Txt_Username" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: "YD2102"
# 93. Source step 0141 field "Txt_Password" in "Enter Sign On Credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 94. Source step 0142 "Provide Sign on credentials" in module "EU||Login" was disabled. Reason: 14.12.23 20:51:55 [ct2518]
#    - INPUT "Txt_Login ID_1" with "\"^{a}\""
#    - INPUT "Txt_Login ID_1" with "CT2451"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "X"
# 95. Source step 0145 field "H4" in "eChecklist-Verify if 'Application' links in the checklist are completed" was disabled. Reason:  
#    - Preserved source value: "True"
# 96. Source step 0146 field "H4" in "eChecklist-Click the 'drag/drop' link to upload the documents in the checklist" was disabled. Reason:  
#    - Preserved source value: "True"
# 97. Source step 0152 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "True"
# 98. Source step 0152 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "Transmit"
# 99. Source step 0152 field "Btn_Transmit" in "Transmit Confirmation-Get Policy Number, Premium details" was disabled. Reason:  
#    - Preserved source value: "X"
# 100. Source step 0157 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 101. Source step 0158 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 102. Source step 0159 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 103. Source step 0164 field "Btn_Yes" in "EU||Transact" was disabled. Reason:  
#    - Preserved source value: "{Invoke[Click]}"
# 104. Source step 0168 field "DIV_Risk Score" in "Buffer Activity points" was disabled. Reason:  
#    - Preserved source value: "RiskScore"
# 105. Source step 0174 "Set AliasName" in module "TBox Set Buffer" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "AliasName" with the RUNTIME-DERIVED buffer expression "{B[TCName]}_{TIME[][][HHmmss]}"
# 106. Source step 0175 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 107. Source step 0176 "TestData - Find & provide item with Alias" in module "TestData - Find & provide item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 108. Source step 0177 "Temp Prmium Update into TDS Premium Validation Table if Empty" in module "TestData - Update item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
...
# 109. Source step 0178 "Unlock TDS Item" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockItem"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#    - INPUT "Alias name (item)" with captured runtime value "AliasName"
# 110. Source step 0179 "Wait" in module "TBox Wait" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Duration" with "5000"
# 111. Source step 0180 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
# 112. Source step 0181 "TestData - Create New Entry" in module "TestData - Create & provide new item" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
...
#    - INPUT "Data structure > LOB" with captured runtime value "LOB"
#    - INPUT "Data structure > State" with captured runtime value "State"
# 113. Source step 0182 "Unlock TDS Table" in module "TestData - Expert module" was disabled. Reason: 28.06.24 19:43:54 [ct2721]
#    - INPUT "Test data task" with "UnlockType"
#    - INPUT "Existing or new TDS type" with "PremiumValidation_Reference"
#
# RECOVERY BEHAVIOR FROM TOSCA — automation support, not normal manual business flow
# Recovery scenario: Recovery Scenario - Take screenshot, EQ sign out and Close browser
# 1. Source recovery step 0001 TBox Take Screenshot of failure(during initial run) at TC level: I capture a "Desktop" screenshot at "\\\\fs1\\public\\Tosca\\PL DC Automation\\Screenshots\\Auto\\Activity Points - At fault (Auto) - NJ_{DATE[][][MM/dd/yyyy]}_{TIME}"
