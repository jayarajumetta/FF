# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 200_Happy_Path_Auto_1V1D_AL.feature
...
Feature: Execute Happy Path Auto 1V1D for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Happy Path Auto 1V1D workflow for the selected source iteration
  ...
  Scenario: Happy Path Auto 1V1D using representative iteration Alabama (AL)
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8b9-cacc-4fd3-0aba2f089802
    ...
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8b9-71a2-f3ef-a2f5fe604a3e
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8b9-c779-f776-28651e1a01ce
    Then I wait until "Loading ..." exists

    # Source step 0094: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8b9-a59b-aa41-7eeca26c5b23
    ...
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8b9-6abc-1de6-23a3a7fa9578
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8d8-c240-2006-37ae8bc85bbd
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8d8-1053-5d20-06e7d2365604
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "Auto_PolicyData_HappyPath"
    ...
    # Source step 0231: CloseBrowser | Module: CloseBrowser
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1aafe0-a8d8-464b-7ed8-8fad221ebbb4
    When I close the active browser
...
# 14. Source step 0068 "EQ | Side Menu" in module "EQ | Side Menu" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Driver Information" with "X"
#    - CONTAINER "Vehicle Summary" with "AL"
#    - CONTAINER "Coverages" with "Happy Path Auto 1V1D"
# 15. Source step 0069 "EQ|| Add Additional Driver 1" in module "EQ|| Add Additional Driver 1" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
#    - BUFFER "Driver_1" with "Driver_1"
# 16. Source step 0070 "EQ | Side Menu" in module "EQ | Side Menu" was disabled. Reason: 03.06.25 07:52:17 [pa2096@dnanico1.aniconet.com]
...
# 83. Source step 0214 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 84. Source step 0221 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 85. Source step 0227 "Submission_1-Back to Submission page" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:26 [pa2096@dnanico1.aniconet.com]
...
# 86. Source step 0229 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 87. Source step 0229 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
# 88. Source step 0230 "Submission_2-Save & Exit" in module "EQ||Submission" was disabled. Reason: 18.06.25 11:42:31 [pa2096@dnanico1.aniconet.com]
