# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 197_FFCIC_New_Business_Cycle_Group_4_AIC_Writing_Company_CT.feature
...
Feature: Execute FFCIC New Business Cycle Group 4 AIC Writing Company for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the FFCIC New Business Cycle Group 4 AIC Writing Company workflow for the selected source iteration
  ...
  Scenario: FFCIC New Business Cycle Group 4 AIC Writing Company using representative iteration Connecticut (CT)
    ...
    When I derive and retain the RUNTIME-DERIVED date from Tosca expression "{Date[10.01.2025][][MM/dd/yyyy]}" as runtime value "EffectiveDate"
    ...
    When I enter or select "Argonaut Insurance Co." in "WritingCompany" when "LOB != \"RecreationalVehicle\"" is satisfied
    ...
    # Source step 0068: Cycle Selection | Module: EQ || CyclePreFillSelection
    ...
    # Source step 0069: Cycle Selection | Module: EQ || CyclePreFillSelection
    ...
    # Source step 0070: Cycle Summary | Module: EQ || 1st Cycle
    ...
    # Source step 0071: Add Cycle/Next | Module: EQ || Add Cycle/Next
    ...
    # Source step 0072: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0073: (New) EQ || Multiple Driver Assignment_1 | Module: (New) EQ || Multiple Driver Assignment
    ...
    # Source step 0074: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bc111-6425-22b1-92a3-5e2b88709cf6
    ...
    # Source step 0075: (New) EQ || Multiple Driver Assignment | Module: (New) EQ || Multiple Driver Assignment
    # Section: Process > 06 Driver Assignment | Reusable flow: <none> | Source XTestStep: 3a1bc111-6425-3ea6-35b0-f6fa907e8b66
    ...
    # Source step 0076: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bc111-6425-e967-f0a4-f80f1287ba03
    Then I wait until "Loading ..." exists

    # Source step 0077: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bc111-6425-6257-28a1-89121d50abdb
    ...
    # Source step 0078: EQ||Claims\Violations | Module: EQ||Claims\Violations
    # Section: Process > 07 Claims\Violations | Reusable flow: <none> | Source XTestStep: 3a1bc111-6425-c0fb-009f-095e43f169f2
    ...
    # Source step 0079: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0080: Check for claims/violations needing edited | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0081: Edit Item(s) | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0082: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0083: If Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0084: Edit Claim | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0085: Edit Violation | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0086: Check for PopUp | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0087: Select Continue | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0088: Next | Module: EQ || ClaimsViolation (NEW)
    ...
    # Source step 0089: EQ||Discount- Rate Tier Questions Cycle(NEW) | Module: EQ||Discount- Rate Tier Questions Cycle(NEW)
    ...
    # Source step 0090: EQ||Discount - Rate Tier Questions(NEW) | Module: EQ||Discount - Rate Tier Questions(NEW)
    ...
    # Source step 0092: EQ||Discount-Cycle (NEW) | Module: EQ||Discount-Cycle (NEW)
    ...
    # Source step 0094: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0096: Select Policy Coverage Option | Module: Coverages (New)
    ...
    # Source step 0097: Edit Coverage Option | Module: Edit Coverage Option (New)
    ...
    # Source step 0099: Navigate down screen to V1 | Module: Coverages (New)
    ...
    # Source step 0100: Select V1 Coverages | Module: Coverages (New)
    ...
    # Source step 0101: Navigate down screen to V2 | Module: Coverages (New)
    ...
    # Source step 0102: Select V2 Coverages | Module: Coverages (New)
    ...
    # Source step 0103: Navigate down screen to V3 | Module: Coverages (New)
    ...
    # Source step 0104: Select V3 Coverages | Module: Coverages (New)
    ...
    # Source step 0105: Navigate down screen to V4 | Module: Coverages (New)
    ...
    # Source step 0106: Select V4 Coverages | Module: Coverages (New)
    ...
    # Source step 0116: EQ || Other Policy Coverages Section | Module: EQ || Other Policy Coverages Section (New)
    ...
    # Source step 0117: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0118: EQ || Personal Injury Protection Section  | Module: EQ || Personal Injury Protection Section (New)
    ...
    # Source step 0119: TBox Set Buffer | Module: TBox Set Buffer
    ...
    # Source step 0120: EQ || Vehicle Coverages Section | Module:  EQ || Vehicle Coverages Section
    ...
    # Source step 0121: Additional Coverages Next | Module: EQ || Additional Coverages Next (New)
    ...
    # Source step 0122: EQ || Pricing Details (New) | Module: EQ || Pricing Details (New)
    ...
    # Source step 0124: EQ | Underwriting Eligibility Restrictions | Module: EQ | Underwriting Eligibility Restrictions
    ...
    # Source step 0125: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0126: EQ | Underwriting Collector And Vintage Information | Module: EQ | Underwriting Collector And Vintage Information
    ...
    # Source step 0127: EQ | Underwriting Underwriting Next | Module: EQ | Underwriting Underwriting Next
    ...
    # Source step 0129: AdditionalInterest | Module: EQ || AdditionalInterest
    ...
    # Source step 0131: Billing-Create and Update Billing details | Module: EQ||Billing
    ...
    # Source step 0140: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0141: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0159: EQ || OpenUrl | Module: EQ || OpenUrl
    ...
    # Source step 0160: Verify if ExpressUI login page is shown | Module: EU||Login
    ...
    # Source step 0161: Provide Express UI Login credentials | Module: EU||Login
    ...
    # Source step 0162: EU||Home | Module: EU||Home
    ...
    # Source step 0163: EU|Home | Module: EU|Home/Motorcycle/PersonalAuto
    ...
    # Source step 0164: EU||Applicant | Module: EU||Applicant
    ...
    # Source step 0165: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0167: Recall Quote\Policy | Module: EQ||New Quote
    ...
    # Source step 0168: EQ||Click on Submission Page | Module: EQ||Auto Tabs
    ...
    # Source step 0172: OpenUrl | Module: OpenUrl
    ...
    # Source step 0182: EU||Pricing | Module: EU||Pricing
    ...
    # Source step 0233: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0234: EQ||Agent List count capture | Module: EQ||Agent List count capture
    ...
    # Source step 0235: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0236: TBox Save As | Module: TBox Save As
    ...
    # Source step 0237: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0239: TBox Save As_1 | Module: TBox Save As
    ...
    # Source step 0240: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0241: EQ||Submission - UW Comments(NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0242: EQ||ECheckList | Module: EQ||ECheckList
    ...
    # Source step 0243: TBox Save As | Module: TBox Save As
    ...
    # Source step 0244: EQ||ECheckList_1 | Module: EQ||ECheckList
    ...
    # Source step 0247: EQ |Common|Loading Indicator Wait | Module: EQ |Common|Loading Indicator Wait
    ...
    # Source step 0249: EQ|| Checklist Close | Module: EQ|| Checklist Close
    ...
    # Source step 0250: EQ||Submission (NEW) | Module: EQ||Submission (NEW)
    ...
    # Source step 0251: Transmit Confirmation | Module: EQ || Transmit Confirmation
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bdb64-e5f0-7c32-bc5d-6cd3a7280a46
    ...
    # Source step 0252: TestData - Create & provide new item | Module: TestData - Create & provide new item
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bdb64-e5f0-81c3-6dd0-349a283e6ee2
    When I retrieve test data through TDM operation "TestData - Create & provide new item"
    And I use TDM parameter "Existing or new TDS type" with "FFCIC_NB_Cycle_AIC_WritingCompany"
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a1bdb64-e5f9-e81f-4c6c-11b4428c23bf
    When I close the active browser
...
# 14. Source step 0084 field "claim/violationDoes Not Apply" in "Edit Claim" was disabled. Reason:  
#    - Preserved source value: "X"
# 15. Source step 0091 "EQ||Discount - Rate Tier Questions" in module "EQ||Discount - Rate Tier Questions(NEW)" was disabled. Reason: 15.04.25 14:50:31 [pa2096@dnanico1.aniconet.com]
# 16. Source step 0092 field "Multi_Cycle_Yes" in "EQ||Discount-Cycle (NEW)" was disabled. Reason:  
#    - Preserved source value: "True"
# 17. Source step 0107 "V1 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 18. Source step 0108 "V1 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V1_CollDed" with "X"
#    - INPUT "V1_CollDedMoreOpt" with "X"
# 19. Source step 0109 "V2 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
...
# 20. Source step 0110 "V2 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CollDed" with "X"
#    - INPUT "V2_CollDedMoreOpt" with "X"
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 21. Source step 0111 "V3 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDed" with "X"
...
#    - INPUT "V3_CompDed" with "X"
#    - INPUT "V3_CompDedMoreOpt" with "X"
# 22. Source step 0112 "V3 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V3_CollDed" with "X"
#    - INPUT "V3_CollDedMoreOpt" with "X"
# 23. Source step 0113 "V4 Comp Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V2_CompDedMoreOpt" with "X"
...
#    - INPUT "V4_CompDedMoreOpt" with "X"
# 24. Source step 0114 "V4 Coll Cov" in module "Coverages (New)" was disabled. Reason: 28.08.25 14:01:14 [pa2096@dnanico1.aniconet.com]
#    - INPUT "V4_CollDed" with "X"
#    - INPUT "V4_CollDedMoreOpt" with "X"
#    - INPUT "Next" with "X"
# 25. Source step 0120 field "Cycle Accessories_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 26. Source step 0120 field "Original Parts_V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 27. Source step 0120 field "Endorsement Limit V1" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1398 $5,000"
# 28. Source step 0120 field "Cycle Accessories_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 29. Source step 0120 field "Original Parts_V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "X"
# 30. Source step 0120 field "Endorsement Limit V2" in "EQ || Vehicle Coverages Section" was disabled. Reason:  
#    - Preserved source value: "SA-1399 $7,000"
# 31. Source step 0129 field "H1_Additional Interest Summary" in "AdditionalInterest" was disabled. Reason:  
#    - Preserved source value: "True"
# 32. Source step 0132 "Verify if Due date is Enabled or not" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Due Date" with "True"
# 33. Source step 0133 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
...
# 34. Source step 0134 "Billing-Create and Update Billing details" in module "EQ||Billing" was disabled. Reason: 24.07.25 14:44:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Rd Btn_Custom Amount" with "X"
#    - INPUT "Btn_CHECK" with "X"
#    - WAIT "Txt_Check Number" with "True"
#    - INPUT "Txt_Check Number" with "{CLICK}{sendkeys[42]}"
#    - INPUT "Btn_Billing_NEXT" with "X"
# 35. Source step 0135 "EQ || Billing" in module "<unresolved module>" was disabled. Reason: 23.07.25 11:29:56 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "<unnamed value>" with "X"
# 36. Source step 0142 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 37. Source step 0143 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 38. Source step 0144 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 39. Source step 0145 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 40. Source step 0146 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 41. Source step 0147 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 42. Source step 0148 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 43. Source step 0149 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 44. Source step 0150 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
...
# 46. Source step 0152 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 47. Source step 0153 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 48. Source step 0154 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 49. Source step 0155 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 50. Source step 0156 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 51. Source step 0157 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 52. Source step 0158 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 53. Source step 0161 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 54. Source step 0161 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
# 55. Source step 0169 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 56. Source step 0170 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 57. Source step 0171 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 58. Source step 0173 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 59. Source step 0174 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 60. Source step 0175 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 61. Source step 0177 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: "True"
# 62. Source step 0177 field "Txt_Password_1" in "Provide Express UI Login credentials" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-CONFIGURED protected Tosca-encrypted source value
...
#    - Preserved source value: "X"
# 67. Source step 0182 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 68. Source step 0182 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 69. Source step 0182 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 70. Source step 0182 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 71. Source step 0183 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 72. Source step 0183 field "Txt_Underwriting Notes *" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "{Click}{SENDKEYS[Approved]}"
# 73. Source step 0183 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "True"
# 74. Source step 0183 field "Btn_Approve" in "EU||Pricing" was disabled. Reason:  
#    - Preserved source value: "X"
# 75. Source step 0184 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 76. Source step 0185 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 77. Source step 0189 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Submission_1" with "True"
# 78. Source step 0190 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 79. Source step 0191 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Comments" with "True"
# 80. Source step 0192 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Comments" with "\"Test\""
# 81. Source step 0193 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ReferUW" with "True"
# 82. Source step 0194 "EQ||Submission - UW Comments(NEW)" in module "EQ||Submission (NEW)" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ReferUW" with "X"
#    - INPUT "SaveExit_1" with "X"
# 83. Source step 0195 "OpenUrl" in module "OpenUrl" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "UseActiveTab" with a blank value
#    - INPUT "WebDriverBrowserArguments > Argument" with "--silent-debugger-extension-api"
# 84. Source step 0196 "Enter Sign On Credentials" in module "EQ||Sign On" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Txt_Username" with "True"
# 85. Source step 0197 "TBox Wait" in module "TBox Wait" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Duration" with "1000"
# 86. Source step 0198 "Maximize Window" in module "TBox Window Operation" was disabled. Reason: 05.06.25 14:50:33 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Caption" with "*Sign On*"
#    - INPUT "Operation" with "Maximize"
# 87. Source step 0199 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 88. Source step 0200 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 89. Source step 0201 "EU||Home" in module "EU||Home" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 90. Source step 0202 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
#    - INPUT "Lnk_Motorcycle" with "x"
#    - INPUT "Lnk_PersonalAuto" with "x"
#    - INPUT "Lnk_RV" with "x"
# 91. Source step 0203 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 93. Source step 0205 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "ChkBox_Bypass Level 9 Rules" with "True"
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
# 94. Source step 0206 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "True"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "Approved"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 95. Source step 0207 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 10:52:23 [pa2096@dnanico1.aniconet.com]
#    - INPUT "ChkBox_Bypass Level 9 Rules" with "x"
#    - INPUT "Bypass Level 9 Comments_1" with "{Click}"
#    - INPUT "Bypass Level 9 Comments_1" with "{SENDKEYS[Approved]"
#    - INPUT "Bypass Level 9 Comments_1" with ""
...
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 96. Source step 0208 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 97. Source step 0209 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 98. Source step 0210 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 99. Source step 0211 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 13.11.25 16:06:24 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 100. Source step 0212 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 101. Source step 0213 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 102. Source step 0214 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 103. Source step 0215 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 104. Source step 0216 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 105. Source step 0217 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Lnk_Pricing" with "{Invoke[Click]}"
# 106. Source step 0218 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 107. Source step 0219 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 108. Source step 0220 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 109. Source step 0221 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 110. Source step 0222 "EU||Pricing" in module "EU||Pricing" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Underwriting Notes *" with "True"
#    - INPUT "Txt_Underwriting Notes *" with "{Click}{SENDKEYS[Approved]}"
#    - WAIT "Btn_Approve" with "True"
#    - INPUT "Btn_Approve" with "X"
#    - INPUT "Lnk_Home" with "X"
# 111. Source step 0223 "Recall Quote\\Policy" in module "EQ||New Quote" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Txt_Quote\\Policy Search" with "\"^{a}\""
#    - INPUT "Txt_Quote\\Policy Search" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "{Click}"
# 112. Source step 0224 "EQ||Click on Submission Page" in module "EQ||Auto Tabs" was disabled. Reason: 28.10.25 09:43:04 [pa2096@dnanico1.aniconet.com]
#    - INPUT "DIV_Submission" with "{Invoke[Click]}"
# 113. Source step 0225 "EQ || OpenUrl" in module "EQ || OpenUrl" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Url" with "https://dcpqa.dnanico1.aniconet.com/express/express.aspx"
#    - INPUT "WebDriverBrowserArguments" with "--silent-debugger-extension-api"
# 114. Source step 0226 "Verify if ExpressUI login page is shown" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - VERIFY "Lbl_Login ID" with "True"
# 115. Source step 0227 "Provide Express UI Login credentials" in module "EU||Login" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Login ID_1" with "True"
#    - INPUT "Txt_Login ID_1" with "AQ7314"
#    - INPUT "Password" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - WAIT "Txt_Password_1" with "True"
#    - INPUT "Txt_Password_1" with the RUNTIME-CONFIGURED protected Tosca-encrypted source value
#    - INPUT "Lnk_LOGIN" with "{Click}"
# 116. Source step 0228 "EU||Home" in module "EU||Home" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - WAIT "Txt_Search Type" with "True"
#    - INPUT "Txt_Search Text" with captured runtime value "QuoteNumber"
#    - INPUT "Btn_Search" with "X"
# 117. Source step 0229 "EU|Home" in module "EU|Home/Motorcycle/PersonalAuto" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Policy/Quote#" with "X"
# 118. Source step 0230 "EU||Applicant" in module "EU||Applicant" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Bypass Level 9B Rules" with "True"
#    - INPUT "Bypass Level 9B Rules Comments" with "{Click}{SENDKEYS[Approved]}"
#    - INPUT "Home" with "X"
# 119. Source step 0231 "TBox Wait" in module "TBox Wait" was disabled. Reason: 26.02.25 13:58:29 [pa1639@dnanico1.aniconet.com]
#    - INPUT "Duration" with "12000"
# 120. Source step 0232 "CloseBrowser" in module "CloseBrowser" was disabled. Reason: 20.08.25 16:16:06 [pa2096@dnanico1.aniconet.com]
#    - INPUT "Title" with "*Home*"
# 121. Source step 0234 field "DIV_Agent Documents Count" in "EQ||Agent List count capture" was disabled. Reason:  
#    - Preserved source value: the RUNTIME-DERIVED buffer expression "{MATH[{B[AgentList count]}-1]}"
# 122. Source step 0238 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 02.07.25 08:12:54 [pa2096@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 123. Source step 0245 "Wait_Reference" in module "<unresolved reusable block>" was disabled. Reason: 25.02.25 14:11:17 [pa1639@dnanico1.aniconet.com]
#    - The referenced reusable-flow target was not included in the exported TSUs; the source gap is retained for manual review.
# 124. Source step 0252 field "Data structure > Premium" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: captured runtime value "Premium"
# 125. Source step 0252 field "Data structure > Endorsement" in "TestData - Create & provide new item" was disabled. Reason:  
#    - Preserved source value: "N"
#
