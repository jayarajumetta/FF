# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 059_UW_Rejection_-_Cycle_-_Post_-_ALL_AZ.feature
...
Feature: Execute UW Rejection - Cycle - Post - ALL for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the UW Rejection - Cycle - Post - ALL workflow for the selected source iteration
  ...
  Scenario: UW Rejection - Cycle - Post - ALL using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-dfc5-6fbe-4cd53a7ef73a
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-417f-a9a5-5f7fec2af10c
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-2ab9-d955-ba11c15cf891
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-5bc4-bb6e-a75af107b618
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-3a94-a537-6a7f96d89207
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-0f7f-98ae-a9c80dec15fa
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-4273-de86-b03d3da3b55d
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-6a02-ae6f-5e6bbda39e14
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-ea64-a70c-d4c511397bff
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b33-94b4-514b-da19120043ee
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3b3e-e7e9-c7dc-05956b517068
    When I close the active browser
