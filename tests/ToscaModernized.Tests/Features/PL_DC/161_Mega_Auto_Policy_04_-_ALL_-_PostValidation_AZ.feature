# ==================================================================================================
# Standalone ReqnRoll + Playwright feature generated from: 161_Mega_Auto_Policy_04_-_ALL_-_PostValidation_AZ.feature
...
Feature: Execute Mega Auto Policy 04 - ALL - PostValidation for one representative PL|DC iteration
  As a PL|DC policy processing user
  I want to complete the Mega Auto Policy 04 - ALL - PostValidation workflow for the selected source iteration
  ...
  Scenario: Mega Auto Policy 04 - ALL - PostValidation using representative iteration Arizona (AZ)
    # Source step 0009: EU||Login | Module: EU||Login
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-0164-4f92-ae1c2ab44ad8
    When I enter or select "AQ7314" in "Txt_Login ID_1"
    When I enter the RUNTIME-CONFIGURED value "ExpressPassword" in "Txt_Password_1"
    When I click "Lnk_LOGIN"

    # Source step 0010: EU||Home | Module: EU||Home
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-53d7-6dbe-0c4e79a4cf30
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-ca12-9ff0-84c8d430723b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-6752-6a51-c5a0d8466126
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-27bd-88a7-eb9295b8c10c
    When I retain hard-coded value "Mega Auto Policy 04-AZ" as runtime value "TCName"

    # Source step 0018: TBox Save As_1-To Upload the file | Module: TBox Save As
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-6fac-782b-1ead6f9d0a87
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-6086-c9c8-ea69a0a7e7d4
    When I enter or select "\"\"" in "Keys"
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-5670-4bf6-f1fa34ce058b
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-66a7-d512-e336693f8dbc
    ...
    # Section: Process | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-4b88-882e-ec4409cb4f16
    ...
    # Section: Postcondition | Reusable flow: <none> | Source XTestStep: 3a19e1e5-3f95-08b8-4c46-966a1371cc62
    When I close the active browser
