...
public sealed class EQSFPCountryEstatePolicySteps
{
    ...
    public async Task CompletePolicyWideAsync()
    {
        ...
        await page.PressCECoverageAsync("TAB");
        ...
        {
                    await page.PressChoiceWithHorseAsync("TAB");
        }
        if (data.Condition("CoverageType == \"Select\""))
        {
                    await page.PressSelectAsync("TAB");
        }
        if (data.Condition("CoverageType == \"Select Horse\""))
        {
                    await page.PressSelectWithHorseAsync("TAB");
        }
        if (data.Condition("CoverageType == \"Premier\""))
        {
                    await page.PressPremierAsync("TAB");
        }
        if (data.Condition("CoverageType == \"Premier Horse\""))
        {
                    await page.PressPremierWithHorseAsync("TAB");
        }
        ...
        await page.PressBlanketFPPAsync("ENTER");
