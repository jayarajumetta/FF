...
[Binding, Scope(Feature = "Commercial Lines ExpertQuote - EQ SFP Basic Policy")]
public sealed class EQSFPBasicPolicyStepDefinitions
{
    private readonly EQSFPBasicPolicyFlowPage _flow;

    public EQSFPBasicPolicyStepDefinitions(EQSFPBasicPolicyFlowPage flow)
    {
