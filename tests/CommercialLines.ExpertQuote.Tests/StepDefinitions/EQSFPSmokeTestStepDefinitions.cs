...
[Binding, Scope(Feature = "Commercial Lines ExpertQuote - EQ SFP Smoke Test")]
public sealed class EQSFPSmokeTestStepDefinitions
{
    private readonly EQSFPSmokeTestFlowPage _flow;

    public EQSFPSmokeTestStepDefinitions(EQSFPSmokeTestFlowPage flow)
    {
