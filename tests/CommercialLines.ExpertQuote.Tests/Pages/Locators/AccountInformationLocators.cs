...
public sealed class AccountInformationLocators
{
    ...
    public ILocator StateAE19A => State0110E; // semantic alias; locator defined once
    ...
    public ILocator StateDropdown => State0110E; // semantic alias; locator defined once

    // Source modules: EQ|Common|Account Details - Account Info | confidence=High score=127
    public ILocator StreetAddress => _page.Locator("#owner\\.address\\.line1");

    // Source modules:  | confidence=Medium score=78
    public ILocator Yes => HaveYouReceivedMailAtThisAddressForAtLeast90DaysYes; // semantic alias; locator defined once
