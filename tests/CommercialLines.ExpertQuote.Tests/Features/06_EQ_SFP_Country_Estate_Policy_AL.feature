@CL_EQ @SFP @country_estate_new_business_policy @AL @automated @canonical @artifact_v38 @regression
Feature: Commercial Lines ExpertQuote - EQ SFP Country Estate Policy
  As a Commercial Lines ExpertQuote policy processing user
  I want to complete the attached Special Farm Package country estate new business policy workflow
  ...
  Scenario Outline: Create and verify a Special Farm Package country estate new business policy for <state>
    ...
    Examples:
      ...
      | 06_eq_sfp_country_estate_policy_al | Alabama | AL | Special Farm Package | Country Estate New Business Policy | Current |
