...
@CL_EQ @BOP @basic_new_business_policy @automated @canonical_simple_v39 @state_data_driven
# Automation Maturity: 82/100
# Business Flow: 19/20 | Canonical Mapping: 10/20 | StepDefinitions: 15/15 | Page Model: 14/15 | Locator Quality: 14/20 | Test Data: 10/10
# Page Objects Used: 17 | Locator Confidence Average: 68/100 | Review-required operations: 16
# Locator Review Items: 101 source-derived locator(s) remain below high confidence.
...
Feature: EQ BOP Basic Policy
  ...
  Scenario Outline: EQ BOP Basic Policy - <stateCode>
    ...
    Examples:
      ...
      | TestData/Scenarios/02_eq_bop_basic_policy_al.json | AL | AL | Alabama |
      | TestData/Scenarios/02_eq_bop_basic_policy_ar.json | AR | AR | Arkansas |
      | TestData/Scenarios/02_eq_bop_basic_policy_az.json | AZ | AZ | Arizona |
      | TestData/Scenarios/02_eq_bop_basic_policy_ca.json | CA | CA | California |
      | TestData/Scenarios/02_eq_bop_basic_policy_co.json | CO | CO | Colorado |
      | TestData/Scenarios/02_eq_bop_basic_policy_ct.json | CT | CT | Connecticut |
      | TestData/Scenarios/02_eq_bop_basic_policy_de.json | DE | DE | Delaware |
      | TestData/Scenarios/02_eq_bop_basic_policy_ga.json | GA | GA | Georgia |
      | TestData/Scenarios/02_eq_bop_basic_policy_ia.json | IA | IA | Iowa |
      | TestData/Scenarios/02_eq_bop_basic_policy_id.json | ID | ID | Idaho |
      | TestData/Scenarios/02_eq_bop_basic_policy_il.json | IL | IL | Illinois |
      | TestData/Scenarios/02_eq_bop_basic_policy_in.json | IN | IN | Indiana |
      | TestData/Scenarios/02_eq_bop_basic_policy_ks.json | KS | KS | Kansas |
      | TestData/Scenarios/02_eq_bop_basic_policy_ky.json | KY | KY | Kentucky |
      | TestData/Scenarios/02_eq_bop_basic_policy_la.json | LA | LA | Louisiana |
      | TestData/Scenarios/02_eq_bop_basic_policy_ma.json | MA | MA | Massachusetts |
      | TestData/Scenarios/02_eq_bop_basic_policy_md.json | MD | MD | Maryland |
      | TestData/Scenarios/02_eq_bop_basic_policy_me.json | ME | ME | Maine |
      | TestData/Scenarios/02_eq_bop_basic_policy_mn.json | MN | MN | Minnesota |
      | TestData/Scenarios/02_eq_bop_basic_policy_mo.json | MO | MO | Missouri |
      | TestData/Scenarios/02_eq_bop_basic_policy_ms.json | MS | MS | Mississippi |
      | TestData/Scenarios/02_eq_bop_basic_policy_mt.json | MT | MT | Montana |
      | TestData/Scenarios/02_eq_bop_basic_policy_nd.json | ND | ND | North Dakota |
      | TestData/Scenarios/02_eq_bop_basic_policy_ne.json | NE | NE | Nebraska |
      | TestData/Scenarios/02_eq_bop_basic_policy_nh.json | NH | NH | New Hampshire |
      | TestData/Scenarios/02_eq_bop_basic_policy_nj.json | NJ | NJ | New Jersey |
      | TestData/Scenarios/02_eq_bop_basic_policy_nm.json | NM | NM | New Mexico |
      | TestData/Scenarios/02_eq_bop_basic_policy_nv.json | NV | NV | Nevada |
      | TestData/Scenarios/02_eq_bop_basic_policy_ny.json | NY | NY | New York |
      | TestData/Scenarios/02_eq_bop_basic_policy_oh.json | OH | OH | Ohio |
      | TestData/Scenarios/02_eq_bop_basic_policy_ok.json | OK | OK | Oklahoma |
      | TestData/Scenarios/02_eq_bop_basic_policy_or.json | OR | OR | Oregon |
      | TestData/Scenarios/02_eq_bop_basic_policy_pa.json | PA | PA | Pennsylvania |
      | TestData/Scenarios/02_eq_bop_basic_policy_ri.json | RI | RI | Rhode Island |
      | TestData/Scenarios/02_eq_bop_basic_policy_sc.json | SC | SC | South Carolina |
      | TestData/Scenarios/02_eq_bop_basic_policy_sd.json | SD | SD | South Dakota |
      | TestData/Scenarios/02_eq_bop_basic_policy_tn.json | TN | TN | Tennessee |
      | TestData/Scenarios/02_eq_bop_basic_policy_tx.json | TX | TX | Texas |
      | TestData/Scenarios/02_eq_bop_basic_policy_ut.json | UT | UT | Utah |
      | TestData/Scenarios/02_eq_bop_basic_policy_va.json | VA | VA | Virginia |
      | TestData/Scenarios/02_eq_bop_basic_policy_vt.json | VT | VT | Vermont |
      | TestData/Scenarios/02_eq_bop_basic_policy_wa.json | WA | WA | Washington |
      | TestData/Scenarios/02_eq_bop_basic_policy_wi.json | WI | WI | Wisconsin |
      | TestData/Scenarios/02_eq_bop_basic_policy_wv.json | WV | WV | West Virginia |
      | TestData/Scenarios/02_eq_bop_basic_policy_wy.json | WY | WY | Wyoming |
