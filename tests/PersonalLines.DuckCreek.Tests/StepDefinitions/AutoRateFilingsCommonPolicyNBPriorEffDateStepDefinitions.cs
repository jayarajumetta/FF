...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Auto Rate Filings Common Policy NB Prior Eff Date")]
public sealed class AutoRateFilingsCommonPolicyNBPriorEffDateStepDefinitions
{
    private readonly AutoRateFilingsCommonPolicyNBPriorEffDateFlowPage _flow;

    public AutoRateFilingsCommonPolicyNBPriorEffDateStepDefinitions(AutoRateFilingsCommonPolicyNBPriorEffDateFlowPage flow)
    {
