...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Auto Rate Filings Policy 3 NB Prior Eff Date")]
public sealed class AutoRateFilingsPolicy3NBPriorEffDateStepDefinitions
{
    private readonly AutoRateFilingsPolicy3NBPriorEffDateFlowPage _flow;

    public AutoRateFilingsPolicy3NBPriorEffDateStepDefinitions(AutoRateFilingsPolicy3NBPriorEffDateFlowPage flow)
    {
