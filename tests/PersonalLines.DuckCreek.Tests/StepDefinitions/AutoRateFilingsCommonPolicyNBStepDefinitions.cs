...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Auto Rate Filings Common Policy NB")]
public sealed class AutoRateFilingsCommonPolicyNBStepDefinitions
{
    private readonly AutoRateFilingsCommonPolicyNBFlowPage _flow;

    public AutoRateFilingsCommonPolicyNBStepDefinitions(AutoRateFilingsCommonPolicyNBFlowPage flow)
    {
