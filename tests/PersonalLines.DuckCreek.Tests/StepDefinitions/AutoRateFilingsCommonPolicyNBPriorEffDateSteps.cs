...
[Binding, Scope(Feature = "Auto Rate Filings Common Policy NB Prior Eff Date")]
public sealed class AutoRateFilingsCommonPolicyNBPriorEffDateSteps
{
    private readonly ScenarioContext _scenario;
    public AutoRateFilingsCommonPolicyNBPriorEffDateSteps(ScenarioContext scenario) => _scenario = scenario;
    ...
    public async Task CompleteVehicleSummaryAutomobileRateFilingCommonAutoAsync()
    {
        ...
        {
                    await page.WaitForAdditionalVehicleAsync("Visible");
        }
        if (await page.IsAdditionalVehiclePresentAsync())
        {
        ...
        await page.EnterVIN06D01Async(data.Resolve("{{data:txt_vin_210}}"));
        ...
        {
                    await page.EnterNYFFCICTotalAnnualMilesAsync(data.Resolve("{{data:ny_ffcic_total_annual_miles_224}}"));
                    await page.PressNYFFCICTotalAnnualMilesAsync("CTRL+A");
        }
        if (data.Condition("State == \"NY\" AND Company == \"FFCIC\""))
        {
                    await page.EnterNYFFCICTotalAnnualMilesAsync(data.Resolve("{{data:ny_ffcic_total_annual_miles_225}}"));
        }
        if (data.Condition("State == \"KS\""))
        {
                    await page.EnterWorkMilesDayAsync(data.Resolve("{{data:work_miles_day_226}}"));
                    await page.PressWorkMilesDayAsync("CTRL+A");
        }
        if (data.Condition("State == \"KS\""))
        {
                    await page.EnterWorkMilesDayAsync(data.Resolve("{{data:work_miles_day_227}}"));
        }
        if (data.Condition("State == \"KS\""))
        {
                    await page.EnterNonWorkAnnualMilesAsync(data.Resolve("{{data:non_work_annual_miles_228}}"));
                    await page.PressNonWorkAnnualMilesAsync("CTRL+A");
        }
        if (data.Condition("State == \"KS\""))
        {
                    await page.EnterNonWorkAnnualMilesAsync(data.Resolve("{{data:non_work_annual_miles_229}}"));
        }
        ...
        await page.EnterPurchaseDateBB8AFAsync(data.Resolve("{{data:txt_purchase_date_232}}"));
        await page.PressPurchaseDateBB8AFAsync("CTRL+A");
        await page.EnterPurchaseDateBB8AFAsync(data.Resolve("{{data:txt_purchase_date_233}}"));
        await page.EnterOdometer3843FAsync(data.Resolve("{{data:txt_odometer_234}}"));
        await page.PressOdometer3843FAsync("CTRL+A");
        await page.EnterOdometer3843FAsync(data.Resolve("{{data:txt_odometer_235}}"));
        if (data.Condition("State != \"KS\""))
        {
                    await page.EnterAnnualMileage51344Async(data.Resolve("{{data:txt_annual_mileage_236}}"));
                    await page.PressAnnualMileage51344Async("CTRL+A");
        }
        if (data.Condition("State != \"KS\""))
        {
                    await page.EnterAnnualMileage51344Async(data.Resolve("{{data:txt_annual_mileage_237}}"));
        }
        await page.ClickSaveContinue2E7CDAsync();
        await page.ClickAddVehicleAsync();
        await page.WaitForVIN0A17CAsync("True");
        await page.EnterVIN0A17CAsync(data.Resolve("{{data:vin_241}}"));
        ...
        await page.EnterAgreedValue8E288Async(data.Resolve("{{data:agreed_value_248}}"));
        ...
        await page.EnterAppraisalDate8A115Async(data.Resolve("{{data:appraisal_date_252}}"));
        await page.EnterTotalAnnualMileageAsync(data.Resolve("{{data:total_annual_mileage_253}}"));
        await page.PressTotalAnnualMileageAsync("CTRL+A");
        await page.EnterTotalAnnualMileageAsync(data.Resolve("{{data:total_annual_mileage_254}}"));
        await page.ClickSaveContinue86B78Async();
        await page.ClickAddVehicleAsync();
        await page.WaitForVIN0A17CAsync("True");
        await page.EnterVIN0A17CAsync(data.Resolve("{{data:vin_258}}"));
        await page.PressVIN0A17CAsync("TAB");
        await page.ClickVeh3Async();
        await page.SelectVehicleMoreOptionsAsync("");
        await page.ClickCollectorCarAsync();
        await page.ClickModernClassicAsync();
        await page.EnterAgreedValue8E288Async(data.Resolve("{{data:agreed_value_264}}"));
        await page.ClickOwnB8575Async();
        await page.ClickContinueAsync();
        if (data.Condition("State != \"KS\""))
        {
        ...
        await page.EnterAppraisalDate8A115Async(data.Resolve("{{data:appraisal_date_268}}"));
        await page.EnterOdometerD648FAsync(data.Resolve("{{data:odometer_269}}"));
        await page.PressOdometerD648FAsync("CTRL+A");
        await page.EnterOdometerD648FAsync(data.Resolve("{{data:odometer_270}}"));
        await page.EnterTotalAnnualMileageAsync(data.Resolve("{{data:total_annual_mileage_271}}"));
        await page.PressTotalAnnualMileageAsync("CTRL+A");
        await page.EnterTotalAnnualMileageAsync(data.Resolve("{{data:total_annual_mileage_272}}"));
        await page.ClickSaveContinue86B78Async();
        if (data.Condition("State == \"CA\""))
        {
                    await page.ClickOptOutAsync();
        }
        await page.ClickPricingDetailsNextAsync();
    ...
    public async Task CompleteEditClaimsViolationsAsync()
    {
        ...
        {
                    await page.EnterComboBoxAsync(data.Resolve("{{data:combobox_312}}"));
        }
    ...
    public async Task CompleteDiscount1Async()
    {
        ...
        await page.SetOnAsync(data.Resolve("{{data:multi_car_discount_on_328}}"));
        ...
        await page.SetOnAsync(data.Resolve("{{data:commercial_auto_on_331}}"));
        if (data.Condition("'Special Farm Package' != NULL"))
        {
                    await page.VerifySpecialFarmPackageAsync("Exists", "");
        }
        await page.SetOnAsync(data.Resolve("{{data:special_farm_package_on_333}}"));
        ...
        data.Set("V4_CompDed", data.Get("V4_CompDed"));
        data.Set("V4_CompDedMoreOpt", data.Get("V4_CompDedMoreOpt"));
        data.Set("V4_CollDed", data.Get("V4_CollDed"));
    ...
    public async Task CompleteCoveragesAsync()
    {
        ...
        {
                    await page.SetOption1Async(data.Resolve("{{data:option_1_365}}"));
        }
        if (data.Condition("PolicyCovOption == \"OPTION 2\""))
        {
                    await page.SetOption2Async(data.Resolve("{{data:option_2_366}}"));
        }
        if (data.Condition("PolicyCovOption == \"OPTION 3\""))
        {
                    await page.SetOption3Async(data.Resolve("{{data:option_3_367}}"));
        }
        ...
        if (data.Condition("'V1_Comprehensive Only' != NULL"))
        {
                    await page.SetV1ComprehensiveOnlyAsync(data.Resolve("{{data:v1_comprehensive_only_381}}"));
        }
        ...
        if (data.Condition("'V2_Comprehensive Only' != NULL"))
        {
                    await page.SetV2ComprehensiveOnlyAsync(data.Resolve("{{data:v2_comprehensive_only_391}}"));
        }
        ...
        if (data.Condition("'V3_Comprehensive Only' != NULL"))
        {
                    await page.SetV3ComprehensiveOnlyAsync(data.Resolve("{{data:v3_comprehensive_only_401}}"));
        }
        ...
        if (data.Condition("'V4_Comprehensive Only' != NULL"))
        {
                    await page.SetV4ComprehensiveOnlyAsync(data.Resolve("{{data:v4_comprehensive_only_411}}"));
        }
    ...
    public async Task CompleteAutoAddlCovPolicyCoveragessAsync()
    {
        ...
        {
                    await page.SetLossOfIncomeDriver1Async(data.Resolve("{{data:loss_of_income_driver1_438}}"));
        }
        if (data.Condition("'Loss of Income Coverage_Driver2' != NULL"))
        {
                    await page.SetLossOfIncomeDriver2Async(data.Resolve("{{data:loss_of_income_driver2_439}}"));
        }
        if (data.Condition("'Loss of Income Coverage_Driver3' != NULL"))
        {
                    await page.SetLossOfIncomeDriver3Async(data.Resolve("{{data:loss_of_income_driver3_440}}"));
        }
        if (data.Condition("'Loss of Income Coverage_Driver4' != NULL"))
        {
                    await page.SetLossOfIncomeDriver4Async(data.Resolve("{{data:loss_of_income_driver4_441}}"));
        }
        if (data.Condition("'Loss of Income Coverage_Driver5' != NULL"))
        {
                    await page.SetLossOfIncomeDriver5Async(data.Resolve("{{data:loss_of_income_driver5_442}}"));
        }
    ...
    public async Task ConfigureDirectPayBillingAsync()
    {
        ...
        await page.EnterPaymentDueDateAsync(data.Resolve("{{data:txt_paymentduedate_558}}"));
        await page.ClickRdBtnFullBalanceAsync();
        await page.ClickCHECKAsync();
        await page.EnterCheckNumberAsync(data.Resolve("{{data:txt_check_number_561}}"));
    ...
    public async Task ApproveTheUnderwritingReferralInExpressAsync()
    {
        ...
        await page.EnterTxtLoginID1Async(data.Resolve("{{data:txt_login_id_1_568}}"));
        await page.EnterPasswordAsync(data.Resolve("{{env:PL_DC_PASSWORD}}"));
        await page.ClickLnkLOGINAsync();
        if (await page.IsTxtSearchTypePresentAsync())
        {
        ...
        {
                    await page.SetChkBoxBypassLevel9RulesAsync(data.Resolve("{{data:chkbox_bypass_level_9_rules_579}}"));
        }
        await page.ClickBypassLevel9Comments1Async();
        await page.EnterBypassLevel9Comments1Async(data.Resolve("{{data:bypass_level_9_comments_1_581}}"));
        ...
        if (await page.IsChkBoxBypassLevel9RulesPresentAsync())
        {
                    await page.SetChkBoxBypassLevel9RulesAsync(data.Resolve("{{data:chkbox_bypass_level_9_rules_585}}"));
        }
        await page.ClickBypassLevel9Comments1Async();
        await page.EnterBypassLevel9Comments1Async(data.Resolve("{{data:bypass_level_9_comments_1_587}}"));
        await page.PressBypassLevel9Comments1Async("TAB");
        await page.ClickLnkHomeAsync();
    ...
    public async Task CompleteTheLevel9UnderwritingBypassForTxtQuotePolicySearchAsync()
    {
        ...
        if (await page.IsQuotePolicySearchPresentAsync())
        {
                    await page.EnterQuotePolicySearchAsync(data.Resolve("{{data:txt_quote_policy_search_591}}"));
                    await page.PressQuotePolicySearchAsync("CTRL+A");
        }
        await page.EnterQuotePolicySearchAsync(data.Resolve("{{runtime:QuoteNumber}}"));
        await page.ClickNewQuoteSearchAsync();
    ...
    public async Task CompleteSubmissionUnderwritingCommentsAndReviewAsync()
    {
        ...
        if (await page.IsCommentsPresentAsync())
        {
                    await page.EnterCommentsAsync(data.Resolve("{{data:comments_598}}"));
        }
    ...
    public async Task CompleteTheExpressUnderwritingReviewAsync()
    {
        ...
        await page.EnterTxtLoginID1Async(data.Resolve("{{data:txt_login_id_1_605}}"));
        await page.EnterPasswordAsync(data.Resolve("{{env:PL_DC_PASSWORD}}"));
        await page.ClickLnkLOGINAsync();
        if (await page.IsTxtSearchTypePresentAsync())
        {
        ...
        await page.EnterTxtUnderwritingNotesAsync(data.Resolve("{{data:txt_underwriting_notes_614}}"));
    ...
    public async Task RecallTheQuoteInExpertQuoteAsync()
    {
        ...
        if (await page.IsQuotePolicySearchPresentAsync())
        {
                    await page.EnterQuotePolicySearchAsync(data.Resolve("{{data:txt_quote_policy_search_619}}"));
                    await page.PressQuotePolicySearchAsync("CTRL+A");
        }
        await page.EnterQuotePolicySearchAsync(data.Resolve("{{runtime:QuoteNumber}}"));
        await page.ClickNewQuoteSearchAsync();
    ...
    public async Task CompleteTheSubmissionChecklistAsync()
    {
        ...
        await page.EnterCaptionAsync(data.Resolve("{{data:caption_627}}"));
        await page.EnterFilePathAsync(data.Resolve("{{data:filepath_628}}"));
        await page.EnterButtonAsync(data.Resolve("{{data:button_629}}"));
        await page.ClickDIVDragAndDropFilesHereToUploadOrClickHereToOpenAFileExplorerAsync();
        await page.EnterCaptionAsync(data.Resolve("{{data:caption_631}}"));
        await page.EnterFilePathAsync(data.Resolve("{{data:filepath_632}}"));
        await page.EnterButtonAsync(data.Resolve("{{data:button_633}}"));
        ...
        {
                    await page.EnterCaptionAsync(data.Resolve("{{data:caption_638}}"));
        }
        await page.EnterFilePathAsync(data.Resolve("{{data:filepath_639}}"));
        await page.EnterButtonAsync(data.Resolve("{{data:button_640}}"));
        ...
        if (await page.IsCaptionPresentAsync())
        {
                    await page.EnterCaptionAsync(data.Resolve("{{data:caption_642}}"));
        }
        await page.EnterFilePathAsync(data.Resolve("{{data:filepath_643}}"));
        await page.EnterButtonAsync(data.Resolve("{{data:button_644}}"));
        await page.VerifyEQCommonLoadingIndicatorWaitAsync("Exists", "");
