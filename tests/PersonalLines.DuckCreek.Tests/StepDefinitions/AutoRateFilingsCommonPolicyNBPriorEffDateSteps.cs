...
public sealed class AutoRateFilingsCommonPolicyNBPriorEffDateSteps
{
    ...
    public async Task StartNewQuoteAsync()
    {
        ...
        await page.StartNewQuoteAsync6();
    }
    ...
    public async Task SelectOrCreateThePolicyClientAsync()
    {
        ...
        await page.SelectOrCreateThePolicyClientAsync6();
    }
    ...
    public async Task EnterAccountDetailsAsync()
    {
        ...
        await page.EnterAccountDetailsAsync6();
    }
    ...
    {
        var page = new ProposalPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.StartThePolicyProposalAsync6();
    }
    ...
    public async Task CompletePrequalificationAsync()
    {
        ...
        await page.CompletePrequalificationAsync4();
    }
    ...
    {
        var page = new ProposalPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CaptureTheProposalNumberAsync6();
    }
    ...
    public async Task CompleteDriverInformationAsync()
    {
        ...
        await page.CompleteDriverInformationAsync4();
    }
    ...
    {
        var page = new PolicyWorkflowPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.OpenTheConfiguredPolicyApplicationAsync4();
    }
    ...
    public async Task ApproveLevel9BAsync()
    {
        ...
        await page.ApproveLevel9BAsync4();
    }
    ...
    {
        var page = new UnderwritingPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteDriverInformationForTxtQuotePolicySearchAsync4();
    }
    ...
    {
        var page = new DriversPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteDriverInformationForExistingClient1Async4();
    }
    ...
    public async Task ReviewTheDriverInformationSummaryAsync()
    {
        ...
        await page.ReviewTheDriverInformationSummaryAsync4();
    }
    ...
    public async Task ReviewHouseholdDriverPrefillResultsAsync()
    {
        ...
        await page.ReviewHouseholdDriverPrefillResultsAsync4();
    }
    ...
    {
        var page = new VehiclesPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteVehicleSummaryAutomobileRateFilingCommonAutoAsync2();
    }
    ...
    {
        var page = new DriversPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteDriverAssignmentAsync4();
    }
    ...
    {
        var page = new DriversPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteMultipleDriverAssignmentAsync4();
    }
    ...
    public async Task CompleteClaimsViolationsAsync()
    {
        ...
        await page.CompleteClaimsViolationsAsync4();
    }
    ...
    {
        var page = new LossHistoryPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteEditClaimsViolationsAsync4();
    }
    ...
    public async Task CompleteDiscount1Async()
    {
        ...
        await page.CompleteDiscount1Async4();
    }
    ...
    public async Task CompleteCoveragesAsync()
    {
        ...
        await page.CompleteCoveragesAsync4();
    }
    ...
    public async Task CompleteAutoAddlCovPolicyCoveragessAsync()
    {
        ...
        await page.CompleteAutoAddlCovPolicyCoveragessAsync4();
    }
    ...
    {
        var page = new PolicyWorkflowPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteAutoAddlCovPIPAsync4();
    }
    ...
    {
        var page = new VehiclesPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteAutoAddlCovVehicleCoveragesAsync4();
    }
    ...
    {
        var page = new CoveragesPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteAutoAddlCovNextAsync4();
    }
    ...
    public async Task CompletePricingAndVerifyThePremiumAsync()
    {
        ...
        await page.CompletePricingAndVerifyThePremiumAsync4();
    }
    ...
    {
        var page = new UnderwritingPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteUnderwritingPageAutoAsync2();
    }
    ...
    public async Task CompleteAdditionalInterestPageAsync()
    {
        ...
        await page.CompleteAdditionalInterestPageAsync4();
    }
    ...
    public async Task ConfigureDirectPayBillingAsync()
    {
        ...
        await page.ConfigureDirectPayBillingAsync4();
    }
    ...
    public async Task CompleteTheLevel9UnderwritingBypassAsync()
    {
        ...
        await page.CompleteTheLevel9UnderwritingBypassAsync3();
    }
    ...
    {
        var page = new PolicyWorkflowPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.OpenTheConfiguredPolicyApplicationForOpenurlAsync4();
    }
    ...
    {
        var page = new LoginPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.ApproveTheUnderwritingReferralInExpressAsync3();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteTheLevel9UnderwritingBypassForTxtQuotePolicySearchAsync3();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteSubmissionUnderwritingCommentsAndReviewAsync4();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.OpenTheConfiguredPolicyApplicationFor15SubmissionAsync2();
    }
    ...
    {
        var page = new LoginPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteTheExpressUnderwritingReviewAsync4();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.RecallTheQuoteInExpertQuoteAsync4();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.CompleteTheSubmissionChecklistAsync4();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.TransmitThePolicyAsync4();
    }
    ...
    {
        var page = new SubmissionPage(_scenario.Get<BrowserSession>(), _scenario.Get<ScenarioData>(), _scenario.Get<PageUiActions>());
        await page.VerifyPolicyTransmissionConfirmationAsync4();
    }
