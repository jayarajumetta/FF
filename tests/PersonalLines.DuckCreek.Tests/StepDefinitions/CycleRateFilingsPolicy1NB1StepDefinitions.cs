...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Cycle Rate Filings Policy 1 NB 1")]
public sealed class CycleRateFilingsPolicy1NB1StepDefinitions
{
    private readonly CycleRateFilingsPolicy1NB1FlowPage _flow;

    public CycleRateFilingsPolicy1NB1StepDefinitions(CycleRateFilingsPolicy1NB1FlowPage flow)
    {
