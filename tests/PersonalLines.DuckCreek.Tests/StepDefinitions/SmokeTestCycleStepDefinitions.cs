...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Smoke Test Cycle")]
public sealed class SmokeTestCycleStepDefinitions
{
    private readonly SmokeTestCycleFlowPage _flow;

    public SmokeTestCycleStepDefinitions(SmokeTestCycleFlowPage flow)
    {
