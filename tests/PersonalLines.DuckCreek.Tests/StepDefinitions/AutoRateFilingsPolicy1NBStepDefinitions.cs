...
[Binding, Scope(Feature = "Personal Lines Duck Creek - Auto Rate Filings Policy 1 NB")]
public sealed class AutoRateFilingsPolicy1NBStepDefinitions
{
    private readonly AutoRateFilingsPolicy1NBFlowPage _flow;

    public AutoRateFilingsPolicy1NBStepDefinitions(AutoRateFilingsPolicy1NBFlowPage flow)
    {
