...
Feature: Personal Lines Duck Creek - Auto Rate Filings Policy 1 NB
  ...
  Scenario Outline: Create and verify a Personal Auto rate filing new business for <state>
    ...
    Examples:
      ...
      | 181_auto_rate_filings_policy_1_nb_al | Alabama | AL | Personal Auto | Rate Filing New Business | Current |
