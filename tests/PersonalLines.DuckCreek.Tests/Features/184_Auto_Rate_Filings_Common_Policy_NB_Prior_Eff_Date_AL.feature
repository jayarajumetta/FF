...
Feature: Personal Lines Duck Creek - Auto Rate Filings Common Policy NB Prior Eff Date
  ...
  Scenario Outline: Create and verify a Personal Auto new business with prior effective date for <state>
    ...
    Examples:
      ...
      | 184_auto_rate_filings_common_policy_nb_prior_eff_date_al | Alabama | AL | Personal Auto | New Business with Prior Effective Date | Prior |
