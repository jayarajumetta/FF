...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - BAP Basic Policy")]
public sealed class BAPBasicPolicyStepDefinitions
{
    private readonly BAPBasicPolicyFlowPage _flow;

    public BAPBasicPolicyStepDefinitions(BAPBasicPolicyFlowPage flow)
    {
