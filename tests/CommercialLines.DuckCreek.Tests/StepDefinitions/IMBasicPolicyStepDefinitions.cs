...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - IM Basic Policy")]
public sealed class IMBasicPolicyStepDefinitions
{
    private readonly IMBasicPolicyFlowPage _flow;

    public IMBasicPolicyStepDefinitions(IMBasicPolicyFlowPage flow)
    {
