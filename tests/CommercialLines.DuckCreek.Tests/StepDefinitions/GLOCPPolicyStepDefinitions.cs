...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - GL OCP Policy")]
public sealed class GLOCPPolicyStepDefinitions
{
    private readonly GLOCPPolicyFlowPage _flow;

    public GLOCPPolicyStepDefinitions(GLOCPPolicyFlowPage flow)
    {
