...
public sealed class GLOCPPolicySteps
{
    ...
    public async Task CompleteOCPRiskFieldsAsync()
    {
        ...
        await page.EnterGLOCPRiskTypeAsync(data.Resolve("{{data:type_107}}"));
        await page.EnterClassCodeAsync(data.Resolve("{{data:class_code_108}}"));
        await page.EnterPolicyHolderStateAsync(data.Resolve("{{data:state_109}}"));
        ...
        await page.EnterGLOCPRiskAddressAsync(data.Resolve("{{data:address_1_113}}"));
        await page.EnterGLOCPRiskZipCodeAsync(data.Resolve("{{data:zip_code_114}}"));
        await page.ClickCommonNavigationLinksNextAsync();
        await page.ClickOCPAsync();
        await page.WaitForOptionAAsync("Exists");
        await page.EnterGLOCPRiskTypeAsync(data.Resolve("{{data:type_118}}"));
        await page.EnterClassCodeAsync(data.Resolve("{{data:class_code_119}}"));
        await page.EnterPolicyHolderStateAsync(data.Resolve("{{data:state_120}}"));
        ...
        await page.EnterGLOCPRiskAddressAsync(data.Resolve("{{data:address_1_124}}"));
        await page.EnterGLOCPRiskZipCodeAsync(data.Resolve("{{data:zip_code_125}}"));
        await page.ClickCommonNavigationLinksNextAsync();
        await page.ClickOCPAsync();
        await page.WaitForOptionAAsync("Exists");
        await page.EnterGLOCPRiskTypeAsync(data.Resolve("{{data:type_129}}"));
        await page.EnterClassCodeAsync(data.Resolve("{{data:class_code_130}}"));
        await page.EnterPolicyHolderStateAsync(data.Resolve("{{data:state_131}}"));
        await page.EnterTotalCostOfWorkAsync("");
        ...
        await page.EnterGLOCPRiskAddressAsync(data.Resolve("{{data:address_1_135}}"));
        await page.EnterGLOCPRiskZipCodeAsync(data.Resolve("{{data:zip_code_136}}"));
        await page.ClickCommonNavigationLinksNextAsync();
    ...
    public async Task CompleteCG0424CoverageForInjuryToLeasedWorkersAsync()
    {
        ...
        {
            await page.EnterCG2401NonBindingArbitrationEndorsementTypeAsync(data.Resolve("{{data:endorsement_type_141}}"));
        }
    ...
    public async Task CompleteCG2401NonBindingArbitrationAsync()
    {
        ...
        if (data.Condition("'Endorsement Type' != NULL"))
        {
            await page.EnterCG2401NonBindingArbitrationEndorsementTypeAsync(data.Resolve("{{data:endorsement_type_147}}"));
        }
        await page.ClickOKAsync();
    ...
    public async Task CompleteCG2812PesticideOrHerbicideApplicatorCoverageAsync()
    {
        ...
        if (data.Condition("'Endorsement Type' != NULL"))
        {
            await page.EnterCG2401NonBindingArbitrationEndorsementTypeAsync(data.Resolve("{{data:endorsement_type_152}}"));
        }
    ...
    public async Task CompleteCG2935AddLInsuredStateOrPoliticalPermitsAsync()
    {
        ...
        await page.WaitForSignsHeadingAsync("Exists");
        await page.ClickAddAddlInterestAsync();
        await page.EnterCG2007AddLInsuredEngineersArchitectsTypeAsync(data.Resolve("{{data:type_168}}"));
        await page.EnterStateOrPoliticalSubdivisionAsync(data.Resolve("{{data:state_or_political_subdivision_169}}"));
        await page.EnterCG2935AddLInsuredStateOrPoliticalPermitsAddressAsync(data.Resolve("{{data:address_1_170}}"));
        await page.EnterLocationZipCodeAsync(data.Resolve("{{data:zip_code_171}}"));
        await page.ClickOKAsync();
    ...
    public async Task CompleteFG0013AutomaticAdditionalInsuredSpecificAsync()
    {
        ...
        await page.WaitForSignsHeadingAsync("Exists");
        await page.ClickAddAddlInterestAsync();
        await page.EnterFG0013AutomaticAdditionalInsuredSpecificRelationshipTypeAsync(data.Resolve("{{data:type_176}}"));
