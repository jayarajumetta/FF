...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - GL Basic Policy")]
public sealed class GLBasicPolicyStepDefinitions
{
    private readonly GLBasicPolicyFlowPage _flow;

    public GLBasicPolicyStepDefinitions(GLBasicPolicyFlowPage flow)
    {
