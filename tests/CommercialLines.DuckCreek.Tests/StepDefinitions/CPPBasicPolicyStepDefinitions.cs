...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - CPP Basic Policy")]
public sealed class CPPBasicPolicyStepDefinitions
{
    private readonly CPPBasicPolicyFlowPage _flow;

    public CPPBasicPolicyStepDefinitions(CPPBasicPolicyFlowPage flow)
    {
