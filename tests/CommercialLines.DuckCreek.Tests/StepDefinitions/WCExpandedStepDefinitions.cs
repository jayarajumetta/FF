...
[Binding, Scope(Feature = "Commercial Lines Duck Creek - WC Expanded")]
public sealed class WCExpandedStepDefinitions
{
    private readonly WCExpandedFlowPage _flow;

    public WCExpandedStepDefinitions(WCExpandedFlowPage flow)
    {
