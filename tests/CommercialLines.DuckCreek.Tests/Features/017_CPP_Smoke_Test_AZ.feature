@CL_DC @CPP @smoke_test @AZ @automated @canonical @artifact_v38 @smoke
Feature: Commercial Lines Duck Creek - CPP Smoke Test
  As a Commercial Lines Duck Creek policy processing user
  I want to complete the attached Commercial Package smoke test workflow
  ...
  Scenario Outline: Create and verify a Commercial Package smoke test for <state>
    ...
    Examples:
      ...
      | 017_cpp_smoke_test_az | Arizona | AZ | Commercial Package | Smoke Test | Current |
