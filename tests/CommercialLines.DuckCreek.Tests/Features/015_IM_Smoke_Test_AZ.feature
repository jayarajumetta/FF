...
Feature: IM Smoke Test
  ...
  Scenario Outline: IM Smoke Test - <stateCode>
    ...
    Examples:
      ...
      | TestData/Scenarios/015_im_smoke_test_az.json | AZ | AZ | Arizona |
      | TestData/Scenarios/015_im_smoke_test_ct.json | CT | CT | Connecticut |
      | TestData/Scenarios/015_im_smoke_test_de.json | DE | DE | Delaware |
      | TestData/Scenarios/015_im_smoke_test_ma.json | MA | MA | Massachusetts |
      | TestData/Scenarios/015_im_smoke_test_md.json | MD | MD | Maryland |
      | TestData/Scenarios/015_im_smoke_test_me.json | ME | ME | Maine |
      | TestData/Scenarios/015_im_smoke_test_nh.json | NH | NH | New Hampshire |
      | TestData/Scenarios/015_im_smoke_test_nj.json | NJ | NJ | New Jersey |
      | TestData/Scenarios/015_im_smoke_test_ny.json | NY | NY | New York |
      | TestData/Scenarios/015_im_smoke_test_or.json | OR | OR | Oregon |
      | TestData/Scenarios/015_im_smoke_test_pa.json | PA | PA | Pennsylvania |
      | TestData/Scenarios/015_im_smoke_test_ri.json | RI | RI | Rhode Island |
      | TestData/Scenarios/015_im_smoke_test_va.json | VA | VA | Virginia |
      | TestData/Scenarios/015_im_smoke_test_vt.json | VT | VT | Vermont |
      | TestData/Scenarios/015_im_smoke_test_wa.json | WA | WA | Washington |
      | TestData/Scenarios/015_im_smoke_test_wv.json | WV | WV | West Virginia |
