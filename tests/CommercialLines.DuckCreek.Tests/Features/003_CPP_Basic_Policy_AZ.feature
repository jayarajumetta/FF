@CL_DC @CPP @basic_new_business_policy @AZ @automated @canonical @artifact_v38 @regression
Feature: Commercial Lines Duck Creek - CPP Basic Policy
  As a Commercial Lines Duck Creek policy processing user
  I want to complete the attached Commercial Package basic new business policy workflow
  ...
  Scenario Outline: Create and verify a Commercial Package basic new business policy for <state>
    ...
    Examples:
      ...
      | 003_cpp_basic_policy_az | Arizona | AZ | Commercial Package | Basic New Business Policy | Current |
