...
@CL_DC @CPP @basic_new_business_policy @automated @canonical_simple_v39 @state_data_driven
...
# Page Objects Used: 9 | Locator Confidence Average: 89/100 | Review-required operations: 0
# Locator Review Items: 27 source-derived locator(s) remain below high confidence.
...
Feature: CPP Basic Policy
  ...
  Scenario Outline: CPP Basic Policy - <stateCode>
    ...
    Examples:
      ...
      | TestData/Scenarios/003_cpp_basic_policy_az.json | AZ | AZ | Arizona |
      | TestData/Scenarios/003_cpp_basic_policy_ct.json | CT | CT | Connecticut |
      | TestData/Scenarios/003_cpp_basic_policy_de.json | DE | DE | Delaware |
      | TestData/Scenarios/003_cpp_basic_policy_ma.json | MA | MA | Massachusetts |
      | TestData/Scenarios/003_cpp_basic_policy_md.json | MD | MD | Maryland |
      | TestData/Scenarios/003_cpp_basic_policy_me.json | ME | ME | Maine |
      | TestData/Scenarios/003_cpp_basic_policy_nh.json | NH | NH | New Hampshire |
      | TestData/Scenarios/003_cpp_basic_policy_nj.json | NJ | NJ | New Jersey |
      | TestData/Scenarios/003_cpp_basic_policy_ny.json | NY | NY | New York |
      | TestData/Scenarios/003_cpp_basic_policy_or.json | OR | OR | Oregon |
      | TestData/Scenarios/003_cpp_basic_policy_pa.json | PA | PA | Pennsylvania |
      | TestData/Scenarios/003_cpp_basic_policy_ri.json | RI | RI | Rhode Island |
      | TestData/Scenarios/003_cpp_basic_policy_va.json | VA | VA | Virginia |
      | TestData/Scenarios/003_cpp_basic_policy_vt.json | VT | VT | Vermont |
      | TestData/Scenarios/003_cpp_basic_policy_wa.json | WA | WA | Washington |
      | TestData/Scenarios/003_cpp_basic_policy_wv.json | WV | WV | West Virginia |
