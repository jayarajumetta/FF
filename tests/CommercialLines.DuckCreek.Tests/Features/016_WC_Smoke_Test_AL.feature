@CL_DC @WC @smoke_test @AL @automated @canonical @artifact_v38 @smoke
Feature: Commercial Lines Duck Creek - WC Smoke Test
  As a Commercial Lines Duck Creek policy processing user
  I want to complete the attached Workers Compensation smoke test workflow
  ...
  Scenario Outline: Create and verify a Workers Compensation smoke test for <state>
    ...
    Examples:
      ...
      | 016_wc_smoke_test_al | Alabama | AL | Workers Compensation | Smoke Test | Current |
