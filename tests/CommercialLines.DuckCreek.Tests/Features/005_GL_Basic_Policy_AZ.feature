@CL_DC @GL @basic_new_business_policy @AZ @automated @canonical @artifact_v38 @regression
Feature: Commercial Lines Duck Creek - GL Basic Policy
  As a Commercial Lines Duck Creek policy processing user
  I want to complete the attached General Liability basic new business policy workflow
  ...
  Scenario Outline: Create and verify a General Liability basic new business policy for <state>
    ...
    Examples:
      ...
      | 005_gl_basic_policy_az | Arizona | AZ | General Liability | Basic New Business Policy | Current |
