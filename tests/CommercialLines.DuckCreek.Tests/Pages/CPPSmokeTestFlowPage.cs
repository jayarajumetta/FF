...
public sealed class CPPSmokeTestFlowPage : IFlowPage
{
    private readonly CanonicalActionExecutor _executor;
    private readonly ScenarioDataContext _data;

    public CPPSmokeTestFlowPage(CanonicalActionExecutor executor, ScenarioDataContext data)
    {
    ...
    public Task ApplicationSetupAsync(CancellationToken cancellationToken = default) =>
        _executor.ExecuteAsync(CPPSmokeTestCanonicalMap.ApplicationSetup, _data, cancellationToken);
