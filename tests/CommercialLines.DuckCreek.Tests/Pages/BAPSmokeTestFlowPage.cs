...
public sealed class BAPSmokeTestFlowPage : IFlowPage
{
    private readonly CanonicalActionExecutor _executor;
    private readonly ScenarioDataContext _data;

    public BAPSmokeTestFlowPage(CanonicalActionExecutor executor, ScenarioDataContext data)
    {
    ...
    public Task ApplicationSetupAsync(CancellationToken cancellationToken = default) =>
        _executor.ExecuteAsync(BAPSmokeTestCanonicalMap.ApplicationSetup, _data, cancellationToken);
