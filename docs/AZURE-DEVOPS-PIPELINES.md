...
The framework calls NUnit `TestContext.AddTestAttachment` after the Playwright context is finalized. Each scenario can therefore attach its own:
...
- `execution.log`;
- browser `console.log`;
- network request/response/failure log;
