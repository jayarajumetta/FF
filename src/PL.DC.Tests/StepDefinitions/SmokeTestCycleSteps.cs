...
[Binding, Scope(Feature = "Smoke Test Cycle")]
public sealed class SmokeTestCycleSteps
{
    private readonly BrowserSession _browser;
    private readonly ScenarioData _data;
    public SmokeTestCycleSteps(BrowserSession browser, ScenarioData data) { _browser = browser; _data = data; }
