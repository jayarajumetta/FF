...
public sealed class BOP051
{
    private readonly IPage _page;
    private readonly ScenarioData _data;

    public BOP051(IPage page, ScenarioData data)
    {
        _page = page;
        _data = data;
    }

    private ILocator AcknowledgementLetterX5201 => BOP051Locators.AcknowledgementLetterX5201(_page);
    ...
    private ILocator Attach => BOP051Locators.Attach(_page);
