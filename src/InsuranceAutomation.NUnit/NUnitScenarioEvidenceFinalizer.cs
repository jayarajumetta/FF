...
/// Playwright trace/HAR/video are finalized before attachments are registered. Deferred Tosca
...
public static class NUnitScenarioEvidenceFinalizer
{
        ...
        Exception? scenarioError)
    {
        ...
        try
        {
            ...
            // Closing the context finalizes HAR and video; trace is stopped inside CloseAsync.
